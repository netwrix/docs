---
title: "Where is my PolicyPak Preferences Component license and how do I request one?"
description: "Where is my PolicyPak Preferences Component license and how do I request one?"
sidebar_position: 10
---

# Where is my PolicyPak Preferences Component license and how do I request one?

The Netwrix PolicyPak Preferences component is available only
upon request. It is still part of what you paid for, and you can ask for it at anytime. It is no
longer included by default because PolicyPak Preferences (PPPrefs) is typically not
