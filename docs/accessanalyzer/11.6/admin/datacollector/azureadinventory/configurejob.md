...
Creating the Connection Profile requires the Client ID and Key generated when you registered
Enterprise Auditor as a web application with Microsoft Entra ID. See the
