...
- Configures alerts related to VMware data source. Current version doesn't include predefined
  alerts for that data source, so follow the [Create Alerts](/docs/auditor/10.9/admin/alertsettings/create/create.md) to
