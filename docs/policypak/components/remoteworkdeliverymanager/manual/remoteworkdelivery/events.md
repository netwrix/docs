...
PolicyPak Remote Work Delivery Manager places events (like what is shown in Figure 57)
in the PolicyPak log (within Applications and Services Log). All PolicyPak Remote Work Delivery Manager events will have the PolicyPak Remote Work
Delivery Manager Client source type.

![tips_security_and_troubleshooting_8](/images/policypak/troubleshooting/remoteworkdelivery/tips_security_and_troubleshooting_8.webp)

Figure 57. PolicyPak Remote Work Delivery Manager events can be found in the PolicyPak node within Application and Services.
