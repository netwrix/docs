...
Privilege Secure. See the [Proxy Service Install](/docs/privilegesecure/25.12/install/servicesonadditional/proxyservice.md) topic for installation
instructions.
:::
...
![licenseagreement](/images/privilegesecure/25.12/accessmanagement/install/licenseagreement_4.webp)

**Step 4 –** To install the Scheduler Service in an alternate location, click **Options**.

![scheduleoptions](/images/privilegesecure/25.12/accessmanagement/install/scheduleoptions.webp)
...
![installcompleted](/images/privilegesecure/25.12/accessmanagement/install/installcompleted.webp)
