...
- Active Servers – Number of distinct servers accessed (destination IP Addresses) with any type of
  file activity over the specified time interval
...
- Top Users – Displays the top five users associated with file activity over the specified
  time interval
- Top Servers – Displays the top five servers (destination IP Addresses) associated with file
  activity over the specified time interval
- Latest Events – Tabular format of all file activity events over the specified time
  interval
