...
The Results page provides a checklist of the data that is available for return by the query. You
can select any number of options at once, but you must select at least one to complete
the wizard.
