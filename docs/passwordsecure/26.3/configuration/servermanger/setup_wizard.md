...
[General settings](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/general_settings.md).
...
This step can also be carried out later “in the [License settings](/docs/passwordsecure/26.3/configuration/servermanger/mainmenu/license_settings.md)
...
[Advanced settings](/docs/passwordsecure/26.3/configuration/servermanger/mainmenu/advanced_settings.md) and can also be edited there later on.
...
the [Advanced settings](/docs/passwordsecure/26.3/configuration/servermanger/mainmenu/advanced_settings.md) should it be necessary to make changes
later on.
...
[Backup management](/docs/passwordsecure/26.3/configuration/servermanger/mainmenu/backupsettings/backup_management.md) are created
and the [Certificates](/docs/passwordsecure/26.3/configuration/servermanger/certificates/certificates.md) are backed up.
