...
How to define the simple, or **scalar**, properties of an [Entity Type](../../../../integration-guide/toolkit/xml-configuration/metadata/entitytype)'s resources.
...
Before saving, you must first [Select Primary Keys](../../../../user-guide/set-up/connect-system/entity-type-creation/key-selection)for the entity type.
