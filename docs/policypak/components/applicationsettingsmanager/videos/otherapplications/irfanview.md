---
title: "PolicyPak for IrfanView"
description: "PolicyPak for IrfanView"
sidebar_position: 50
---
# PolicyPak for IrfanView
...
That's where Netwrix PolicyPak comes in. We enforce and lock down
the optimum settings that you, the administrator, want them to have. PolicyPak sets
and enforces expectations for your users' applications, so that they get the same experience, every
time they launch it. Oh, and PolicyPak also supports IrfanView too, just as we do so
many other applications. Keep your IrfanView configuration settings enforced and streamlined with
PolicyPak. Check out this video to see how it's done.

<iframe width="560" height="315" src="https://www.youtube.com/embed/evQsOAGTczo" title="PolicyPak: Manage InfranView using Group Policy, SCCM or your own management utility" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
