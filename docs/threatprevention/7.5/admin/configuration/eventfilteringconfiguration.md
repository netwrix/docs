...
Repeat the process until all hosts for which authentication event data won't be collected have
...
[Select Active Directory Perpetrators Window](/docs/threatprevention/7.5/admin/policies/configuration/eventtype/window/perpetrators.md)
to browse for the accounts. Account names [domain name\account] can also be typed in the
...
Select the Send Latency Alerts checkbox to enable this option. Use the arrows, or enter into the
