...
- Approvers at [Approvers Dashboard: Approvers](/docs/privilegesecure/26.03/enduser/dashboard/approvals.md)
- Auditors at [Historical Dashboard: Auditors](/docs/privilegesecure/26.03/enduser/dashboard/historicalauditor/historical.md)
- Reviewers at [Audit and Reporting: Reviewer](/docs/privilegesecure/26.03/enduser/auditreviewer.md)
...
[Browser Extension App](/docs/privilegesecure/26.03/enduser/browserextension/browserextension.md) topic for additional information.
...
![Default Login](/images/privilegesecure/26.03/accessmanagement/enduser/defaultloginuser.webp)
...
![Alternate Login](/images/privilegesecure/26.03/accessmanagement/enduser/alternatelogin.webp)
...
![Okta authentication connector](/images/privilegesecure/26.03/accessmanagement/enduser/oktadefault.webp)
...
![Multi Factor Authentication Login](/images/privilegesecure/26.03/accessmanagement/enduser/mfalogin.webp)

**Step 7 –** Click MFA Login. Privilege Secure opens on the Dashboard Interface.

![Dashboard Interface](/images/privilegesecure/26.03/accessmanagement/enduser/active.png)
