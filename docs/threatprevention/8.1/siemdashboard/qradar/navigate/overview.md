...
![Overview Dashboard](/images/threatprevention/8.1/siemdashboard/qradar/dashboard/overview.webp)
...
- Authentication Attacks – Number of authentication attacks that started in the specified timeframe,
  ...
  [Authentication Attacks Dashboard](/docs/threatprevention/8.1/siemdashboard/qradar/navigate/authenticationattacks.md).
- AD Changes – Number of Active Directory changes recorded in the specified timeframe, i.e., last
  ...
  [AD Changes Dashboard](/docs/threatprevention/8.1/siemdashboard/qradar/navigate/adchanges.md).
...
- Attacks by Type – Breakdown of authentication attacks that started within the last three (3) hours
  by type of attack. See the [Graph Card Features](/docs/threatprevention/8.1/siemdashboard/qradar/navigate/navigate.md#graph-card-features) topic for
