...
Note that when the reversion mode is set, the text in the PolicyPak Application
Settings Manager user interface changes to italics as a visual signal, as seen In the figure shown.

![policypak_application_settings_1_6](/images/policypak/applicationsettings/modes/endpointpolicymanager_application_settings_1_6.webp)
