...
![Search for KMS Service](/images/privilegesecure/26.03/accessmanagement/requirements/searchkms.webp)

**Step 4 –** On the Specify permissions page, navigate to the Select a service box and search for
the ‘KMS’ service.

![Select KMS option](/images/privilegesecure/26.03/accessmanagement/requirements/selectkms.webp)

**Step 5 –** Select the **KMS** option.

![Select Decrypt permission checkbox](/images/privilegesecure/26.03/accessmanagement/requirements/selectdecryptioncheckbox.webp)

**Step 6 –** Under the Write dropdown menu, locate, and select the **Decrypt permission** checkbox.

![Select Any In This Account](/images/privilegesecure/26.03/accessmanagement/requirements/selectanyinthisaccount.webp)
...
![Review and Create the Policy](/images/privilegesecure/26.03/accessmanagement/requirements/reviewandcreate.webp)
...
![Create User Name](/images/privilegesecure/26.03/accessmanagement/requirements/enterusername.webp)
...
![Select Attach Policies Directly](/images/privilegesecure/26.03/accessmanagement/requirements/selectattachpoliciesdirectly.webp)
...
![Review and Create the User Cofiguration](/images/privilegesecure/26.03/accessmanagement/requirements/reviewandcreate.webp)

**Step 6 –** On the Review and create window, review the policy configuration and click **Create
now**.

![User Security Credentials Tab](/images/privilegesecure/26.03/accessmanagement/requirements/usersecuritycredentialstab.webp)
...
![Select Application Running Outside AWS](/images/privilegesecure/26.03/accessmanagement/requirements/selectapplicationrunningoutsideaws.webp)

**Step 9 –** after the creation window opens, select the **Application running outside of AWS**
option.

![Set Tag and Create Key](/images/privilegesecure/26.03/accessmanagement/requirements/settagcreatekey.webp)

**Step 10 –** Set an optional description tag if required, and then select **Create access key**.

![Copy Access Key](/images/privilegesecure/26.03/accessmanagement/requirements/copyaccesskey.webp)
...
![Select Create Key](/images/privilegesecure/26.03/accessmanagement/requirements/selectcreatekey.webp)

**Step 3 –** Select **Create Key**.

![Configure Key Window](/images/privilegesecure/26.03/accessmanagement/requirements/configurekeywindow.webp)

**Step 4 –** For Key Type, Select **Symmetric**. For Key Usage, select **Encrypt and decrypt**.
Click **Next** to continue.

![Add Alias Key Name](/images/privilegesecure/26.03/accessmanagement/requirements/addaliaskeyname.webp)

**Step 5 –** Add an Alias for the key. The Description and Tags are optional. Click **Next** to
continue.

![Add Key Admin](/images/privilegesecure/26.03/accessmanagement/requirements/addkeyadmin.webp)
...
![Add Key User](/images/privilegesecure/26.03/accessmanagement/requirements/addkeyuser.webp)
...
![ANR Key Completed](/images/privilegesecure/26.03/accessmanagement/requirements/arnkeycomplete.webp)
...
![AIM Policy Permissions Tab](/images/privilegesecure/26.03/accessmanagement/requirements/aimpolicypermissionstab.webp)

**Step 2 –** Select the **Permissions** tab.

**Step 3 –** Click the **Edit** button.

![Policy Editor Window](/images/privilegesecure/26.03/accessmanagement/requirements/policyeditorwindow.webp)

**Step 4 –** after the policy editor window opens, switch to the Visual display mode and expand the
KMS item dropdown.

![Expand Resources Item](/images/privilegesecure/26.03/accessmanagement/requirements/expandresourcesitem.webp)
...
![Add ARN KMS Policy Key](/images/privilegesecure/26.03/accessmanagement/requirements/addarn.webp)

**Step 7 –** Paste the copied ARN for the NPS key into the bottom box then

**Step 8 –** Click **Add ARNs**.

![Review and Save Policy Changes](/images/privilegesecure/26.03/accessmanagement/requirements/reviewandsavepolicychanges.webp)
...
Privilege Secure. See the [AWS KMS Key Rotation](/docs/privilegesecure/26.03/requirements/awskey/awskeyrotation.md) topic for additional
information.
