...
description: >-
  ...
  a domain controller when the Password Scanner is enabled, and shows
...
- Netwrix Password Policy Enforcer Mailer is required for the Password Scanner to operate. If it was not installed previously, refer to the following article for additional information on installation: Administration − Mailer ⸱ v10.2: https://docs.netwrix.com/docs/passwordpolicyenforcer/11_0
