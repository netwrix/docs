...
The Oracle Solution requires a special Access Analyzer license. Install it from the Access
Analyzer Instant Job Wizard. After you install it into the Jobs tree, navigate to the
