...
To install the Dell CEE, complete these steps:
...
After Dell CEE installation is complete, you must complete the
...
one where the Activity Monitor activity agent is deployed. In those cases, you must
