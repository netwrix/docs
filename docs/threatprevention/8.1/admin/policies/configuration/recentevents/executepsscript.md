...
This folder contains an example script. The example PowerShell script creates or appends
...
:::note
For a PowerShell script to reference the selected event data, use the
...
See the [Default PowerShell 4.0 Script](/docs/threatprevention/8.1/admin/policies/configuration/actions/powershell.md#default-powershell-40-script) topic
