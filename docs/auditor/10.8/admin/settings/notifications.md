...
To run following commands using PowerShell.
...
For more information about product health, see the
[Health Status Dashboard](/docs/auditor/10.8/admin/healthstatus/dashboard/overview.md) topic. You can also navigate to the Health status tile in the main
window to access the Health Status dashboard, which contains information on the product
activity and system health state.
