...
![addactionwindow](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/activities/addactionwindow.webp)
...
See the [Action Types](/docs/privilegesecure/26.03/admin/activities/addaction/activityactiontypes.md) section for detailed descriptions of the
fields.
...
:::note
It isn't possible to change the Action Type after the action is created. Delete the
...
Post-Session group. See the [Protection Policies Page](/docs/privilegesecure/26.03/admin/resources/protectionpolicies/protectionpolicies.md) topic for
additional information.

:::note
It isn't necessary to select a protection policy. All protection policies that apply to
