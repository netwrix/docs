...
Data Collector. They contain additional information for building queries. The following is an
...
The following table translates the types of exceptions you might encounter.
