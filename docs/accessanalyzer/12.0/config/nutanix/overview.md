...
See the [Nutanix Appliance Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/config/nutanix/access.md) topic for
...
[Nutanix Files Activity Auditing Configuration](/docs/accessanalyzer/12.0/config/nutanix/activity.md) topic for instructions.
