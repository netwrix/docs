...
:::info
When deploying multiple Dell CEE instances at scale, configure an accommodating agent for each CEE
instance. If multiple CEE instances send events
...
exactly match the name entered in the Activity Monitor for the **Monitored Host** list.
