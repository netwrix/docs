...
Sensitive Data Discovery Auditing scans on SharePoint Online. You can configure the Netwrix Activity
Monitor to monitor activity on SharePoint Online and make the event data available for Access
