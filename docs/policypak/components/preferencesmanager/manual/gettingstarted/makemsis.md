---
title: "Using the PolicyPak Exporter to Make MSIs"
description: "Using the PolicyPak Exporter to Make MSIs"
sidebar_position: 10
---

# Using the PolicyPak Exporter to Make MSIs

:::note
For an overview of the PolicyPak Exporter utility, please watch this video:
[](https://www.policypak.com/video/endpointpolicymanager-preferences-with-endpointpolicymanager-exporter.html)[PolicyPakPreferences with PolicyPak Exporter](/docs/policypak/archive/preferencesexporter.md)l.
:::


PolicyPak Exporter's job is to take Microsoft or PolicyPak items and
...
:::note
Non-domain-joined machines are never supported via the PolicyPak Preferences
...
PolicyPak Cloud or PolicyPak MDM.
:::


**Step 1 –** Run the PolicyPak Exporter utility on your management station. You can
find it on the Start Menu (for pre-Windows 8 systems).

![quickstart_using_policypak_4](/images/policypak/preferences/quickstart_using_endpointpolicymanager_4.webp)

**Step 2 –** In the PolicyPak Exporter tool, select **Create a new MSI installer** and
click **Next**.

![quickstart_using_policypak_5](/images/policypak/preferences/quickstart_using_endpointpolicymanager_5.webp)
...
![quickstart_using_policypak_6](/images/policypak/preferences/quickstart_using_endpointpolicymanager_6.webp)
...
![quickstart_using_policypak_7](/images/policypak/preferences/quickstart_using_endpointpolicymanager_7.webp)
...
![quickstart_using_policypak_8](/images/policypak/preferences/quickstart_using_endpointpolicymanager_8.webp)

See Appendix A: [Using PolicyPak with MDM and UEM Tools](/docs/policypak/gettingstarted/mdmmanual/uemtools/uemtools.md) for
additional information on the PolicyPak Exporter utility
