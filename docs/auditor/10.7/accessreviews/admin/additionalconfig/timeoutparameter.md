...
1. Open the `AccessInformationCenter.Service.exe.Config` file with a text editor, e.g.
Notepad.
...
2. Change the value for the `AuthSessionTimeout` parameter to the number of
minutes. For example:
