...
The Microsoft Entra ID User Details page provides information about a user, including the threats
the user generated, the user's activity, group membership, and role assignments.
