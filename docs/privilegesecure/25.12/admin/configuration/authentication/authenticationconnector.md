...
![addauthentication](/images/privilegesecure/25.12/accessmanagement/admin/configuration/add/addauthentication.webp)
...
See the [OpenID Connect Authentication](/docs/privilegesecure/25.12/admin/configuration/authentication/openidconnectconfigu/openidconnectauthentication.md)
