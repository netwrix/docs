---
title: "PolicyPak Software Package Manager: AppX Manager"
description: "PolicyPak Software Package Manager: AppX Manager"
sidebar_position: 10
---

# PolicyPak Software Package Manager: AppX Manager

Want to nuke Candy Crush and other pre-installed Windows 10 apps? And would you like to nicely
install Windows Store apps? You've got it with Netwrix PolicyPak
Software Package Manager and our AppX Manager function.

<iframe width="560" height="315" src="https://www.youtube.com/embed/NT07ngb0aJM" title="PolicyPak Software Package Manager: AppX Manager" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
all this using PolicyPak Software Manager and our AppX function.

What are we going to do? For all of our e-sales users, we can say Manage Our Windows Store and AppX.
We can right click Edit here. Then we'll dive down under user side under PolicyPak.
We're going to find the Apps and Patch Management, then Software Package Manager. PolicyPak has a lot of features, but this is just for Software Package Manager.
...
that is called the PolicyPak Helper utility here.

I'll go to File Explorer, and I will go to my Extras. Let's find our PolicyPak Helper
utility here. I'm going to go ahead and run the PolicyPak Software Package Manager
...
Now that we have the link here, we're ready to go back to PolicyPak land, Add a New
...
Check out our other videos if you like PolicyPak Package Manager and everything we
