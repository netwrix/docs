...
![Investigate interface - Data Grid](/images/threatprevention/8.1/admin/investigate/datagrid.webp)
...
[Event Viewer Window](/docs/threatprevention/8.1/admin/policies/configuration/recentevents/eventviewer.md) with detailed information on the
...
- Perpetrator: Access URL – Raw data, the combination of the protocol, IP address, and the Port used
  ...
  - Process Guardian monitoring/blocking – Process name that is modifying or attempting to modify
    target process
...
[Export Data](/docs/threatprevention/8.1/admin/navigation/datagrid.md#export-data) topic.
