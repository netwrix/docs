...
tenant environment you want to use.

2. Select the authentication method that will be used when accessing Office 365 services:
...
1. Select the monitoring plan item.

2. In the item configuration menu, select Netwrix Privilege Secure as an option for data collection.

![npsdatacollectingaccount](/images/auditor/10.7/configuration/grouppolicy/npsdatacollectingaccount.webp)

3. Select the type of Access Policy you want to use in Netwrix Privilege Secure.
...
documentation for details on Access Policies.
...
:::note
Netwrix recommends using different credentials for different monitoring plans and data sources.
:::
