...
If there have been additional security or permission modifications on the servers, you may need to
enable the following rights and policies on the targeted host:
