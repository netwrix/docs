...
one policy is assigned to a user, and Password Policy Enforcer can't decide which policy to enforce
...
**Step 3 –** Select the policy you want.
...
Policies page to quickly determine which policy Password Policy Enforcer enforces for a
particular user.
