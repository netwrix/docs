...
Audits Events Collection category. To customize configurations, complete the following steps.
...
[SQL Data Collector](/docs/accessanalyzer/12.0/admin/datacollector/sql/overview.md) page. Select the scan options
you want. The query is preconfigured with the following default settings:
