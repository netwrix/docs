...
![Add Resources window showing the Import from AD option](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/resources/addresourcesonboardad.webp)
...
![Add Resources window showing the Import from CSV option](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/resources/addresourcesonboardcsv.webp)
...
columns. See the [Create Resource Import CSV File](/docs/privilegesecure/26.03/admin/resources/addserver/resourceimportcsv.md) topic for
...
![Add Resources window showing the Add Manually option](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/resources/addresourcesonboardmanually.webp)
