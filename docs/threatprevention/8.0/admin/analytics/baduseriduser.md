...
![Bad User ID (by User) Analytic Type - Settings tab](/images/threatprevention/8.0/admin/analytics/baduseridsettings.webp)
...
![Bad User ID (by User) Analytic Type - Policy tab](/images/threatprevention/8.0/admin/analytics/policytab.webp)
...
![Bad User ID (by User) Analytic Type  window](/images/threatprevention/8.0/admin/analytics/baduseriduser.webp)
