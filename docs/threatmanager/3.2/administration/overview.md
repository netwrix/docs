...
- Threats – Opens the [Threats Page](/docs/threatmanager/3.2/administration/threats/threats.md)
- Investigate – Opens the [Investigations Interface](/docs/threatmanager/3.2/administration/investigations/overview.md)
