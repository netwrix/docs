...
- Informative APIs
  ...
  the [Agents Interface](/docs/threatprevention/8.0/admin/agents/overview.md) and a list of available PowerShell APIs the
  user can use.
  :::
...
- The PowerShell service account must be an Active Directory account with the Threat Prevention
  ...
  [Users and Roles Window](/docs/threatprevention/8.0/admin/configuration/userroles/overview.md).
...
**Step 1 –** Create a policy in the Administration Console and export it as an XML file.
...
[Add or Modify Policies](/docs/threatprevention/8.0/api/policy.md#add-or-modify-policies) instructions.
