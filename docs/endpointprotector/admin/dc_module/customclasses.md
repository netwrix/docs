...
![Choose to log out or continue your session, resetting the session timeout interval](/images/endpointprotector/5.9.4.2/admin/systemconfiguration/sessiontimeout.webp)
