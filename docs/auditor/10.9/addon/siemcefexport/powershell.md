...
while. Ensure the script execution completed successfully. The add-on creates the CEF log file in the
destination folder.

:::note
Details (or "msg" in CEF terms) exceeding 16,000 characters are trimmed.
:::
