---
title: "PolicyPak Cloud Scripts Manager: Distribute and Import X.509 certificates"
description: "PolicyPak Cloud Scripts Manager: Distribute and Import X.509 certificates"
sidebar_position: 10
---
# PolicyPak Cloud Scripts Manager: Distribute and Import X.509 certificates

Use Netwrix PolicyPak Cloud and Scripts Manager to distribute and
import X.509 certificates to your endpoints, regardless of where they may reside, for use with
PolicyPak VPN Manager or any any other purpose you have.

<iframe width="560" height="315" src="https://www.youtube.com/embed/yUj83ArFyZI" title="PolicyPak Cloud Scripts Manager: Distribute and Import X.509 certificates" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Hi, there. This is John Demianiuk with PolicyPak Software. I'm going to show you how
to use PolicyPak Cloud and Scripts Manager to distribute and import your custom 509
Certificates to use with PolicyPak VPN Manager or for any other purposes you may need
...
The first thing is to log onto our PolicyPak Portal. All of our clients have access to
...
Let's start creating the rule. Let's head over to the PolicyPak Cloud Editor. I'm
...
The next thing we're going to do is we're going to tell PolicyPak to apply those
policies. You don't have to do this. I'm just accelerating the hands of time to get this done.
PolicyPak does by default every hour run a sync and update your policies. That is
