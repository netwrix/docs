...
![Netwrix Threat Manager installer — Move Database option](/images/threatmanager/3.3/install/upgrade/migration.webp)
...
![Netwrix Threat Manager installer — database connection page](/images/threatmanager/3.3/install/upgrade/port5435.webp)
...
![Netwrix Threat Manager installer — NTM Updated](/images/threatmanager/3.3/install/upgrade/pg18_step3.webp)
...
![Netwrix Threat Manager installer — move database connection page](/images/threatmanager/3.3/install/upgrade/port5439.webp)
...
- **Show Advanced Settings** – Expands the following additional parameters:
    ...
    - **Compression Level** – Select the compression level applied to the exported data. Higher
      compression reduces the disk space required but increases migration time. Options:
        ...
        ![PostgreSQL migration — thread settings](/images/threatmanager/3.3/install/postgresqlthreads.webp)
...
![PostgreSQL migration — ready for migration](/images/threatmanager/3.3/install/readyformigration.webp)
...
![System Health page showing PostgreSQL version 18](/images/threatmanager/3.3/install/upgrade/system_health_pg18.webp)
