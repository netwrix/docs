---
title: "Managing Group Policy using PolicyPak and PDQ Deploy"
description: "Managing Group Policy using PolicyPak and PDQ Deploy"
sidebar_position: 10
---
...
using Netwrix PolicyPak and PDQ Deploy together to manage the
...
of this man: GPanswers, the founder of PolicyPak, Microsoft MVP, Enterprise Mobility.
...
this video, we're going to do a setup of getting PolicyPak ready. If you decide that
you like what you see in this series of videos and you want to try PolicyPak and/or
...
What we just said is we're going to add a little muscle to this by adding the PolicyPak node. This is super easy. You probably want to do this step by hand. You could use PDQ
Deploy to do it, but just to make things easier for this demonstration, I just want to go to the
downloaded PolicyPak, which you get my contacting PolicyPak first of
...
Step number two is one of the superpowers that PolicyPak has is the ability to manage
...
one domain controller which is to say your Central Store for PolicyPak.

What we're going to do here is we're going to take the PolicyPak stuff, and I've
...
PolicyPak is going to be – I know, wait for it, this is super complicated – "PolicyPak."

Shane:If you're lost by creating a folder, you probably need a couple of other videos.

Jeremy: Yeah, this is not the tool for you. We'll go ahead and create the "PolicyPak"
...
more time. If we take a look, we can go to user or computer, "PolicyPak." Take a look
...
this "PolicyPak CSE," the client side extensions, perfect.
...
There's our "PolicyPak CSE," and we'll go ahead and deploy. Obviously, you could
...
Jeremy: The best part is no reboot required. Once you get it deployed out there, PolicyPak is automatically working, ready to rock from moment zero. You don't have to wait for a
reboot or schedule a reboot. We're just ready to rock since it's installed. That's it. PolicyPak is fully deployed. We have it all ready to go, and we're ready to actually do some
work with PolicyPak and PDQ.
