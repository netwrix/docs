...
**Note:** Some of the following reports are marked as obsolete but remain available for backward compatibility. Renewed versions of these reports are available under **SharePoint Online** in the **Reports** section and are described later in this article. All other reports remain current and fully supported.
...
The renewed reports appear in the following table.
