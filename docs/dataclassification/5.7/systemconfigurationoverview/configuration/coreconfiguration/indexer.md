...
| DocumentID`<N>` Mapping          | Used to map fields into the search index ID references. Allows for custom queries based on external IDs against the SOAP search API calls.                                                                    | These are ID3 — ID8                                                                                                                                                      |
