...
issue arises, a red icon indicates the problem. If a problem occurs, you can either fix the CSV
...
a previously added service account with credentials for the selected resources. The selection populates the Service Account value for resources without an assigned Credential from the import file.
