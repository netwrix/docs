...
2. On the Review Type page, provide the following information and click **Next**:
...
3. On the Resources page, select the resources to be included in the review. The Search
...
- Select the resources and click **Add**. The **View Selections** button indicates how
...
- After the resources have been selected, click **Next**.
...
4. On the Summary page, review the settings and click Finish. The Access Reviews begins to
