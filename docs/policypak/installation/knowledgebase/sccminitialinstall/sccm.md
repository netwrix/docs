---
title: "How do I deploy the PolicyPak CSE via SCCM (or other systems management system) ?"
description: "How do I deploy the PolicyPak CSE via SCCM (or other systems management system) ?"
sidebar_position: 10
---

# How do I deploy the PolicyPak CSE via SCCM (or other systems management system) ?

Using SCCM to deploy the Netwrix PolicyPak CSE is a simple
...
- Internet Explorer should be closed when deploying the PolicyPak CSE to avoid
