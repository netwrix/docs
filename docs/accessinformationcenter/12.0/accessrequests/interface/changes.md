...
Select the request you want on the [Request History Tab](/docs/accessinformationcenter/12.0/accessrequests/interface/interface.md#request-history-tab) of the
