...
Threat Prevention for objects on the [Active Directory Page](/docs/identityrecovery/2.6/admin/activedirectory/overview.md).
...
![Netwrix Integrations page](/images/identityrecovery/2.6/admin/configuration/integrations.webp)
...
- Click the Add account access button to add an account. The Add Account Access wizard is displayed.
    ...
    ![Add Account Access wizard - Account page](/images/identityrecovery/2.6/admin/configuration/account.webp)
...
- Enter a user's first or last name, display name, sAMAccountName, or group name in the **Search**
  ...
  Select the desired user and click **Next**.
    ...
    ![Add Account Access wizard - Confirm page](/images/identityrecovery/2.6/admin/configuration/confirm_3.webp)
...
[Integration with Threat Prevention](/docs/identityrecovery/2.6/admin/activedirectory/overview.md#integration-with-threat-prevention)
