...
displayed for a template in the list on the [Templates Interface](/docs/threatprevention/8.1/admin/templates/overview.md).
...
[Templates Interface](/docs/threatprevention/8.1/admin/templates/overview.md). Active at Specified Times is represented by a clock icon, and
