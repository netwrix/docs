...
To back up the Self-Service portals created using GroupID 9.0, and 10.0.
...
To restore GroupID Self-Service portals.
...
To back up Password Center User and Helpdesk portals created using GroupID 9.0
and 10.0.
...
To restore Password Center portals to Directory Manager.
...
To create a backup of jobs created with GroupID 9.0 and 10.0 Synchronize.
...
:::note
If some scheduled tasks are defined for Synchronize jobs, you don't need to create their
...
To restore jobs from Directory Manager 9.0 and 9.0.
...
To create a backup of Directory Manager 9.0 and 10.0 Reports:
...
Note: You don't need to create a backup of scheduled tasks that include report criteria. On
...
To restore Directory Manager 9.0 and 10.0 Reports:

Step 1 – Copy the data from the backup folder you created in the previous steps.

Step 2 – On the Windows Run dialog box, enter the path of the location where the reports are saved
and run the command:
