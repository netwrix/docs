...
These tables and their associated views appear in the following table:
...
NIS Data Collector. They contain additional information for building queries. The following table
explains the corresponding view created for some of the tables generated by the NIS Data Collector:
