...
![  Recovery Configuration Utility](/images/recoveryforactivedirectory/3.1/install/configurationutility.png)
...
![RSAT Extension Registered message](/images/recoveryforactivedirectory/3.1/install/rsatextensionregistered.webp)
...
![RSAT Extension Not Registered message](/images/recoveryforactivedirectory/3.1/install/rsatextensionunregistered.webp)
...
[Update SQL Server Service Account Password](/docs/recoveryforactivedirectory/3.1/troubleshooting/credentialpasswords/sqlserverserviceaccount.md)
topic.
