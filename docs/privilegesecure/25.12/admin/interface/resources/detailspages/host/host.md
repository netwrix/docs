...
- Test button — Opens the Test Resource Connectivity window. See the
  [Test Resource Connectivity Window](/docs/privilegesecure/25.12/admin/interface/resources/testresourceconnectivity.md) topic
...
- WinRM Config button — Opens the Configure Secure WinRM Connection window. See the
  [Configure Secure WinRM Connection Window](/docs/privilegesecure/25.12/admin/interface/resources/configuresecurewinrmconnection.md)
