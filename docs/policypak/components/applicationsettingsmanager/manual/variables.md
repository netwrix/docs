...
Netwrix PolicyPak Application Settings Manager can use
...
But when you're using PolicyPak Application Settings Manager, you can specify
...
PolicyPak also supports the use of variables such as `%USERPROFILE%\Favorites` or
