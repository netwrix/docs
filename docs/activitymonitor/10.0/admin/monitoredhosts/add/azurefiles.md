...
Before adding Azure Files storage accounts to the Activity Monitor, the prerequisites for the target environment
must be met. See the [Azure Files Requirements](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/azure-files/azurefiles-activity.md) 
topic for additional information.

Use the following steps to add Azure Files storage accounts to be monitored:
