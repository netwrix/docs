...
:::note
To get an overview of PolicyPak Browser Router and Internet Explorer in Edge
Mode, please see:
[PolicyPak Browser Router: Internet Explorer in Edge mode](/docs/policypak/components/browserrouter/videolearningcenter/tipsandtricks/ieedgemode.md).
:::
...
users to open a dedicated IE session for these sites, you can use PolicyPak Browser
...
![about_policypak_browser_router_29](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_29.webp)
...
see that the PolicyPak website now appears in IE mode within the Edge browser itself:

![about_policypak_browser_router_30](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_30.webp)

### Converting Existing IE Site List XMLs

:::note
To get an overview on how to convert existing IE site lists, please see
[Internet Explorer to PolicyPak Browser Router Site lists](/docs/policypak/components/browserrouter/videolearningcenter/tipsandtricks/iesitelists.md).
:::


See how you can take a Microsoft Enterprise Mode Internet Explorer site list and quickly convert it
to be used in PolicyPak Browser Router. This saves you the time and trouble of
...
![about_policypak_browser_router_31](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_31.webp)

When this is complete, save the list as an XML file. Once you have a list, create a **From
Enterprise Mode Site List** rule using PolicyPak Browser Router.

![about_policypak_browser_router_32](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_32.webp)
...
![about_policypak_browser_router_33](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_33.webp)

The imported rules now appear.

![about_policypak_browser_router_34](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_34.webp)

You can review any of the rules to confirm or change their settings.

![about_policypak_browser_router_35](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_35.webp)
...
:::note
To get an overview of PolicyPak Browser Router's special policies for
Microsoft Edge, please see
[PolicyPak and Edge ‘Special' policies](/docs/policypak/components/browserrouter/videolearningcenter/gettingstarted/edgespecial.md).
:::


The policies are **All intranet to IE** policy and **All Enterprise from Edge to I**E policy.

![about_policypak_browser_router_36](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_36.webp)
