...
![Add secrete Vault Resource](/images/privilegesecure/25.12/accessmanagement/admin/configuration/add/addsecretvault.webp)
...
[Secret Vault Details Page](/docs/privilegesecure/25.12/admin/interface/resources/detailspages/secretvault/secretvault.md) topic for additional
information.
...
time on the [Connection Profiles Page](/docs/privilegesecure/25.12/admin/interface/accesspolicy/connectionprofiles/connectionprofiles.md) page or use the
...
[Users Tab for Credential Based Access Policies](/docs/privilegesecure/25.12/admin/interface/accesspolicy/credentialbasedpolic/users.md) for
