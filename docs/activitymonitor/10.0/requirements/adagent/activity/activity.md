...
See the [File Archive Repository Option](/docs/activitymonitor/10.0/requirements/adagent/activity/filearchive.md) topic for additional information on that
option.
...
To set up integration between Activity Monitor and Access Analyzer through an API server:
...
- Configure the following:
    ...
    - Click **Copy** and save the Client Secret value to a text file.
        ...
        :::warning
        It isn't possible to retrieve the value after closing the Add or edit
...
- The IPv4 or IPv6 allowlist limits access to the API server data to specific hosts.
...
To configure the monitored domain output for Netwrix Access Analyzer:
...
The Access Analyzer requires additional configurations to collect domain activity data.
...
![Active Directory Activity DC wizard Category page](/images/activitymonitor/9.0/config/activedirectory/categoryimportfromnam.webp)

**Step 4 –** On the Category page, choose **Import from SAM** option and click **Next**.

![Active Directory Activity DC wizard SAM connection settings page](/images/activitymonitor/9.0/config/activedirectory/namconnection.webp)
...
![Active Directory Activity DC wizard Scoping and Retention page](/images/activitymonitor/9.0/config/activedirectory/scope.webp)
...
**AD_ActivityCollection** Job. However, this is disabled by default. To enable the importing of AD activity data into the Access Information Center:
