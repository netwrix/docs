...
Access Analyzer users should be familiar with several special features and functions available for
...
You can send generated but unpublished reports to the Web Console by using the
...
You can track job configuration changes using the **Changes** option in the right-click menu from
...
You can export jobs to a ZIP file using the **Export** option in the right-click menu from the
...
- Save in the following location – Type or browse to the save location you want
...
After Access Analyzer creates the archive, the Support Email window opens. By default, Access
Analyzer sets the recipient to [Netwrix Support](https://www.netwrix.com/support.html), but you can
change it before sending. You can also add additional recipients and modify the Subject and email
body.
...
You can choose which reports to publish or remove from the Web Console.
