...
- Propagate permissions to child folders – Propagates permissions to the child folders of the
  selected folders
- After you select User, Folder, and Permission, click **Add** to add them to the action summary
- To remove an added Permission, select it in the panel and click **Remove**

## User Window

Use the User window to select a user. The User window opens when you select the **User** down-arrow
...
Use the Folder window to select folders. The Folder window opens when you select the **Folder**
down-arrow on the Permissions page.
...
- The list of folders – Select one of the default folders
    ...
    - Select a folder from the dropdown menu and click **Add**
    - To remove a folder, select it and click **Remove**

## Permission Window

Use the Permission window to specify permissions. The Permission window opens when you select the
**Permission** down-arrow on the Permissions page.
...
- Permissions Level – Each permission level has a set of default selections. If you change a
  setting, the Permissions Level field changes to **Custom**. Permission levels are associated with
...
- Other – Select any other permissions to apply from the following:
    ...
    - Folder Contact – User receives automated messages about the folder such as replication
      ...
      status
    - Folder visible – User can see the folder but can't read or edit the items within
