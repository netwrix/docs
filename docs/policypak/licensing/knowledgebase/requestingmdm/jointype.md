...
![754_1_1_950x287](/images/policypak/license/mdm/754_1_1_950x287.webp)

In all these cases, the computers are counted toward Intune licensing. This is because:

- Case Item 3 —This machine is fully managed (registered) by Intune. It can receive Netwrix PolicyPak directives via MSI (supported) or .Intunewin files (not
  recommended.) or Intune's PowerShell commands (not recommended.)
- Case Item 2 —This machine is BYOD/Workplace Joined by Intune. From a PolicyPak
  perspective, this machine has exactly the same management capabilities as a fully managed machine.
  A BYOD/Workplace Joined machine can also get PolicyPak directives via MSI,
...
![754_2_2_950x795](/images/policypak/license/mdm/754_2_2_950x795.webp)
