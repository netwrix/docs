...
there are three configured report requests shown.

#### Creating a report request

New report requests can be created in list view via the ribbon or also the context menu that's
...
selection of tags. Once saved, the report is shown in the list of report requests.
