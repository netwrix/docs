...
been completed, the data appears in the **Discovery Service module**.
...
2. **General**: The latest information about the **Discovery Service Task** is shown here. A
   **message** indicates an active **Discovery Service Task**.
...
options in the **filter** are described in the following sections:
