...
![Threat Prevention Server Setup wizard - Enterprise Manager Location Information page](/images/threatprevention/8.0/install/emlocationinfo.webp)
...
![Threat Prevention Server Setup wizard - Database Login Information page](/images/threatprevention/8.0/install/databselogininfor.webp)
...
![Threat Prevention Server Setup wizard – Logon page](/images/threatprevention/8.0/install/logon.webp)
...
![Threat Prevention Admin Console desktop icon](/images/threatprevention/8.0/install/desktopicon.webp)

The selected components have been installed, and the Threat Prevention Console icon is now on the
desktop. See the [First Launch](/docs/threatprevention/8.0/install/firstlaunch/firstlaunch.md) topic for the next steps.
