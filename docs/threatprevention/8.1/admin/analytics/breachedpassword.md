...
![Breached Password Analytic Type - Settings tab](/images/threatprevention/8.1/admin/analytics/breachedpasswordsettings.webp)
...
login within the specified interval duration, Threat Prevention triggers an incident record.
...
![Breached Password Analytic Type - Policy tab](/images/threatprevention/8.1/admin/analytics/policytab.webp)
...
- Event Type tab – Configured the same way a regular policy’s
  ...
  - Scope the protocol to monitor on the Authentication Protocol filter. If you enable the
...
![Breached Password Analytic Type window](/images/threatprevention/8.1/admin/analytics/breachedpassword.webp)
...
- Last Failed Attempt – Date timestamp of the last event that triggered the incident. Hover over the
  ...
  simultaneously.
- Breach Date – Date timestamp of the first monitored event that succeeded. Hover over the data
