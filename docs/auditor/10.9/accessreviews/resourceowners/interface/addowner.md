...
The Add Owner window opens from either the [Add New Resource Wizard](/docs/auditor/10.9/accessreviews/resourceowners/interface/add.md) of the
[Update Resource Wizard](/docs/auditor/10.9/accessreviews/resourceowners/interface/update.md). This window is used to search for a user account by
