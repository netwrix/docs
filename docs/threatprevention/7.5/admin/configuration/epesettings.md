...
The HIBP database must be initially deployed to the Enterprise Manager. After  database is stored,
...
:::note
The
[](https://github.com/HaveIBeenPwned/PwnedPasswordsDownloader)[Pwned Passwords Downloader](https://github.com/HaveIBeenPwned/PwnedPasswordsDownloader)
...
**Download NTML Hashes with the Pwned Passwords Downloader**
