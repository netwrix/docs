...
After you have registered the application, the following settings are needed from your tenant:
...
[Exchange Online](/docs/activitymonitor/10.0/admin/monitoredhosts/add/exchangeonline.md) topic for
