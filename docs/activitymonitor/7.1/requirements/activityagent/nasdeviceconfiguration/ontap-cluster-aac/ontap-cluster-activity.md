...
:::info
Create a tailored FPolicy that collects only the activity you want from the environment to limit the scope and impact.
:::
...
depends on the fault tolerance requirements and the expected event flow. As a general guideline, the
