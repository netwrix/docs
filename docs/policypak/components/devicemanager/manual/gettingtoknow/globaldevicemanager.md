...
![device04](/images/policypak/device/devicemanager/device04.webp)
...
By default, PolicyPak Device Manager has a simple notification message to the user,
but that is customizable as well.

![device05](/images/policypak/device/devicemanager/device05.webp)

Your Global policy is now set in the GPO.

![device06](/images/policypak/device/devicemanager/device06.webp)
...
![global1](/images/policypak/device/devicemanager/global1.webp)
...
![read1](/images/policypak/device/devicemanager/read1.webp)

![execute](/images/policypak/device/devicemanager/execute.webp)

![writeattemppt](/images/policypak/device/devicemanager/writeattemppt.webp)
