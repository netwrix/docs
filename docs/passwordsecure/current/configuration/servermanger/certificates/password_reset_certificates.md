...
If a [Password Reset](/docs/passwordsecure/current/configuration/advancedview/clientmodule/passwordreset/password_reset.md) is created,
...
The section [Certificates](/docs/passwordsecure/current/configuration/servermanger/certificates/certificates.md)explains how to back up the certificate and link it
again.
