...
See the [Add Subscription](/docs/threatmanager/3.2/administration/investigations/options/subscription.md) topic and [Export Report](/docs/threatmanager/3.2/administration/investigations/options/export.md)
