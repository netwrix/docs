---
title: "Rings with PolicyPak Cloud"
description: "Rings with PolicyPak Cloud"
sidebar_position: 10
---

# Rings with PolicyPak Cloud

In PolicyPak Cloud, because the concept of groups is already used, you can consider a
PolicyPak Cloud group like a ring. You can choose a group and manually specify to use
...
can raise it to the PolicyPak support team and we will work with you.

**Step 2 –** If all goes well, you can roll out the latest CSE and/or Cloud Client to more PolicyPak Cloud groups. It only takes one click within the group to select the CSE or Cloud
...
roll it out to all machines. When ready, pick the remaining PolicyPak Cloud groups and
select the latest CSE and/or PolicyPak Cloud client to opt-in more groups.
