...
How to define policies to organize roles and rules. See the [Policy](../../integration-guide/toolkit/xml-configuration/provisioning/policy) topic for additional information.
...
:::note
 Netwrix Identity Manager (formerly Usercube) provides a default policy. Only when the project is mature enough should integrators think about creating additional policies. 
:::
...
See the [Create a Resource Type](../../user-guide/set-up/categorization/resource-type-creation) topic for additional information.

## Create a Policy

Create a policy by proceeding as follows:

![Home - Access Policies](/images/identitymanager/home_accesspolicies_v602.webp)
