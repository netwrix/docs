...
products:
- threat-manager
title: 'File Systems Events Not Appearing in Netwrix Threat Manager From the Netwrix Activity Monitor agents'
knowledge_article_id: kA0Qk0000001qUPKAY
---

# File Systems Events Not Appearing in Netwrix Threat Manager From the Netwrix Activity Monitor agents
...
To resolve this issue, change the Syslog message template from **LEEF** to **Netwrix Threat Prevention**:
...
:::note
This is UDP, so there is no true confirmation that a connection is/was made.
:::
...
:::note
This could take several minutes for the agent to update and for new events to occur.
:::
