...
- Allow Connection — This setting allows a connection to the host. (No event is generated.)
- Log Event and Allow — This setting allows a connection to the host and log an event in the
Event table. If a SIEM connection is configured, an event is sent to SIEM as well.
- Log Event and Block — This setting blocks the connection to the host and log an event in
