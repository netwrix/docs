...
[Export wizard](/docs/passwordsecure/9.2/configuration/advancedview/mainmenufc/export/export_wizard.md) because the export result isn't separately secured
by a password.
