...
The server requires a license key provided by Netwrix Identity Manager (formerly Usercube). See the [Application Settings](../../integration-guide/network-configuration/server-configuration/general-purpose) topic for additional information.

## Software

The server is a .NET application and requires Windows Server 2022 or later.
...
See the [Database](../../installation-guide/requirements/database-requirements) and [Install the Server](../../installation-guide/production-ready/server) topics for additional information.
...
The server needs access to an **SMTP server** to [Send Notifications](../../installation-guide/production-ready/email-server).
