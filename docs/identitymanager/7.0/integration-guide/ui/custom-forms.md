...
To create the entity view, manipulate a [Form](../../integration-guide/toolkit/xml-configuration/user-interface/form).
...
To create the view, manipulate one or more forms. The example below shows how to create a view from several different forms so you can reuse some forms in workflows.
