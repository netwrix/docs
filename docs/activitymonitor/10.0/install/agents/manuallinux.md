...
Monitor\Console\Agents\activity-monitor-agentd-10.0.0-400.rhel.x86_64.rpm"
...
```
sudo yum localinstall activity-monitor-agentd-10.0.0-400.rhel.x86_64.rpm
```
...
To effectively monitor activity on a Linux host, deploy an agent to the host.
See the
[Linux Agent Server Requirements](/docs/activitymonitor/10.0/requirements/linuxagent.md) topic for additional
information.
