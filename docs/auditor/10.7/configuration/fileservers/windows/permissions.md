...
- The **Manage auditing and security log** and Backup files and directories policies must be defined
  ...
  [Permissions for Active Directory Auditing](/docs/auditor/10_7/configuration/activedirectory/permissions#configure-the-manage-auditing-and-security-log-policy) and topics for
