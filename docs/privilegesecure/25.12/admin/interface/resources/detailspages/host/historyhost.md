...
![History Tab for Host Resource](/images/privilegesecure/25.12/accessmanagement/admin/policy/tab/resources/historyhost.webp)
...
the [Access Policy Page](/docs/privilegesecure/25.12/admin/interface/accesspolicy/accesspolicy.md) topic for additional information.
