...
- [Application Server Requirements](/docs/recoveryforactivedirectory/3.1/requirements/server.md)
- [SQL Server Requirements](/docs/recoveryforactivedirectory/3.1/requirements/sqlserver.md)
- [RSAT Extension Requirements](/docs/recoveryforactivedirectory/3.1/requirements/rsatextension.md)

Target Domain Considerations

The target domains include the Active Directory domains that can be added through the
[Domains Page](/docs/recoveryforactivedirectory/3.1/admin/configuration/domain.md). See the following topic for target domain considerations:

- [Target Domains](/docs/recoveryforactivedirectory/3.1/requirements/targetdomain.md)
...
- [Target Server Considerations](/docs/recoveryforactivedirectory/3.1/requirements/targetserver.md)
