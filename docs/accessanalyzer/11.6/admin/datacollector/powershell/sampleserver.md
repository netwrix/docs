...
![PowerShell Data Collector Wizard Select Server page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/powershell/selectserver.webp)
