...
In the figure shown. The figure shows that the data key, data value, on value, and off value settings are
not known.

![configuring_elements_using_5](/images/policypak/applicationsettings/designstudio/configurationwizard/configuring_elements_using_5.webp)
...
automatically put in place, as shown In the figure shown.

![configuring_elements_using_6](/images/policypak/applicationsettings/designstudio/configurationwizard/configuring_elements_using_6.webp)

The figure shown. The Configuration Wizard inputs the known property values.
