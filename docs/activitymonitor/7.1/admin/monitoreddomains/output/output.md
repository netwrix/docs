...
When you're monitoring a domain, you can send the event stream to multiple outputs.
...
**Step 1 –** On the Monitored Domains tab, select the domain you want to configure and click **Add Output**.
...
:::note
Netwrix Threat Manager creates an App Token that authenticates the connection between
...
**Step 2 –** Select **Netwrix Threat Manager (StealthDEFEND)** from the dropdown menu. The Add New
Output window opens.
