...
![Reports Tree](/images/privilegesecure/26.03/accessmanagement/admin/auditreporting/page/reportstree.webp)
...
![Reporting Filters Tab](/images/privilegesecure/26.03/accessmanagement/admin/auditreporting/page/filterstab.webp)
...
Subscribe to a report. See the [Schedule Policies Page](/docs/privilegesecure/26.03/admin/platforms/schedulepolicies/schedulepolicies.md) topic
