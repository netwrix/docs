...
![Connection Test Successful](/images/identityrecovery/2.6/troubleshooting/updatepassword/connectiontest.webp)

**Step 4 –** Click **OK**.

**Step 5 –** Once the connection has been established, click **Save** to update the account.

![Configuration Utility Saved Confirm](/images/identityrecovery/2.6/troubleshooting/updatepassword/sqlsettings.webp)
