...
Use Netwrix PolicyPak Device Manager to specify exactly which
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/O8qGAIpor54" title="PolicyPak Device Manager (Complete): Permit specific devices by serial number" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
devices, not by Vendor ID, but if you opt into the PolicyPak Device Manager COMPLETE
...
With PolicyPak Device Manager, you're in charge. You can let particular user do
