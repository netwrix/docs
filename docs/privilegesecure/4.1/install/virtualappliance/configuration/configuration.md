...
| | |
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Rename the virtual machine | Specify a new name for the virtual machine (e.g.,NPSAM-Server). Consider the following: <ul><li>The name should be no longer than 15 characters</li><li>It may contain letters (a-z, A-Z), numbers (0-9), and hyphens (-). However, it can't contain numbers only.</li><li>Spaces and periods (.) aren't allowed</li></ul> |
