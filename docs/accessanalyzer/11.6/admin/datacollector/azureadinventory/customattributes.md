...
![Entra ID Inventory Data Collector Wizard Custom Attributes page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/adinventory/customattributes.webp)
...
![Custom Attribute Window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/azureadinventory/customattributewindow.webp)
...
![Custom Attributes Import Wizard](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/azureadinventory/customattributesimportwizard.webp)
...
|                                                                                                                                                                                 |                                                                                                                                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![customattributesimportwizardschema](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/azureadinventory/customattributesimportwizardschema.webp) | ![customattributesimportwizardapplication](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/azureadinventory/customattributesimportwizardapplication.webp) |
