...
![Apply settings globally to all Netwrix Endpoint Protector entities](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/settings/globalsettings.webp)
...
![Manage settings that relate directly to the Netwrix Endpoint Protector Client](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/clentsettings.webp)
...
![Manage settings that relate directly to the Netwrix Endpoint Protector Client](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/clientsettingstwo.webp)
...
- User Remediation Pop-up – this setting is available when the
  [User Remediation](/docs/endpointprotector/5.9.4/system-management/system-parameters.md#user-remediation)
...
![Manage settings that relate directly to the Netwrix Endpoint Protector Client](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/clientsettingsthree.webp)

### Client Mode

Select from the drop-down list a client mode to deﬁne the Endpoint Protector Client behavior.

![Select from the drop-down list a client mode to deﬁne the Endpoint Protector Client behavior.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/clientmode.webp)
...
![If enabled, network and browser traﬃc can be inspected for content](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/dpiconfiguration.webp)
...
![Pop-up window informing the user that a System Extension is blocked](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/systemextensionblocked.webp)

**Step 6 –** Go to **System Preferences** >**Security and Privacy** > **General**, and then
**allow** the Endpoint Protector Client Extension.

![Security and private settings on Mac](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/generaltabios.webp)

**Step 7 –** On the Endpoint Protector Proxy Conﬁguration pop-up window, click **Allow**.

![Proxy Conﬁguration pop-up window](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/proxypop-up.webp)
...
![Downloading a DPI Certificate](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/dpicertificate.webp)
...
![Enable this setting to address the number of excessive false positives for URL Denylists](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/smartdpi.webp)
...
![File Tracing and Shadowing Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/filetracingshadowing.webp)
...
![File Tracing and Shadowing Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/blockprintone.webp)
...
![blockprinttwo](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/blockprinttwo.webp)
...
![Conﬁguring GPO for Browser Extensions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/grouppolicyeditor.webp)
...
![Conﬁguring GPO for Browser Extensions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/grouppolicyeditortwo.webp)
...
![ Tailor Content Aware Protection scanner’s ﬁle size settings according to their speciﬁc needs. ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/maxfileconfg.webp)
...
**NOTE:** For
[Content Aware Protection](/docs/endpointprotector/5.9.4/features/content-aware-protection/index.md),
the Outside Network and Outside Hours Policy Type also needs to be selected.

![Manage Outside Network and Outside Hours Policies, for both Device Control and Content Aware modules](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/outsidehoursnetwork.webp)
...
![Set the transfer limit, within a speciﬁc time interval (hours)](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/transferlimit.webp)
...
![Enable a Transfer Limit Reached Alert and schedule a Transfer Limit Reached Report on a daily, weekly, or monthly basis](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/transferlimitreached.webp)
...
![Use this feature to collect logs for a speciﬁc issue](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/debuglogging.webp)
...
![Used to debug feature and collect logs](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/debugloggingtwo.webp)
...
![Netwrix Endpoint Protector Client Debug Mode](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/clientdebugmode.webp)
...
![Debug Logging Actions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/debugloggingactions.webp)

- Collect Diagnostics - registers an event when diagnostic data are requested (Artifact requested
  event)

![Registers an event when diagnostic data are requested](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/collectdiagnostics.webp)
...
![Redirects the user to the Reports and Analysis module on the Logs Report page to Artifact received type events with debug mode logs](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/logsreport.webp)

- Terminate Client - this option terminates the Endpoint Protector Client

![Terminates the Netwrix Endpoint Protector Client](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/terminateclient.webp)
...
![A message warning to avoid losing unsaved documents](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/forcedrestart.webp)

![Forced Restart Computer - this option sends a force reboot command to the computer](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/forcedrestarttwo.webp)
...
![Data Obfuscation Example](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/dataobfuscationone.webp)

![Data Obfuscation Example](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/dataobfuscationtwo.webp)

![Data Obfuscation Example](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/dataobfuscationthree.webp)

![Data Obfuscation Example](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/dataobfuscationfour.webp)
...
![Allow EasyLock to be installed](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/easylocksettings.webp)
...
![Restore global settings to default and view the name and date when the action was performed](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/additionalinformation.webp)
...
![Set the maximum number of logs that can be displayed](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/displaysettings.webp)
...
![priortyorder](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/priortyorder.webp)
...
![Standard supported Devices](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/standarddevices.webp)
...
[Trusted Device™](/docs/endpointprotector/5.9.4/features/enforced-encryption/index.md#trusted-device)
topic.
...
![Bluetooth Device Management on Mac](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/macbluetooth.webp)
...
![Device Type configuration](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/devicetypes.webp)
...
![Manage USB access through the virtual environment.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/vmusb.webp)
...
![Manage access rights for a speciﬁc device.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/specificdevices.webp)
...
![Device Wizard - Adding New Device](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/newdevicestep.webp)
...
![Add devices previously connected to protected computers and already in the database.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/existingdevice.webp)
...
![ Add multiple devices at the same time.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/multipledevices.webp)
...
![Add up to 1000 devices at the same time](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/bulkdevices.webp)
...
[Denylists and Allowlists](/docs/endpointprotector/5.9.4/features/denylists-and-allowlists/index.md)
topic.
...
![Deﬁne fallback policies that will apply when outside the network](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/outsidenetwork.webp)
...
![ Deﬁne fallback policies that will apply when outside working hours](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/outsidehours.webp)
