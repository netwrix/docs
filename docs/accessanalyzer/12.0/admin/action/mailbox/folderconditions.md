...
the **No, the query results don't contain a mailbox identification** column option on the Folder
Identification page.
...
- Select conditions – Select the checkbox next to any of the following filter conditions to apply
  them to the search and add them to the Edit conditions box. Folder Conditions include:
    ...
    - With specific folders to include/exclude
...
window opens if you select **specific** in **with specific folder type** in the Edit Conditions
box.
...
Search Terms window opens if you select **search terms** in the Edit Conditions box.
...
action. The Folder Inclusion/Exclusion window opens if you select **specific** in **with specific
folders to include/exclude** in the Edit Conditions box.
...
- Scope auto-populates with **This folder**. Click **This folder** to reveal a dropdown menu to
