...
- Add Output – Select an output from the Add Output dropdown. The outputs are: File, Syslog, and
  Threat Manager. See the [Output for Monitored Domains](/docs/activitymonitor/10.0/admin/monitoreddomains/output/output.md)
...
- Edit – Opens the selected AD Monitoring Configuration window to modify monitoring settings. See
  the [AD Monitoring Configuration Window](/docs/activitymonitor/10.0/admin/monitoreddomains/admonitoringconfiguration/overview.md) topic for
