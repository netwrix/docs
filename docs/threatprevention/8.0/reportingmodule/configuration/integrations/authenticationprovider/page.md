...
![Integrations interface displaying the details for an Authentication Provider with the type dropdown menu open](/images/threatprevention/8.0/reportingmodule/configuration/integrations/authenticationprovider/type.webp)
