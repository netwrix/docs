...
created in the [Activities Page](/docs/privilegesecure/25.12/admin/interface/activities/activities.md).

![Add activities and activity groups window](/images/privilegesecure/25.12/accessmanagement/admin/policy/window/usersgroups/addactivitiesandactivitygroups.webp)
...
To add activities to an activity group.
