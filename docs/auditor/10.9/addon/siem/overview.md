...
Auditor Integration API, refer to [Integration API](/docs/auditor/10.9/api/overview.md).
...
See the [Configure a Response Action for Alert](/docs/auditor/10.9/admin/alertsettings/responseaction.md)
