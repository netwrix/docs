---
title: "XML Data Files from PolicyPak Preferences Manager"
description: "XML Data Files from PolicyPak Preferences Manager"
sidebar_position: 70
---

# XML Data Files from PolicyPak Preferences Manager
...
so on. Refer to the [Preferences Manager](/docs/policypak/components/preferencesmanager/manual/overview.md) for more details.
...
![deploying_policypak_directives_19](/images/policypak/mdm/xmldatafiles/deploying_endpointpolicymanager_directives_19.webp)
...
Alternatively, the PolicyPak management console can also export existing Group Policy
...
![deploying_policypak_directives_20](/images/policypak/mdm/xmldatafiles/deploying_endpointpolicymanager_directives_20.webp)

Figure 20. The user can export an existing GPO through the PolicyPak management
console.
