...
![Enable MFA page](/images/recoveryforactivedirectory/3.1/product/mfa_enable.png)
...
![Configure authenticator app page](/images/recoveryforactivedirectory/3.1/product/mfa_authenticator.png)
...
[Sign In](/docs/recoveryforactivedirectory/3.1/install/login.md#sign-in) topic for additional information.

## Disable Authenticator for MFA

Follow the steps to disable MFA for your Identity Recovery account.

![Disable MFA page](/images/recoveryforactivedirectory/3.1/product/mfa_disable.png)
