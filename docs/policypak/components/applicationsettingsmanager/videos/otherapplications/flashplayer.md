---
title: "PolicyPak for Adobe Flash Player"
description: "PolicyPak for Adobe Flash Player"
sidebar_position: 40
---
# PolicyPak for Adobe Flash Player
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/UEHHthW_YZY" title="PolicyPak:  Manage Flash Player using Group Policy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Enter Netwrix PolicyPak, and it's free Pre-configured PolicyPak for Flash player. Using Group Policy, it's super easy to manage how:
...
computers. That is, without PolicyPak.
...
![130_1_flash-player-group-policy-policypak-1](/images/policypak/video/applicationsettings/130_1_flash-player-group-policy-endpointpolicymanager-1.webp)

And you can prevent users from picking up dangerous Flash super cookies, by performing this simple
step.

![130_2_flash-player-group-policy-policypak-2](/images/policypak/video/applicationsettings/130_2_flash-player-group-policy-endpointpolicymanager-2.webp)
...
![130_3_flash-player-group-policy-policypak-3](/images/policypak/video/applicationsettings/130_3_flash-player-group-policy-endpointpolicymanager-3.webp)
