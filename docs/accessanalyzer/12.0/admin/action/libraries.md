...
![Libraries window](/img/product_docs/accessanalyzer/12.0/admin/action/libraries.webp)
...
![PowerShell Action Module Wizard](/img/product_docs/accessanalyzer/12.0/admin/action/powershellmodulewizard.webp)
...
![Add custom library on Libraries window](/img/product_docs/accessanalyzer/12.0/admin/action/librariescustom.webp)

**Step 4 –** In the pop-up window, specify a name for the library and click **OK**.

![Libraries window paste button](/img/product_docs/accessanalyzer/12.0/admin/action/librariescustompaste.webp)
