...
latest version available to take advantage of the new features.

## Preparatory Steps

Before upgrading, take the following steps:

1. Ensure you have .NET Framework 4.7.2 installed on the computer where Netwrix Data
...
2. After the upgrade, indexing mode will be set to Compound Term mode. See [How to modify Index Processing Mode](https://kb.netwrix.com/5353)
   for instructions on how to modify default Index Processing Mode.
