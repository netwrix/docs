...
replay of the remote session. See the [Replay Viewer Window](/docs/privilegesecure/25.12/admin/dashboard/historical/replayviewer.md) topic
...
session. See the [Session Logs Window](/docs/privilegesecure/25.12/admin/dashboard/historical/sessionlogs.md) topic for additional
information.
