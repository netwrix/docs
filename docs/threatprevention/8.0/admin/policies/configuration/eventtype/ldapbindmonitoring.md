...
users who connected with LDAP. While the [LDAP Monitoring Event Type](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/ldapmonitoring/ldapmonitoring.md) creates
...
![Policy window - LDAP Bind Monitoring Event Type](/images/threatprevention/8.0/admin/policies/eventtype/ldapbind.webp)
...
![Policy window - Bind Protocol filter](/images/threatprevention/8.0/admin/policies/eventtype/bindprotocol.webp)
...
Select the monitoring filter you want:
