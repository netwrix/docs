...
[Update SQL Server Service Account Password](/docs/identityrecovery/2.6/troubleshooting/credentialpasswords/sqlserverserviceaccount.md) topic for additional
information.
...
[Edit Domain Configuration](/docs/identityrecovery/2.6/admin/configuration/domain.md#edit-domain-configuration) topic for
...
Recovery Console. See the [Update Domain Controller Backup Account Password](/docs/identityrecovery/2.6/troubleshooting/credentialpasswords/serverbackupaccount.md)
