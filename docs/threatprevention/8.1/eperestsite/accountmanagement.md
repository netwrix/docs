...
![GET api/account/users](/images/threatprevention/8.1/eperestsite/users.webp)
...
![POST api/account/create](/images/threatprevention/8.1/eperestsite/create.webp)
...
![GET api/account/user/userId](/images/threatprevention/8.1/eperestsite/userid.webp)
...
![GET api/account/user/userName](/images/threatprevention/8.1/eperestsite/username.webp)
...
![DELETE api/account/delete?userName=username](/images/threatprevention/8.1/eperestsite/delete.webp)
