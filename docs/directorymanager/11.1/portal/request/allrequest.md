...
the description, approvers, requester name, the target to change, status, date the request was
...
Step 2 – Select the request you want to deny, enter the reason for denial and click **Deny Request**.
