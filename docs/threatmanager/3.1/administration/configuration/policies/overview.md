...
deployment history. You can also add new policies and configure them from here.
...
- Host – The host on which the policy was applied. If the host exists in the Threat Manager
  database, click the host link to go to the [Host Details Page](/docs/threatmanager/3.1/administration/threats/activedirectoryobjects/host.md)
...
You can also click a policy to view information and configuration options for that policy. See [Policy Configuration](/docs/threatmanager/3.1/administration/configuration/policies/policiesconfiguration.md) for
...
**Step 2 –** In the Type dropdown, select Honeytoken:
