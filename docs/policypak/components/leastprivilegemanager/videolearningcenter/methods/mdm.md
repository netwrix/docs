...
<iframe width="560" height="315" src="https://www.youtube.com/embed/J6_Bg9ZkqPM" title="Least Privilege Manager + Your MDM Service!" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Now what? We'll close out our GPMC. We don't need this anymore. We're going to use our PolicyPak exporter tool. It installs alongside the admin console MSI and can be found under
PolicyPak in your start menu. We are going to Create a New MSI Installer and choose
Next.
...
installed. We're going to say that the manufacturer is PolicyPak and click Next.
