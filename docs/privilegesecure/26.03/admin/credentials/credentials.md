...
page displays the same information as the [Credentials Dashboard](/docs/privilegesecure/26.03/admin/dashboard/credentials.md).

![Credentials page](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/credentials/credentials.png)
...
displays. See the
[Manage Internal Service Accounts](/docs/privilegesecure/26.03/admin/credentials/manageinternalserviceaccount.md) section
...
[Account Dependencies Window](/docs/privilegesecure/26.03/admin/credentials/accountdependencies.md) topic for additional
information.
- Rotate — Initiate credential rotation now. This button is only available
when the Method is Automatic managed. See the
[Scheduled Tasks Page](/docs/privilegesecure/26.03/admin/configuration/servicenodes/scheduledtasks.md) topic for additional
information.
...
See the [Password History Window](/docs/privilegesecure/26.03/admin/credentials/passwordhistory.md) topic for additional
information.
...
[View Password Window](/docs/privilegesecure/26.03/admin/credentials/viewpassword.md) topic for additional
information.
...
for that platform type. See the [Platforms Page](/docs/privilegesecure/26.03/admin/platforms/overview.md) topic for additional
information.
...
Secure. See the [Service Accounts Page](/docs/privilegesecure/26.03/admin/configuration/serviceaccounts/serviceaccounts.md) section
...
:::note
See the [Rotation Methods](/docs/privilegesecure/26.03/admin/credentials/credentialrotationmethod.md) topic for additional
information.
:::
...
[Platforms Page](/docs/privilegesecure/26.03/admin/platforms/overview.md) topic for additional information on configuring a
