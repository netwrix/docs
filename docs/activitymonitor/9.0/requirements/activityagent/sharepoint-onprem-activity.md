...
Activity Monitor and/or audited by Netwrix Access Analyzer.
...
SharePoint creates the audit logs for the Netwrix Activity Monitor to monitor by the Netwrix Activity Monitor and/or audited
