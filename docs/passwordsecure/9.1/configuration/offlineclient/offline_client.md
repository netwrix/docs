...
- See the [Microsoft documentation](https://technet.microsoft.com/en-us/library/gg592949(v=sql.110).aspx) for details
...
[Operation and setup](/docs/passwordsecure/9.1/configuration/servermanager/operation_and_setup_admin_client.md).
