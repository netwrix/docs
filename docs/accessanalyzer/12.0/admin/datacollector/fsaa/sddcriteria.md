...
Use the SDD Criteria Settings page to configure criteria for discovering sensitive data during a
scan. It is a wizard page for the category of Sensitive Data Scan.
