...
field: "Gap" or "Edge link." The purpose of this field is to help identify errors in PolicyPak Start Screen policies. For instance, you might make a policy that is attempting to add an
application that doesn't exist. When you do this with PolicyPak Start Screen,
...
![collections_policy_settings_6](/images/policypak/startscreentaskbar/settings/startscreen/collections_policy_settings_6.webp)
...
![collections_policy_settings_7](/images/policypak/startscreentaskbar/settings/startscreen/collections_policy_settings_7.webp)
...
![collections_policy_settings_8](/images/policypak/startscreentaskbar/settings/startscreen/collections_policy_settings_8.webp)
...
you need in order to deploy the application or correct the PolicyPak Start Screen
policy.
...
![collections_policy_settings_9](/images/policypak/startscreentaskbar/settings/startscreen/collections_policy_settings_9.webp)
