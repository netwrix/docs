...
categories = {
    "deployment-and-installation": [
        ...
        "how_to_apply_an_offline_patch_or_upgrade.md",
        "how_to_apply_security_backend_updates.md",
        ...
        "how_to_update_to_macos_12_(monterey)_while_using_endpoint_protector_client_and_deep_packet_inspectio.md",
    ...
    "administration-security-and-monitoring": [
        ...
        "how_to_export_the_list_of_computers,_users,_or_devices.md",
    ...
    "troubleshooting-and-errors": [
        "cleaning-up-and-recreating-an-audit-configuration.md",
        ...
        "how-to-generate-a-memory-dump.md",
        ...
        "verify-if-the-endpoint-protector-network-extension-is-enabled.md",
    ],
    "features-and-operations": [
        ...
        "how-to-view-all-ediscovery-scan-results-when-the-number-exceeds-the-10-000-record-limit.md",
        "how_to_display_the_destination_url_in_content_aware_reports.md",
        ...
        "restrict-applications-or-cli-commands.md",
