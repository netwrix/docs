...
2. Enter a path to the add-on. Or simply drag and drop the add-on file in the console window.
...
:::note
If the script path contains spaces (e.g., _C:\Netwrix Add-ons_), embrace it in double quotes and insert the ampersand (**&**) symbol in front (e.g., & "_C:\Netwrix Add-ons_").
:::
...
:::note
Details (or 'msg' in CEF terms) exceeding 16000 symbols are trimmed.
:::
