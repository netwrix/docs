---
title: "Why does the PolicyPak Licensing Tool (LT.EXE) require admin rights to query for Intune / Azure data?"
description: "Why does the PolicyPak Licensing Tool (LT.EXE) require admin rights to query for Intune / Azure data?"
sidebar_position: 80
---

# Why does the PolicyPak Licensing Tool (LT.EXE) require admin rights to query for Intune / Azure data?
...
The Netwrix PolicyPak Licensing Tool` (LT.EXE)` uses the
