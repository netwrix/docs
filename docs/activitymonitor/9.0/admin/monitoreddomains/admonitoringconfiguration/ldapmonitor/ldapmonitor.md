...
![Operations Tab in the LDAP Monitor Tab](/images/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/operations.webp)
...
Each filter tab acts like an “AND” statement for the filter. Any filter tab left blank applies to all values for that filter set.

## Host (From)

The Hosts (from) option is where you can scope the policy to monitor only specific hosts as
originators of an authentication event or exclude specific hosts from monitoring for
authentication events.

![Host (From) Tab in the LDAP Monitor Tab](/images/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/hostfrom.webp)
...
![LDAP Tab in the LDAP Monitor Tab](/images/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/ldap.webp)
...
![Servers Tab in the LDAP Monitor Tab](/images/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/servers.webp)
...
The Users option is where you can scope the policy to monitor only specific security principals
committing changes within Active Directory or exclude specific users committing changes from
monitoring.

![Users Tab in the LDAP Monitor Tab](/images/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/users.webp)
