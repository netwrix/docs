...
![SSH Command Restriction Page](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/command.png)
...
- Match (regex) - enter a regular expression that defines any commands you want to observe
