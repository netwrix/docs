...
management tools for virtualization, data storage and hosting, private networking, and both relational and
NoSQL databases. AWS CloudTrail is an internal tracking service that records AWS API
