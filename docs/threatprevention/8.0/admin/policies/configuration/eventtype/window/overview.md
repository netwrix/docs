...
![Selection Window - Connect to Agent/Server option](/images/threatprevention/8.0/admin/policies/eventtype/window/selectagent.webp)
...
![Selection Window - Browse mode](/images/threatprevention/8.0/admin/policies/eventtype/window/adperpetrators.webp)
...
![Selection Window - Search Mode](/images/threatprevention/8.0/admin/policies/eventtype/window/searchmode.webp)
