...
You can't create an Admin Center application or delete an existing one from Admin Center tab.
...
the URL from the address bar or from Admin Center deployment settings. See the
