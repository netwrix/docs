...
- In addition to the LSASS process termination check, the Agent can be configured for a Safe Mode.
  ...
  in AD Monitor Pending Mode Email Alert topic for more information.
  :::
...
:::note
Most Microsoft Security Bulletins that alter LSASS won't interfere with Agent
instrumentation.
:::


Active Directory monitoring/blocking won't resume until the pending modules are started. To
...
information. Netwrix tests Microsoft Security Bulletins affecting LSASS before their becoming
...
[Email Tab](/docs/threatprevention/7.5/admin/configuration/systemalerting/email.md) topic for more information.
