---
title: "PolicyPak File Associations Manager: Helper Application"
description: "PolicyPak File Associations Manager: Helper Application"
sidebar_position: 60
---
# PolicyPak File Associations Manager: Helper Application
...
Hi. This is Jeremy Moskowitz. In this video, I'm going to show you how you can use the PolicyPak File Associations Manager Helper program if you're in a situation where you only have
a single or handful of machines that have an application installed and you can't get it installed on
your own machine.

In previous examples you saw, and in fact I said quite a bit, PolicyPak File
...
On the download, we have this thing in the "PolicyPak Extras" folder called "PolicyPak File Associations Manager Helper" "Application." Now don't click on the ".exe" which
...
Now this is a little bit special, this XML file, because you might be familiar with PolicyPak export and import routines. You can just click on computer side, "PolicyPak" here and click
