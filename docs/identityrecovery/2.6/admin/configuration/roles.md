...
![Users and Roles page](/images/identityrecovery/2.6/admin/configuration/roles.webp)
...
![Add Account Role wizard – Account page](/images/identityrecovery/2.6/admin/configuration/account.webp)
...
![Add Account Role wizard – Role page](/images/identityrecovery/2.6/admin/configuration/role.webp)
...
![Add Account Role wizard – Confirm page](/images/identityrecovery/2.6/admin/configuration/confirm.webp)
...
![Delete Role Confirmation](/images/identityrecovery/2.6/admin/configuration/deleterole.webp)
