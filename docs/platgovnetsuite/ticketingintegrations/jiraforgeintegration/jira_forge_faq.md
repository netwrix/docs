...
1. I already have Strongpoint Connect app installed in my instance. Is is okay to install the Forge app as well?
...
3. Is it normal that I see two(2), Netwrix Netsuite tabs in my issues panel if my instance has both Connect and Forge apps?
    - **Yes, if is normal. Two(2) separate and different apps would mean that they have separate file descriptors that shows separate tabs in the issue panel.**
...
4. Is there impact to existing connect tickets if forge is being used?
...
**Back To:** [ Jira Forge Walkthrough Example](/docs/platgovnetsuite/ticketingintegrations/jiraforgeintegration/jira_forge_walkthrough.md)