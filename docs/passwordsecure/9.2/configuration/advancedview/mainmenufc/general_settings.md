...
If this option has been activated, the Netwrix Password Secure client does not end when the window
is closed but is merely minimised. It continues to run in the background. It is then only
