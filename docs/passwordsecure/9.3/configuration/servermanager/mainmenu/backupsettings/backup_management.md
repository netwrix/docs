...
An incremental backup is run every hour. In addition, a full backup should be
created once a week.
...
entered under [Backup settings](/docs/passwordsecure/9.3/configuration/servermanager/mainmenu/backupsettings/backup_settings.md) will be used by default.
