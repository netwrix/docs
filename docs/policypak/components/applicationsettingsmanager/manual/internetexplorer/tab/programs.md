...
Video: For a quick overview of how to manage the Programs tab using PolicyPak
...
![ie_appset_tab_by_tab_16](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_16.webp)

The figure shown. Managing add-ons in Internet Explorer.

The corresponding PolicyPak dialog is shown In the figure shown.

![ie_appset_tab_by_tab_17](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_17.webp)

The figure shown. Managing IE add-ons in PolicyPak.
...
:::note
These items are more configurable using the PolicyPak DesignStudio if you
