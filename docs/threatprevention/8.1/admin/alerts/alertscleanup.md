...
You can clear alert data displayed on the [Alerts Interface](/docs/threatprevention/8.1/admin/alerts/overview.md) as well as schedule
...
![Alerts Cleanup window](/images/threatprevention/8.1/admin/alerts/window/alertscleanup.webp)
