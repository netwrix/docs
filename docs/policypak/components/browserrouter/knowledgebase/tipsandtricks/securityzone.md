...
This is possible, using the Netwrix PolicyPak Browser Router.

**Step 1 –** Set up a rule (route as seen in this example. Specify that the Internet Security Zone
is set to BLOCK.

![170_1_image001](/images/policypak/browserrouter/editpolicytemplate/170_1_image001.webp)
...
![170_2_image002](/images/policypak/browserrouter/editpolicytemplate/170_2_image002.webp)
