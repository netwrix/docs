...
![Analysis Tasks for the Box_UnusualUserActivity Job](/img/product_docs/accessanalyzer/12.0/solutions/box/activity/suspiciousactivity/unusualuseractivityanalysis.webp)
