...
Follow the following steps to deploy the virtual machine to VMware infrastructure.
...
**Step 3 –** Follow the instructions in the following table:
...
| Disk Format | We recommend that you select **Thin Provision** — to save the disk space. |
