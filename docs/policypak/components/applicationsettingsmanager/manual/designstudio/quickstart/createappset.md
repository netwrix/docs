...
PolicyPak DesignStudio generally works well with most applications. This includes most
...
:::note
You might find applications that are not good candidates for PolicyPak
DesignStudio. If you do encounter one, then don't keep it a secret. Post your questions about
PolicyPak DesignStudio on the PolicyPak DesignStudio support forum.
:::


In this section, we're going to perform the following procedures:

**Step 1 –** Install the application that we want to control with PolicyPak
Application Settings Manager

**Step 2 –** Run the `PolicyPak `Capture Wizard to capture the user interface (UI) and PolicyPak AppLock™ data

**Step 3 –** Run `PolicyPak `DesignStudio to tweak, complete, and compile the AppSet

If you followed along in
[Troubleshooting](/docs/policypak/components/applicationsettingsmanager/manual/applicationsettings/overview.md), you installed WinZip on
...
![policypak_application_settings_5](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_5.webp)
...
PuTTY. Leave the PuTTY application open as you proceed to run the PolicyPak
DesignStudio tool. Run` PolicyPak DesignStudio` by clicking
`Start|PolicyPak|PolicyPak Design Studio`. When you do, the PolicyPak Design Studio
Wizard will run, as shown In the figure shown. Choose to start a new project using the Capture Wizard. Then
click "Next."

![policypak_application_settings_6](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_6.webp)

The figure shown. The PolicyPak Design Studio Wizard.

**Step 6 –** You will now see a list of all the processes that are running and might have a UI for
the PolicyPak Capture Wizard to capture, as shown In the figure shown. In the top pane
(Processes), select "PuTTY Configuration [```putty.exe```]." You will then see "PuTTY Configuration"
in the bottom pane (Windows).

![policypak_application_settings_7](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_7.webp)
...
shown In the figure shown. PolicyPak Application Settings Manager can deliver settings to
...
![policypak_application_settings_8](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_8.webp)
...
![policypak_application_settings_9](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_9.webp)
...
**Step 9 –** At this point, the PolicyPak Capture Wizard will bring the first tab of
...
new category of settings, a new tab will be created. Note that PolicyPak DesignStudio
will usually bring in all the existing defaults for your application. For instance, PolicyPak DesignStudio can determine the checked status of the checkboxes, the content of the dropdown
...
![policypak_application_settings_10](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_10.webp)
...
Once the tab is selected in the application, return to the PolicyPak DesignStudio
tool. When you do, the tab will be captured automatically. Click "OK" to capture the active tab.

![policypak_application_settings_11](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_11.webp)
...
![policypak_application_settings_12](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_12.webp)

The figure shown. Applying a new name for the captured tab.

**Step 12 –** The new tab will be brought into the PolicyPak Capture Wizard, as shown
In the figure shown. Note the tab hierarchy listed on the right side of the screen.

![policypak_application_settings_13](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_13.webp)
...
![policypak_application_settings_14](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_14.webp)
...
![policypak_application_settings_15](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_15.webp)
...
of elements, such as checkboxes, radio buttons, etc., from the PolicyPak DesignStudio
menu.

![policypak_application_settings_16](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_16.webp)
...
![policypak_application_settings_17](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_17.webp)

The figure shown. Reordering the tabs.

:::note
The PolicyPak Capture Wizard isn't perfect. There are some UI elements that
...
**Step 16 –** PolicyPak DesignStudio can help you automatically configure the behavior
...
![policypak_application_settings_18](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_18.webp)
...
![policypak_application_settings_19](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_19.webp)
...
![policypak_application_settings_20](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_20.webp)
...
PolicyPak DesignStudio, ensure that the field is blank to begin with. This will help
...
![policypak_application_settings_21](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_21.webp)
...
![policypak_application_settings_22](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_22.webp)
...
![policypak_application_settings_23](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_23.webp)
...
![policypak_application_settings_24](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_24.webp)
...
![policypak_application_settings_25](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_25.webp)

The figure shown. Choosing the linked label.

**Step 24 –** You have now completed your first setting capture using PolicyPak
DesignStudio. Figure 27 shows the congratulatory screen that you should see when you are finished.

![policypak_application_settings_26](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_26.webp)
...
![policypak_application_settings_27](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_27.webp)
...
![policypak_application_settings_28](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_28.webp)
...
![policypak_application_settings_29](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_29.webp)
...
![policypak_application_settings_30](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_30.webp)
...
![policypak_application_settings_31](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_31.webp)
...
![policypak_application_settings_32](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_32.webp)
...
![policypak_application_settings_33](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_33.webp)
...
![policypak_application_settings_34](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_34.webp)
...
![policypak_application_settings_35](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_35.webp)

The figure shown. The completion of the process.

:::note
A red shading on a value indicates that the PolicyPak DesignStudio
...
![policypak_application_settings_36](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_36.webp)
...
![policypak_application_settings_37](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_37.webp)
...
![policypak_application_settings_38](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_38.webp)
...
![policypak_application_settings_39](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_39.webp)
...
![policypak_application_settings_40](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_40.webp)
...
![policypak_application_settings_41](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_41.webp)
...
![policypak_application_settings_42](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_42.webp)
...
![policypak_application_settings_43](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_43.webp)
...
![policypak_application_settings_44](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_44.webp)
...
![policypak_application_settings_45](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_45.webp)
...
loaded on your PolicyPak creation station.

![policypak_application_settings_46](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_46.webp)

The figure shown. The wizard prompts the user to save their work.

Tip: Use the "Show test PolicyPak when complete" checkbox to see a preview of your
AppSet.

![policypak_application_settings_47](/images/policypak/applicationsettings/designstudio/quickstart/endpointpolicymanager_application_settings_47.webp)

The figure shown. The successful compilation of the project.

**Step 46 –** Click "OK" to exit, and then close PolicyPak DesignStudio.
