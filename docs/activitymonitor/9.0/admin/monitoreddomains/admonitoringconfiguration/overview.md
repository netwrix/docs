...
- [Changes Tab](/docs/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/changes.md)
- [Authentication Tab](/docs/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/authentication.md)
- [Replication Tab](/docs/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/replication.md)
- [LSASS Guardian Tab](/docs/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/lsassguardian.md)
- [LDAP Monitor Tab](/docs/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/ldapmonitor/ldapmonitor.md)
