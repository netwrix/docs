...
If you want to know which GROUPS your Users or Computers are in within Azure AD, then use Netwrix PolicyPak and these scripts with your MDM service like Intune,
...
Hi. This is Jeremy Moskowitz. This is part three of how to use PolicyPak Scripts to
query Azure AD to then do interesting things like apply Group Policy Preferences or PolicyPak items depending on if a user or a computer is a member of an Azure AD group.

In this video, we're going to assume that you have nothing but MDM. This is the PolicyPak MDM solution, and you don't have PolicyPak Group Policy and you don't have
PolicyPak Cloud. You've only got PolicyPak MDM.

Now if you only have PolicyPak MDM, we still recommend that you do what I showed you
...
It's already wrapped up nicely in PolicyPak format. Then the last thing we want to do
is let's just go right for it and take the Group Policy Preferences for PolicyPak item
...
targeting" you can do item-level targeting everywhere and anywhere in PolicyPak land.
...
we're going to do then is use the "PolicyPak Exporter Tool." PolicyPak
...
"Computer." We'll go ahead and click "Next" here and we'll call this "[PolicyPak ] MDM
and Azure AD Check." So that's the name of our MSI. And "File name" "PolicyPak Azure
...
This machine is Azure AD joined only. The idea is that he already has the "PolicyPak
Client-Side Extension" using your MDM service. He has "PolicyPak MDM Licenses"
delivered using your MDM service. You did this before in the Walk Before You Run video and also your
Getting Started with PolicyPak MDM. You've already done this.
...
I hope this helps you out and you're looking to get started with PolicyPak MDM real
soon.
