...
![Custom Messages Editor window](/images/threatprevention/8.0/admin/configuration/custommessageseditor.webp)
...
![Password Dictionary window](/images/threatprevention/8.0/admin/configuration/passworddictionary.webp)
...
![Words List Dictionary window](/images/threatprevention/8.0/admin/configuration/wordslistdictionary.webp)
...
![Substitution Editor window](/images/threatprevention/8.0/admin/configuration/substitutioneditor.webp)
