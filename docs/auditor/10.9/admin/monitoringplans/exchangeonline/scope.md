...
| propnames.txt    | Contains a list of human-readable names for object classes and their properties to be displayed in search results, reports, and Activity Summaries.                                                          | `cmdletobject=friendlyname` `cmdlet.param=friendlyname` For example: `RoleGroupMember = Role Group` `UMHuntGroup = Unified Messaging Hunt Group`                                                                                                                                                                         |
