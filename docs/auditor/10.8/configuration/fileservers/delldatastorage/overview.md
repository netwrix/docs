...
- Monitoring and reporting of the Dell Data Storage systems may not provide the results you expect
  due to native Dell audit peculiarities. See the [File Servers](/docs/auditor/10.8/configuration/fileservers/overview.md) topic for
...
**Step 1 –** [Configure Security Event Log](/docs/auditor/10.8/configuration/fileservers/delldatastorage/securityeventlog.md) to set the log path, maximum size, and retention so that the log doesn't overwrite security events. Auditor
