...
![mp_wizard_step1](/images/auditor/10.8/admin/monitoringplans/mp_wizard_step1.webp)
...
![mp_wizard_step2](/images/auditor/10.8/admin/monitoringplans/mp_wizard_step2.webp)
...
- Install a new instance of Microsoft SQL Server Express automatically — this option is available at
  the first run of the wizard. It deploys SQL Server 2016 SP2 Express with Advanced
...
![mp_wizard_step_db_thumb_0_0](/images/auditor/10.8/admin/monitoringplans/mp_wizard_step_db_thumb_0_0.webp)
...
A monitoring plan can't collect data until at least one item is specified.
