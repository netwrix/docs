...
[Notifications](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/notifications.md), as well as in the Seal
overview.

## 2. Granting a release

The [Seal overview](/docs/passwordsecure/26.3/configuration/advancedview/permissionconceptandprotective/protectivemechanisms/seals/seal_overview.md) can be opened via the seal symbol in the
