...
1. In your issue ticket, you should see the 'Netwrix NetSuite Forge' tab in the issues tab. Click the tab.
    Two possible displays:
        ...
        ![Jira Forge Issue No Project Key](/static/images/platgovnetsuite/integrations/jira_forge_issue_no_project_key.webp)

        2. If you have, you should see the connect page where you can connect or log in to a NetSuite defined in [Set up Jira TBA Credentials](/docs/platgovnetsuite/ticketingintegrations/jiraforgeintegration/jira_forge_set_up#set-up-jira-tba-credentials) in Setup page.


        ![Jira Forge Issue Connect Form](/static/images/platgovnetsuite/integrations/jira_forge_issue_connect_form.webp)
...
![Jira Forge Issue Connect Form Successful](/static/images/platgovnetsuite/integrations/jira_forge_issue_connect_form_successful.webp)
...
![Jira Forge Issue Connect Form Successful ITGC](/static/images/platgovnetsuite/integrations/jira_forge_connect_itgc_form.webp)
...
![Jira Forge Lookup Customization Modal](/static/images/platgovnetsuite/integrations/jira_forge_lookup_customization_modal.webp)
...
![Jira Forge Lookup Customization Modal Name Filter](/static/images/platgovnetsuite/integrations/jira_forge_lookup_name_filter.webp)
...
3. Select a customization to attach by ticking the checkbox beside the name. Once ticked, click the "Add Customizations" button at the botton part of the modal.
    ...
    ![Jira Forge Add Customization Flag In Progress](/static/images/platgovnetsuite/integrations/jira_forge_add_customization_in_progress.webp)

    - Below shows a flag with a message that the action is successful.


    ![Jira Forge Add Customization Flag In Progress](/static/images/platgovnetsuite/integrations/jira_forge_successful_add_customization.webp)
...
4. You can also add customization that is yet to be created. This is what the "Proposed Customization" button is for. To add one, click the "Proposed Customization" button. A modal should appear with the following fields:
    ...
    ![Jira Forge Proposed Customization Modal](/static/images/platgovnetsuite/integrations/jira_forge_proposed_customization_modal.webp)
...
5. Select the Type for your proposed customization. In this case, we will select "Body Field" type. Notice that the Script ID/Name field is prepopulated with the prefix of the script ID, this allows the user ease of use and not mistakenly input the wrong script ID prefix for the type. Type the script ID of your choice.
    ...
    ![Jira Forge Proposed Customization Input](/static/images/platgovnetsuite/integrations/jira_forge_add_proposed_wth_input.webp)
6. Click the "Add Proposed Customization" button to add/attach it to the Jira ticket change request.
    - Below shows a flag with a message that the action is in progress.


    ![Jira Forge Proposed Customization Flag In Progress](/static/images/platgovnetsuite/integrations/jira_forge_add_proposed_in_progress.webp)    

    - Below shows a flag with a message that the action is successful.


    ![Jira Forge Proposed Customization Flag Successful](/static/images/platgovnetsuite/integrations/jira_forge_add_proposed_successful.webp) 

Below shows the existing and proposed customiations that were added in steps 1 through 6.


![Jira Forge Existing and Proposed Customizations](/static/images/platgovnetsuite/integrations/jira_forge_existing_and_proposed_customizations_added.webp)       
...
![Jira Forge Remove Customizations Icon](/static/images/platgovnetsuite/integrations/jira_forge_remove_trash_icon.webp)   

    - Below shows a flag with a message that the action is in progress.


    ![Jira Forge Remove Customizations Flag In Progress](/static/images/platgovnetsuite/integrations/jira_forge_remove_customization_in_progress.webp)  

    - Below shows a flag with a message that the action is successful.


    ![Jira Forge Remove Customizations Flag Success](/static/images/platgovnetsuite/integrations/jira_forge_remove_customization_successful.webp)  
...
![Jira Forge Import Customization](/static/images/platgovnetsuite/integrations/jira_forge_import_customization_modal.webp)

2. Select a file to import.
- Importing XML file format


![Jira Forge Import Customization](/static/images/platgovnetsuite/integrations/jira_forge_import_xml_file.webp)  

- Importing SDF ZIP file format


![Jira Forge Import Customization](/static/images/platgovnetsuite/integrations/jira_forge_import_sdf_zip.webp)  
...
![Jira Forge Impact Analysis Button](/static/images/platgovnetsuite/integrations/jira_forge_impact_analysis_button.webp)  
2. A modal will appear to start the risk assessment process.


![Jira Forge Impact Analysis Calculating](/static/images/platgovnetsuite/integrations/jira_forge_calculating_impact_analysis.webp) 
...
![Jira Forge Impact Analysis Data](/static/images/platgovnetsuite/integrations/jira_forge_impact_analysis.webp) 
...
![Jira Forge View ERD Button](/static/images/platgovnetsuite/integrations/jira_forge_view_erd_button.webp) 

2. A modal will appear to start pulling ERD data.


![Jira Forge Pulling ERD Data](/static/images/platgovnetsuite/integrations/jira_forge_pulling_erd_data.webp) 

3. The modal populates with the customization and its corresponding hyperlink to the ERD.


![Jira Forge ERD Data](/static/images/platgovnetsuite/integrations/jira_forge_list_erd_data.webp) 

4. Click "View ERD" link to view the customization's ERD. It will open to a new tab within the same browser.


![Jira Forge ERD Data NetSuite](/static/images/platgovnetsuite/integrations/jira_forge_sample_erd.webp) 
...
![Jira Forge Push Button](/static/images/platgovnetsuite/integrations/jira_forge_push_button.webp)

- Below shows a flag with a message that the action is in progress.


![Jira Forge Push In Prgoress](/static/images/platgovnetsuite/integrations/jira_forge_push_in_progress.webp) 

- Below shows a flag with a message that the action is successful.


![Jira Forge Push Successful](/static/images/platgovnetsuite/integrations/jira_forge_push_successful.webp) 
...
![Jira Forge Change Request Pending Approval](/static/images/platgovnetsuite/integrations/jira_forge_change_request_pending_approval_status.webp) 
...
![Jira Forge Change Request Approved](/static/images/platgovnetsuite/integrations/jira_forge_approved_cr_status.webp) 
...
![Jira Forge Change Request Approved Flag In Progress](/static/images/platgovnetsuite/integrations/jira_forge_push_in_progress.webp) 

- Below shows a flag with a message that the action is successful.


![Jira Forge Change Request Approved Flag Sucessful](/static/images/platgovnetsuite/integrations/jira_forge_push_successful.webp) 
...
![Jira Forge Change Request NetSuite 1](/static/images/platgovnetsuite/integrations/jira_forge_itgc_cr_1.webp) 
...
![Jira Forge Change Request NetSuite 2](/static/images/platgovnetsuite/integrations/jira_forge_itgc_cr_2.webp) 
...
![Jira Forge Add Bundle Button](/static/images/platgovnetsuite/integrations/jira_forge_add_bundle_button.webp) 



![Jira Forge Add Bundle Modal](/static/images/platgovnetsuite/integrations/jira_forge_add_bundle_modal.webp) 
...
![Jira Forge Push External Button](/static/images/platgovnetsuite/integrations/jira_forge_push_external_button.webp) 



![Jira Forge Push External Modal](/static/images/platgovnetsuite/integrations/jira_forge_push_external_modal.webp) 
...
![Jira Forge Settings Button](/static/images/platgovnetsuite/integrations/jira_forge_settings_change_account.webp) 
