...
- Remote Desktop Monitor Service – The Privilege Secure Remote Desktop Monitor service monitors the
  ...
  See the [Install Remote Desktop Monitor Service on Target RDP Hosts](/docs/privilegesecure/25.12/install/servicesonadditional/rdpmonitor.md) topic for
...
![Single Server Deployment](/images/privilegesecure/25.12/accessmanagement/install/singleserverdeployment.webp)
...
![Distributed Architecture Data Flow Diagram](/images/privilegesecure/25.12/accessmanagement/install/distributedarchitecture.webp)
...
See the [Ports](/docs/privilegesecure/25.12/requirements/ports.md) topic for additional information.
...
![Active-Passive Database Deployment Diagram](/images/privilegesecure/25.12/accessmanagement/install/activepassivedatabase.webp)
...
![Active-Active Database Deployment Diagram](/images/privilegesecure/25.12/accessmanagement/install/activeactivedatabase.webp)
...
![AWS Acrive-Active Database Deployment Diagram](/images/privilegesecure/25.12/accessmanagement/install/awsdatabase.webp)
...
![Bring Your Own Vault Integration Diagram](/images/privilegesecure/25.12/accessmanagement/install/byovdatabase.webp)
...
![Bring Your Own Vault LAPS Integration Diagram](/images/privilegesecure/25.12/accessmanagement/install/byovlapsdatabase.webp)
