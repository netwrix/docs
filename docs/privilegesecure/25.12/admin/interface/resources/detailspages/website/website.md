...
![Website Resource details page](/images/privilegesecure/25.12/accessmanagement/admin/policy/page/details/websitedetails.webp)
...
- [URLs Tab for Website](/docs/privilegesecure/25.12/admin/interface/resources/detailspages/website/urlswebsite/urlswebsite.md)
- [Users Tab for Website](/docs/privilegesecure/25.12/admin/interface/resources/detailspages/website/userswebsite/userswebsite.md)
- [Sessions Tab for Website](/docs/privilegesecure/25.12/admin/interface/resources/detailspages/website/sessionswebsite.md)
- [Access Policies Tab for Website](/docs/privilegesecure/25.12/admin/interface/resources/detailspages/website/accesspolicieswebsite.md)
- [History Tab for Website](/docs/privilegesecure/25.12/admin/interface/resources/detailspages/website/historywebsite.md)
