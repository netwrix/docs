...
- Click Analytics in the left pane to launch the Analytics interface. Then click the gear icon for
  the analytic.
- Expand the Analytics node and click the Kerberos Weak Encryption analytic. On the analytic window, click the gear
...
![Kerberos Weak Encryption Analytic Type - Policy tab](/images/threatprevention/8.0/admin/analytics/policytab.webp)
...
![kerberosweakencryption](/images/threatprevention/8.0/admin/analytics/kerberosweakencryption.webp)
