...
Netwrixindustry experts, as described in the [How Risk Levels Are Estimated ](/docs/auditor/10.9/admin/riskassessment/levels.md) topic. They
...
![modify_thresholds_thumb_0_0](/images/auditor/10.9/admin/riskassessment/modify_thresholds_thumb_0_0.webp)
...
See the [Create Subscriptions](/docs/auditor/10.9/admin/subscriptions/create.md) topic for additional information.
