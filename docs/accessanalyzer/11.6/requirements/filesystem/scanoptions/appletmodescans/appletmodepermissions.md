...
Sensitive Data Discovery Auditing scans require .NET Framework 4.7.2 or later on the server where the applet is deployed, for Sensitive Data Discovery collections to succeed.
