...
When the client is online and able to make contact with a domain controller, PolicyPak
...
![policypak_application_settings_1_20](/images/policypak/applicationsettings/modes/endpointpolicymanager_application_settings_1_20.webp)
...
Additionally, PolicyPak Application Settings Manager cannot use AppLock™ for every
setting for every application. That is, PolicyPak Application Settings Manager cannot
gray out or remove the UI from every application.

In these cases, PolicyPak Application Settings Manager will do the next best thing: it
...
PolicyPak Application Settings Manager will reapply an application's settings manually
when

- the computer is online and the Microsoft `GPupdate `command is run and
- the computer is online or offline and the PolicyPak `ppupdate` command is run.
...
Let's explore the manual command `ppupdate` and the various automatic ways that PolicyPak Application Settings Manager will reenforce application settings.
...
![policypak_application_settings_1_21](/images/policypak/applicationsettings/modes/endpointpolicymanager_application_settings_1_21.webp)
...
are used) (see section, "Deploying PolicyPak Directives without Group Policy," in
Appendix A: Using PolicyPak with MDM and UEM Tools). The PolicyPak
...
![policypak_application_settings_1_22](/images/policypak/applicationsettings/modes/endpointpolicymanager_application_settings_1_22.webp)
...
that PolicyPak Application Settings Manager is managing. If you wish to fully disable
...
![policypak_application_settings_1_23](/images/policypak/applicationsettings/modes/endpointpolicymanager_application_settings_1_23.webp)

The figure shown. Use the following Registry location to fully disable the PolicyPak driver,
...
PolicyPak Application Settings Manager will automatically utilize the Group Policy
...
PolicyPak Application Settings Manager reapply the application's settings.

PolicyPak Application Settings Manager has an optional switch, which must be manually
...
![policypak_application_settings_1_24](/images/policypak/applicationsettings/modes/endpointpolicymanager_application_settings_1_24.webp)
