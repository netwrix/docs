...
- Exchange Mailbox (2010 and newer) – Lets you specify an Exchange Mailbox Alias for MAPI
  connections

    - When you select Exchange Mailbox (2010 and newer), the wizard enables the textbox. Enter the Alias
