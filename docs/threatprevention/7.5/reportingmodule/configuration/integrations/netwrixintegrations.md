...
permissions. See the [Credential Profile Page](/docs/threatprevention/7.5/reportingmodule/configuration/integrations/credentialprofile.md) topic for instructions.
:::
...
- Credential Profile — Select the Credential Profile by name from the dropdown menu. This profile must be created on the Credential Profiles page.
...
- Default Source — When checked, the database is the default source for Investigation reports. This option can't be deselected for the first integration configured.
...
**Step 3 –** Select a product from the table or the navigation pane to view the integration details.
...
dropdown menu. This profile must be created on the Credential Profiles page.
