...
[Users and Roles Window](/docs/threatprevention/8.0/admin/configuration/userroles/overview.md) topic to configure users.

## Configure Alerts

The administrator must configure email and SIEM alerts before they can be enabled. See the
[System Alerting Window](/docs/threatprevention/8.0/admin/configuration/systemalerting/overview.md) topic to enable alerts and
...
[Collection Manager Window](/docs/threatprevention/8.0/admin/configuration/collectionmanager/overview.md) topic to configure
Collections.
...
- Use a policy template to create a policy. See the
  [Pre-Created Templates](/docs/threatprevention/8.0/admin/templates/folder/overview.md) topic for additional information.
- Create a new policy and template configuration. See the
  [Policy Configuration](/docs/threatprevention/8.0/admin/policies/configuration/configuration.md) and
...
[Recent Events Tab](/docs/threatprevention/8.0/admin/policies/configuration/recentevents/overview.md) in the policy's configuration or to the
[Investigate Interface](/docs/threatprevention/8.0/admin/investigate/overview.md) to confirm that the intended events being
...
- Administration Console – Navigate to either the Recent Events tab in the policy's configuration or
  ...
  [Recent Events Tab](/docs/threatprevention/8.0/admin/policies/configuration/recentevents/overview.md) and
  [Investigate Interface](/docs/threatprevention/8.0/admin/investigate/overview.md) topics for details. Event data configured
...
[Database Maintenance Window](/docs/threatprevention/8.0/admin/configuration/databasemaintenance/overview.md) topic for
...
- See the [Reporting Module Server Requirements](/docs/threatprevention/8.0/requirements/reportingserver.md) topic for details
  on prerequisites.
- See the
  [Netwrix Threat Manager Reporting Module Ports](/docs/threatprevention/8.0/requirements/ports.md#netwrix-threat-manager-reporting-module-ports)
...
[Reporting Module Installation](/docs/threatprevention/8.0/install/reportingmodule/overview.md) topic for additional
information.
...
[First Launch](/docs/threatprevention/8.0/install/reportingmodule/firstlaunch.md) topic for additional information.
...
- Credential Profile – See the
  [Credential Profile Page](/docs/threatprevention/8.0/reportingmodule/configuration/integrations/credentialprofile.md) topic
...
- Active Directory Sync – Configure the application to sync with Active Directory. See the
  [Active Directory Sync Page](/docs/threatprevention/8.0/reportingmodule/configuration/integrations/activedirectorysync.md)
  topic for additional information.
- Netwrix Integration – Configure connection to the Netwrix Threat Manager Reporting Module
  database. See the
  [Netwrix Integrations Page](/docs/threatprevention/8.0/reportingmodule/configuration/integrations/netwrixintegrations.md)
  topic for additional information.
