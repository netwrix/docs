...
- On pre-Windows Server 2012 versions:
    ...
    3. Ensure that the **Apply these auditing entries to objects and/or containers within this
       container only** checkbox is cleared. Also, ensure that the **Apply onto** parameter is
...
- On Windows Server 2012 and above
    ...
    3. Set **Type** to _"Success"_. In the **Applies to** field, select _"This object and all descendant objects"_.
    ...
    5. Scroll to the bottom of the list and ensure that the **Only apply these auditing settings
...
Server 2008 and above, this component installs with the AD DS role, or you can download and install
it with Remote Server Administration Tools. See the
[Install ADSI Edit](/docs/1secure/configuration/admanual/adsi.md) topic for additional information.
