...
PolicyPak has some extra powers to prevent users from managing and installing
additional add-ons. First, if PolicyPak is set to disable an add-on (or a whole
...
![add_ons_9](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_9.webp)
...
![add_ons_10](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_10.webp)
...
![add_ons_11](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_11.webp)
