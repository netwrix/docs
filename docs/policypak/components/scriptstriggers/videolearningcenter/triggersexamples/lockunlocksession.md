---
title: "PolicyPak Scripts + Triggers: Perform actions at LOCK and UNLOCK of session"
description: "PolicyPak Scripts + Triggers: Perform actions at LOCK and UNLOCK of session"
sidebar_position: 30
---
# PolicyPak Scripts + Triggers: Perform actions at LOCK and UNLOCK of session

In this demo you'll see how to use Session Lock and Session Unlock trigger types with Netwrix PolicyPak Scripts. It's easy to do ! Pre-test your script first,
then you're off to the races. Remember which processes require RUN INTERACTIVE though!

<iframe width="560" height="315" src="https://www.youtube.com/embed/p00SeWdMn7U" title="PolicyPak Scripts + Triggers: Perform actions at LOCK and UNLOCK of session" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz, and in this video, I'm going to show you how you can use PolicyPak scripts and triggers to fire off activities when the session is locked and unlocked.
Now you should practice what you're doing to do before you jump into PolicyPak scripts
...
this works as well, perfectly well, in MDM or PolicyPak Cloud. I'm just using group
...
PolicyPak scripts and triggers enables you to at session lock or unlock time, do some
