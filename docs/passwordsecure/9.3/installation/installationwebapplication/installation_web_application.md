...
:::warning
This guide focuses on the initial installation of the Web Application and isn't
...
ensured that all [Webserver](/docs/passwordsecure/9.3/installation/requirements/webserver/webserver.md) requirements have been met.
...
:::warning
Don't use the Server Manager installation directory
:::
...
The process for opening the Web Application depends on the configuration of the web server:
...
:::note
In order for the redirect to be used, ensure on apache and nginx web
