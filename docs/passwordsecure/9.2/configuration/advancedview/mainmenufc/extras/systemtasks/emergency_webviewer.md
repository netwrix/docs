...
**[System tasks](/docs/passwordsecure/9.2/configuration/advancedview/mainmenufc/extras/systemtasks/system_tasks.md)** and this task lets you guarantee a regular backup of
...
The user can log in again using the **password** and **key** as described in the login section. After successfully
