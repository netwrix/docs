...
**[System tasks](/docs/passwordsecure/9.3/configuration/advancedview/mainmenufc/extras/systemtasks/system_tasks.md)** and this task lets you guarantee a regular backup of
...
:::note
The current user needs to log in using their password. If an incorrect password is entered,
