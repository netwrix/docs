...
<iframe width="560" height="315" src="https://www.youtube.com/embed/CGsKr4_aBFs" title="PolicyPak: Browser Router now supports Chrome on Non-Domain Joined machines" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
browser with non-domain joined machines and Netwrix PolicyPak
Cloud. In previous instances of PolicyPak, we didn't have any support at all for
non-domain joined machines and Browser Router with Chrome. In this video, I'm going to show you how
it's supported.

First things first, I'm going to download the latest "PolicyPak Cloud Client." You
already are probably joined to PolicyPak PolicyPak Cloud, so you don't
have to do this. Like I said, you've already done this and auto-magically in the background you're
going to get the latest PolicyPak client-side extension and it will have the support
built in.

When you do this, I'm also assuming that you have a route. This is PolicyPak Cloud. I
have a route here that says any time I go to PolicyPak.com or anything like that open
it up in Firefox ("\*pak\* to Firefox"). I want to show you how to go from Chrome to Firefox or
anything like that.

Now that I have the PolicyPak Cloud Client here, let me show you the before behavior
and the after behavior. If you were to just go into "Google Chrome" here and try to go to
"www.PolicyPak.com," it's not going to work. That's still the deal. It's still going
...
(PolicyPak Browser Router Chrome Extension)." You can click there. That's the first
choice. There we go: "New extension added (PolicyPak Browser Router Chrome
...
The point is that if you want Chrome support with your non-domain joined machines in PolicyPak Cloud, that is the deal. The deal is that each user needs to manually specify to turn on the
