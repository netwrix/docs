...
- [0.Collection Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/exchange/sensitivedata/collection/overview.md)
  – Locates sensitive data found in mailboxes and public folders in the Exchange environment
- [EX_SDDResults Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/exchange/sensitivedata/ex_sddresults.md)
