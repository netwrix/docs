...
![credential_creation](/images/changetracker/8.2/admin/agentlesscis/credential_creation.webp)
...
![credential_grid](/images/changetracker/8.2/admin/agentlesscis/credential_grid.webp)
...
![proxide_device_configuration](/images/changetracker/8.2/admin/agentlesscis/proxide_device_configuration.webp)

The proxied Windows device will now be present in the detail grid of the master proxy device.

![device_grid](/images/changetracker/8.2/admin/agentlesscis/device_grid.webp)
...
![compliance_report_configuration](/images/changetracker/8.2/admin/agentlesscis/compliance_report_configuration.webp)

Execute the compliance report in the standard way.

![running_compliance_report](/images/changetracker/8.2/admin/agentlesscis/running_compliance_report.webp)

Completed compliance report:

![completed_compliance_report](/images/changetracker/8.2/admin/agentlesscis/completed_compliance_report.webp)
...
![compliance_report](/images/changetracker/8.2/admin/agentlesscis/compliance_report.webp)
