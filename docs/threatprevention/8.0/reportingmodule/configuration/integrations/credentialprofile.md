...
![Integrations interface on the Credential Profile page](/images/threatprevention/8.0/reportingmodule/configuration/integrations/page_1.webp)
...
See the [Reporting Module Server Requirements](/docs/threatprevention/8.0/requirements/reportingserver.md) topic for a
...
![Name and Description box for a Credential Profile in Edit mode](/images/threatprevention/8.0/reportingmodule/configuration/integrations/editprofile.webp)
