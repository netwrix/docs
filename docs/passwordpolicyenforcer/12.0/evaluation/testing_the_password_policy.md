...
**mypassword** fails two requirements: it doesn't contain an upper alpha character and it is similar to a common password. You can hover over the requirements to view the associated
rule.
