...
![Integrations interface on the Netwrix Integration page](/images/threatprevention/8.1/reportingmodule/configuration/integrations/page_2.webp)

With integrations to other Netwrix products, you can run Investigations on the event data within
...
selecting a different database from the dropdown menu. The table provides the following
information:
...
:::note
Before adding a Netwrix Integration, you must first configure a Credential Profile with
credentials properly provisioned for connecting to the database. See the
[Reporting Module Server Requirements](/docs/threatprevention/8.1/requirements/reportingserver.md) topic for the
permissions. See the [Credential Profile Page](/docs/threatprevention/8.1/reportingmodule/configuration/integrations/credentialprofile.md) topic for additional
information on creating a profile.
:::


To add a Netwrix product for integration:
...
![Add New Integrations window with the Netwrix Integration type selected](/images/threatprevention/8.1/reportingmodule/configuration/integrations/addnewintegration.webp)

**Step 3 –** In the Type dropdown list, select Netwrix Integration.
...
![Netwrix Integration Details on the Configuration tab](/images/threatprevention/8.1/reportingmodule/configuration/integrations/configurationtab.webp)
...
![Netwrix Integration Details on the Policy Sync tab](/images/threatprevention/8.1/reportingmodule/configuration/integrations/policysynctab.webp)
...
![Name and Description box for a Netwrix Integration in Edit mode](/images/threatprevention/8.1/reportingmodule/configuration/integrations/editnetwrixintegration.webp)
...
**Step 2 –** The Configuration tab opens, where you can make the modification you want.
