...
[Masterkey mode](/docs/passwordsecure/current/configuration/advancedview/clientmodule/organisationalstructure/directoryservices/activedirectorylink/masterkey_mode.md)
...
[Managing users](/docs/passwordsecure/current/configuration/advancedview/clientmodule/organisationalstructure/managingusers/managing_users.md).
...
See also in
[Multifactor authentication](/docs/passwordsecure/current/configuration/advancedview/clientmodule/organisationalstructure/multifactorauthentication/multifactor_authentication.md)
