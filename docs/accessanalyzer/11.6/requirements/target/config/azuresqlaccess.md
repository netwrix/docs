...
![Azure SQL - Add a role assignment window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/requirements/target/config/azuresqlperm_customrolecreation_14z.webp)
