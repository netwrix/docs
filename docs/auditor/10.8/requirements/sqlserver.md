...
[How to Migrate Netwrix Auditor Databases to Another SQL Server Instance](https://docs.netwrix.com/docs/kb/auditor/how-to-migrate-netwrix-auditor-databases-to-another-sql-server-instance)
