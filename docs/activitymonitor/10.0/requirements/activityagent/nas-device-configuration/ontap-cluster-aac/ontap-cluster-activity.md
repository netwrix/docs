...
depends on the fault tolerance requirements and the expected event flow. Generally, the
...
**Checklist Item 2: [Provision ONTAP Account](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/ontap-cluster-aac/provisionactivity.md)**
...
**Checklist Item 3: [Configure Network](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/ontap-cluster-aac/configurefirewall.md)**
...
**Checklist Item 4: [Configure FPolicy](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/ontap-cluster-aac/configurefpolicy.md)**
