...
| Port      | Provide the port configured in your monitoring plan for Network Devices (514 by default). See the[Network Devices](/docs/auditor/10.9/admin/monitoringplans/networkdevices.md) topic for additional information. |
