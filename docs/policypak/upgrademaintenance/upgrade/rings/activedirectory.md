---
title: "Rings with PolicyPak and Active Directory"
description: "Rings with PolicyPak and Active Directory"
sidebar_position: 30
---

# Rings with PolicyPak and Active Directory

There are several ways to make rings when you have machines joined to Active Directory using a
third-party software installation mechanism, or the PolicyPak built-in CSE updater. We
describe these options in the sections that follow.

## Third-Party Software Deployment Tools

The first option for using rings with PolicyPak and Active Directory is to make rings
...
## PolicyPak CSE Auto-Updater

The second way to use rings with PolicyPak and Active Directory is by using the
built-in PolicyPak CSE update mechanism. This is an excellent choice when using rings
since not everyone has a third-party software deployment tool.

:::note
While it is possible to deploy the PolicyPak CSE via Microsoft's Group
...
As an alternative, you can use the PolicyPak CSE Auto-Updater. The general idea with
...
## PolicyPak CSE Auto-Updater in Reverse

The third option for using rings with Active Directory is to use the built-in PolicyPak CSE update mechanism in an alternative manner. You can use a similar technique as Option 2,
...
**Step 5 –** You can automate this signal using a script, PolicyPak Scripts &
Triggers, SCCM, or any other another technique, and the machine will upgrade.

## PolicyPak Remote Work Delivery Manager

The last way to use rings with Active Directory is by using PolicyPak Remote Work
...
See the
[Using Remote Work Delivery Manager to Update the PolicyPak Client Side Extension](/docs/policypak/components/remoteworkdeliverymanager/videos/tipsandtricks/updateclientsideextension.md)video for
