---
title: "Add Microsoft Entra ID Tenant"
...
![Add Azure AD Tenant](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/addazureadtenant.webp)
...
[Microsoft Entra ID Details Page](/docs/privilegesecure/26.03/admin/resources/detailspages/entraid/entraid.md) topic for additional information.
