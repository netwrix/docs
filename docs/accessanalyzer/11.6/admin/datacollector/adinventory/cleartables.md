...
When you run the job, Enterprise Auditor removes all of the ADInventory standard reference tables
from the database.
...
:::tip
Remember, this job deletes data from the Enterprise Auditor database. Verify that you configured
the job correctly before running it.
:::
