...
The Introduction Guide introduced the [Entitlement Management](../../introduction-guide/overview/entitlement-management) and how it influences assigning entitlements to identities. Let's sum up the key principles here.
...
The role model is built iteratively, together with the [Entity Model](../../integration-guide/entity-model), as they closely influence one another.
...
![Cascading From **dimensions** To Roles To Provisioning Orders](/images/identitymanager/enforce-assignment-policy-summary.webp)
