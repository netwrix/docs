...
When dealing with large sets of data, use the Filter icon to search for a desired attribute.
...
You can also filter data on dates and times. Expanding the column’s width activates hyperlinks to
...
Use comparison operators to filter numeric columns. Available comparison operators include the following:
...
columns you want to display. Click the up or down arrows to scroll through the list of columns.
