---
title: "What must I send to PolicyPak support in order to get the FASTEST support?"
description: "What must I send to PolicyPak support in order to get the FASTEST support?"
sidebar_position: 10
---

# What must I send to PolicyPak support in order to get the FASTEST support?
...
for an account if necessary. Be sure to choose PolicyPak to ensure your case is routed
properly.
...
- Explain if you are using PolicyPak alongside Group Policy, Cloud or with an MDM
  service
- Specific screenshots of what you did in PolicyPak
...
[Gathering and Uploading Logs](/docs/policypak/gettingstarted/misc/videos/troubleshooting/logs.md) topic on how to gather logs
...
[Gathering and Uploading Logs](/docs/policypak/gettingstarted/misc/videos/troubleshooting/logs.md) topic for additional information.

:::note
If you do not see the GUI version of pplogs, you are not using the latest CSE. PolicyPak support only accepts logs from machines with the latest CSE and latest pplogs zip files.
:::


![Running the PPLOGS tool](/images/policypak/troubleshooting/runninglogs.webp)
...
![exportonexml](/images/policypak/troubleshooting/exportonexml.webp)
![exportcollectionxml](/images/policypak/troubleshooting/exportcollectionxml.webp)

**Step 4 –** If using the Group Policy Method, export policies and/or collections as XML files.

![exportfromappmanager](/images/policypak/troubleshooting/exportfromappmanager.webp)
...
## Troubleshooting Previous Versions of PolicyPak

Use these steps for gathering and uploading logs for versions previous to PolicyPak
v25.4.
...
- What you did in Netwrix PolicyPak
- The result on the endpoint
...
![128_1_command-prompt](/images/policypak/troubleshooting/128_1_command-prompt.webp)
...
- Most PolicyPak settings are simply **right-click** > **Export as XML**. See the
  examples below for exporting as a collection and an individual policy.

![128_2_export-collection-as-xml](/images/policypak/troubleshooting/128_2_export-collection-as-xml.webp)

![128_3_export-as-xml](/images/policypak/troubleshooting/128_3_export-as-xml.webp)

**Step 4 –** For PolicyPak Application Manager (most common) this is what you want to
...
![128_4_image002](/images/policypak/troubleshooting/128_4_image002.webp)
