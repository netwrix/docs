...
:::note
You can create custom playbooks using the PowerShell Script action. However, this feature
...
See the [Action Configuration for Playbook Steps](/docs/threatmanager/3.3/administration/playbooks/action/overview.md) topic for
