...
section[Multifactor Authentication](/docs/passwordsecure/26.3/configuration/servermanger/managingdatabases/databasesettings/multifactor_authentication_ac.md).
