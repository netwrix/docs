...
You can apply filters on the [Investigate Interface](/docs/threatprevention/7.5/admin/investigate/overview.md) to filter event data as desired. Filters settings can be saved.
