...
1. You hand-install the CSE and immediately start to tryNetwrix PolicyPak Browser Router or launch your browsers.
...
But if Interenet Explorer is running WHILE the installation of thePolicyPak CSE
occurs, you might get this message the next time you launch Internet Explorer.

![524_1_unnamed-1](/images/policypak/troubleshooting/browserrouter/install/524_1_unnamed-1.webp)

Even if users select DON'T ENABLE, thePolicyPak CSE will fix it at the next login.

The workaround and recommendation is to install thePolicyPak CSE when no users are
