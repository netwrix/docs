...
[LDAP Lockdown Event Type](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/ldaplockdown.md), the LDAP filter lets you enable the LDAP Ping
option.
...
- `(&(NtVer=0x6)(AAC=16)(User='` – Including this filter string will return only those queries
  generated by the known version of LDAP Nom Nom
