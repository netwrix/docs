...
Users can continue working with that older version, but the latest Netwrix Account Lockout Examiner
is recommended to benefit from the variety of its new features and enhanced usability.
...
Your feedback and ideas are welcome. You can check in on
