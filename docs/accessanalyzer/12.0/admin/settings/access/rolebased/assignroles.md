...
Assign roles in the Access Analyzer Console:
...
permissions. This allows roles to be used without requiring local Administrator rights.

:::note
The Web Administrator and Report Viewer roles don't require access to the Access Analyzer
console, so users assigned these roles aren't added to the NEAUsers group.
:::
...
Edit an Access Analyzer user's role:

![Edit Member Role](/images/accessanalyzer/12.0/admin/settings/access/rolebased/editmemberrole.webp)

**Step 1 –** On the Access page, select the user and click **Edit Member Role**.
...
Delete a user's access to the Access Analyzer Console:

![Delete Role Member](/images/accessanalyzer/12.0/admin/settings/access/rolebased/deleterolemember.webp)

**Step 1 –** On the Access page, select the user and click **Delete Role Member**. The
