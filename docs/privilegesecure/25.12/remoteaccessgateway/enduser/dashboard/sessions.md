...
![startsessionrag](/images/privilegesecure/25.12/remoteaccessgateway/enduser/dashboard/startsessionrag.webp)

Clicking the **Session** icon via the Active Dashboard will launch a session on the Sessions tab.

![sessionwindowrag](/images/privilegesecure/25.12/remoteaccessgateway/enduser/dashboard/sessionwindowrag.webp)
...
![sessionstabrag](/images/privilegesecure/25.12/remoteaccessgateway/enduser/dashboard/sessionstabrag.webp)
