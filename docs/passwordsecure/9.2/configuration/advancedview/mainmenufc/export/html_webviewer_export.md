...
NOTE: Use the password search function when there are more than 20 passwords!
...
You can log out by clicking on **Logout**. After a longer period of inactivity, the user
