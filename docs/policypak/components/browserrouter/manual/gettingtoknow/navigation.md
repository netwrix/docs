...
PolicyPak Browser Router editor is located in the PolicyPak node.
PolicyPak Browser Router enables you to create a new PolicyPak Browser
...
![about_policypak_browser_router](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router.webp)

All PolicyPak Browser Router policies must always reside within collections. There are
two steps for this.

![about_policypak_browser_router_1](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_1.webp)

**Step 1 –** Create and name a collection.

**Step 2 –** Put Browser Router policies (or other collections) inside the collection.

![about_policypak_browser_router_2](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_2.webp)

You can create collections and policies within collections on either the User or Computer side (or
both). PolicyPak Browser Router has a precedence order if you decide to have multiple
...
![about_policypak_browser_router_3](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_3.webp)

Once you click **OK**, you'll get an entry such as the one shown below.

![about_policypak_browser_router_4](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_4.webp)
...
![about_policypak_browser_router_5](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_5.webp)

Click OK to save the entry.

Create another policy to route \*.policypak.com to Edge.

![about_policypak_browser_router_6](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_6.webp)

Last, create an entry for **New Default Browser**.

![about_policypak_browser_router_7](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_7.webp)

After you do this, a dialog box with limited options appear. You can only choose a default browser,
which will be Chrome.

![about_policypak_browser_router_8](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_8.webp)

When you've finished these actions, your entries will resemble these.

![about_policypak_browser_router_9](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_9.webp)
...
go if you followed along with the PolicyPak Browser Router Quickstart, created a new
...
![about_policypak_browser_router_10](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_10.webp)
