...
1. Go to **Settings > General > Access Reviews**.
...
3. Select the data sources to review.
...
1. Go to **Configuration > Monitoring plans**.

2. Double click the monitoring plan.

3. Click **Edit data source** button on the left.

![enablear](/images/auditor/10.7/enablear.webp)

4. Navigate to the Send data for Access Reviews and select the checkbox.
