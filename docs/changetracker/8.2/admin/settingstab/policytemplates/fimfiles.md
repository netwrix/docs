...
![ConfigTemplatesFIMFiles](/images/changetracker/8.2/admin/settings/policytemplates/configtemplatesfimfiles.webp)
...
:::note
For Advanced Options: see [Appendix B](/docs/changetracker/8.2/admin/matchrulesoverview/filefolderrules.md) for more
information.
