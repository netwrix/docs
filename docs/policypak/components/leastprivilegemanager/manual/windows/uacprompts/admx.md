---
title: "Using the Least Privilege Manager ADMX Settings"
description: "Using the Least Privilege Manager ADMX Settings"
sidebar_position: 20
---

# Using the Least Privilege Manager ADMX Settings

There are two reasons you might want to configure the PolicyPak Least Privilege
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/tool/helper/using_the_endpointpolicymanager_least.webp)

## ADMX Settings with the Printer Tool

The ADMX setting prevents users from configuring Print Server Properties using the PolicyPak Printers tool, and will block access to the button and window highlighted here.

![using_the_policypak_least](/images/policypak/leastprivilege/tool/helper/using_the_endpointpolicymanager_least.webp)
...
installed on the computer, except for the PolicyPak client-side extension or other
Netwrix or PolicyPak-signed installed applications or components.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/tool/helper/using_the_endpointpolicymanager_least_1.webp)

However, using the PolicyPak Least Privilege Manager ADMX settings you can hide or
reveal which applications are available for users to uninstall. This is possible by using one the
following policies:

- Configure program names to include or exclude from the PolicyPak Programs Manager
  tool
- Configure publisher names to include or exclude from the PolicyPak Programs Manager
  tool
...
names to include or exclude from the PolicyPak: Programs Manager tool settings that
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/tool/helper/using_the_endpointpolicymanager_least_2.webp)
