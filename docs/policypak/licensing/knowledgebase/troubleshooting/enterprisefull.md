---
title: "Action Recommended PolicyPak Customers to transition from \"Enterprise\" Licenses to \"Enterprise Full\" licenses."
description: "Action Recommended PolicyPak Customers to transition from \"Enterprise\" Licenses to \"Enterprise Full\" licenses."
sidebar_position: 80
---

# Action Recommended PolicyPak Customers to transition from "Enterprise" Licenses to "Enterprise Full" licenses.

## What is happening:

- The latest PolicyPak CSE (endpoint piece CSE 23.6.3557) and later now honors a new
...
- When PolicyPak releases new features, customers who have implemented the Enterprise
  Full license will NOT have to request updated license keys every time PolicyPak
  comes out with a new component or enhances an existing component.

Here's an example Enterprise license:

![935_1_image-20230713042924-1_950x533](/images/policypak/troubleshooting/license/935_1_image-20230713042924-1_950x533.webp)

Example Enterprise Full License:

![935_2_image-20230713042924-2_950x359](/images/policypak/troubleshooting/license/935_2_image-20230713042924-2_950x359.webp)

## Why is this happening:

- From time-to-time PolicyPak would ship new features and components, requiring
...
![935_3_image-20230713042924-3_950x346](/images/policypak/troubleshooting/license/935_3_image-20230713042924-3_950x346.webp)
...
![935_4_image-20230713042924-4_950x469](/images/policypak/troubleshooting/license/935_4_image-20230713042924-4_950x469.webp)
...
![935_5_image-20230713042924-5](/images/policypak/troubleshooting/license/935_5_image-20230713042924-5.webp)
...
- We have an extensive KB article which will help you. Please refer
  here:[How can I tell how a machine is licensed (by GPO, MDM, or XML file), and also know for what components it is licensed?](/docs/policypak/licensing/knowledgebase/troubleshooting/components.md)
...
![935_6_image-20230713042924-6_950x735](/images/policypak/troubleshooting/license/935_6_image-20230713042924-6_950x735.webp)
...
- Recommended method is to use a PolicyPak ADMX setting to specifically unlicense a
  component:[What if I want to unlicense specific components via ADMX or PolicyPak Cloud?](/docs/policypak/licensing/knowledgebase/activedirectorygposccm/componentscloud.md)
- Note that PolicyPak Preferences 1.0 will still always be "force disabled" by default
  until specifically licensed as per this
  article:[Why is PolicyPak Preferences (original version) "forced disabled" by default?](/docs/policypak/licensing/knowledgebase/activedirectorygposccm/forceddisabled.md)
...
- Please honor the philosophy of RINGS and don't "blast out" an upgrade CSE to all of your computers
  ...
  this guidance: [Using Rings to Test and Update the PolicyPak Client-Side Extension and/or Cloud Client (And How to Stay Supported)](/docs/policypak/upgrademaintenance/bestpractices/rings.md)
