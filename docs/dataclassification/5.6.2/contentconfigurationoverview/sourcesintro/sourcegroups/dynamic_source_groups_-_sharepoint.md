...
| Authentication Type     | Credentials — Selecting **Credentials** lets users authenticate with username and password credentials. Modern (O365) — Selecting **Modern (O365)** lets users authenticate with Tenant ID.                                                |
