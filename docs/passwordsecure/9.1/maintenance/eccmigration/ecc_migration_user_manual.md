...
If you use the Offline Add-on and the Mobile app it's necessary to synchronize them before your
admin starts the migration.

:::warning
If you don't synchronize your data, it's lost and no more accessible after the
migration!
:::
