...
[SQL Data Collector](/docs/accessanalyzer/11.6/admin/datacollector/sql/overview.md)
page. Select the scan options that you want.
...
**Step 6 –** Add PostgreSQL databases to the query before you scan them. Navigate to
...
- PostgreSQL SDD AIC Import — Imports PostgreSQL SDD into the Access Information Center (AIC)
