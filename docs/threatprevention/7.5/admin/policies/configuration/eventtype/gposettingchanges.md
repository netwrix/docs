...
The logical operator is displayed as left-aligned red text. To change the logical operator, click it
...
Specify filter criteria in the `<enter a value>` textbox.
