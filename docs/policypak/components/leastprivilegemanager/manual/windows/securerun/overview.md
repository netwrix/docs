...
having unsafe applications being downloaded and used, PolicyPak can ensure that
...
PolicyPakLeast Privilege Manager can block all items that are not properly installed
by the admin with the PolicyPak SecureRun™ policy. To see how this works, let's first
create a new SecureRun™ policy in the GPO.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_1.webp)
...
When SecureRun™ is on, PolicyPakLeast Privilege Manager checks to see who owns the
...
Members list, PolicyPak Least Privilege Manager will block all applications that they
have installed.
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_2.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_3.webp)

Additionally, MSI files that attempt to launch are also subjected to PolicyPak
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_4.webp)

This works because PolicyPak Least Privilege Manager is enforcing the SecureRun™
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_5.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_6.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_7.webp)

The result can be seen in the MMC list view.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_8.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/securerun/quick_start_using_securerun_9.webp)

To recap, PolicyPakLeast Privilege Manager SecureRun™ operates under the following
criteria:

- The PolicyPak Least Privilege Manager SecureRun™ policy checks every executable and
...
The result is that PolicyPak SecureRun™ blocks any executable or MSI that the user
...
:::note
Remember, all PolicyPak Least Privilege Manager rules, including SecureRun,
