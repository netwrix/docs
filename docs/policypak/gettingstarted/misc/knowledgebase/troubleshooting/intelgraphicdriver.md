...
If the Intel Driver and Support Assistant cannot install updates when PolicyPak CSE is
...
![Intel Driver and Support Assistant Update error](/images/policypak/troubleshooting/inteldsaupdates.webp)
...
[How can I change the behavior of "Run as Admin" with Least Privilege Manager and how has it changed from previous versions?](/docs/policypak/components/leastprivilegemanager/technotes/tipspplpm/runasadmin.md)
topic for additional information on how to disable the Explicit Elevate option.

Resolution 2

Alternatively, you can import and use the PolicyPak Admin Templates XML file below
...
![Intel Driver and Support Assistant Installer](/images/policypak/troubleshooting/inteldsainstaller.webp)
