---
title: "Removing Unwanted Windows Apps Using PolicyPak and PDQ Deploy"
description: "Removing Unwanted Windows Apps Using PolicyPak and PDQ Deploy"
sidebar_position: 20
---
# Removing Unwanted Windows Apps Using PolicyPak and PDQ Deploy
...
Easy.  
By using Netwrix PolicyPak Scripts Manager, and a PolicyPak preconfigured script.

Check out this video to see PolicyPak instantly remove junk from the Windows 10
...
script. You can get this script from PolicyPak.com. It's not hard to generate if you
...
use PolicyPak Scripts Manager. PolicyPak Scripts Manager is a built-in
...
We'll go to user side, "PolicyPak" and we'll dive down under "Scripts Manager." We'll
