...
Relevant NetApp Documentation: For information about node access controls, see the NetApp
article
...
After the role has been created, it must be attached to a group. The following command needs to be
