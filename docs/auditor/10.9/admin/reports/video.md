...
You can configure Netwrix Auditor to capture video of user activity on the monitored computers to
help analyze and control changes made there. When you click a link, a video player opens and
...
![ReportsWithVideo](/images/auditor/10.9/admin/reports/alluseractivityvideo_thumb_0_0.webp)
...
report you want to receive regularly. See the [Subscriptions](/docs/auditor/10.9/admin/subscriptions/overview.md)
