...
modified. These settings are initially configured when the output is added. For a monitored hosts/services
output, this tab can also be used for integration with Netwrix Threat Manager.

Select a Syslog output from either the Monitored Domains tab or the Monitored Hosts & Services tab and click
...
![syslogactivedirectory](/images/activitymonitor/9.0/admin/outputs/syslogactivedirectory.webp)
...
- Syslog message template – Template that controls what data is sent in the event stream. The
  ...
  [Message Template Window](/docs/activitymonitor/10.0/admin/outputs/syslog/messagetemplate.md) topic for additional information.
...
![sysloglinux](/images/activitymonitor/9.0/admin/outputs/sysloglinux.webp)
...
![syslogentraid](/images/activitymonitor/9.0/admin/outputs/syslogentraid.webp)
...
![syslognas](/images/activitymonitor/9.0/admin/outputs/syslognas.webp)
...
![syslogwindows](/images/activitymonitor/9.0/admin/outputs/syslogwindows.webp)
