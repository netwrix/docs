...
The Add Credentials window provides a list of Credentials that have been onboarded and aren't
already present in the collection. Credentials are onboarded in the
[Credentials Page](/docs/privilegesecure/26.03/admin/credentials/credentials.md).

![Add Credentials Window](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/addcredentials.webp)
...
for that platform type. See the [Platforms Page](/docs/privilegesecure/26.03/admin/platforms/overview.md) topic for
...
Secure. See the [Service Accounts Page](/docs/privilegesecure/26.03/admin/configuration/serviceaccounts/serviceaccounts.md)
...
[Platforms Page](/docs/privilegesecure/26.03/admin/platforms/overview.md) topic for additional information on configuring
...
To add credentials to a credential group.
...
**Step 7 –** Click **Add** to add the credentials to the group.

The new credentials are added to the applicable group.

## Add Credentials to a Policy Override

To add credentials to a Credential Policy Override. In order for an account to be
...
[Manage Internal Service Accounts](/docs/privilegesecure/26.03/admin/credentials/manageinternalserviceaccount.md) topic for additional
information.
...
**Step 6 –** Click **Add** to add the credentials to the policy override.
