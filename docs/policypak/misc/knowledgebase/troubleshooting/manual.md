...
1. Expand "Applications and Services Logs", right-click on "Netwrix PolicyPak" event log and choose "Save All Events As…", save the file as
...
- Copy entire `%localappdata%\PolicyPak`, this folder is important for troubleshooting all and any
  CSE issues.
- Locate and gather any PolicyPak log files in the `%TEMP%, %USERPROFILE%`,
