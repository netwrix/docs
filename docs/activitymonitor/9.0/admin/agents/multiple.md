...
devices when applicable. Deploy the activity agent to multiple Windows servers. See the [Activity Agent Server Requirements](/docs/activitymonitor/9.0/requirements/activityagent/activityagent.md) topic
