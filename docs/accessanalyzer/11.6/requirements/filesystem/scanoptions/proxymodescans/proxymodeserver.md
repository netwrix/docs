...
The recommended disk space sizing information is based on the needs of Enterprise Auditor and the
File System solution for running Permission scans with the default configuration (500
...
For example, to scan 200 million files and folders, including 10 million files
...
configuration. It doesn't conflict with other JDKs or Java Runtimes in the same environment.
:::
