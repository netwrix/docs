...
collector. See the
[0-Create Schema Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/0-create_schema.md)
topic for additional information.
...
- [1-FSAA System Scans Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/1-fsaa_system_scans.md)
  – Collects access information from the targeted file servers
- [2-FSAA Bulk Import Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/2-fsaa_bulk_import.md)
...
- [3-FSAA Exceptions Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/3-fsaa_exceptions.md)
...
- [0-FSDFS System Scans Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/0-fsdfs_system_scans.md)
  ...
  file system and creating a dynamic host list that will be used by the other 0.Collection jobs
    ...
    - The Connection Profile and required permissions for the 0-FSDFS System Scans job are the same
      ...
      [File System Scan Options](/docs/accessanalyzer/11.6/accessanalyzer/requirements/solutions/filesystem/scanoptions.md) topic
      for additional information.
...
[Configure the (FSAA) File System Scan Query](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/1-fsaa_system_scans.md#configure-the-fsaa-file-system-scan-query)
topic.
...
[Configure the Activity Scan Query](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/1-fsac_system_scans.md#configure-the-activity-scan-query)
topic for additional information.
...
- [2-FSAC Bulk Import Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/2-fsac_bulk_import.md)
  – Imports collected activity events from the targeted file servers
- [3-FSAC Exceptions Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/3-fsac_exceptions.md)
...
[Configure the (SEEK) File System Scan Query](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/1-seek_system_scans.md#configure-the-seek-file-system-scan-query)
topic for additional information.
...
[1-SEEK System Scans Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/1-seek_system_scans.md)
...
- [2-SEEK Bulk Import Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/collection/2-seek_bulk_import.md)
