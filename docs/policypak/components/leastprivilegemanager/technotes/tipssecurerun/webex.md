...
![575_1_image-20200826125733-1](/images/policypak/leastprivilege/securerun/575_1_image-20200826125733-1.webp)
...
If WebEx is blocked after using these policy settings, please check in the Netwrix PolicyPak Event log to see if `WebEx.exe` is being blocked by SecureRun due to
...
![575_3_image-20200826125733-2](/images/policypak/leastprivilege/securerun/575_3_image-20200826125733-2.webp)

![575_5_image-20200826125733-3](/images/policypak/leastprivilege/securerun/575_5_image-20200826125733-3.webp)
...
![575_7_01_321x213](/images/policypak/leastprivilege/securerun/575_7_01_321x213.webp)

**Step 3 –** Click **View Certificate**.

![575_8_02_323x239](/images/policypak/leastprivilege/securerun/575_8_02_323x239.webp)

**Step 4 –** Click the **Certification Path** tab and select the second certificate from the chain.
Click **View Certificate**.

![575_9_03_319x130](/images/policypak/leastprivilege/securerun/575_9_03_319x130.webp)

**Step 5 –** Click on the **Details** tab and select **Copy to File**.

![575_10_04_243x307](/images/policypak/leastprivilege/securerun/575_10_04_243x307.webp)
...
:::note
You can also use PolicyPak Remote Work Delivery Manager to deliver the
certificate file at the desired location of the remote computer. For more information on this issue,
please see  Remote Work Delivery Manager > [Knowledge Base](/docs/policypak/)
:::


Use PolicyPak Scripts Manager to deliver the Certificate in Intermediate Certification
...
**Step 1 –** Create a new PolicyPak Scripts Manager GPO and use the following
PowerShell command:
...
![575_11_05_549x169](/images/policypak/leastprivilege/securerun/575_11_05_549x169.webp)
