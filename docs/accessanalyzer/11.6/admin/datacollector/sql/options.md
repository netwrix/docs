...
![SQL Data Collector Wizard Options page for Server Audit](/img/product_docs/accessanalyzer/11.6/admin/datacollector/sql/optionsserveraudits.webp)
...
![SQL Data Collector Wizard Options page for Sensitive Data](/img/product_docs/accessanalyzer/11.6/admin/datacollector/sql/optionssensitivedata.webp)
