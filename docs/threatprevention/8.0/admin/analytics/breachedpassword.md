...
- Click Analytics in the left pane to launch the Analytics interface. Then click the gear icon for
  the analytic.
- Expand the Analytics node and click the Breached Password analytic. On the analytic window, click the gear
...
![Breached Password Analytic Type - Settings tab](/images/threatprevention/8.0/admin/analytics/breachedpasswordsettings.webp)
...
![Breached Password Analytic Type - Policy tab](/images/threatprevention/8.0/admin/analytics/policytab.webp)
...
![Breached Password Analytic Type window](/images/threatprevention/8.0/admin/analytics/breachedpassword.webp)
...
- Attacked Account SID – Security Identifier of the attacked account
