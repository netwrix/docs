...
The Add Owner window opens from either the [Add New Resource Wizard](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md) or the
[Update Resource Wizard](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md). Choose between:
...
The Select Group window opens from either the [Add New Resource Wizard](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md) or the
[Update Resource Wizard](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md).
...
- 4. Access Groups — Optionally enable Access Requests and Owner Ad Hoc changes for this resource.
  ...
  **NOTE:** This feature requires the Access Information Center is to be configured to commit
  ...
  See the [Commit Active Directory Changes](/docs/accessinformationcenter/12.0/administration/advanced-configuration/commit-changes.md) topic
...
add multiple owners. See the [Add Owner Window](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md) topic for additional
information.
...
[Select Group Window](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md) topic for additional information.
...
[Owner Confirmation Request Email](/docs/accessinformationcenter/12.0/access-management/resource-owners/owner-confirmation.md) topic for additional
information.
...
Owner Ad Hoc changes. See the [Update Resource Wizard](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md) topic for additional information.
...
[Update Resource Wizard](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md) topic for information on making alterations to the imported
resources.
...
- Add new owners — Click **Add** to browse for a new owner. See the
  [Add Owner Window](/docs/accessinformationcenter/12.0/access-management/resource-owners/managing-owners.md) topic for additional information.
