---
title: "PolicyPak File Associations Manager: Understanding the First Login"
description: "PolicyPak File Associations Manager: Understanding the First Login"
sidebar_position: 50
---
# PolicyPak File Associations Manager: Understanding the First Login

This isn't a problem with PolicyPak File Associations Manager, but it's worth noting
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/PH8zDNUE8XI" title="PolicyPak File Associations Manager: Understanding the First Login" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

:::note
This is OLD behavior; PolicyPak doesn't require logoff and back on for File
Associations unless the old method is specifically enabled. This would only be requested by PolicyPak support team.
:::
...
Software. In a previous video, you saw me use "PolicyPak File Associations Manager" to
...
and that's fine. PolicyPak will kick in the second time around. For instance, if you
...
So it's sort of a mixed bag at the first time you ever log on. Again, this is not a PolicyPak File Associations Manager problem. It's just we rely upon the guts of what's in the
...
you're using PolicyPak File Associations Manager.
