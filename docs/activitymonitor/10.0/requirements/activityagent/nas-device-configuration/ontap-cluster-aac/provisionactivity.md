...
configure the FPolicy. See the [Configure FPolicy](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/ontap-cluster-aac/configurefpolicy.md) topic for additional
information.
:::
...
automatically configure the FPolicy. See the [Configure FPolicy](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/ontap-cluster-aac/configurefpolicy.md) topic for
additional information.
:::
