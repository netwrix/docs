---
title: "PolicyPakand Citrix Endpoint Manager: Deploy real Group Policy and PolicyPak settings via CEM"
description: "PolicyPakand Citrix Endpoint Manager: Deploy real Group Policy and PolicyPak settings via CEM"
sidebar_position: 60
---
# PolicyPakand Citrix Endpoint Manager: Deploy real Group Policy and PolicyPak settings via CEM

CEM is great ! But it has no way to deliver real Group Policy settings, or Netwrix PolicyPak's own special settings. Use PolicyPak MDM alongside
Citrix CEM for a powerful combination to increase your endpoint management capabilities !

<iframe width="560" height="315" src="https://www.youtube.com/embed/PLwimJ92PUg" title="PolicyPak and Citrix Endpoint Manager: Deploy real Group Policy and PolicyPak settings via CEM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz, Microsoft MVP and founder of PolicyPak Software. In this
video we're going to learn how to use PolicyPak plus Citrix Endpoint Management or CEM
...
be the three items that we gave you. The first thing is going to be the PolicyPak
...
first, and we'll give it a name. The name we want to give it is something like PolicyPak License for Fabrikam.
...
called the PolicyPak MSI Product Code Input Tool. You're going to select the PolicyPak license file. Let me go ahead and do that right here. Give me a quick second to track
...
PolicyPak Client-Side Extension. We'll change the default group to our nice group that
...
to go ahead and rerun the MSI product tool code again that we provide on the PolicyPak
...
Let's give it a name like PolicyPak Examples Walk Before You Run, same thing here for
...
We're going to use our MDM inquiry tool here; again, that's hanging out in the PolicyPak extras, the MSI code output tool. We're then going to select the example files or whatever
...
I can see that because you can see the PolicyPak icon there on the left as one of our
...
options. You can see the renamed guest account is now PolicyPak Guest. That was part
of our examples.
...
with PolicyPak and Citrix CEM. If you need any TLC, we're here to help you out and so
are our friends at Citrix. Thank you very much and looking forward to getting you started with
PolicyPak and Citrix CEM soon. Thanks very much. Take care.
