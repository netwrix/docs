...
ownership in My Expired Groups** checkbox on the [Portal Settings](/docs/directorymanager/11.1/portal/generalfeatures/portal.md) panel.
...
Filters**. All the expired groups matching the filters appear.
