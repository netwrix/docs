...
The Autofill Add-on can be directly started via the desktop link that's automatically created when
it's installed. The login data correspond to the normal user data for the client.
...
makes all of the databases configured on the client available. It's also possible to create
