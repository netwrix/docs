...
Manager > [Video Learning Center](/docs/policypak/components/startscreenandtaskbar/videos/videolearningcenter.md).
:::
...
![quickstart_start_screen_manager](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager.webp)
