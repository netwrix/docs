...
On the FPolicy tab, you can modify FPolicy settings for NetApp devices, privileged access, and
...
The Privileged Access tab is enabled when the Configure FPolicy checkbox is selected at the top. Configure the Privileged Access tab when you automatically configure the FPolicy for NetApp Data ONTAP Cluster-Mode devices. See the
[Configure Privileged Access](/docs/activitymonitor/9.0/admin/monitoredhosts/add/netapp.md#configure-privileged-access) topic for additional
information.
