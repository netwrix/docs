...
The following sections group the tables and their views by type.
...
FSAA Data Collector. They contain additional information for building queries. The following
describes the corresponding views created for some of the tables generated by the FSAA
Data Collector:
