...
Use the Script page to input the PowerShell script that performs the
...
Use the three tabs at the bottom of the page to configure the PowerShell action module
...
The table in the Columns tab displays the columns you can use for the PowerShell script. To use
