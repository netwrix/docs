...
1. In Netwrix Auditor Home screen, click
   ![reports_tile](/images/auditor/10.9/admin/reports/reports_tile.webp)on
...
![searchreports_thumb_0_0](/images/auditor/10.9/admin/reports/searchreports_thumb_0_0.webp)

2. Click View button in the right pane.

To learn how to subscribe to a report, see [Create Subscriptions](/docs/auditor/10.9/admin/subscriptions/create.md).
...
2. For SSRS-based reports - verify that SSRS (SQL Server Reporting Services) settings are configured
   properly. See the [Audit Database](/docs/auditor/10.9/admin/settings/auditdatabase.md) topic for additional
   information.
