...
Item-Level Targeting is used in Microsoft Group Policy Preferences and other areas of PolicyPak to target or filter where specific items will apply. With PolicyPak
...
![about_policypak_browser_router_37](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_37.webp)

Alternatively, within a Browser Router policy, you can dictate when a policy will apply by clicking
**Item Level Targeting**.

![about_policypak_browser_router_38](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_38.webp)
...
![about_policypak_browser_router_39](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_39.webp)
...
![about_policypak_browser_router_40](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_40.webp)
...
![about_policypak_browser_router_41](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_41.webp)
