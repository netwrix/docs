...
![Add approval teir to workflow](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/addapprovalteirtoworkflow.webp)

**Step 4 –** after the policy has been created, click the **Add Tier** icon (green + in a circle) to add an Approval Tier.

![Tier 1 Escalation Options](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/tier1escalationoptions.webp)
...
![tierescalation](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/tierescalation.webp)
...
![Tier 1 Escalation Example](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/tier1escalationexample.webp)

**Step 8 –** Click the **Add Approvers** icon to open the Add Users and Groups as Approvers window.

![Add Users and Groups as Approvers](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/addusersandgroupsasapprovers.webp)
...
![Tier 1 Example](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/tier1example.webp)
