...
configured credential groups, which control account assignments in Credential Based
access policies. See the
[Credentials Tab for Credential Based Access Policies](/docs/privilegesecure/26.03/admin/accesspolicy/credentials.md)
topic for additional information.

![Administrative Credential Group Page](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/credentialgroupspage.webp)
...
[Add Credential Groups](/docs/privilegesecure/26.03/admin/credentials/credentialgroups/credentialgroup.md) topic for additional information.
...
Secure. See the [Service Accounts Page](/docs/privilegesecure/26.03/admin/configuration/serviceaccounts/serviceaccounts.md) topic for
