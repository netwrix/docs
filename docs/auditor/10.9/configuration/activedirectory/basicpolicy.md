...
[Configure Advanced Audit Policies](/docs/auditor/10.9/configuration/activedirectory/advancedpolicy.md) topic for additional information.
...
4. Configure the following audit policies.
    ...
    You only need the Audit logon events policy to collect the information on the originating
    workstation, i.e., the computer where a change occurred. This functionality is optional and
    can be disabled.
