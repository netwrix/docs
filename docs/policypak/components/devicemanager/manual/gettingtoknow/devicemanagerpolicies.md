...
There are two main policy types in PolicyPak Device Manager besides Global settings
policy:
...
![device07](/images/policypak/device/devicemanager/device07.webp)
...
![device08](/images/policypak/device/devicemanager/device08.webp)
...
of what's possible in PolicyPak Device Manager with regard to USB policy, we will
explore the most popular path, which is Allow Users to use specific devices.

![usb1](/images/policypak/device/devicemanager/usb1.webp)
...
- The PolicyPak Device Manager Helper Tool
- Other Methods like Windows Device Manager or vendor documentation

![device09](/images/policypak/device/devicemanager/device09.webp)

The most reliable way to get what you need is either from the PolicyPak Pop-Up on the
endpoint or from the PolicyPak Device Manager Helper Utility.
...
:::note
You may ignore the **STANDARD** or **COMPLETE** designations in the PolicyPak Device Manager UI. Typically, PolicyPak is sold in Enterprise or SaaS editions
and in those configurations you get **COMPLETE** (meaning all the features).
:::


![device10](/images/policypak/device/devicemanager/device10.webp)
...
![device11](/images/policypak/device/devicemanager/device11.webp)
...
![usb2](/images/policypak/device/devicemanager/usb2.webp)
...
![usb3](/images/policypak/device/devicemanager/usb3.webp)
...
![usb4](/images/policypak/device/devicemanager/usb4.webp)
...
However, as a reminder you may also use PolicyPak Device Manager to:
...
- Allow specific user(s) to use all devices. This is useful if you want some people to have blanked
  ...
  [Allow ONE user (or group) access to USB and/or CD-ROM and DVDs](/docs/policypak/components/devicemanager/videolearningcenter/gettingstarted/usbdriveallowuser.md)
  topic for additional information.
- Allow specific devices based upon Serial Number(s). See the
  [Permit specific devices by serial number](/docs/policypak/components/devicemanager/videolearningcenter/gettingstarted/serialnumber.md) topic for
  additional information.
- Allow specific devices based upon BitLocker Key ID (restricts a specific BitLocker device) or
  ...
  [Restrict access only to Bitlocker drives](/docs/policypak/components/devicemanager/videolearningcenter/gettingstarted/bitlockerdrives.md) topic for
  additional information.
...
![upd1](/images/policypak/device/devicemanager/upd1.webp)
...
![wpd3](/images/policypak/device/devicemanager/wpd3.webp)
