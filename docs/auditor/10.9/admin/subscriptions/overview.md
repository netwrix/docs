...
You can add any elements (a dashboard, report, alert, risk, and more) to the Auditor Home screen for quick access. For details, see [Navigation](/docs/auditor/10.9/admin/navigation/overview.md) and [Customize Home Screen](/docs/auditor/10.9/admin/navigation/customizehome.md).
...
- [Review and Manage Subscriptions](/docs/auditor/10.9/admin/subscriptions/manage.md)
