...
from the parent group, if any)** or **Specify individual hosts or hosts lists** option. If you selected the first
option, skip to Step 7. If you selected the second option, click **Next** to go to the
...
to assign to the job group or job. Alternatively enter hosts manually. Then click **Next**.
