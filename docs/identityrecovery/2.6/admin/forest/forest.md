...
> ![Forest Configuration page](/images/identityrecovery/2.6/admin/forest/add.webp)
>
...
![Forest Page](/images/identityrecovery/2.6/admin/forest/forest.webp)
...
![ Add Forest window](/images/identityrecovery/2.6/admin/forest/addforest.webp)
...
[Firewall Rules for Forest Server Backups](/docs/identityrecovery/2.6/requirements/firewallrules.md) topic for additional
information.
:::
...
![Server Backup Configuration wizard - Server page](/images/identityrecovery/2.6/admin/forest/server.webp)
...
![Server Backup Configuration wizard - Schedule page](/images/identityrecovery/2.6/admin/forest/schedule.webp)
...
![Server Backup Configuration wizard - Options page](/images/identityrecovery/2.6/admin/forest/options.webp)
...
![Server Backup Configuration wizard - Confirm page](/images/identityrecovery/2.6/admin/forest/confirm.webp)
...
![Server Backup Configuration Saved](/images/identityrecovery/2.6/admin/forest/serverbackupconfiguration.webp)
...
![Forest Server Backup History](/images/identityrecovery/2.6/admin/forest/serverbackuphistory.webp)
...
See the [Recover a Forest](/docs/identityrecovery/2.6/admin/forest/recover.md) topic for information on how to recover a forest.
