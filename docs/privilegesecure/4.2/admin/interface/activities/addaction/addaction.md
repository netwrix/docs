...
- Post-Session (Remove) — List of actions that runs after the session completes.
...
Organizational Unit the login account has delegated permissions for.
...
:::note
The fields changes depending on the selected Action Type.
:::
