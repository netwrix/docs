---
title: "PolicyPak Export Manager with MDM (like Intune)"
description: "PolicyPak Export Manager with MDM (like Intune)"
sidebar_position: 30
---
# PolicyPak Export Manager with MDM (like Intune)

After you use Netwrix PolicyPak Export Manager to export your
GPOs, you need to get them to be deployed with your MDM service like Intune or Workspace ONE. Here's
how to do that.

<iframe width="560" height="315" src="https://www.youtube.com/embed/pyVAtIGv10Y" title="PolicyPak Export Manager with MDM (like Intune)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
do is we're going to run our utility called the PolicyPak Exporter utility. What this
...
for all of Microsoft settings and all of PolicyPak settings as well. I'm going to make
...
assignment. I guess publisher would be PolicyPak. Go ahead and click Next.
...
to do is export them using the PolicyPak Exporter that I showed you in the first
