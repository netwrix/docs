...
console, users or groups have to be added in the top level [Users & Groups Page](/docs/privilegesecure/25.12/admin/interface/usersgroups/usersgroups.md).
...
![Users and Group Collections Page](/images/privilegesecure/25.12/accessmanagement/admin/policy/page/userandgroupcollectionspage.webp)
