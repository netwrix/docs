---
title: "How can I best install PolicyPak Cloud for remote clients over a slow link/internet connection?"
description: "How can I best install PolicyPak Cloud for remote clients over a slow link/internet connection?"
sidebar_position: 80
---

# How can I best install PolicyPak Cloud for remote clients over a slow link/internet connection?

To enroll your client machine with the Netwrix PolicyPak Cloud
service to manage the policies, you must install the PolicyPak Cloud-Client.MSI (PPC
MSI).

During the installation process, thePolicyPak Client-Side Extension.MSI (CSE) is
...
find the PolicyPak Client-Side Extension folder in the archive.

![image1](/images/policypak/install/cloud/image1.webp)
...
for an older version of CSE. In these special cases please reach out to PolicyPak
