...
The time frame used to define stale content is set by default to 365 days. You can modify this
...
You can customize the parameter. It's listed in a section at the bottom of the SQL Script Editor.
See the
