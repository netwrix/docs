...
1. Navigate to Service Control Manager (`services.msc`). The Services Control Manager
opens.
...
2. Right-click the Netwrix Auditor Access Reviews service and select **Properties**.
...
3. On the **Log On** tab, select the **This account** radio button. Enter the account name
...
4. The selected account is displayed in the Log On As column for the service. Either
