...
![loginrag](/images/privilegesecure/25.12/remoteaccessgateway/enduser/loginrag.webp)
...
- When using an authentication connector, there's no 'username' or 'password' field for the user to
  enter. Instead there's just a single button to login.
    ...
    ![mfaloginrag](/images/privilegesecure/25.12/remoteaccessgateway/enduser/mfaloginrag.webp)
...
![authcoderag](/images/privilegesecure/25.12/remoteaccessgateway/enduser/authcoderag.webp)

**Step 7 –** Click **MFA Login**. Privilege Secure opens on the Access Interface.

![accessdashboardrag](/images/privilegesecure/25.12/remoteaccessgateway/enduser/accessdashboardrag.webp)
