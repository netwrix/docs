...
- [Network Devices](/docs/auditor/10.9/configuration/networkdevices/overview.md) – Configure data source as
...
| Select authentication type                               | Access through API. You can access Cisco Meraki dashboard using an API secret key. You need to provide your API secret key. See Cisco Meraki documentation for additional information about Cisco Meraki API: [Meraki Dashboard API](https://developer.cisco.com/meraki/api-v1/#meraki-dashboard-api). |

This monitoring plan also requires a management IP address. A management IP is an IP address
used for management purposes. For example, the IP configured on a switch so that you can
remotely access it is a management IP address.
