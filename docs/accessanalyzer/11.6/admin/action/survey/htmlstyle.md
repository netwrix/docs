...
- HTML Style List – Select which HTML Style the survey uses from the HTML Style list. An example of
  the style shows in the Sample box at the bottom of the wizard.
