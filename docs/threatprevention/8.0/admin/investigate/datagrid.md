...
![Investigate interface - Data Grid](/images/threatprevention/8.0/admin/investigate/datagrid.webp)
...
[Event Viewer Window](/docs/threatprevention/8.0/admin/policies/configuration/recentevents/eventviewer.md) with detailed information on the
