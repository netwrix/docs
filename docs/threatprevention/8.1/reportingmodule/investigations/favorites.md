...
and click the icon that appears.

![Investigation interface on the Favorites page](/images/threatprevention/8.1/reportingmodule/investigations/favorites.webp)
