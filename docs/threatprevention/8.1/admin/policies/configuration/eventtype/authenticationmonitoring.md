...
![Policy window - Authentication Monitoring Event Type](/images/threatprevention/8.1/admin/policies/eventtype/authenticationmonitoring.webp)
...
![Policy window - Authentication Protocol filter for monitoring](/images/threatprevention/8.1/admin/policies/eventtype/authenticationprotocolmonitoring.webp)
...
- The **Exclude failed authentications with previously valid (N-2) passwords** option, if enabled,
  ...
  **Windows Settings** > **Security Settings** > **Account Policies** > **Password Policy** (shown
  ...
  ![Default Domain Policy](/images/threatprevention/8.1/admin/policies/eventtype/gpo.webp)
...
![ipaddressesto](/images/threatprevention/8.1/admin/policies/eventtype/ipaddressesto.webp)
...
target hosts of an event or to exclude specific hosts from monitoring.

![Policy window - Hosts (to) filter for monitoring](/images/threatprevention/8.1/admin/policies/eventtype/hoststo.webp)
