...
ASP.NET Core 8.06 or newer is required. You can also navigate to the [Recovery for Active Directory Requirements](https://docs.netwrix.com/docs/identityrecovery/2_6/requirements/server) located under **Getting Started**.
...
- [Recovery for Active Directory Requirements](https://docs.netwrix.com/docs/identityrecovery/2_6/requirements/server)