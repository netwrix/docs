...
You can lock out the user if suspicious or unauthorized activity is
observed, either from the [Active Dashboard](/docs/privilegesecure/26.03/admin/dashboard/active/active.md), or the
[Live Session Viewer Window](/docs/privilegesecure/26.03/admin/dashboard/active/liveviewer.md).
...
![Lock User Session](/images/privilegesecure/26.03/accessmanagement/admin/dashboard/window/locksession.webp)
