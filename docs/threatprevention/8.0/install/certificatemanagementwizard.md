...
![Certificate Management Wizard on the Export Certificate Signing Requests to page](/images/threatprevention/8.0/install/exportcertificate.webp)
...
![Certificate Management Wizard on the Import Signed Certificates page](/images/threatprevention/8.0/install/importsignedcertificates.webp)

**Step 3 –** On the Import Signed Certificates page, select the folder containing the signed
certificates. Then click **Next**.

![Certificate Management Wizard - Import Certificate Authority Certificates page](/images/threatprevention/8.0/install/importcertificateauthority.webp)
