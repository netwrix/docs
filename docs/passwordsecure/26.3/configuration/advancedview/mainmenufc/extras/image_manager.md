...
In the main menu in [Extras](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/extras/extras.md) you can find the image management. Here, you have the
