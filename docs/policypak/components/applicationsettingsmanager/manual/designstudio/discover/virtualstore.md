...
![discovering_configuration_4](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_4.webp)
...
![discovering_configuration_5](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_5.webp)

The figure shown. The location for 64-bit machines is `%LocalAppData%\VirtualStore\Program Files (x86).`

![discovering_configuration_6](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_6.webp)

The figure shown. The location for 32-bit machiens is `%LocalAppData%\VirtualStore\Program Files.`

If you select a file within the VirtualStore directory, PolicyPak DesignStudio
recognizes this and provides two features to ensure proper delivery to clients. First, as shown in
Figure 94, PolicyPak DesignStudio will substitute the correct variable so it will work
on client machines of the same type.

![discovering_configuration_7](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_7.webp)

The figure shown. PolicyPak DesignStudio substituting the correct variable.

To account for the possibility that you might have both 32-bit and 64-bit machines as targets,
PolicyPak Application Settings Manager, by default, will always try to write to both
locations on the target machine. That way, you're ensured that both 32-bit and 64-bit machines will
get your directives. Note that this behavior is controllable within PolicyPak
...
![discovering_configuration_8_624x322](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_8_624x322.webp)
...
![discovering_configuration_9_312x592](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_9_312x592.webp)
...
![discovering_configuration_10](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_10.webp)

The figure shown. The file location for the first action.

![discovering_configuration_11_624x79](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_11_624x79.webp)
