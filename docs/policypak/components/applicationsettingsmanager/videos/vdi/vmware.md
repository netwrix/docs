---
title: "PolicyPak and VMWare Horizon View"
description: "PolicyPak and VMWare Horizon View"
sidebar_position: 20
---
# PolicyPak and VMWare Horizon View
...
That's where Netwrix PolicyPak comes in. Once the application is
running inside VMware Horizon View, PolicyPak ensures your applications' settings and
locks down the user's access.

Watch this video to see how PolicyPak can lock down your applications inside of VMware
...
### PolicyPak and VMware Horizon View Linked Clones with Persona Management
