...
## For Monitored Hosts/Services

Monitored Hosts/Services Syslog outputs have the following preconfigured Templates:
...
- QRadar – Use this template for IBM QRadar integration. See the
  [Netwrix File Activity Monitor App for QRadar](/docs/activitymonitor/10.0/siem/qradar/overview.md) topic for
  additional information.
- Splunk – Use this template for Splunk integration. See the Configure the
  [File Activity Monitor App for Splunk](/docs/activitymonitor/10.0/siem/splunk/overview.md) topic for additional
  information.
...
| File Servers & NAS Devices, SharePoint, SharePoint Online | %COMPANY%                      | Fixed string: Netwrix                                                                                                                  |
...
| SharePoint Online                                       | %DLP_POLICY%                   | Policys that triggered the event                                                                                                         |
...
| File Servers & NAS Devices                              | %IO_TYPE%                      | Type of input/output: Filesystem/VSS                                                                                                      |
