...
- [Сonnection Issue when TLS 1.2 Is Required](/docs/kb/auditor/troubleshooting-and-errors/ssl-tls-certificate-issues/сonnection_issue_when_tls_1.2_is_required)
