...
![about_policypak_file_associations_27](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_27.webp)

Notice that you get a popup message alerting you that user-side file and protocol associations are
ignored on PolicyPak CSE versions older than 20.2.2361.

![about_policypak_file_associations_28](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_28.webp)

You can then choose all of the possible file types for Adobe Acrobat Reader.

![about_policypak_file_associations_29](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_29.webp)

Next choose the **Apply once (for policies)** option.

![about_policypak_file_associations_30](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_30.webp)
...
![about_policypak_file_associations_31](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_31.webp)
