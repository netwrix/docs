...
![Integrations interface on the Authentication Provider page](/images/threatprevention/8.1/reportingmodule/configuration/integrations/authenticationprovider/page.webp)
...
![Add New Integration window with Authentication Provider type selected](/images/threatprevention/8.1/reportingmodule/configuration/integrations/authenticationprovider/authenticationprovider.webp)
...
![Integrations interface displaying the details for an Authentication Provider with the type drop-down menu open](/images/threatprevention/8.1/reportingmodule/configuration/integrations/authenticationprovider/type.webp)
...
- SAML – See the [SAML Authentication Provider](/docs/threatprevention/8.1/reportingmodule/configuration/integrations/authenticationprovider/saml.md) topic for additional information.
