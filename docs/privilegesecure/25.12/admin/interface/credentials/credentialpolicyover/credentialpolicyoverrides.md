...
![Credential Policy Overrides Page](/images/privilegesecure/25.12/accessmanagement/admin/policy/page/credentialpolicyoverridepage.webp)
...
[Add Credentials Window](/docs/privilegesecure/25.12/admin/interface/credentials/credentialgroups/addcredentials.md) topic for additional
information.
