...
You can install the SharePoint Agent for the Access Analyzer SharePoint & SharePoint Online Solution
on the following SharePoint versions as targeted environments:
