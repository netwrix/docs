---
title: "Reduce GPOs (and/or export them for use with PolicyPak Cloud or with MDM)"
description: "Reduce GPOs (and/or export them for use with PolicyPak Cloud or with MDM)"
sidebar_position: 20
---
# Reduce GPOs (and/or export them for use with PolicyPak Cloud or with MDM)

Want to reduce the number of GPOs you have? Then use Netwrix PolicyPak's PP Merge Utility to take entire GPOs, or portions of GPOs and merge them into PP Admin
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/a1QE8ljmGFA" title="PolicyPak: Reduce GPOs (and/or export them for use with PolicyPak Cloud or with MDM)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
PolicyPak On-Prem? The second question is: How can I take my existing Group Policy
...
PolicyPak Cloud or PolicyPak with MDM?

The answer is pretty simple. We have a utility that's called the "PolicyPak Group
Policy Merge Tool." You get it when you download the PolicyPak bits. It's in the
"PolicyPak Extras" folder. Be careful. There's this thing that says "PolicyPak Group Policy Merge Tool.exe" but it's really just the .exe XML configuration. The real thing
you want to click on is the actual "PolicyPak Group Policy Merge Tool" "Application."

Let's see how easy this tool is to use. The goal is to get your Group Policy settings that have
Microsoft's "ADM/ADMX Registry Settings" into our format, which is called the PolicyPak Administrative Templates Manager format. It's very easy to do.
...
Policy Object to update ("Convert policies to PolicyPak ATM policies and put into
existing GPO").
...
What we're going to do now is ask you, "Where do you want to put these things?" because PolicyPak is amazingly powerful. You can put them in what's called containers. You can say on
...
Why is computer hanging out here? Because PolicyPak has this amazing ability to say,
...
all were. Let's "Edit GPO" and see what has occurred here. Now if I go to user side, "PolicyPak /Administrative Templates Manager," you can see I have "All our user side stuff."
Those are all the settings that we had across those two Group Policy Objects.

What's that? You want to get this into PolicyPak Cloud or use it with PolicyPak and MDM? No problem. You can right click and "Export Collection as XML." At that point, you
can either upload the XML file directly into PolicyPak Cloud or you can use the
"PolicyPak Exporter Tool" to then wrap it up and then get it and use it with your MDM
solution.
...
computer side, "PolicyPak" and look at "Administrative Templates Manager," we now have
...
user side also into the computer side because PolicyPak is magical and we can "Add"
stuff, any policy, including stuff that's on the user side.

Once again, if you like this and you want to use it with PolicyPak Cloud or your MDM,
you can right click and "Export Collection as XML" and use it with our "PolicyPak
Exporter Tool" and you can export this and wrap it up into an MSI to be used with your MDM service
or straight into PolicyPak Cloud as an XML.
