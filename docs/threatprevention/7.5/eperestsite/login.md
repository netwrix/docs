...
This operation returns a session hash value in the body of the response. Use this value in
api/Epe/CheckPassword requests by providing it in the header of the request.
...
This operation returns an access_token value in the body of the response. Use this value in
api/Epe/CheckPassword requests by providing it in the header of the request.
