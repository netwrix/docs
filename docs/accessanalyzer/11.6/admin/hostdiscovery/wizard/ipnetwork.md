...
![Host Discovey Wizard Query page for IP network scan](/img/product_docs/accessanalyzer/11.6/admin/datacollector/nis/query.webp)
...
![Host Discovey Wizard Options page for IP network scan](/img/product_docs/accessanalyzer/11.6/install/application/options.webp)
...
![Host Discovey Wizard Summary page for IP network scan](/img/product_docs/accessanalyzer/11.6/admin/datacollector/adinventory/summary.webp)
