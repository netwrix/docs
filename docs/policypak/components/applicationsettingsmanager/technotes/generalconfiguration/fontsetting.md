...
Although the vast majority of application settings can be delivered in our preconfigured Netwrix PolicyPaks, there are some exceptions. You can try configuring
the setting yourself using the PolicyPak design studio.
