...
selected from the four previously mentioned work processes.
...
The differences between the four work processes to be automated are described in the following sections. These
