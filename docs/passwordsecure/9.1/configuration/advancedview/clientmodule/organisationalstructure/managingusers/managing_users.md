...
users can't use the Advanced view. However, Advanced view Users can also switch to the
Basic view.
...
context menu that opens, you'll find the following options under **displaying data records**:
