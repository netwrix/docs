...
AppLock is an aspect of PolicyPak Application Settings Manager.
...
![applock9](/images/policypak/troubleshooting/applicationsettings/applock/applock9.webp)
...
- [AppLock™ Modes](/docs/policypak/components/applicationsettingsmanager/manual/modes/applock.md)
...
![applock1](/images/policypak/troubleshooting/applicationsettings/applock/applock1.webp)

- For CSEs before 24.9, AppLock is ON, and you might want to turn it off because of interference or
  because you are directed by PolicyPak support.
- Starting with CSE 24.9, AppLock is OFF, and if you want to turn it on you may do so to restore the
  functionality if needed.

![applock4](/images/policypak/troubleshooting/applicationsettings/applock/applock4.webp)
...
![applock5](/images/policypak/troubleshooting/applicationsettings/applock/applock5.webp)

When the "Disable PolicyPak Applock(TM)" setting is set to "Enabled" this will
...
Therefore, if you're using newer ADMX settings, the setting has been renamed to "Configure PolicyPak AppLock(TM) code injection state." And the setting will automatically be changed from
...
name change (to Configure PolicyPak AppLock code injection state) and also a state
...
![applock3](/images/policypak/troubleshooting/applicationsettings/applock/applock3.webp)
...
![applock7](/images/policypak/troubleshooting/applicationsettings/applock/applock7.webp)

![applock8](/images/policypak/troubleshooting/applicationsettings/applock/applock8.webp)
