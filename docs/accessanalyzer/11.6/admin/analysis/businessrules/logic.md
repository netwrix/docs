...
- Show First [Number] rows – Sets how many rows of the selected table to show. The default value is
  50. You can manually adjust it to any value between 0 and all.
...
- Captured Values – Use this section to select up to five optional properties. The scorecard entry
  captures and stores the values of the properties you select. For each property selected, a name
  column and value column appear in the scorecard.
