...
This guide shows how to install an agent separated from the server, for production environment. See the [Architecture](/docs/identitymanager/current/introduction-guide/architecture) topic for additional information.
...
Ensure that all [Agent](/docs/identitymanager/current/installation-guide/requirements/agent-requirements) requirements can be met before starting the installation of the production agent.
...
Integrators should have all the elements they need to operate.
 ...
 | Input | Output |
 | --- | --- |
 | [Agent](/docs/identitymanager/current/installation-guide/requirements/agent-requirements) prerequisites (required) | Production agent |
...
5. [Set the Working Directory's Permissions](/docs/identitymanager/current/user-guide/deploy/production-agent-installation/directory-permissions).
6. [Finalize the Installation](/docs/identitymanager/current/user-guide/deploy/production-agent-installation/finalization).

## Verify Agent Installation

To verify the process:

- ensure the website is accessible from IIS by clicking on **Browse** (in the menu on the right),
