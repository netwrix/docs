...
A:Netwrix PolicyPak was contacted by Google about thePolicyPak Browser Router Chrome Extension.
...
A: When you install thePolicyPak CSE and use thePolicyPak Browser Router
...
A: In the short term, nothing.PolicyPak Browser Router will continue to operate within
...
- If you manually delete the older Chrome extension, then the olderPolicyPak Browser
  Router CSE will not be able to re-download the old Chrome Extension.
- If you delete a user's profile and then re-log on, then the olderPolicyPak Browser
  Router CSE will not be able to re-download the old Chrome Extension.
- If you bring up a brand new machine and then users log on, then the olderPolicyPak
  Browser Router CSE will not be able to re-download the old Chrome Extension.

Q: How would I know if I'm affected byPolicyPak being forced to take down some
olderPolicyPak Browser Router Chrome Extensions?
...
A: We have a KB article about it here: "How can I use the onlyPolicyPak published
Chrome Extension with my older CSE? (CSE 18.7.1779.937 - 19.12.2283.849)"
[How can I use the only remaining PolicyPak published Chrome Extension with my older CSE? (CSE 18.7.1779.937 - 19.12.2283.849)](/docs/policypak/components/browserrouter/knowledgebase/troubleshooting/chromeextension.md)
