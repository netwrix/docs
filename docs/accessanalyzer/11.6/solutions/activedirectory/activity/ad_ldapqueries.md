...
![Largest Queries analysis task configuration](/img/product_docs/accessanalyzer/11.6/solutions/activedirectory/activity/ldapqueriesanalysisconfiguration.webp)
