---
title: "PolicyPakScripts .. Deploy Software via VPN or with PolicyPak Cloud"
description: "PolicyPakScripts .. Deploy Software via VPN or with PolicyPak Cloud"
sidebar_position: 20
---
# PolicyPakScripts .. Deploy Software via VPN or with PolicyPak Cloud

If you have remote workers and you want to deploy software to them, it's easy with Netwrix PolicyPak. Using PolicyPak Scripts you can deploy software
to your machines which are domain joined and VPN, or those with PolicyPak Cloud.
Here's how to do it!

<iframe width="560" height="315" src="https://www.youtube.com/embed/1j-_J0FTh50" title="PolicyPak Scripts .. Deploy Software via VPN or with PolicyPak Cloud" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz, and in this video, I'm going to show you how you can use PolicyPak Scripts to deploy software to remote workers. In this demonstration, this machine,
...
join PolicyPak Cloud. He's not domain-joined, but he is going to get PolicyPak Cloud, and I'm going to show you how to deploy software like Chrome or Firefox or whatever
you want using PolicyPak Scripts.

To get started here we have a couple of examples for you to use. We have them in a KB article called
"How to Silently install Firefox ESR, Chrome and WinZip using PolicyPak Scripts
...
world and the other one for my PolicyPak Cloud world, so I'm going to create a GPO
...
Then I'm going to go to Computer side PolicyPak Scripts. Scripts Manager can work
...
going to go back to PolicyPak Scripts and get that – get the Chrome script that we
...
Now, you can take these scripts, these same scripts, and in PolicyPak Cloud, of which
I am logged onto over here – in PolicyPak Cloud land, you might want to on a
particular computer group or on this special group called All, you can create and link a new policy,
so you can go to PolicyPak Settings, Scripts Manager, and you can go through the
...
PolicyPak Scripts land, same basic gist. You can see it's now linked over to my
special All group.
...
I'm going to go over back to PolicyPak Scripts, and you can in the All group or
...
Now we've set it up for both our group policy/VPN and our PolicyPak Cloud guy. What
...
this machine that's not domain joined and join him to PolicyPak Cloud – let's go ahead
...
joined PolicyPak Cloud machine. If I were to refresh here in program files, I can see
...
whatever, you'd see the output here. That's really all there is to it to using PolicyPak Scripts Manager to deploy your software through the internet, through your domain joined
machines and VPN, or to your not domain joined machines with PolicyPak Cloud as well.
Hope this helps you out. Looking forward to getting you started with PolicyPak real
soon. Take care.
