...
There is a Search box above a table's header row that Use this to filter the table data.
...
There is a filter icon to the right of each column name that Use this to apply a column specific
...
Simply select the edges of the column headers and drag to the width.
...
There are two export buttons above a table's header row that Use this to export the data
