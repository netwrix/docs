...
- [2. Notify Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/cleanup/notify/overview.md)
  – Designed to report on and notify the owners of resources of target file servers that data is
  pending cleanup
- [3. Quarantine Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/cleanup/quarantine/overview.md)
...
- [4. Delete Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/cleanup/delete/overview.md)
  – Designed to report on and take action against resources from targeted file servers that can be
  deleted
- [FS_CleanupProgress Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/cleanup/fs_cleanupprogress.md)
