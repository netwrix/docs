...
The **Add** button in the Resource Owners interface opens the Add new resource wizard.
...
add multiple owners. See the [Add Owner Window](/docs/auditor/10.9/accessreviews/resourceowners/interface/addowner.md) topic for additional
information.
