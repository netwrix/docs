...
[Browser Router with Custom Browsers](/docs/policypak/components/browserrouter/videolearningcenter/citrixvirtualapps/custombrowsers.md).
:::
...
![about_policypak_browser_router_19](/images/policypak/browserrouter/policy/about_endpointpolicymanager_browser_router_19.webp)

Then, using PolicyPak Browser Router, make a custom route and paste the target path
into the **Custom Browser Path** field.

![about_policypak_browser_router_20](/images/policypak/browserrouter/policy/about_endpointpolicymanager_browser_router_20.webp)

This technique works for most virtualized browsers such as Microsoft App-V, VMware ThinApp, etc.
Note that once a virtualized browser is opened, PolicyPak Browser Router cannot route
away from those browsers and then back to real browsers. This is because PolicyPak
