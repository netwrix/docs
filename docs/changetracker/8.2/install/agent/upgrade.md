...
![UpgradeAgentWindowsCommandPrompt](/images/changetracker/8.2/install/agent/upgradeagentwindowscommandprompt.webp)

- **For Linux** – Use: `service nntagent stop`

**Step 5 –** Install Gen 7 Agent. Review the following for additional information:

- **Windows** – See the [Gen 7 Agent for Windows](/docs/changetracker/8.2/requirements/gen7agentwindows.md) topic for
  additional information.

- **Linux** – See the [Installing Gen 7 Agent for Linux](/docs/changetracker/8.2/install/agent/linuxos.md) topic for additional
  information.
