---
title: "Billable Accounts In Netwrix 1Secure Guide"
...
the [Billable Users Report](/docs/1secure/reporting/report-types/billable-users-report.md) topic for additional information.
...
settings. See the
[Add a Source and Connectors for Microsoft Entra ID](/docs/1secure/data-sources/azure-entra-id.md) or
[Add a Source and Connectors for Active Directory](/docs/1secure/data-sources/active-directory.md) topics
