...
Follow the steps in these topics to install the bundle, set access for the Strongpoint tab on the NetSuite toolbar, and manage users. There is a **Next Step** link at the end of each installation topic.
...
After installation is complete, review the [Installation Settings](/docs/platgovnetsuite/installation/installation_settings_report.md) report.
