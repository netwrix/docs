...
- External Links - a list of files you've staged on web services to be used with PolicyPak Remote Work Delivery Manager.
- ADMX Files - files with your own ADMX settings for custom applications that you can upload and
  that PolicyPak (the company) doesn't automatically provide for you.

![web_interface_and_controls_44_625x138](/images/policypak/cloud/interface/web_interface_and_controls_44_625x138.webp)

## External Links

Video: You can learn more about external links and PolicyPak Remote Work Delivery
...
to your remote PCs. However, PolicyPak Cloud needs to know about this link before it
...
be available within the in-cloud editor for PolicyPak Cloud Remote Work Delivery
Manager.

![web_interface_and_controls_45_499x230](/images/policypak/cloud/interface/web_interface_and_controls_45_499x230.webp)
...
While PolicyPak (the company) automatically keeps many important ADMX settings
...
![web_interface_and_controls_46_624x346](/images/policypak/cloud/interface/web_interface_and_controls_46_624x346.webp)
...
![web_interface_and_controls_47_624x396](/images/policypak/cloud/interface/web_interface_and_controls_47_624x396.webp)

Click **Save** to continue. Now you can see your ADMX settings, and you can also peruse your upload
to see all the settings.

![web_interface_and_controls_48_625x200](/images/policypak/cloud/interface/web_interface_and_controls_48_625x200.webp)

Now you're ready to use the uploaded ADMX and ADML files when using the PolicyPak
Cloud in-cloud ADMX editors to create administrative template policies.

![web_interface_and_controls_49_624x318](/images/policypak/cloud/interface/web_interface_and_controls_49_624x318.webp)
