...
![Domain Backup Configuration Page](/images/identityrecovery/2.6/admin/activedirectory/domainbackupconfig.webp)
...
[Domains Page](/docs/identityrecovery/2.6/admin/configuration/domain.md) topic to add a domain and its backup configurations.
