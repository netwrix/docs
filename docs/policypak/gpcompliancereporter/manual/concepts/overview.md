...
![gpcr_concepts_and_quickstart_2](/images/policypak/grouppolicycompliancereporter/mode/gpcr_concepts_and_quickstart_2.webp)

Figure 3. PolicyPak GPCR working in pull mode (gray arrows) and in push mode (black
arrows).

## Pull Mode

In pull mode with PolicyPak GPCR, each administrator acts as an island. Administrators
...
Push mode in PolicyPak GPCR uses the PolicyPak GPCR server.
...
data is automatically delivered to the shared database on the designated PolicyPak
