...
![special_applications_and_project_5](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_5.webp)
...
![special_applications_and_project_6](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_6.webp)

The figure shown. The `prefs.js` file location.

The good news is PolicyPak DesignStudio and the PolicyPak Application
Settings Manager CSE can handle this problem. PolicyPak Application Settings Manager
...
To control Mozilla-based applications using PolicyPak Application Settings Manager and
PolicyPak DesignStudio, we only need to teach DesignStudio where the profiles.ini file
...
![special_applications_and_project_7](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_7.webp)

The figure shown. The `profiles.ini `file.

In PolicyPak DesignStudio, for all other file-based project types (INI, XML,
...
![special_applications_and_project_8](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_8.webp)
...
PolicyPak Application Settings Manager "displayname." This is what's shown in the MMC
...
PolicyPak Application Settings Manager looks in the MSI installed table for a match
...
![special_applications_and_project_9](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_9.webp)
...
![special_applications_and_project_10](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_10.webp)
...
Once PolicyPak DesignStudio is pointing toward the profiles.ini file (and not
the` prefs.js` file), we are ready to perform our normal work in PolicyPak
DesignStudio. PolicyPak DesignStudio will use the `prefs.js` file on the machine you
perform the work on.
...
modified. Instead, PolicyPak Application Settings Manager will create a new file (or
...
![special_applications_and_project_11](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_11.webp)

The figure shown. The `prefs.js` file.

After the AppSet successfully applies, PolicyPak Application Settings Manager will
...
![special_applications_and_project_12](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_12.webp)
...
This is perfect for PolicyPak Application Settings Manager because you can define the
settings using Group Policy. Those settings are always written to `user.js` by PolicyPak Application Settings Manager.

If a user makes any configuration changes to Firefox, Thunderbird, etc., those changes are thrown
out if the setting is defined within `user.js`. For instance, if you use PolicyPak
