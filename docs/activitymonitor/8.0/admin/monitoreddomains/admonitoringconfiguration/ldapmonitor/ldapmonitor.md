...
Double-click the text box beneath Value to enter the search string you want. Press the Enter or Tab key to
...
Double-click the text box beneath Value to enter the result string you want. Press the Enter or Tab key to
add another text box.
...
Double-click the text box beneath Name to enter the server names to include or exclude. Press the
...
exclude. Double-click the text box beneath Type to enter the Active Directory object type you want to include or
