...
The Netwrix PolicyPak directives you create are not performed on
clients unless the PolicyPak client-side extension (CSE) is on the target machine and
...
- Building the PolicyPak CSE into your virtual desktop infrastructure (VDI), desktop,
  or laptop image
...
The PolicyPak CSE ships as an MSI file and, as such, is very flexible in the initial
...
Our recommended tool of choice to get the PolicyPak CSE deployed to multiple machines
...
Because the PolicyPak CSE ships as an MSI file, you can quickly get this deployed
...
:::note
You can also use Microsoft Group Policy Software Installation to deploy the PolicyPak CSE. However, software delivery (and removal) by Group Policy Software Installation
...
we've set up a share named PolicyPak.

**Step 2 –** Copy the PolicyPak Client-Side Extension x32.msi for 32-bit systems or
PolicyPak Client-Side Extension x64.msi for 64-bit systems to that share.
...
[Mass Deploy the PolicyPak CSE using GPSI](/docs/policypak/archive/massdeploy.md) and
[Upgrading the CSE using GPSI](/docs/policypak/archive/upgrading.md). In this example, we've created a GPO named
Deploy PP Client and linked it to East Sales Desktops.
:::


![Deploying Client Side](/images/policypak/install/deploying_the_client_side_350x474.webp)
...
![deploying_the_client_side_1_620x359](/images/policypak/install/deploying_the_client_side_1_620x359.webp)

**Step 6 –** Once this is complete, type in the server and share names you used. In our example, our
server is `\\DC-Computer` and our share is PolicyPak. Then select the PolicyPak CSE Setup x64.msi file, and click **Open**. Next, choose **Assigned**, and select **OK**.

![deploying_the_client_side_2_620x389](/images/policypak/install/deploying_the_client_side_2_620x389.webp)

![deploying_the_client_side_3_550x381](/images/policypak/install/deploying_the_client_side_3_550x381.webp)

When you're done, the GPO should look like this:.

![deploying_the_client_side_4_1200x309](/images/policypak/install/deploying_the_client_side_4_1200x309.webp)

**Step 7 –** Repeat this process until both the x86 and x64 MSIs appear.

![deploying_the_client_side_5_1200x240](/images/policypak/install/deploying_the_client_side_5_1200x240.webp)
...
If you have an older version of the PolicyPak CSE and wish to update it using Group
...
[Upgrading the CSE using GPSI](/docs/policypak/archive/upgrading.md) topic for additional information.
