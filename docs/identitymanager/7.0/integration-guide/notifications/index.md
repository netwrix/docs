...
[Custom Notifications](../../integration-guide/notifications/custom) can be configured for specific needs, to be triggered by a workflow, or periodically via a task.
