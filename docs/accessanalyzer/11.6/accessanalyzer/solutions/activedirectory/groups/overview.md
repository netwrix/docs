...
- [AD_CircularNesting Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_circularnesting.md)
...
- [AD_DCLogonGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_dclogongroups.md)
...
- [AD_DuplicateGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_duplicategroups.md)
...
- [AD_EmptyGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_emptygroups.md)
  – Identifies empty and single member groups which are suitable candidates for consolidation or
  cleanup
- [AD_GroupProbableOwners Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_groupprobableowners.md)
...
- [AD_LargestGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_largestgroups.md)
...
- [AD_MailSecurityGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_mailsecuritygroups.md)
  – Identifies mail-enabled security groups within Active Directory
- [AD_NestedGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_nestedgroups.md)
...
- [AD_SensitiveSecurityGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_sensitivesecuritygroups.md)
...
- [AD_StaleGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/groups/ad_stalegroups.md)
