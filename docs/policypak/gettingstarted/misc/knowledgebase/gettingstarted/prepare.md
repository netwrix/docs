---
title: "How must I prepare for my PolicyPak QuickStart / Onboarding?"
description: "How must I prepare for my PolicyPak QuickStart / Onboarding?"
sidebar_position: 80
---
...
:::tip
Remember, This session is designed to integrateNetwrix PolicyPak into your environment within 60 or 90 minutes. While this may seem sufficient, the time
...
- (Optional if testing PolicyPak Cloud) you have verified that you can LOG ON to
  PolicyPak Cloud.
...
:::tip
Remember, PolicyPak does not require installing anything on Domain Controllers, nor
...
2. Option 2 (Yours): If you want to supply us with a GoToMeeting or something similar, email your
   PolicyPak Tech Lead with the details
...
**Step 1 –** Use the PolicyPak Customer Portal
([https://www.policypak.com/customerportal](http://www.policypak.com/customerportal)) to download
Everything.

![289_1_image-20240111131924-2](/images/policypak/gettingstarted/289_1_image-20240111131924-2.webp)
...
![289_2_image-20240111133126-3](/images/policypak/gettingstarted/289_2_image-20240111133126-3.webp)

For all versions of PolicyPak (Group Policy, MDM, and Cloud), you need access to a
...
new domain: [How to create a DC for editing purposes](/docs/policypak/deliverymethods/cloud/videos/testlabbestpractices/createdc.md)
...
- You should have one machine joined to your Active Directory. This is called the Walk before you
  run computer.
- Leave the second machine not domain joined. After verifying that PolicyPak works
  with the domain-joined machines, those directives will be used with PolicyPak Cloud
  or PolicyPak MDM.

## Part 3: What to install on your Windows 10 or 11 ENDPOINT

First, know that PolicyPak and other security software may not play nicely together
...
**Step 1 –** Install the latest PolicyPak Client Side Extension you downloaded and
...
**Step 5 –** (Recommended): PolicyPak's engine can be controlled via ADMX settings and
...
**Step 6 –** (Recommended): If you want to perform some PolicyPak Least Privilege base
hits: Install any software you want to see magically work with PolicyPak Least
...
:::note
If you want to "convert" from another least privilege tool to PolicyPak
...
You can run PolicyPaklicensed or unlicensed.
...
- PolicyPak MDM Edition:
  ...
  - You should have an MDM license file from your salesperson. Keep your PolicyPak
...
- You can run a PolicyPak trial without a license:
  ...
  - Ensure that the computer is named COMPUTER1 or something similar with COMPUTER in the name.
    ...
    [Testing and Troubleshooting By Renaming an endpoint Computer](/docs/policypak/deliverymethods/cloud/videos/usingwithothermethods/mdm.md)
    :::


Example machine renamed to work UN-licensed:

![289_3_image-20191022200736-3](/images/policypak/gettingstarted/289_3_image-20191022200736-3.webp)

## Part 6: Preparing for PolicyPakCloud

(Continue here If you are alsotrialing PolicyPak Cloud).

- **NOTE:** PolicyPak Cloud is not the PolicyPak Portal.
...
- You should have a Welcome Letter to the PolicyPak Cloud. If you cannot find your
...
tests and verify your ideas work via Group Policy before using PolicyPak Cloud or
PolicyPak MDM.

If you do not have a “real” or “not real domain” please see and perform these steps:

**Step 1 –** [How to create a DC for editing purposes](/docs/policypak/deliverymethods/cloud/videos/testlabbestpractices/createdc.md)
...
## Part 9: Converting from another least-privilege tool to Least Privilege Manager

If you’ve pre-arranged or asked for this, then we’re ready to help. To best help you convert from
another least-privilege tool to PolicyPak Least Privilege Manager here is what we
recommend:
...
- On Computer2, also install all the software you’d like to elevate and work around UAC prompts.
  Install the PolicyPak Client Side Extension on this machine. Because PolicyPak Least Privilege Manager doesn’t have any rules yet, the end-user software won’t work as
...
tool) and create PolicyPak Least Privilege Manager rules that will work similarly.
