...
- Click Analytics in the left pane to launch the Analytics interface. Then click the gear icon for
  the analytic.
- Expand the Analytics node and click the Horizontal Movement Attacks analytic. On the analytic window, click the gear
...
![Horizontal Movement Attacks Analytic Type - Settings tab](/images/threatprevention/8.0/admin/analytics/horizontalattackssettings.webp)
...
![Horizontal Movement Attacks Analytic Type - Policy tab](/images/threatprevention/8.0/admin/analytics/policytab.webp)
...
![Horizontal Movement Attacks Analytic Type window](/images/threatprevention/8.0/admin/analytics/horizontalmovement.webp)
