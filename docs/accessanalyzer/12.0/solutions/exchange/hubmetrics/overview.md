...
mail-flow activity occurring within your organization. This job group connects to each server that
contains the Message Tracking Logs and parses the log to return the data to the Access Analyzer
database.
