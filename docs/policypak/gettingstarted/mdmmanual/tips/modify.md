---
title: "Modifying Existing MSI Files with PolicyPak Exporter"
description: "Modifying Existing MSI Files with PolicyPak Exporter"
sidebar_position: 10
---

# Modifying Existing MSI Files with PolicyPak Exporter

PolicyPak Exporter enables you to quickly open and edit previously created MSI files.
To do this, select "Open an existing MSI installer previously generated by this tool for editing,"
as shown in Figure 51, when running PolicyPak Exporter.

![policypak_exporter_tips_tricks](/images/policypak/mdm/tips/endpointpolicymanager_exporter_tips_tricks.webp)

Figure 51. PolicyPak Exporter allows the user to open and edit existing MSI files.

After choosing this option, specify the MSI file that you previously created using PolicyPak Exporter. When you do this, you'll be able to instantly see the XML data files you
previously placed inside the MSI along with the users you specified to receive the XML data files.

You can manually add or delete users and add or replace XML data files and PolicyPak
...
![policypak_exporter_tips_tricks_2](/images/policypak/mdm/tips/endpointpolicymanager_exporter_tips_tricks_2.webp)
