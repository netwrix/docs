...
the [Users & Groups Page](/docs/privilegesecure/25.12/admin/interface/usersgroups/usersgroups.md). It allows users to be added to a custom role.

![Add Role Users Window](/images/privilegesecure/25.12/accessmanagement/admin/policy/window/usersgroups/addroleusers.webp)
...
[Custom Role Details Page](/docs/privilegesecure/25.12/admin/interface/usersgroups/rolemanagement/rolemanagementcustom/rolemanagementcustom.md).
