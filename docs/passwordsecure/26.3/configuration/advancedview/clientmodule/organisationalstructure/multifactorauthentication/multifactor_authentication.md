...
In the [Organisational structure](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/organisationalstructure/organisational_structure.md) module, you select the user and
...
in[Multifactor Authentication](/docs/passwordsecure/26.3/configuration/servermanger/managingdatabases/databasesettings/multifactor_authentication_ac.md).
