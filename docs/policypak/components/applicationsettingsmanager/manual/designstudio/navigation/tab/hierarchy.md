...
highlighted as well (See the figure here).

![getting_around_3](/images/policypak/applicationsettings/designstudio/navigation/tab/getting_around_3.webp)

The figure shown. The Hierarchy tab provides a granular view of each element.
