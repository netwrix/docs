...
For a SharePoint source, tagging means automatically populating
...
1. Ensure you have set up the necessary term sets as described in
...
4. Install the appropriate SharePoint product in your SharePoint environment
   ...
   SharePoint. It also creates the necessary event handlers to keep the classification up to date when
   you add new documents or edit existing documents.

**To configure tagging using the wizard**

1. Click the app to start the **SharePoint Tagging wizard**.
...
2. Configure the Term Sets that you want to auto-classify. For that, click the **Add** button and
...
3. If needed, select the specific site/list columns you want to restrict auto-classification to.
4. Confirm the selection.
5. Finally, having configured the tagging you want, re-classify the appropriate content so that the
   system writes the tags back to SharePoint.
