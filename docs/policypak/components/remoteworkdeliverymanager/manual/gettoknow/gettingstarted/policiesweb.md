...
:::note
For a video overview of using PolicyPak Remote Work Delivery Manager to
install software using web-based shares, see
[Install software using web-based shares](/docs/policypak/components/remoteworkdeliverymanager/videos/gettingstarted/webbasedshares.md).
:::
...
The following is a list of file-based web services that PolicyPak has tested for
...
**Step 1 –** Create a web policy for PolicyPak Remote Work Delivery Manager by adding
a new policy.

![getting_to_know_policypak_16](/images/policypak/remoteworkdelivery/gettingstarted/getting_to_know_endpointpolicymanager_16.webp)
...
![getting_to_know_policypak_17](/images/policypak/remoteworkdelivery/gettingstarted/getting_to_know_endpointpolicymanager_17.webp)
...
![getting_to_know_policypak_18](/images/policypak/remoteworkdelivery/gettingstarted/getting_to_know_endpointpolicymanager_18.webp)

**Step 4 –** Select your destination directory and replacement file name.

![getting_to_know_policypak_19](/images/policypak/remoteworkdelivery/gettingstarted/getting_to_know_endpointpolicymanager_19.webp)

**Step 5 –** Complete the remaining pages of the wizard as described earlier. Then, click **Finish**
to see the policy in the editor.

![getting_to_know_policypak_20](/images/policypak/remoteworkdelivery/gettingstarted/getting_to_know_endpointpolicymanager_20.webp)
...
![getting_to_know_policypak_21](/images/policypak/remoteworkdelivery/gettingstarted/getting_to_know_endpointpolicymanager_21.webp)
