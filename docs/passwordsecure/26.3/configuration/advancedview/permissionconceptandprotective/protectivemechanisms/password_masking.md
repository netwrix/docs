...
In the same way as for the [Seals](/docs/passwordsecure/26.3/configuration/advancedview/permissionconceptandprotective/protectivemechanisms/seals/seals.md) configuration, the **authorize permission**
...
[Form field permissions](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/passwords/form_field_permissions.md). In the
[List view](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/list_view.md) of a record, there is a separate
