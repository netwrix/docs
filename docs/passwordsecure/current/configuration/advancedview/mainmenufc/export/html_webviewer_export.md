...
[Filter](/docs/passwordsecure/current/configuration/advancedview/operationandsetup/filter/filter.md) function. The passwords for which the user
...
NOTE: Use the password search function if there is more than 20 passwords!
...
the reason for being logged out. You can log in again.
