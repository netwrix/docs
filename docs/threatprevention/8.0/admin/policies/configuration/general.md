...
![Policy - General tab](/images/threatprevention/8.0/admin/policies/generaltab.webp)
...
[Policies Interface](/docs/threatprevention/8.0/admin/policies/overview.md). Event data can be filtered by policy; therefore, a descriptive
...
displayed for a policy in the list on the [Policies Interface](/docs/threatprevention/8.0/admin/policies/overview.md).
...
[Policies Interface](/docs/threatprevention/8.0/admin/policies/overview.md). Active at Specified Times is represented by a clock icon, and
