...
![Active Directory Activity DC wizard Results page for Remove Tables category](/img/product_docs/accessanalyzer/12.0/admin/datacollector/adactivity/resultsremovetables.webp)
