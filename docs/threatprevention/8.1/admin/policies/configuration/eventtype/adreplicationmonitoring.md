...
![Policy window - AD Replication Monitoring Event Type](/images/threatprevention/8.1/admin/policies/eventtype/adreplicationmonitoring.webp)
...
- AD Perpetrator filter
  ...
  - Add domain controllers to the Exclude lists
