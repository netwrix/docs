...
[HTML WebViewer export](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/export/html_webviewer_export.md), the resulting file is
...
- **Starting via the ribbon:** The export can also be started via the
  [Ribbon](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/ribbon.md) in the
  [Passwords](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/passwords/passwords.md) module.
