...
**CAUTION:** File and folder attributes marked with the (\*) aren't monitored by default. Contact Netwrix Technical Support team to monitor these file and folder attributes.
