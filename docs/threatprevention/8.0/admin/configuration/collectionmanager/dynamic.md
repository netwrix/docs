...
[Add New Collection Window](/docs/threatprevention/8.0/admin/configuration/collectionmanager/listcollections.md#add-new-collection-window) are only enabled for the
...
![Options on the Add New Collection window](/images/threatprevention/8.0/admin/configuration/collectionmanager/addcollectionoptions.webp)

- The _Provide a list_ option button enables the default setting for a static collection. See
  the [Add New Collection Window](/docs/threatprevention/8.0/admin/configuration/collectionmanager/listcollections.md#add-new-collection-window) topic to manually
...
| Column Name    | Column Type     | Column Description                                                                   |
| -------------- | --------------- | --------------------- |
| Path           | NVARCHAR (1024) | File path to the folder you want. Can't be null.                                    |
