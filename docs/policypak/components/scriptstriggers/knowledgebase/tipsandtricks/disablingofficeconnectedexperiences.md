...
If you are using **Netwrix PolicyPak**, you can deploy the above PowerShell script as a policy using the **Scripts & Triggers** component. Refer to [How to create a shortcut under the Public Desktop using PolicyPak Scripts Manager](https://docs.netwrix.com/docs/policypak/) to see an example of how to run PowerShell scripts via Scripts & Triggers Manager.

## Related Links

- [How to create a shortcut under the Public Desktop using PolicyPak Scripts Manager](https://docs.netwrix.com/docs/policypak/)
