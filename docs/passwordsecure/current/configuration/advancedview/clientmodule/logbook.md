...
:::note
If desired, the logbook can be automatically cleaned up. This option can be configured on the
...
[Syslog](/docs/passwordsecure/current/configuration/servermanager/databaseproperties/syslog.md) server. Further information on this
