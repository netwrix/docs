...
When Firefox runs the first time, it shows extra tabs. But using Netwrix PolicyPak you can remove these extra tabs on both Windows 7 and Windows 10. This video
shows you how.
...
### PolicyPak: Remove Firefox's Extra Tabs at First Launch
