...
Dashboards are available in almost all [Client Module](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/client_module.md)s. A
...
widgets** is managed in the[User settings](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/usersettings/user_settings.md).
