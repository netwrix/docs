...
Restore the configuration, Active Directory configuration file, and activity log
files for Activity Monitor Agents deployed on file system servers, SharePoint servers, and domain
controllers by following these steps:
...
**Step 4 –** Disable all activity monitoring on the Monitored Hosts & Services and Monitored Domains page.
