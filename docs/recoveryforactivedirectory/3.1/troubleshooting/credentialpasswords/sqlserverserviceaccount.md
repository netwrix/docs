...
![  Recovery Configuration Utility](/images/recoveryforactivedirectory/3.1/product/config_utility.png)
...
![Connection Test Successful](/images/recoveryforactivedirectory/3.1/troubleshooting/updatepassword/connectiontest.webp)

**Step 4 –** Click **OK**.

**Step 5 –** Once the connection has been established, click **Save** to update the account.

![Configuration Utility Saved Confirm](/images/recoveryforactivedirectory/3.1/troubleshooting/updatepassword/sqlsettings.webp)
