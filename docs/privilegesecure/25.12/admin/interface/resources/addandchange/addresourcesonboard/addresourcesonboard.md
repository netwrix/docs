...
- Download CSV Template — Downloads the `nps-resource-import-template.csv` file with required
  columns. See the [Create Resource Import CSV File](/docs/privilegesecure/25.12/admin/interface/resources/addandchange/addresourcesonboard/resourceimportcsv.md) topic for
