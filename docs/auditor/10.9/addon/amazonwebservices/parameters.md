...
user credentials, etc. Most parameters are optional; the script uses the default values unless you
explicitly define them. You can skip or define parameters depending on your execution
scenario and security policies. See the [Choose Appropriate Execution Scenario](/docs/auditor/10.9/addon/amazonwebservices/deployment.md) 
...
| ImportAllEvents        | —                                         | By default, the add-on imports only events with processed details. To import all events, set the switch during the add-on execution. **NOTE:** Importing all events makes audit data less human-readable.                                                                                                                                                                                                                                                                                                                                 |
...
**Step 1 –** Right-click a script and select **Edit**. **Windows PowerShell ISE** starts.
...
| AccessKeyID     | Provide an AWS access key ID for your account. The access key authenticates requests to the AWS SDK, CLIs, and API.                                                                                                                                                                                                                   |
