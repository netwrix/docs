...
![globalsettingspage](/images/privilegesecure/25.12/accessmanagement/admin/configuration/page/globalsettingspage.webp)
...
- Certificate Thumbprint — The hexadecimal certificate (or thumbprint) value. See the
  [Sign RDP Files to Prevent Publisher Warning](/docs/privilegesecure/25.12/admin/troubleshooting.md)
