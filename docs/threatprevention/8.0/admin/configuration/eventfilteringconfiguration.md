...
![Event Filtering Configuration Window](/images/threatprevention/8.0/admin/configuration/eventfiltering.webp)
...
## Do Not Ignore Events With Unchanged Attributes

The Do Not Ignore Events With Unchanged Attributes option is disabled by default to filter out events where an attribute’s old value is equal to its new value.
...
![Edit Collection window - For Hosts](/images/threatprevention/8.0/admin/configuration/editcollectionhosts.webp)
...
![Edit Collection window - For Selected Accounts](/images/threatprevention/8.0/admin/configuration/editcollectionaccounts_1.webp)
