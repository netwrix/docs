...
Netwrix PolicyPak is able to hide many Firefox elements,
sometimes with only one click.

Video: To see a video of PolicyPak disabling various Firefox user interface (UI) pages
see
...
![hiding_preferences_pages_and](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and.webp)

The figure shown. Hiding the about:config page.

PolicyPak can hide the about:addons page UI with a checkbox in the Add-Ons:
Extensions, Appearance, Plugins, and Service page, as shown In the figure shown.

![hiding_preferences_pages_and_1](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_1.webp)

The figure shown. Hiding the about:addons page.

PolicyPak can allow you to hide the Australis menu in FireFox (seen In the figure shown) by
clicking the "Hide Australis button" in the Extras tab, as shown In the figure shown. PolicyPak can also provide you with the ability to disable the web developer menu and many other
special pages, as shown In the figure shown.

![hiding_preferences_pages_and_2](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_2.webp)

The figure shown. The Australis menu.

![hiding_preferences_pages_and_3](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_3.webp)
...
Lastly, PolicyPak has another huge array of special things that can be hidden within
the About:Preferences tab, as shown In the figure shown.

![hiding_preferences_pages_and_4](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_4.webp)
...
Video: To see a video of PolicyPak removing elements in about:prefrences, go to
...
![hiding_preferences_pages_and_5](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_5.webp)
...
![hiding_preferences_pages_and_6](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_6.webp)
...
![hiding_preferences_pages_and_7](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_7.webp)
...
![hiding_preferences_pages_and_8](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_8.webp)
...
![hiding_preferences_pages_and_9](/images/policypak/applicationsettings/preconfigured/firefox/hiding_preferences_pages_and_9.webp)
