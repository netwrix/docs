---
title: "Mass Deploy the PolicyPak CSE using GPSI"
description: "Mass Deploy the PolicyPak CSE using GPSI"
sidebar_position: 30
---

# Mass Deploy the PolicyPak CSE using GPSI

You have tested out Netwrix PolicyPak on one machine, and it is
