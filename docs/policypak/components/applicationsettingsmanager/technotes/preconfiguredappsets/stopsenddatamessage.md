...
Netwrix PolicyPak Application Manager can remove the message
"Firefox automatically sends some data to Mozilla so that we can improve your experience" as seen
below.

![177_1_image001](/images/policypak/applicationsettings/preconfigured/firefox/177_1_image001.webp)

To do this, use the PolicyPak Application Manager pak About:Config A-I Pak.
