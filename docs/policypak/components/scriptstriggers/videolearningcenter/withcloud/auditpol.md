---
title: "Using PolicyPak Cloud and Auditpol.exe to enable Advanced Auditing on non-domain joined computers"
description: "Using PolicyPak Cloud and Auditpol.exe to enable Advanced Auditing on non-domain joined computers"
sidebar_position: 40
---
# Using PolicyPak Cloud and Auditpol.exe to enable Advanced Auditing on non-domain joined computers

Use Netwrix PolicyPak's Scripts and Triggers Manager and
...
Hi, this is John from PolicyPak. In this video, we're going to show you how you can
enable advanced auditing for remote domain or nondomain joined computers using PolicyPak Cloud. Local domain joined computers have the ability to create group policy objects to
...
PolicyPak provides the vehicle in which to distribute this policy to remote machines
whether domain joined or not. Let's dive in. Let's take a look how PolicyPak can help
you enable advanced auditing.

We have our PolicyPak Cloud web GUI. We're going to create a policy for my test group.
...
with most other PolicyPak policies.
...
using PolicyPak, using this command line and Scripts Manager.
