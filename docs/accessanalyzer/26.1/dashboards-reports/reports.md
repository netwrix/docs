...
For full details on these reports, see [File Server Reports](/docs/accessanalyzer/26_1/gettingstarted/file-servers/reports).
...
For full details on these reports, see [SharePoint Online Reports](/docs/accessanalyzer/26_1/gettingstarted/sharepoint-online/reports).
