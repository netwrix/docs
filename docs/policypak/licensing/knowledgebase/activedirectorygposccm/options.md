---
title: "My organization doesn't permit me to run the LT (PolicyPak Licensing Tool) or provide the XML information it produces. What are my other options?"
description: "My organization doesn't permit me to run the LT (PolicyPak Licensing Tool) or provide the XML information it produces. What are my other options?"
sidebar_position: 20
---

# My organization doesn't permit me to run the LT (PolicyPak Licensing Tool) or provide the XML information it produces. What are my other options?
...
:::tip
Remember, If you were to use our Netwrix PolicyPak On-Prem
...
![144_1_lt-and-powershell-counts](/images/policypak/license/mdm/200_3_image-20200723102952-2.webp)
...
![144_2_image001](/images/policypak/license/unlicense/144_2_image001.webp)
...
![144_3_get-fqdn-with-powershell](/images/policypak/license/812_3_get-fqdn-with-powershell.webp)

So, to recap:

**Step 1 –** If you use our PolicyPak On-Prem Licensing tool (LT), we collect only
...
[Why do I have to run the licensing tool / what information is gathered and sent to PolicyPak for my trial (or becoming a customer?)](/docs/policypak/licensing/knowledgebase/requestingall/tool.md)for additional
information
...
method. So as per the EULA, you must manually state if you plan to use PolicyPak upon
