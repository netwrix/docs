...
AppSet also has some special sections. You can see an example of a special section In the figure shown.

![normal_sections_in_the_ie](/images/policypak/applicationsettings/preconfigured/internetexplorer/normal_sections_in_the_ie.webp)

The figure shown. Special and normal sections in the IE AppSet.

The normal sections act just like sections in all other Netwrix PolicyPak Application Settings Manager AppSets. By clicking on a setting, it becomes underlined,
