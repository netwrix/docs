...
- Unlock Account — Indicates if the account is locked. When the account is locked, the user isn't able to create a session. Click the button to unlock the account.
