...
- The Activity Monitor must register with the NetApp device as an FPolicy server. By default, it
  ...
  [Customize FPolicy Policy Name](/docs/activitymonitor/9.0/requirements/activityagent/nas-device-configuration/ontap7-aac/customizefpolicy.md) section for information on using a different
  policy name.
