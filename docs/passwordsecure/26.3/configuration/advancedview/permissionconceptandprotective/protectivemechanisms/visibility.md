...
The use of a [Filter](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/filter/filter.md) is generally the gateway to
...
consideration when handling records. [Tags](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/tags.md) are not
