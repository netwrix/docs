---
title: "PolicyPak Package Manager (AppX Policies): Add or Remove Microsoft Store using your MDM service."
description: "PolicyPak Package Manager (AppX Policies): Add or Remove Microsoft Store using your MDM service."
sidebar_position: 10
---
# PolicyPak Package Manager (AppX Policies): Add or Remove Microsoft Store using your MDM service.

Once you've rolled out a machine using Autopilot, how can you REMOVE unwanted applications and ADD
important Windows 10 Store applications? With Netwrix PolicyPak
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/tjoNyqcvWRU" title="PolicyPak Package Manager (AppX Policies): Add or Remove Microsoft Store using your MDM service." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video I'm going to show you how you can use PolicyPak Software Package Manager to deliver AppX settings and also remove AppX settings from your
...
The next thing I want to do is I want to go to my PolicyPak Export utility. I'm going
...
Here in InTune we're already deploying the PolicyPak Client Side Extension, that's the
...
Store using PolicyPak and your MDM service. I hope this helps you out. Looking forward
to getting you started with PolicyPak real soon. Thanks.
