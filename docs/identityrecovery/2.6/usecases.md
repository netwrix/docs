...
- [Active Directory Page](/docs/identityrecovery/2.6/admin/activedirectory/overview.md)
    ...
    - Recover the object by following the steps in the
      [Recover an Object](/docs/identityrecovery/2.6/admin/activedirectory/recover.md#recover-an-object) topic.
...
- [Active Directory Page](/docs/identityrecovery/2.6/admin/activedirectory/overview.md)
    ...
    - Rollback changes to the object by following the steps in the
      [Rollback Objects](/docs/identityrecovery/2.6/admin/activedirectory/rollback.md) topic
...
Steps 9 and 10 in the [Add a Domain](/docs/identityrecovery/2.6/admin/configuration/domain.md#add-a-domain) topic for
...
[Forest Page](/docs/identityrecovery/2.6/admin/forest/forest.md) allows administrators to configure and manage backups for a
...
- [Forest Page](/docs/identityrecovery/2.6/admin/forest/forest.md)
    ...
    - Restore one or more domain controllers in a forest by following the steps in the
      [Create a Recovery Playbook](/docs/identityrecovery/2.6/admin/forest/recover.md#create-a-recovery-playbook) topic
