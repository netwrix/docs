...
the [Software Compatibility & Versions](/docs/activitymonitor/10.0/install/overview.md) section for information on integration with
...
following the instructions in the [Install Application](/docs/activitymonitor/10.0/install/application.md) section.
