...
This User Guide offers brief guidance on using the Netwrix Endpoint Protector Server in Amazon
Web Services (AWS), Google Cloud Platform (GCP), and Azure. It doesn't provide a step-by-step guide
for creating AWS or GCP accounts. This guide assumes the reader already has these accounts set up
...
Endpoint Protector Virtual Appliance. To purchase a license contact your Endpoint Protector
