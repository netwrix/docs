...
| | Cross Role Exemption                                                                                  | Compliant SoD Incidents for those caused by multiple Roles   | 1. Cross Role Exemption associated to the SOD Incidents.<br />2. If the Role removal resolved an existing SOD Conflict, Employee removed from Affected Employees on the SOD Cross Role Exemption |                                                                                                                                                                                                                                                                                                                                                                  |
| | SoD Conflicts that have no Exemption                                                                  | Unresolved SoD Incidents                                     | 1. No immediate action taken<br />2. If an Exemption is created to resolve the SoD Conflicts in arrears, it is associated to the SoD Incidents at that time                                    |                                                                                                                                                                                                                                                                                                                                                                  |
