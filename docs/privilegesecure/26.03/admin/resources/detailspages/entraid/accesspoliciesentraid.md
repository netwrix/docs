...
![Access Policies Tab Azure AD](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/resources/accesspoliciesazuread.webp)
...
- Name — Displays the name of the policy. See the [Access Policy Page](/docs/privilegesecure/26.03/admin/accesspolicy/accesspolicy.md)
