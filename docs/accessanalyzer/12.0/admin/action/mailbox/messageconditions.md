...
![New Mailbox Action Wizard Mailbox Message Conditions page](/img/product_docs/accessanalyzer/admin/datacollector/ewsmailbox/filterwizard/messageconditions.webp)
...
![MessageClasses Window](/img/product_docs/accessanalyzer/admin/action/mailbox/messageclasseswindow.webp)

Modify message classes using the following options:

- Click **Add** to populate a field to add a message class

    ![New class added in MessageClasses Window](/img/product_docs/accessanalyzer/admin/action/mailbox/messageclasseswindownew.webp)
...
![Data Range Selection Window](/img/product_docs/accessanalyzer/admin/action/mailbox/datarangeselectionwindow.webp)
...
![Values Window](/img/product_docs/accessanalyzer/admin/action/mailbox/valueswindow.webp)
