...
![Netwrix Setup Launcher](/images/threatprevention/8.0/install/reportingmodule/setuplauncher.webp)
...
![Netwrix PostgreSQL Setup wizard on the EULA page](/images/threatprevention/8.0/install/reportingmodule/eula_1.webp)

**Step 3 –** Read the End User License Agreement and select the I accept the license agreement
checkbox. Click Next.

![Netwrix PostgreSQL Setup wizard on the Folder Location page](/images/threatprevention/8.0/install/reportingmodule/folder.webp)
...
![Netwrix PostgreSQL Setup wizard on the Successfully Installed page](/images/threatprevention/8.0/install/reportingmodule/completed.webp)
...
[Install the Netwrix Threat Manager Reporting Module](/docs/threatprevention/8.0/install/reportingmodule/application.md) topic for additional
information.
