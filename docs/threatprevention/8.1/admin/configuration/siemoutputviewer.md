...
- Event data generated for an event/incident/policy is sent to SIEM if a SIEM profile has been
  assigned to it on the [SIEM Tab](/docs/threatprevention/8.1/admin/configuration/systemalerting/siem.md) of the System Alerting Window.
...
- Columns can be reordered as desired as well as removed from the data grid. Removed columns can be
  added back through the [Customization Window](/docs/threatprevention/8.1/admin/navigation/datagrid.md#customization-window).
