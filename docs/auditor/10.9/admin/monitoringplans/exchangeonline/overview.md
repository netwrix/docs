...
- [Exchange Online](/docs/auditor/10.9/configuration/microsoft365/exchangeonline/overview.md) – Configure data
...
To configure an Office 365 tenant as a monitored item:
...
:::note
Basic authentication is no longer possible for Exchange Online. For existing tenants, you can still
use basic authentication for SharePoint Online and Microsoft Entra ID monitoring.
:::
...
| Configure audit settings                           | See the [Exchange Online](/docs/auditor/10.9/configuration/microsoft365/exchangeonline/overview.md) configuration topic for additional information about audit settings required to collect comprehensive audit data and the instructions on how to configure them. |
...
See the [Microsoft 365](/docs/auditor/10.9/configuration/microsoft365/overview.md) topic for additional
information.
