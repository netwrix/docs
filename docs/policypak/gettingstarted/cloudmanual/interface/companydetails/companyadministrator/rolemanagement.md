...
PolicyPak Cloud has a few roles that can be assigned to other admins. Each user's
assigned roles can be seen in the **Role Management** tab.

![web_interface_and_controls_85_624x118](/images/policypak/cloud/interface/companydetails/companyadministrators/web_interface_and_controls_85_624x118.webp)
...
- Authentication Options Admin: An admin with this role can specify which admins can have which 2FA
  ...
  [Edit Customer-Level Portal Policies](/docs/policypak/gettingstarted/cloudmanual/interface/companydetails/editcustomerlevelportalpolicies.md) section.
...
- Notification & Logging Options Admin: An admin with this role can use the **Notifications Editor**
  ...
  [Edit Notification Configuration](/docs/policypak/gettingstarted/cloudmanual/interface/companydetails/editnotificationconfiguration.md) section).
