...
Use the `SIAgentCert.exe` command line utility to create certificates
for each Agent.
...
See the [Upgrade Procedure](/docs/threatprevention/8.1/install/upgrade/overview.md) topic for upgrade considerations. See the
[Upgrade Agent](/docs/threatprevention/8.1/install/upgrade/agent.md) topic for instructions on upgrading an Agent from the
