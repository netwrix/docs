...
![addactivitygroup](/images/privilegesecure/25.12/accessmanagement/admin/policy/page/addactivitygroup.webp)
...
- Name — Displays the name of the activity. Click the link to view additional details. See the
  [Activities Page](/docs/privilegesecure/25.12/admin/interface/activities/activities.md) topic for additional details.
