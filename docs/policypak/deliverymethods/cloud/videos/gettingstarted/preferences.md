---
title: "PolicyPak Cloud + GPPrefs (More examples)"
description: "PolicyPak Cloud + GPPrefs (More examples)"
sidebar_position: 100
---
# PolicyPak Cloud + GPPrefs (More examples)

Create Group Policy Preferences inside theNetwrix PolicyPak Cloud
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/3U-4zOMQHLI" title="PolicyPak Cloud + GPPrefs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak Cloud + GPPrefs video transcript
