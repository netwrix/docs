...
The setting **Display passwords in Basic view & display passwords in Advanced view** lets you configure the display of both clients. The passwords can be displayed with an icon, logo, or in text
form.
