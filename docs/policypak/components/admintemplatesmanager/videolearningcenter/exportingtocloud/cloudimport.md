---
title: "Use your GPOs with PolicyPak Cloud"
description: "Use your GPOs with PolicyPak Cloud"
sidebar_position: 20
---
# Use your GPOs with PolicyPak Cloud

After you've exported your settings via PP Exporter, then upload them straight into Netwrix PolicyPak Cloud. As a bonus, you can also continue to edit those policies
within PolicyPak Cloud AFTER you've uploaded them. If you want to say goodbye to
on-prem GPOs and use our PolicyPak.

<iframe width="560" height="315" src="https://www.youtube.com/embed/iYj9C-sn8P8" title="PolicyPak Exporter: Use your GPOs with PolicyPak Cloud" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

In a previous video, we exported the three kinds of Group Policy Settings that you wanted to use for
PolicyPak Cloud, and we've got them here just hanging out in exported form. It's super
easy to use with PolicyPak Cloud. There's two different ways you can get them
...
land, they just transfer right over here to PolicyPak land, and for the last one,
...
existing Microsoft on-prem Group Policy settings and we've used them in PolicyPak
Cloud, so let's go over here and see it work.

This is a machine that's not yet enrolled in PolicyPak Cloud. Let's go ahead and
...
Microsoft settings or any PolicyPak setting, you just go ahead and you click it and
...
You take your Group Policy Objects, export them, upload them for use in PolicyPak
Cloud and continue to keep them updated or edited in PolicyPak Cloud. No need to go
back to the Group Policy Editor for most things. Hope this video helps you out. Looking forward to
getting you started with PolicyPak Cloud and PolicyPak Exporter real
soon. Thanks so much.
