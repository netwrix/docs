...
PolicyPak Least Privilege Manager problems can generally be divided into three
categories:
...
In all cases, you can see detailed information about the occurrence within the PolicyPak Least Privilege Manager log files which are found in:
...
PolicyPak Least Privilege Manager policies you have. There are several files to check:
...
![A screenshot of a computer Description automatically generated](/images/policypak/troubleshooting/leastprivilege/troubleshooting_1.webp)
...
![A screenshot of a computer code Description automatically generated](/images/policypak/troubleshooting/leastprivilege/troubleshooting_2.webp)

An Allowed result can be seen here.

![A screenshot of a computer code Description automatically generated](/images/policypak/troubleshooting/leastprivilege/troubleshooting_3.webp)

An Elevated result can be seen here.

![A screenshot of a computer code Description automatically generated](/images/policypak/troubleshooting/leastprivilege/troubleshooting_4.webp)
...
![A screenshot of a computer program Description automatically generated](/images/policypak/leastprivilege/adminapproval/avoid_pop_ups_with_admin_approval_1.webp)
...
an Admin when he or she uses the PolicyPak Admin Approval Tool.

:::note
The Reason Code is also stored here and is a fixed list from within the PolicyPak Admin Approval Tool.
:::
