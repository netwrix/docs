...
Manager Console opens. See the [Getting Started with Threat Manager](/docs/threatmanager/3.1/gettingstarted.md) topic for
next steps.
...
If MFA was enabled for the built-in Administrator account during first launch, to configure MFA for
the account:
...
**Step 3 –** A list of recovery codes appears for restoring access to the application if you
lose access to the authenticator application or device. Save this list
of codes for account recovery.

**Step 4 –** Click **Continue**.

Once MFA is configured for this account, the Threat Manager Console opens. See the
[Getting Started with Threat Manager](/docs/threatmanager/3.1/gettingstarted.md) topic for next steps.
