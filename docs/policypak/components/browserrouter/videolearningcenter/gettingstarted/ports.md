---
title: "PolicyPak Browser Router and Ports"
description: "PolicyPak Browser Router and Ports"
sidebar_position: 50
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Zy08Oi7e0ak" title="PolicyPak: Browser Router and Ports" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak: Browser Router and Ports

Hi. This is Jeremy Moskowitz, Group Policy MVP and Founder of Netwrix PolicyPak Software. In this video, I'm going to show you how if you go to a specific port
...
using "PolicyPak Browser Router." There's actually a nifty website called PortQuiz. We
...
PolicyPak Browser Router routes. We'll wait for this to finish. Okay, that's done.
...
There you go. That should give you a quick rundown of how to use PolicyPak Browser
...
With that in mind, if you have any questions about how to use PolicyPak Browser
