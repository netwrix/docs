...
| POST   | `https://{host:port}/netwrix/api/v1/activity_records/enum{?format=json}{&count=Number}` | [Continuation Mark](/docs/auditor/10.9/api/postdata/continuationmark.md) |
...
mark to the same endpoint. See the [Continuation Mark](/docs/auditor/10.9/api/postdata/continuationmark.md) topic for more
