...
![Monitoring Process -CTERA Portal](/images/activitymonitor/9.0/config/ctera/cterasyslogmsg.webp)
...
Configure the Edge Filer Syslog Service manually.

**Step 1 –** Configure monitoring of the CTERA Portal in the Activity Monitor Console.

**Step 2 –** Add a CTERA host on the Monitored Hosts & Services tab and specify the portal host name,
