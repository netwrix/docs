...
includes both the visibility of individual [Client Module](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/client_module.md), as
...
1. The **personal user right** only applies to a specific user. This is always configured via
   the[Organisational structure](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/organisationalstructure/organisational_structure.md).
...
the basis for the configuration of the [User settings](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/usersettings/user_settings.md).
