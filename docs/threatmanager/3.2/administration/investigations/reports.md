...
investigation. See the [Entra ID Sync Page](/docs/threatmanager/3.2/administration/configuration/integrations/entraidsync.md) topic for
additional information.
:::
...
See the [Host Details Page](/docs/threatmanager/3.2/administration/threats/activedirectoryobjects/host.md) topic and the
[User Details Page](/docs/threatmanager/3.2/administration/threats/activedirectoryobjects/user.md) topic for additional information.
...
Click the link to view target details. See the [Host Details Page](/docs/threatmanager/3.2/administration/threats/activedirectoryobjects/host.md) topic
