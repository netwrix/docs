...
groups,  and hosts (computers). These pages lets you discover more information about the
...
3. Magnifying Glass Icon : This magnifying glass icon opens the investigation page to create an investigation for this object.
...
The Add Tag button lets you assign existing tags to a user, group, or host computer. It also
provides the option to create new tags.

**Add an Existing Tag**

 add a tag to a user, group, or computer.
