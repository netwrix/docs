...
- Use firewall rules to allow only the minimum required outbound endpoints — see [Network Configuration](/docs/accessanalyzer/26_1/install/system/network)

## TLS / SSL

- Replace the default self-signed certificate with a certificate issued by a trusted CA for production use
- Mount your organization's CA bundle to enable outbound TLS verification — see [SSL / TLS Configuration](/docs/accessanalyzer/26_1/install/system/certificates)
