...
- Password Storage – Choose the option for credential password storage:
    ...
    - CyberArk – Uses the CyberArk Enterprise Password Vault. See the
      ...
      information. The password fields don't apply for CyberArk password storage.
...
Additionally, add the database clusters/instances to the Filter page in the query configuration. See the [NoSQL: Filter](/docs/accessanalyzer/12.0/admin/datacollector/nosql/filter.md) topic for additional information.
