---
title: "How to import a WLAN / 802.11 / Wireless profile from a Network Share using PolicyPak Scripts Manager?"
description: "How to import a WLAN / 802.11 / Wireless profile from a Network Share using PolicyPak Scripts Manager?"
sidebar_position: 10
---

# How to import a WLAN / 802.11 / Wireless profile from a Network Share using PolicyPak Scripts Manager?
...
Create the WLAN GPO and apply it to the OU where the Computers live, next use Netwrix PolicyPak Scripts Manager > on the Computer side to create a new policy
item.

![497_1_img-1](/images/policypak/scriptstriggers/497_1_img-1.webp)

At the "Specify policy target screen be sure to use switched mode for the policy.

![497_2_img-2](/images/policypak/scriptstriggers/497_2_img-2.webp)
...
![497_3_img-3](/images/policypak/scriptstriggers/497_3_img-3.webp)
