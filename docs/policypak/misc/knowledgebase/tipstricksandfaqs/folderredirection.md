---
title: "How does PolicyPak perform Folder Redirection or OneDrive Known Folder Move (KFM) with PolicyPak Group Policy, PolicyPakMDM or PolicyPak Cloud?"
description: "How does PolicyPak perform Folder Redirection or OneDrive Known Folder Move (KFM) with PolicyPak Group Policy, PolicyPakMDM or PolicyPak Cloud?"
sidebar_position: 90
---

# How does PolicyPak perform Folder Redirection or OneDrive Known Folder Move (KFM) with PolicyPak Group Policy, PolicyPakMDM or PolicyPak Cloud?

Netwrix PolicyPak as a product DOESN'T perform Folder Redirection
or OneDrive Known Folder Move.

PolicyPak CAN, however, deliver the Group Policy or registry settings required to
...
**Step 4 –** Then you can use then with your Central Store and PolicyPak Admin
Templates Manager and/or PolicyPak Cloud.
...
Video tip for adding ADMX files to your PolicyPak
Cloud:[PolicyPakCloud: Upload and use your own ADMX files to PolicyPak Cloud](/docs/policypak/deliverymethods/cloud/videos/gettingstarted/admxfiles.md)

The policy settings you might want to use are…

![590_1_img-1](/images/policypak/tips/590_1_img-1.webp)

and / or

![590_2_img-2](/images/policypak/tips/590_2_img-2.webp)
