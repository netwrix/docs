...
![new image](/images/passwordsecure/9.1/configuration/web_application/operation/navigation_bar/settings/installation_with_parameters_180-en.webp)

After filling in and uploading the icon/logo, the process only needs to be saved.

![save new image](/images/passwordsecure/9.1/configuration/web_application/operation/navigation_bar/settings/installation_with_parameters_181-en.webp)
