...
[ Create a Working Directory ](/docs/identitymanager/saas/installation/production-setup/working-directory.md) topic for additional information.
...
[ Connection to the Database ](/docs/identitymanager/saas/configuration/network/server-settings/database-connection.md)
and
[ Usercube-Protect-CertificatePassword ](/docs/identitymanager/saas/automation/executables/protect-certificate-password.md)
...
DNS. See the [Server](/docs/identitymanager/saas/getting-started/requirements.md) topic for additional
information.
...
Install the Agent is the next step of the process. See the [ Install the Agents](/docs/identitymanager/saas/installation/production-setup/agent.md)
topic for additional information.
