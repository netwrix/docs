...
It's recommended that an incremental backup is run every hour. In addition, a full backup should be
created once a week.
...
In the advanced settings, you can configure whether the backup should be activated directly. It's
