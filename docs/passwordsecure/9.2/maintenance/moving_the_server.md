...
under [License settings](/docs/passwordsecure/9.2/configuration/servermanager/mainmenu/license_settings.md). Now stop
...
[Certificates](/docs/passwordsecure/9.2/configuration/servermanager/certificates/certificates.md) are backed up.
...
the setup wizard. The [Setup wizard](/docs/passwordsecure/9.2/configuration/servermanager/setup_wizard.md) is
