...
disabled from the dropdown list.

**Step 6 –** Select the rules to disable.

**Step 7 –** Click OK to close the Policy Properties page

Disabled rules aren't counted when calculating the compliance level, but Password Policy Enforcer accepts passphrases that comply with all enabled rules, irrespective of the compliance level.
This ensures that passphrases can be used, even if they don't meet the compliance level when
...
length alone makes up for the reduced complexity, as this isn't always true.
