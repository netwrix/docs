...
The AD_DSRMSettings Job provides details on domain controller registry settings for the
DSRMAdminLogonBehavior key. If this key is set to 1 or 2, you can use the Directory Services Restore
Mode (DSRM) Admin Account to log in to the domain controller even if it has not been started in
DSRM, which can present a potential security vulnerability. Additional information on this
registry key is available in this
