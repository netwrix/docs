...
See the [Folder Settings Page](/docs/threatmanager/3.2/administration/configuration/integrations/foldersettings.md) topic for
...
[Folder Settings Page](/docs/threatmanager/3.2/administration/configuration/integrations/foldersettings.md) section for additional
information.
:::
...
See the [Subscriptions and Exports Page](/docs/threatmanager/3.2/administration/investigations/subscriptionsexports.md) topic for additional
information.
