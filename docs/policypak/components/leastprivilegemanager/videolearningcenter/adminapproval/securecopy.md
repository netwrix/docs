...
Netwrix PolicyPak SecureCopy™ enables you to specify a specific
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/bg--i4NtNxY" title="PolicyPak Least Priv Manager: SecureCopy(TM). Empower users to copy then elevate items." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
share, and I'm going to talk to you and show you about PolicyPak SecureCopy. The way
...
The most important part is the context menu name. You can either just say copy with PolicyPak SecureCopy. That's a choice. That's the default, or you can specify to give it anything you
...
this, SecureCopy. They can do PolicyPak SecureCopy. They can specify where they want
to put it.
...
Let's do the same thing for Skype. We'll right-click PolicyPak SecureCopy. We'll go
ahead and put it in the same location. Now that that's done, we can now see if PolicyPak will perform this elevated. Check it out. We'll double-click it and boom.
...
operation, PolicyPak SecureCopy.

I hope this helps you out. This way, if you have stuff on a share, and you want to enable your users
to copy it locally and then perform the elevation process, PolicyPak SecureCopy to the
rescue.

Hope this video helps you out. Looking forward to getting you started with PolicyPak
real soon. Thanks.
