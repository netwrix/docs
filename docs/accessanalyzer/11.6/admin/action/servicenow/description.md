...
![ServiceNow Action Module wizard Description page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/action/servicenow/description.webp)
...
- Insert Field – Use the drop-down menu to select a field (column) from the source table
    ...
    - Click the file icon with the magnifying glass to preview the sourced table for values. The
      default is 1000 rows.
        ...
        ![Sample Source Data window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/action/servicenow/samplesourcedata.webp)
  ...
  template
    ...
    - Click the **Save to Template** link to preserve the Short Description and Comments sections
      for later use under a template name.
        ...
        ![Save ServiceNow Template window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/action/servicenow/savetemplate.webp)
