...
![Credential based policy users tab](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/policycredentials/accesspolicyuserstab.png)
...
The Activities tab for credential-based Access Policies isn't editable. It only shows that the users can get access to credentials and/or files that are listed in the respective tabs.

![Credential based resource Activities tab](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/policycredentials/activitiestabcredentials.png)
...
![Credential based policy credential tab](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/policycredentials/accesspolicycredentials.png)
...
![Credential based policy credential tab](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/policycredentials/accesspolicyfilestab.png)
