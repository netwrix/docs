---
title: "What is the Chrome Extension ID for all the published versions of PolicyPak Browser Router Client Side Extension?"
description: "What is the Chrome Extension ID for all the published versions of PolicyPak Browser Router Client Side Extension?"
...
Netwrix PolicyPak Application Manager Pak using this article:
...
Note that PolicyPak does not guarantee that the version you are using is definitely in
...
![202_1_image-20220105135628-1](/images/policypak/troubleshooting/browserrouter/clientsideextension/202_1_image-20220105135628-1.webp)
