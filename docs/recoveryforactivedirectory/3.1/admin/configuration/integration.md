...
Threat Prevention for objects on the [Active Directory Page](/docs/recoveryforactivedirectory/3.1/admin/activedirectory/overview.md).
...
[Integration with Threat Prevention](/docs/recoveryforactivedirectory/3.1/admin/activedirectory/overview.md#integration-with-threat-prevention) topic for additional information.
