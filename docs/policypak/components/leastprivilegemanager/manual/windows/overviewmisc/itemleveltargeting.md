...
:::note
For more information on PolicyPak Least Privilege Manager and Item Level
...
Item-Level Targeting is used in Microsoft Group Policy Preferences and other areas of PolicyPak to target or filter where specific items will apply. With PolicyPakLeast Privilege Manager, Item-Level Targeting can be placed on collections as well as
PolicyPak Least Privilege Manager policies within collections.

A collection enables you to group together PolicyPak Least Privilege Manager policies
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/item_level_targeting_with.webp)

Below you can see two created collections that can hold other collections or policies.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/item_level_targeting_with_1.webp)

Right-click any PolicyPak Least Privilege Manager Collection or Policy and select
**Change Item-Level Targeting**, to set filtering conditions on when the policy will apply.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/item_level_targeting_with_2.webp)

The **Change Item Level Targeting** menu item brings up the Targeting Editor.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/item_level_targeting_with_3.webp)
...
:::note
Additionally, PolicyPak Least Privilege Manager allows you to target users
or user groups, even if the policy is on the computer side. See the
[Link to Computer, Filter by User](/docs/policypak/components/leastprivilegemanager/videolearningcenter/basicsandgettingstarted/userfilter.md) video for details on this
superpower.
:::
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/item_level_targeting_with_4.webp)
