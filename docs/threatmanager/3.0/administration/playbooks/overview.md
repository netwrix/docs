...
When testing or getting started with playbooks in Threat Manager, trigger playbooks manually
instead of automatically. After manually testing playbooks and becoming familiar with
Threat Manager threats and threat responses, enable automatic triggering of playbooks.
...
actions that respond to a threat. See the
...
playbooks to run after the playbook has completed. This allows a (Undefined variable: SD.Product
