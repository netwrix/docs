...
![Enter user name for the test](/images/passwordpolicyenforcer/evaluation/evaltestuser.webp)
...
![mypassword fails](/images/passwordpolicyenforcer/evaluation/evaltestuserfail.webp)
...
[Policy Testing vs. Password Changes](/docs/passwordpolicyenforcer/admin/manage-policies/testpolicy.md#policy-testing-vs-password-changes)
...
![introduction_3](/images/passwordpolicyenforcer/evaluation/introduction_3.webp)
