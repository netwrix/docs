...
DaysToKeepEventsFor system setting. See the [System Settings](/docs/changetracker/admin/settingstab/systemsettings/systemsettings.md) topic
...
See the [Overview Tab](/docs/changetracker/compliance/complianceoverviewtab.md) topic for additional information.
