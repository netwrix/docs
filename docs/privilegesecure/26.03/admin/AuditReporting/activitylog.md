...
![activitylogpage](/images/privilegesecure/26.03/accessmanagement/admin/auditreporting/page/activitylogpage.webp)
...
the [Resources Page](/docs/privilegesecure/26.03/admin/resources/resources.md) topic for additional information.
- Login Account — Account user is logged in with
- Policy — Policy associated with the session. See the
[Access Policy Page](/docs/privilegesecure/26.03/admin/accesspolicy/accesspolicy.md) topic for additional information.
