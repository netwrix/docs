...
- New Password – Threat Manager resets the password to this value. If not specified, generates a random
  password.
- Users – The users whose passwords Threat Manager resets. If not specified, the user who triggered
  the threat is used.
