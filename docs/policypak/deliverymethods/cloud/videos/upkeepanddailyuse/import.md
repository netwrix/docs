---
title: "How to import GPOs to PolicyPak Cloud"
description: "How to import GPOs to PolicyPak Cloud"
sidebar_position: 50
---
# How to import GPOs to PolicyPak Cloud

Backup your GPOs, and then quickly upload them to Netwrix PolicyPak Cloud. Use our wizard-driven UI to take GPO contents for Group Policy ADMX, Security,
GPPreferences and/or PolicyPak settings and quickly upload them. When you want the
FASTEST onramp from GPO to the Cloud... this is it !

<iframe width="560" height="315" src="https://www.youtube.com/embed/hovqVVeekU8" title="PolicyPak Cloud: Instantly import existing real GPOs to PolicyPak Cloud" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
