...
Resources are onboarded in the [Resources Page](/docs/privilegesecure/25.12/admin/interface/resources/resources.md).

![Add resources and resource groups window](/images/privilegesecure/25.12/accessmanagement/admin/policy/window/usersgroups/addresourcesandresourcegroups.webp)
