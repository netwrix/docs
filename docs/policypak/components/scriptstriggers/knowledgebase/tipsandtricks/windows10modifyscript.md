---
title: "What is the expected behavior on Windows 10 when you MODIFY an existing PolicyPak Scripts script?"
description: "What is the expected behavior on Windows 10 when you MODIFY an existing PolicyPak Scripts script?"
sidebar_position: 100
---

# What is the expected behavior on Windows 10 when you MODIFY an existing PolicyPak Scripts script?
...
**Step 1 –** If you used Netwrix PolicyPak Scripts and used it to
