...
PolicyPak Least Privilege Manager enables Standard Users to perform operations in the
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/understanding_acl_manage_file.webp)

Next, specify the path(s) to files or registry and change the Permission (using the dropdown or
**Edit permissions** button.)

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/understanding_acl_manage_file_1.webp)
