...
## Arguments
 ...
 | --- | --- | 
 | --batch-select-size (-q) default value: 10000 | **Type** Int32 **Description** Batch size for SELECT queries. [Query batching performance guide](https://docs.microsoft.com/en-us/azure/azure-sql/performance-improve-use-batching). | 
 | --batch-update-size (-c) default value: 20000 | **Type** Int32 **Description** Batch size for UPDATE queries. [Query batching performance guide](https://docs.microsoft.com/en-us/azure/azure-sql/performance-improve-use-batching). | 
 | --- | --- | 
 | --- | --- | 
 ...
 | --batch-size (-q) default value: 5000 | **Type** Int32 **Description** Batch size for queries. [Query batching performance guide](https://docs.microsoft.com/en-us/azure/azure-sql/performance-improve-use-batching). | 
 ...
 | --entitytype-list optional | **Type** String List **Description** List of entity types that the tool is to be applied to. **Note:** required when `--all-entityType` isn't specified. | 
