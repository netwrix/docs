...
If a password is entered outside the RDP session, it is automatically used and the inline password prompt doesn't display, unless there is an authentication error.
