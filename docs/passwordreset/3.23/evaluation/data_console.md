...
Use the Data Console to view and export data collected by APR. Click **Start** > **ANIXIS
...
is empty when Password Reset is first installed, but it populates as the system is used.
