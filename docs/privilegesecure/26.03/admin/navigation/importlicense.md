...
![Dashboard interface showing an expiration banner and pointint to the User Options menu with the About page](/images/privilegesecure/26.03/accessmanagement/admin/expirationbanner.webp)
...
![About page showing trial license details](/images/privilegesecure/26.03/accessmanagement/admin/triallicensedetails.webp)
...
![About page showing successful upload of a license](/images/privilegesecure/26.03/accessmanagement/admin/licenseimportsuccess.webp)
...
[About Page](/docs/privilegesecure/26.03/admin/navigation/aboutpage.md) topic for additional details available on this page.
