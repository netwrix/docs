...
![Policy > Actions tab > Add Actions window for .Net Script](/images/threatprevention/8.1/admin/policies/actions/addactionwindowfornetscript.webp)
...
![Script Editor for .Net Scripts](/images/threatprevention/8.1/admin/policies/actions/scripteditorfornet.webp)
...
![Tools Menu in the Script Editor](/images/threatprevention/8.1/admin/policies/actions/toolsmenu.webp)
