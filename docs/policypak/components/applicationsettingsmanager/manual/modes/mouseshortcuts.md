...
The PolicyPak Application Settings Manager user interface has several shortcuts to
...
![policypak_application_settings_1_17](/images/policypak/applicationsettings/modes/endpointpolicymanager_application_settings_1_17.webp)
...
- "Revert default values to all settings (for this tab)." This is the equivalent of right-clicking
  ...
  configuration data defined from PolicyPak DesignStudio.
- "Do not re-apply default values (all policy settings on this tab)." This is the equivalent of
  ...
  element on the tab has configuration data defined from PolicyPak DesignStudio.
- "Hide all controls in target application (for this tab)." This is the equivalent of right-clicking
  ...
  works if the element on the tab has PolicyPak Application Settings Manager AppLock™
  data captured using the PolicyPak Capture Wizard tool.
- "Disable all controls in target application (for this tab)." This is the equivalent of
  ...
  application." This only works if the element on the tab has PolicyPak Application
  Settings Manager AppLock™ data captured using the PolicyPak Capture Wizard tool.
- "Remove PolicyPak Application Settings Manager AppLock™ for all controls (for this
...
![policypak_application_settings_1_18](/images/policypak/applicationsettings/modes/endpointpolicymanager_application_settings_1_18.webp)
