...
This guide presumes some knowledge of Identity Manager on the part of the reader who should have previously read the [Introduction Guide](../introduction-guide) in order to be aware of the main purposes, principles and capabilities of Identity Manager.
...
While some activities must be carried out before others for technical and/or functional reasons, the order is not absolute. Please follow the instructions and recommendations detailed with the [Global Process](../user-guide/global-process).
