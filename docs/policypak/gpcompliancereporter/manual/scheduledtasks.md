...
![tuning_and_troubleshooting_14](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_14.webp)
...
![tuning_and_troubleshooting_15](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_15.webp)

Figure 74. The scheduled task stuck in a queued state.

Sometimes endpoints require a reboot in order for data to start to flow to the PolicyPak GPCR server. This is normal when the task is first installed via a Group Policy Preference
...
![tuning_and_troubleshooting_16](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_16.webp)
