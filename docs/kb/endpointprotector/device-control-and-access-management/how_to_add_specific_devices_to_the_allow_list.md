...
3. Scroll to the bottom of the page and click the **Add** button.  
   ![Add button in Global Rights section](./../0-images/servlet_image_97c005a48040.png)  
4. In the new window that appears, add the specific device to the allow list.  
   ![Add device to allow list window](./../0-images/servlet_image_5843306691b5.png)  
5. Fill in the requested details for your device and click **Next**. You will be prompted to add the device as a new device.  
   ![Add new device details](./../0-images/servlet_image_18cc5d89ac43.png)  
6. After filling in the device details, click **Save** and you should see the entry in the Allow list.

## Related Links

- [Set Rights for a Specific Device](/docs/kb/endpointprotector/device-control-and-access-management/set-rights-for-a-specific-device)