...
configured during installation. If you need to modify these settings after installation, you can do so on the Database Page of the Configuration interface.
...
To update the Database service account password, follow these steps. These steps only apply for the SQL
