...
When ACL Lockdown™ mode on a Netwrix PolicyPak element is
selected, PolicyPak will "take ownership" of the portion of the user's registry (or
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/bSuxXH10vSA" title="PolicyPak: ACL Lockdown for Registry Based Applications" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak: ACL Lockdown for Registry Based Applications video transcript
