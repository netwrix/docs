...
This document is only needed for customers using Netwrix PolicyPak Application Settings Manager and Firefox ESR. There is no required special workaround for
PolicyPak Browser Router except using the latest PolicyPak CSE and
...
![transition](/images/policypak/applicationsettings/preconfigured/firefox/transition.webp)
...
- Changes within PolicyPak Application Settings Manager on how we register the Firefox
  plug in (requiring an updated CSE)
- The way the AppSet performs its interaction with the CSE
- The AppSet itself which needed to be recompiled with some PolicyPak DesignStudio
  updates.

:::note
If you are using the PolicyPak DesignStudio yourself to make any changes to
the Firefox 23 AppSet, you will need to re-compile with the latest PolicyPak
...
You can acquire the updated FireFox AppSet 115 in the PolicyPak Portal within the
AppSets downloads.

:::note
It is recommended, though not strictly required that you also update your management
station to the latest PolicyPak MMC snap-in. In doing so the screenshots shown here
...
- Then when you use the new CSE and the New AppSet (FF115), PolicyPak will operate as
...
:::note
This document mostly focuses on Group Policy Object delivery of the Firefox PolicyPak AppSet. Note you may have other ways to deliver the FireFox PolicyPak
AppSet like PolicyPak Cloud, local GPOs, and/or XML data files (via MSI files.) Be
...
You'll want to first discover all GPOs with PolicyPak Application Settings Manager
Data, and those with specific Firefox 23 AppSets. That being said, automation can only help you
discover which GPOs contain PolicyPak Application Settings Manager data. After that,
...
![939_2_image-20231101213809-2_950x458](/images/policypak/applicationsettings/preconfigured/firefox/939_2_image-20231101213809-2_950x458.webp)
...
restore your PolicyPak Application Settings Manager and specifically the Firefox
settings before continuing.

### Back up 1: Viewing the Group Policy Object Report and saving the HTML report.

![939_3_image-20231101213809-3_950x493](/images/policypak/applicationsettings/preconfigured/firefox/939_3_image-20231101213809-3_950x493.webp)
...
![939_4_image-20231101213809-4_950x761](/images/policypak/applicationsettings/preconfigured/firefox/939_4_image-20231101213809-4_950x761.webp)
...
Additionally, you should keep handy the OLD PolicyPak Firefox 23 App Set DLL file that
you are currently using; and not merely the one still available in the PolicyPak
portal.
...
- A share. (Tip: To locate the share you could be using see the
  [Using Shares to Store Your Paks (Share-Based Storage)](/docs/policypak/components/applicationsettingsmanager/videos/centralstoresharing/shares.md)[Using Shares to Store Your Paks (Share-Based Storage)](/docs/policypak/components/applicationsettingsmanager/videos/centralstoresharing/shares.md))
...
To play it safe, set the ILT evaluation to check for PolicyPak CSE version 23.9.0.0
...
![939_5_image-20231101213809-5_950x524](/images/policypak/applicationsettings/preconfigured/firefox/939_5_image-20231101213809-5_950x524.webp)

You can test for the presence or absence of PolicyPak CSE version 23.09.0.0 with a
...
![939_6_image-20231101213809-6_950x743](/images/policypak/applicationsettings/preconfigured/firefox/939_6_image-20231101213809-6_950x743.webp)

When done save the values. You will know you have ILT set when you see the Targeting column change
to ON.

![939_7_image-20231101213809-7_950x273](/images/policypak/applicationsettings/preconfigured/firefox/939_7_image-20231101213809-7_950x273.webp)
...
and select Export settings to XMLData file and save the file. Then use the PolicyPak
Item Level Targeting Validation tool to test how ILT will operate. See the
[Troubleshooting ILT with the ILT Validator Tool](/docs/policypak/components/applicationsettingsmanager/videos/featurestechsupport/itemleveltargeting.md)
topic for additional information.
...
![939_8_image-20231101213809-8_950x453](/images/policypak/applicationsettings/preconfigured/firefox/939_8_image-20231101213809-8_950x453.webp)

Expected result on a machine with 23.10 and later CSE:

![939_9_image-20231101213809-9_950x523](/images/policypak/applicationsettings/preconfigured/firefox/939_9_image-20231101213809-9_950x523.webp)

## Adding the FF 115 AppSet to an existing or new Group Policy Object

After you download the FF 115 AppSet from the PolicyPak portal, it will appear like
this. You only need the .DLL file and not the XML file.

![939_10_image-20231101213809-10](/images/policypak/applicationsettings/preconfigured/firefox/939_10_image-20231101213809-10.webp)
...
![939_11_image-20231101213809-11_950x492](/images/policypak/applicationsettings/preconfigured/firefox/939_11_image-20231101213809-11_950x492.webp)

For example in the PolicyPak Central Store you simply add the pp-Mozilla Firefox
115.DLL.
...
![939_12_image-20231101213809-12_950x406](/images/policypak/applicationsettings/preconfigured/firefox/939_12_image-20231101213809-12_950x406.webp)

Next time you open the Group Policy editor you should see PolicyPak For Mozilla
Firefox 115.
...
computers with the latest PolicyPak CSE.

After creating the entry, double-click into it to open it up and select Import XML Settings Data.

![939_13_image-20231101213809-13_950x633](/images/policypak/applicationsettings/preconfigured/firefox/939_13_image-20231101213809-13_950x633.webp)
...
![939_14_image-20231101213809-14](/images/policypak/applicationsettings/preconfigured/firefox/939_14_image-20231101213809-14.webp)

FF AppSet 115 should be applied only to machines with PolicyPak CSE version 23.10.3687
...
![939_15_image-20231101213809-15_950x815](/images/policypak/applicationsettings/preconfigured/firefox/939_15_image-20231101213809-15_950x815.webp)
...
select Export settings to XMLData file and save the file. Then use the PolicyPak Item
...
![939_16_image-20231101213809-16_950x543](/images/policypak/applicationsettings/preconfigured/firefox/939_16_image-20231101213809-16_950x543.webp)

Then you can use the ILT Evaluator tool to ensure your ILT evaluation is properly crafted and the
AppSet will only target machines with the latest PolicyPak CSE.

![939_17_image-20231101213809-17_950x549](/images/policypak/applicationsettings/preconfigured/firefox/939_17_image-20231101213809-17_950x549.webp)
...
![939_18_image-20231101213809-18_950x807](/images/policypak/applicationsettings/preconfigured/firefox/939_18_image-20231101213809-18_950x807.webp)
