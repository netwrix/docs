...
onboarded in the [Resources Page](/docs/privilegesecure/26.03/admin/resources/resources.md).

![Protection policy add resource window](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/resources/addresources.webp)
...
[Resources Page](/docs/privilegesecure/26.03/admin/resources/resources.md) topic for addition information.
