...
![Policy window - Authentication Protocol filter for lockdown](/images/threatprevention/8.1/admin/policies/eventtype/authenticationprotocollockdown.webp)
...
![Policy window - Hosts (to) filter for lockdown](/images/threatprevention/8.1/admin/policies/eventtype/hoststolockdown.webp)
