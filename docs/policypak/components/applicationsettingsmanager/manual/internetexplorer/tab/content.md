...
Video: For a quick overview of how to manage the Content tab using PolicyPak
...
![ie_appset_tab_by_tab_10](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_10.webp)
...
![ie_appset_tab_by_tab_11](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_11.webp)

The figure shown. The content advisor settings.

This PolicyPak dialog corresponds to the following IE 8 dialog as shown In the figure shown.
Note IE 10 and 11 don't have this dialog, but the settings can be delivered anyway.

![ie_appset_tab_by_tab_12](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_12.webp)
...
will be described later. You can, however, disable or hide the certificates buttons using PolicyPak, as shown In the figure shown.

![ie_appset_tab_by_tab_13](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_13.webp)
