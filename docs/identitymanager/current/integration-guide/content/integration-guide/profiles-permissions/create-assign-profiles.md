...
Here is the xml configuration to create a profile in Identity Manager. See the [Profile](../../../../integration-guide/toolkit/xml-configuration/access-control/profile) topic for additional information.
