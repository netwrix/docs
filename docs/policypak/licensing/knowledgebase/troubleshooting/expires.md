...
![937_1_image-20230425211701-1_950x194](/images/policypak/troubleshooting/license/937_1_image-20230425211701-1_950x194.webp)

![937_2_image-20230425211701-2](/images/policypak/troubleshooting/license/937_2_image-20230425211701-2.webp)
...
only have one license remaining. [Using LT for license cleanup](/docs/policypak/licensing/videolearningcenter/troubleshooting/cleanup.md)/
:::


- On an example ENDPOINT computer (one that has the Netwrix PolicyPak CSE; which can also include the Admin's GPMC machine) verify the endpoint got the new
...
registry keys with old PolicyPak license info.
