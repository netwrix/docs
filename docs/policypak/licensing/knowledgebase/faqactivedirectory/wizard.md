...
When you buy Netwrix PolicyPak On-Prem suite you get licenses for
...
![69_1_image005](/images/policypak/license/activedirectory/69_1_image005.webp)
...
![69_2_image0011](/images/policypak/license/activedirectory/69_2_image0011.webp)

## Option 2: Importing a license directly into an existing GPO

Another way to install license files for PolicyPak On-Prem suite is to use the License
Management node, which is found in two places.

:::note
This tip only works when the PolicyPak Admin Console MMC snap in is 759 or
later.
:::


**Step 1 –** Go to **Computer Configuration** > **PolicyPak**, then right-click
**License Management**.
...
![69_3_image0021](/images/policypak/license/activedirectory/69_3_image0021.webp)

Alternatively, click **Computer Configuration** > PolicyPak > **Admin Templates
Manager** > **License Management**. This is an alternate way to get to License Management, and which
does work for NetIQ GPA).

![69_4_2015-06-03_2227](/images/policypak/license/activedirectory/69_4_2015-06-03_2227.webp)

**Step 2 –** Then import the licenses received from PolicyPak sales.

![69_5_image0071](/images/policypak/license/activedirectory/69_5_image0071.webp)

**Step 3 –** Verify that the licenses are in the GPO by looking at the GPMC settings report:

![69_6_image010](/images/policypak/license/activedirectory/69_6_image010.webp)

**Step 4 –** Finally, link the GPO to where the computers are.

PolicyPak doesn't care where USERS are located, only where computersare. In this
example, we are linking the GPO to Sales OU, where the GPO will flow downward and hit the computers.

:::note
PolicyPak will not work in un-licensed locations. Those must be selected
when providing your license request key before your licenses are cut.
:::


![69_7_image011](/images/policypak/license/activedirectory/69_7_image011.webp)
