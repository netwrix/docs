...
- [Install the Application](/docs/identityrecovery/2.6/install/application.md)
- [Configuration Utility](/docs/identityrecovery/2.6/install/configurationutility.md)
- [Install the RSAT Extension](/docs/identityrecovery/2.6/install/installation.md)

Prior to installing, ensure that all prerequisites have been met, as described in the
[Requirements ](/docs/identityrecovery/2.6/requirements/overview.md)topic.
...
See the [Licensing Page](/docs/identityrecovery/2.6/admin/configuration/licensing.md) topic to license the product.
