---
title: "Microsoft Entra ID Details"
description: "Microsoft Entra ID Details"
sidebar_position: 40
---

# Microsoft Entra ID Details
...
![Azure AD Details page](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/details/azureaddetailspage.webp)
...
- [URLs Tab for Microsoft Entra ID](/docs/privilegesecure/26.03/admin/resources/detailspages/entraid/urlsentraid.md)
- [Users Tab for Microsoft Entra ID](/docs/privilegesecure/26.03/admin/resources/detailspages/entraid/usersentraid.md)
- [Groups Tab for Microsoft Entra ID](/docs/privilegesecure/26.03/admin/resources/detailspages/entraid/groupsentraid.md)
- [Sessions Tab for Microsoft Entra ID](/docs/privilegesecure/26.03/admin/resources/detailspages/entraid/sessionsentraid.md)
- [Access Policies Tab for Microsoft Entra ID](/docs/privilegesecure/26.03/admin/resources/detailspages/entraid/accesspoliciesentraid.md)
- [History Tab for Microsoft Entra ID](/docs/privilegesecure/26.03/admin/resources/detailspages/entraid/historyentraid.md)
- [Applications Tab for Microsoft Entra ID](/docs/privilegesecure/26.03/admin/resources/detailspages/entraid/applicationsentraid.md)
