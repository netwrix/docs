...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/adminapproval/avoid_pop_ups_with_admin_approval.webp)

There are two ways to overcome these messages:

**Step 1 –** Disable the product’s auto-update feature.

- Java: You can use PolicyPak Application Settings Manager to disable Java’s
  auto-update.
...
**Step 2 –** Create a PolicyPak Least Privilege Manager rule to elevate the update
...
## Using PolicyPak Operational Logs to Find and Overcome Unwanted Pop-ups

The first way to see which applications are causing unwanted pop-ups is via PolicyPak
...
## Using PolicyPak Event Logs to Find and Overcome Unwanted Pop-ups

You can get similar information from the PolicyPak event logs, which are found in the
**Application and Services Logs** > **PolicyPak**. An event will appear showing
canceled dialogs, like the one shown here.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/adminapproval/avoid_pop_ups_with_admin_approval.webp)

There is more information on using Event Viewer with PolicyPak at the end of this
