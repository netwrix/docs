---
title: "PolicyPakCloud: Upload and use your own ADMX files to PolicyPak Cloud"
description: "PolicyPakCloud: Upload and use your own ADMX files to PolicyPak Cloud"
sidebar_position: 70
---
# PolicyPakCloud: Upload and use your own ADMX files to PolicyPak Cloud

<iframe width="560" height="315" src="https://www.youtube.com/embed/oUTjeGSdb6o" title="PolicyPak Cloud: ADMX thru the cloud" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Using Netwrix PolicyPak Cloud and want to use your own custom
ADMX files? Here's how to do it.

### PolicyPak Cloud: ADMX thru the cloud video transcript
