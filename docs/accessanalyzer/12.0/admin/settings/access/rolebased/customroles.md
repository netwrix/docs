...
- Replace `Special User` between the double quotes in the preceding script with the name of the new
  role.
- Replace `Description of Special User` between the double quotes in the preceding script with a
...
`<privileges>` and ending comment `</privileges>` in the preceding script.
...
See the following sections for examples of how roles should be added in the **rba-roles.conf** file.
