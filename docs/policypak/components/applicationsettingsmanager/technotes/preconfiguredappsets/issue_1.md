...
the changes. We can still get Netwrix PolicyPak to deliver the
setting by disabling the internal item-level targeting.

![323_1_image011dftyrty](/images/policypak/troubleshooting/applicationsettings/java/323_1_image011dftyrty.webp)
