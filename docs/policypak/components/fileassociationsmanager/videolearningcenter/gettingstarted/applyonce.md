---
title: "PolicyPak File Associations Manager: Apply once (and drift)"
description: "PolicyPak File Associations Manager: Apply once (and drift)"
sidebar_position: 20
---
# PolicyPak File Associations Manager: Apply once (and drift)

Want to lay down one set of File Associations for some apps, but leave others to the end user to
change themselves? Use PolicyPak File Associations Manager to "apply once" and let
those settings drift after you set them with the tips in this video.

<iframe width="560" height="315" src="https://www.youtube.com/embed/KkiHMOv97Ms" title="PolicyPak File Associations Manager: Apply once (and drift)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video, I'm going to show you how you can use PolicyPak File Associations Manager to set up your user or computer side file associations and do it
...
to getting you started with PolicyPak real soon. Thanks so much.
