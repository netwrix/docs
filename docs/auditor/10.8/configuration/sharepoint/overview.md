...
To configure Audit Log Trimming on your SharePoint farm.
...
To configure event auditing settings.
...
installation. Perform the procedure below, before the Core Service installation. See the
[Install for SharePoint Core Service](/docs/auditor/10.8/install/sharepointcoreservice.md) topic for additional
information.

To enable SharePoint Administration Service.
