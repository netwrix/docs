...
![Analysis Tasks for the FS_PeerGroupActivity Job](/img/product_docs/accessanalyzer/12.0/solutions/filesystem/activity/suspiciousactivity/peergroupactivityanalysis.webp)
