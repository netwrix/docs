...
![gpcr_concepts_and_quickstart_20](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_20.webp)
...
![gpcr_concepts_and_quickstart_21](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_21.webp)
...
machine or the PolicyPak GPCR server) and the temporary GPO are deleted from the
domain. If the Group Policy Management Editor is closed but fails to tell PolicyPak
GPCR that it has closed, you have the option to select "Force save" using the "Waiting..." dialog
box.

![gpcr_concepts_and_quickstart_22](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_22.webp)
...
![gpcr_concepts_and_quickstart_23](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_23.webp)
...
available for testing with PolicyPak GPCR. Information on the areas of Group Policy
available for testing can be found in the section "Supported Group Policy Settings for Reporting."
If you try to test one of those unavailable Group Policy areas, PolicyPak GPCR
...
![gpcr_concepts_and_quickstart_24](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_24.webp)
