---
title: "How does PolicyPak support (and not support) Windows 7?"
description: "How does PolicyPak support (and not support) Windows 7?"
sidebar_position: 50
---

# How does PolicyPak support (and not support) Windows 7?

First, Windows 7, Server 2008 R2, Windows 8 and Server 2012 R2 are not supported by Microsoft and
not supported with Netwrix PolicyPak installed.

PolicyPak only supports versions of the operating system which are actively supported
by Microsoft. This is covered in this
FAQ:[Which Windows Client and Server are currently supported by PolicyPak?](/docs/policypak/gettingstarted/misc/knowledgebase/tipstricksandfaqs/windows.md)
...
Additionally PolicyPak requires drivers which are signed and work only with Windows 10
...
There could be more pieces which are expected not to work in PolicyPak, but these are
the known items.
