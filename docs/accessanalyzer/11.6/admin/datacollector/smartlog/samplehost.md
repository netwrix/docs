...
![SMART Log DC Wizard Sample Host page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/wmicollector/samplehost.webp)
...
![Select Computer window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/smartlog/selectcomputerwindow.webp)
...
![Advanced Select Computer window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/smartlog/selectcomputerwindowadvanced.webp)
...
- Click the **Columns** button to open the Choose Columns window
    ...
    ![Choose Columns window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/smartlog/choosecolumnswindow.webp)
