...
The New Investigation page within the Investigations interface lets you run queries on
...
Then click **Run Query**. The report data appears in the sections following the Filters section.
...
The Save option lets you save your configured filters to run the investigation again later.

## Save an Investigation

To retain filter configuration after running a query and confirming the report you want data is
...
**Step 4 –** From the Folder dropdown menu, select the folder where you want to save the investigation. The My Investigations folder is the default for custom investigations.

**Step 5 –** Select a user role from the Owner dropdown menu. All users assigned this role own this investigation and can modify the report.
