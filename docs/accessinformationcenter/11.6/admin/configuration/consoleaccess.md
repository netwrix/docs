...
Console access to the Access Information Center is configured through the **Configuration** > **Console Access** page. Adding
...
:::warning
Before disabling the Builtin Administrator account, first assign at
...
When the first user with the role of Administrator has been added, the Builtin Administrator account
...
:::note
These steps are for modifying domain users with console access roles and don't apply to
...
:::warning
Confirmation isn't requested when deleting users. An alternative to deleting a console
...
- Access is enabled — Indicates whether you can log in with this account
- Change Password — Change the password for this Builtin Administrator account. Check
