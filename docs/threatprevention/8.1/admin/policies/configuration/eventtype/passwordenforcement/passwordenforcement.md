...
![Policy window - Password Enforcement Event Type](/images/threatprevention/8.1/admin/policies/eventtype/passwordenforcement.webp)
...
Password Enforcer solution. See the [License Manager Window](/docs/threatprevention/8.1/admin/navigation/licensemanager.md)
...
![Policy window - AD Account filter](/images/threatprevention/8.1/admin/policies/eventtype/adaccount.webp)
...
- Containers – The Containers Add (+) button opens the
  [Select Active Directory Contexts Window](/docs/threatprevention/8.1/admin/policies/configuration/eventtype/window/context.md). All user
  objects in the selected organizational units are subject to the applied rule.
- Groups – The Groups Add (+) button opens the
  [Select AD Groups Window](/docs/threatprevention/8.1/admin/policies/configuration/eventtype/window/groups.md).
...
![Policy window - Hosts (from) filter](/images/threatprevention/8.1/admin/policies/eventtype/hostsfromlockdown.webp)
...
![Policy window - Password Rules filter](/images/threatprevention/8.1/admin/policies/eventtype/passwordrules.webp)
...
[Test Passwords Window](/docs/threatprevention/8.1/admin/policies/configuration/eventtype/window/testpasswords.md), where you can test your set of rules.
:::
...
[Password Dictionary Window](/docs/threatprevention/8.1/admin/configuration/epesettings.md#password-dictionary-window) blocks
