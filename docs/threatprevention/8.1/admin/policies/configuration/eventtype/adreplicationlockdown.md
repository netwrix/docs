...
![Policy window - AD Replication Lockdown Event Type](/images/threatprevention/8.1/admin/policies/eventtype/adreplicationlockdown.webp)
...
![Policy window - Permissions  filter](/images/threatprevention/8.1/admin/policies/eventtype/permissions.webp)
...
![Policy window - Hosts (from) filter for the AD Replication Lockdown event type](/images/threatprevention/8.1/admin/policies/eventtype/adreplicationhostsfrom.webp)
