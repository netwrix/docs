...
You can define a filter set and create a custom report based on the filter so that you don't have
...
**Step 2 –**  Select an organization from the dropdown menu at the top of the left pane to create a
...
**Step 6 –** From the Category dropdown menu, select an existing category or add a new one for the
...
**Step 8 –** Optionally, select the **Share with business users** checkbox to share the report with
...
:::note
This checkbox isn't available for End Customer Organizations.
:::
...
:::note
You can link this report to an alert. See the
...
**Step 5 –** Click **Edit** to modify the report. The Edit Report pane opens.
...
**Step 5 –** Click **Delete**. A confirmation dialog box appears. Click **Delete**.
