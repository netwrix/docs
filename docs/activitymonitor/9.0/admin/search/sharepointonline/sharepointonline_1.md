...
column headers. You can also [Export](/docs/activitymonitor/9.0/admin/search/overview.md#export) the results.

![SharePoint Online Search Results](/images/activitymonitor/9.0/admin/search/results/sharepointonlinesearchresults.webp)
