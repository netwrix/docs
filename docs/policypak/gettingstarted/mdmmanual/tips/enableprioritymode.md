...
added using the PolicyPak Exporter, right-click an item and select **Enable Priority
Mode**. Then move the item item up or down (with the arrow keys) and click Enter to change the
order.

![policypak_exporter_tips_tricks](/images/policypak/mdm/tips/endpointpolicymanager_exporter_tips_tricks.webp)
...
![policypak_exporter_tips_tricks_7](/images/policypak/mdm/tips/endpointpolicymanager_exporter_tips_tricks_7.webp)
...
![policypak_exporter_tips_tricks_1](/images/policypak/mdm/tips/endpointpolicymanager_exporter_tips_tricks_1.webp)
