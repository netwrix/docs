...
Add-On on the Access Analyzer Console. If you use the SharePoint Agent, you must also install it on
the application server that hosts the Central Administration component.
:::
