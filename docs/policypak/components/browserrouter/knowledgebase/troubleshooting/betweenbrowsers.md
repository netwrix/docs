...
[Knowledge Base](/docs/policypak/). This will demonstrate that you are:

- Getting the GPOs involved in Netwrix PolicyPak Browser Router
  and
- Licensing is working for PolicyPak Browser Router
- PolicyPak Browser Router is set as the OS Default Browser for HTTP and HTTPS
...
ONLY continue if you see `ppBRResults.xml` and are sure PolicyPak Browser Router is
correctly licensed.

**Step 2 –** First, test the PolicyPak Browser Router is routing "natural" links. Use
WORDPAD (not notepad!) to create a simple document which will open up the browser based upon your
rules (routes.)

![267_1_img1](/images/policypak/troubleshooting/browserrouter/267_1_img1.webp)
...
before, then PolicyPak Browser Router will not work immediately.
...
…will install the PolicyPak Browser Router helper applications inside each browser on
the endpoint.

So, some examples where PolicyPak Browser Router will not work instantly:

![267_2_img2](/images/policypak/troubleshooting/browserrouter/267_2_img2.webp)

![267_3_img3](/images/policypak/troubleshooting/browserrouter/267_3_img3.webp)

To ensure each browser is ready to route BETWEEN BROWSERS, you are looking for the following.

Inside IE: (Gear | Manage Add-ons)

![267_4_img4-1024x325](/images/policypak/troubleshooting/browserrouter/267_4_img4-1024x325.webp)

FF: The Firefox plugin for PolicyPak Browser Router will ONLY install into Firefox
...
![267_5_pp-ff-img-01](/images/policypak/troubleshooting/browserrouter/267_5_pp-ff-img-01.webp)

If you are ATTEMPTING to use Firefox RR, then it will not work and you will get the following
(expected) error.

![267_6_image_1000x626](/images/policypak/troubleshooting/browserrouter/267_6_image_1000x626.webp)
...
time) to get the PolicyPak Browser Router Chrome Extension automatically downloaded
and installed on your machine.

![267_7_img6](/images/policypak/troubleshooting/browserrouter/267_7_img6.webp)
...
**Step 4 –** Again; make sure you have SOME PolicyPak Browser Router policies.
...
[PolicyPak Browser Router removes other Chrome ‘force installed' extensions. How can I work around this?](/docs/policypak/components/browserrouter/knowledgebase/troubleshooting/forceinstall.md)
