...
Click the **Request Confirmation** button in the Resource Owners interface to open the Confirm Ownership wizard for one or multiple resources.
...
the confirmation email. After the list is set as desired, click **Finish**. The Access Information
