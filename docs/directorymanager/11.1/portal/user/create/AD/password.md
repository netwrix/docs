...
Step 2 – Select the following checkboxes to set the security options for the user account:
...
- Account is disabled – To disable the account, so that the user can't log-on with it.
