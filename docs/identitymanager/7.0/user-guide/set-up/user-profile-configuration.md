...
How to tweak the [References: Permissions](../../integration-guide/profiles-permissions/permissions) for actions **within** Identity Manager, for a set of basic [Assigned Profile](../../integration-guide/toolkit/xml-configuration/access-control/assignedprofile).
...
This documentation defines a permission as an entitlement **within** Identity Manager.
...
The goal here is to create profiles and link specific permissions to the profiles, to build a set of typical profiles that will later be assigned to users. See the [Assign Users a Profile](../../user-guide/set-up/user-profile-assignment) topic for additional information. Instead of assigning permissions one by one to users, you will assign them sets of permissions (i.e. profiles).
...
> their team. It means that the manager can't see or do anything outside the identities included in
> their team.
...
1. On the home page, click **Settings** in the **Configuration** section, then on **General** >
**Profiles** in the left menu.

    ![Home - Configuration](/images/identitymanager/home_settings_v523.webp)
...
clicking on the addition button at the top right and fill in the fields.
    ...
    ![New Profile](/images/identitymanager/profiles_creation_v602.webp)
