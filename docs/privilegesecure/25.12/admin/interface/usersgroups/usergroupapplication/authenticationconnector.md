...
Authentications page. See the [Authentication Page](/docs/privilegesecure/25.12/admin/configuration/authentication/authentication.md)
topic for additional information.

![Users Authentication Connector Tab](/images/privilegesecure/25.12/accessmanagement/admin/policy/tab/usersgroups/userauthenticationtab.webp)
...
- Duo SAML — SAML profile that is used for MFA when the user signs into the Privilege Secure
console
...
group assignment takes precedence over the Internal MFA setting on the user.
