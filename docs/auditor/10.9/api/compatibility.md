...
that use Netwrix Auditor Integration API. Download the latest add-on version in the Add-on Store.
...
For details about input and output Activity Record structure, see [Activity Records](/docs/auditor/10.9/api/postdata/activityrecords.md).
