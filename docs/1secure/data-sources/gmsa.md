...
2. If you are going to collect data using the network traffic compression (see the following section
   for more information:
   [Network Traffic Compression](/docs/1secure/setup-and-configuration/network-configuration.md)), provide the
   following:
...
to [Data Collecting Account](/docs/1secure/setup-and-configuration/data-collection-account.md) article.
