...
[Administration](/docs/passwordpolicyenforcer/12.0/admin/administration_overview.md) topic contains more information to
help you use Password Policy Enforcer's full capabilities.

The [Password Policy Enforcer Web](/docs/passwordpolicyenforcer/12.0/web-overview/web_overview.md) application lets users securely manage their passwords from a web browser, ensuring passwords comply with the password policy, and
