...
are not allowed because it requires admin rights. Creating a PolicyPak Least Privilege
...
However, you may also use PolicyPak Cloud, and MDM service like Intune, or your own
system like SCCM.
...
![A computer screen shot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables.webp)

An executable rule can be one of two types:

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables_1.webp)
...
[PolicyPak & Netwrix Privilege Secure](/docs/policypak/components/leastprivilegemanager/manual/windows/privilegesecure/overview.md)
topic. Future examples will purposely omit this step until we need it.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables_2.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables_3.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables_4.webp)

The next screen, as shown here, demonstrates possible action types and options for PolicyPak Least Privilege Manager.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables_5.webp)
...
- **Apply on demand**. Enables the elevation only when application is right-clicked. For more
  information on this, see [Apply on Demand Rules](/docs/policypak/components/leastprivilegemanager/manual/windows/apply/ondemand.md).
...
- **Do not elevate Open/Save dialog**. By default PolicyPak will prevent child
  processes from gaining elevation thru the Open/Save dialogs. See the
  [Best Practices and Miscellaneous Topics](/docs/policypak/components/leastprivilegemanager/manual/windows/overviewmisc/overviewmisc.md) topic for additional
  information.
- **Show popup message**. Optional requirement to either force the user to reauthenticate and/or put
  ...
  [Best Practices and Miscellaneous Topics](/docs/policypak/components/leastprivilegemanager/manual/windows/overviewmisc/overviewmisc.md) for additional
  information.
...
- **Scope**. See the [Best Practices and Miscellaneous Topics](/docs/policypak/components/leastprivilegemanager/manual/windows/overviewmisc/overviewmisc.md) for
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables_6.webp)

Once you have made your selections, an entry in the Group Policy Management Editor is obtained, as
shown in here.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables_7.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_executables_8.webp)
...
![elevating_executables_9](/images/policypak/leastprivilege/elevate/elevating_executables_9.webp)
