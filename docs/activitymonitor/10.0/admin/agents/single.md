...
[Activity Agent Server Requirements](/docs/activitymonitor/10.0/requirements/activityagent/activityagent.md) have been met,
...
- Windows Activity Monitoring — Check the Add Windows file activity monitoring after installation
  ...
  installation. You can also enable Windows monitoring later on the Monitored Hosts & Services
  tab.
...
**Step 8 –** Click Finish. The Add New Agents window closes, and Activity Monitor deploys and installs the activity agent on the target host.
