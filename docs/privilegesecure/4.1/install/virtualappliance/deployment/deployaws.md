...
Follow the following steps to configure the SQL Server instance.
...
Follow the following steps to configure a guest instance.
...
For the first time, this starts automatically. See the following steps for additional information. For
