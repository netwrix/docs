...
:::note
When saving templates, always select a name that will also allow it to be safely
...
[Predefining rights](/docs/passwordsecure/current/configuration/advancedview/permissionconceptandprotective/predefiningrights/predefining_rights.md) and also under
