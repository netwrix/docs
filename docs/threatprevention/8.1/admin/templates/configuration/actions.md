...
![Template – Actions tab](/images/threatprevention/8.1/admin/templates/actionstab.webp)
...
The [SIEM Output Viewer](/docs/threatprevention/8.1/admin/configuration/siemoutputviewer.md) window
also displays all notifications sent to SIEM.
...
emails. See the [Custom Scripts](/docs/threatprevention/8.1/admin/templates/folder/actions/actions.md#custom-scripts) topic for additional information.
