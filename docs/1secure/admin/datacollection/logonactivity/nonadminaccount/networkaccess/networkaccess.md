...
sidebar_position: 20
---
**To configure the Access this computer from the network policy:**
...
**Step 11** – Type `repadmin /syncall` command and press Enter to replicate GPO changes to other domain controllers.

**Step 12** – Verify that the new GPO settings are applied on any audited domain controller.