---
title: "PolicyPak Software Package Manager PLUS Least Privilege Manager: Block any unwanted store apps !"
description: "PolicyPak Software Package Manager PLUS Least Privilege Manager: Block any unwanted store apps !"
sidebar_position: 30
---
...
In a previous video you saw me use Netwrix PolicyPak's Software
...
It turns out, good news, is that you can use PolicyPak Least Privilege Manager in
...
PolicyPak Least Privilege Manager Complete Edition.
...
can go to the PolicyPak Extras Folder and find the Software Package Helper utility. If
...
PolicyPak Least Privilege Manager. The point of the story is you can use PolicyPak Software Package Manager to deliver any AppX packages you want. You can do a smack
down with PolicyPak Least Privilege Manager with our UWP apps and then open up the
...
helps you out. Looking forward to getting you started with PolicyPak real soon.
