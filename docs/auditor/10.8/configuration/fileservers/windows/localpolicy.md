...
You can choose to configure local audit policies or advanced audit policies. See the [Configure Advanced Audit Policies](/docs/auditor/10.8/configuration/fileservers/windows/advancedpolicy.md) topic for more information.

1. On the audited server, open the **Local Security Policy** snap-in: navigate to **Start** > **Windows Administrative Tools** > **Local Security Policy**.
