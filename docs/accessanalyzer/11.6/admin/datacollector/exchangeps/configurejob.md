...
The ExchangePS Data Collector requires you to create a custom Connection Profile and host list and
assign them to the job that collects the data. The host inventory option during host list
...
Set the ExchangePS Data Collector to run against:
