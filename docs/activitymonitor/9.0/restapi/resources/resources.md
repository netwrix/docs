...
The 9.0 API model consists of the following resources:

- Agent – Represents an Activity Monitor Agent. With the API, you can view existing agents and their
  ...
  See the [Agent](/docs/activitymonitor/9.0/restapi/resources/agent.md) topic for additional information.

- Host – Represents a host or service monitored by the product (Windows, NetApp, SharePoint, SQL
  Server, etc.). It is a Monitored Host/Service in the Console. You can list all the hosts of the agent, or
  just all the hosts. The API provides access to the settings of the host and its status. You can
  create new hosts, modify, enable/disable, or delete existing. Typical properties include a
  ...
  settings.  
  Children: Output  
  See the [Host](/docs/activitymonitor/9.0/restapi/resources/host.md) topic for additional information.
...
- Domain – It is a Monitored Domain in the Console. The API provides summary information about each
  ...
  See the [Domain](/docs/activitymonitor/9.0/restapi/resources/domain.md) topic for additional information.

- Output – A log file or Syslog or AMQP destination for the activity data. Typical
  ...
  Children: File
  See the [Output](/docs/activitymonitor/9.0/restapi/resources/output.md) topic for additional information.
...
- `archive.password`
- `archive.userName`
- `archive.maxLocalSize` – Expected format: number of bytes
- `fpolicy.port`
...
- `minLocalFreeSpace` – Expected format: number of bytes
- `cee.vcapsIsEnabled`
- `cee.vcapsInterval`
- `cee.vcapsEvents`
- `cee.httpEnabled`
...
      "logFile": {
        "format": "Tsv",
        "path": "C:\\ProgramData\\Netwrix\\Activity Monitor\\Agent\\ActivityLogs\\localhost_Log_.tsv",
...
      "logFile": {
        "format": "Tsv",
        "path": "C:\\ProgramData\\Netwrix\\Activity Monitor\\Agent\\ActivityLogs\\WRKST0100_E_Activity_Log_.Tsv",
...
Modifies attributes of the policy. If XML is updated, ID, GUID, and other attributes in the XML are ignored,
