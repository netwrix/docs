---
title: "PolicyPakCloud and PolicyPak OnPremise – Together using PPCloud Licenses"
description: "PolicyPakCloud and PolicyPak OnPremise – Together using PPCloud Licenses"
sidebar_position: 20
---
# PolicyPakCloud and PolicyPak OnPremise – Together using PPCloud Licenses

You get a free "on premise" license when you consume a Netwrix PolicyPak Cloud license. Here is a demonstration video to show you a best practice way to set up
PolicyPak cloud AND PolicyPak on-premise together.

<iframe width="560" height="315" src="https://www.youtube.com/embed/X65ajrbab-U" title="PolicyPakCloud and PolicyPak OnPremise – Together using PPCloud Licenses" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
