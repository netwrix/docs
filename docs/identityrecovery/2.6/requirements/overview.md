...
- [Application Server Requirements](/docs/identityrecovery/2.6/requirements/server.md)
- [SQL Server Requirements](/docs/identityrecovery/2.6/requirements/sqlserver.md)
- [RSAT Extension Requirements](/docs/identityrecovery/2.6/requirements/rsatextension.md)

Target Domain Considerations

The target domains include the Active Directory domains that can be added through the
[Domains Page](/docs/identityrecovery/2.6/admin/configuration/domain.md). See the following topic for target domain
considerations:

- [Target Domains](/docs/identityrecovery/2.6/requirements/targetdomain.md)
...
- [Target Server Considerations](/docs/identityrecovery/2.6/requirements/targetserver.md)
