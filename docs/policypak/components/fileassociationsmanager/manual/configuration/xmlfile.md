...
PolicyPak File Associations Manager will dynamically write the file that Windows needs
...
![troubleshooting](/images/policypak/troubleshooting/fileassociations/troubleshooting.webp)

Figure 54. FileAssocations.xml shows the actions taken by PolicyPak File Associations
Manager.
