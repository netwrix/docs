...
[Activity Records](/docs/auditor/10.9/api/postdata/activityrecords.md) for more details.
...
troubleshooting such cases, refer to the [Sample Deployment Scenarios](/docs/auditor/10.9/requirements/deploymentscenarios.md)
topic.

Additional Sizing Information for File Server and SharePoint Online Data Sources
...
by clicking
[the download link](https://releases.netwrix.com/products/auditor/10.9/auditor-resource-estimation-tool-1.2.46.zip).
