...
**Step 3 –** Click the **Netwrix_PPE_Server**version**x64.msi** installation package. The
...
- Configuration Console – manages policy configuration. Install wherever needed. Selected by
  default.
- Mailer Service – sends email reminders. Should be installed on a Domain Controller. It isn't
  selected by default.
