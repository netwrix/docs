...
- [Netwrix Activity Monitor Integration](/docs/threatmanager/3.2/install/integration/activitymonitor.md) – Activity Monitor can be configured to
  send file system data and/or Active Directory data to Threat Manager.
    - The Active Directory data stream requires a unique App Token to be generated within Threat
      Manager.
- [Netwrix Threat Prevention Integration](/docs/threatmanager/3.2/install/integration/threatprevention/threatprevention.md) – Threat Prevention can be configured
...
- [Netwrix Access Analyzer (formerly Enterprise Auditor) Integration](/docs/threatmanager/3.2/install/integration/accessanalyzer.md) – Access
