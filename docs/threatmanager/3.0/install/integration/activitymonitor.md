...
For Threat Manager to receive the event stream data, configure the Activity Monitor to do so. For file system activity events, use the Threat Manager Syslog template for the
