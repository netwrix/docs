...
![Contents of the NPS.zip file download](/images/privilegesecure/25.12/accessmanagement/install/npszip.webp)
...
[Troubleshooting](/docs/privilegesecure/25.12/install/troubleshooting.md) topic for additional information.
...
the service. See the [Action Service Install](/docs/privilegesecure/25.12/install/servicesonadditional/actionservice.md) topic for additional
information.
...
install the service. See the [Host Scan Service Install](/docs/privilegesecure/25.12/install/servicesonadditional/hostservice.md) topic for
...
on the sames server. See the [Netwrix Setup Launcher](/docs/privilegesecure/25.12/install/setuplauncher.md) topic for instructions. If
...
[Application Silent Installer Option](/docs/privilegesecure/25.12/install/silent.md) topic for additional information.

There is also a Browser Extension that can be installed for Privilege Secure users. See the
[Browser Extension App](/docs/privilegesecure/25.12/enduser/browserextension/browserextension.md) topic for additional
information.
