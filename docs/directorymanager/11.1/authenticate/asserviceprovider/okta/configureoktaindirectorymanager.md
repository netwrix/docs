...
4. Ensure the **Client** box displays the name of the Directory Manager client for which you
   ...
   application in Okta.
5. While creating the Directory Manager application in Okta, download a metadata file. See the
...
7. When Okta is configured with a Directory Manager client, it will be available on the login page
   of that client (the Wizard portal in their example) for single sign-on. You can choose to display
