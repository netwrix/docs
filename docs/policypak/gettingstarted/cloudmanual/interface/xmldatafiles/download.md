...
Getting PolicyPak Application Settings Manager up and going on-prem is beyond the
scope of this manual, but we can use the **PPAM: WinZip 14 and Later (Example) XML** data file as a
working example for this section. Because there is no in-cloud editor for PolicyPak
Application Settings Manager, to edit the policy you would need to do the following:

- Download the XML data file
- Import the file into the PolicyPak Application Settings Manager editor (for the
  WinZip AppSet)
...
![web_interface_and_controls_10_624x122](/images/policypak/cloud/interface/xmldatafiles/web_interface_and_controls_10_624x122.webp)

Then, in the corresponding on-prem MMC editor, you would click on **Import settings from XMLData
File**

![web_interface_and_controls_11_562x273](/images/policypak/cloud/interface/xmldatafiles/web_interface_and_controls_11_562x273.webp)
...
![web_interface_and_controls_12_562x337](/images/policypak/cloud/interface/xmldatafiles/web_interface_and_controls_12_562x337.webp)
