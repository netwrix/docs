...
dashboard displays the same information as the [Credentials Page](/docs/privilegesecure/26.03/admin/credentials/credentials.md).

![Credentials Dashboard Page](/images/privilegesecure/26.03/accessmanagement/admin/dashboard/credentials.png)
...
[Account Dependencies Window](/docs/privilegesecure/26.03/admin/credentials/accountdependencies.md) topic for
additional information.
- Rotate — Initiate credential rotation now. This button is only available
when the Method is Automatic managed. See the
[Scheduled Tasks Page](/docs/privilegesecure/26.03/admin/configuration/servicenodes/scheduledtasks.md) topic for additional information.
...
See the [Password History Window](/docs/privilegesecure/26.03/admin/credentials/passwordhistory.md) topic for
additional information.
...
for that platform type. See the [Platforms Page](/docs/privilegesecure/26.03/admin/platforms/overview.md) topic
...
Secure. See the [Service Accounts Page](/docs/privilegesecure/26.03/admin/configuration/serviceaccounts/serviceaccounts.md) section for
...
[Platforms Page](/docs/privilegesecure/26.03/admin/platforms/overview.md) topic for additional information on
