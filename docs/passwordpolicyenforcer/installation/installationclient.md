...
1. Run **Netwrix_PPE_Client_x64.msi** (64-bit) or **Netwrix_PPE_Client_x86.msi** (32-bit). The Setup wizard opens.

   ![Client Setup](/images/passwordpolicyenforcer/install/clientsetup1.webp)

2. Click **Next**.

   ![Client Setup](/images/passwordpolicyenforcer/install/clientsetup2.webp)

3. Review the End-User License Agreement, select the checkbox to accept the Agreement, then click
   **Next**.

   ![Client Setup](/images/passwordpolicyenforcer/install/clientsetup3.webp)

4. Click **Install**.

   ![Client Setup](/images/passwordpolicyenforcer/install/clientsetup4.webp)
...
```batch
msiexec /i Netwrix_PPE_Client_x64.msi /q
```
...
```batch
msiexec /x Netwrix_PPE_Client_x64.msi /q
```
