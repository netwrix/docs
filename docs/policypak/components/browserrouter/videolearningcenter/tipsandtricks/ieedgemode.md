---
title: "PolicyPak Browser Router: Internet Explorer in Edge mode"
description: "PolicyPak Browser Router: Internet Explorer in Edge mode"
sidebar_position: 80
---
# PolicyPak Browser Router: Internet Explorer in Edge mode

You've heard about Internet Explorer tabs tucked into Edge. But how can you quickly use Netwrix PolicyPak Browser Router to make it happen? Here you'll learn
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/yXL35FnSpqg" title="PolicyPak Browser Router: Internet Explorer in Edge mode" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video, we're going to talk about how to do Internet Explorer
in Edge mode using PolicyPak Browser Router. There's a lot of details in this video.
...
First and foremost, you need to have the latest PolicyPak client set extension
...
PolicyPak to IE, that's fine. You can go to www.policypak.com to Internet Explorer,
...
a PolicyPak thing. This is a Microsoft thing. This merging ability is something that's
built into Internet Explorer, and PolicyPak takes advantage of it, but again, it only
...
PolicyPak, for instance, so we're Googling for PolicyPak, that's fine,
but when you click on PolicyPak, bang, what should happen, it goes to Edge inside
...
That's not a PolicyPak function. That's an Internet Explorer function. That's just
showbiz.
