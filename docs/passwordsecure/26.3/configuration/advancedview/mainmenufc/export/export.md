...
automated [System tasks](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/extras/systemtasks/system_tasks.md) can extract information from
...
[Export wizard](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/export/export_wizard.md) because the export result is not separately secured
by a password.
...
The [HTML WebViewer export](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/export/html_webviewer_export.md) creates a HTML file
