---
title: "PolicyPak + FSLogix: Set default browser based upon if the browser is masked or revealed"
description: "PolicyPak + FSLogix: Set default browser based upon if the browser is masked or revealed"
sidebar_position: 40
---

# PolicyPak + FSLogix: Set default browser based upon if the browser is masked or revealed

Netwrix PolicyPak + FSLogix: Set default browser based upon if
the browser is masked or revealed.

<iframe width="560" height="315" src="https://www.youtube.com/embed/d-nhpXHv_IM" title="PolicyPak + FSLogix: Set default browser based upon if the browser is masked or revealed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
