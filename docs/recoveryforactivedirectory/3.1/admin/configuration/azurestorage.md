...
![Domains Page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/Domain.png)
...
![Add Domain Configuration wizard - Domain page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainAdd.png)
...
![Add Domain Configuration wizard - Backup Schedule page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainBackupSchedule.png)
...
![Add Domain Configuration wizard - Options page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainOptions.png)
...
![Add Domain Configuration wizard - Notification page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainNotification.png)
...
![Add Domain Configuration wizard - Confirm page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainConfirm.png)
...
![Edit Domain Configuration wizard - Domain page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainEdit1.png)
...
![Edit Domain Configuration wizard - Backup Schedule page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainEdit2.png)
...
![Edit Domain Configuration wizard - Options page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainEdit3.png)
...
:::note
The path must be a network share. Do not provide the path to a local drive for storing the backup.
:::

**Step 12 –** Click **Next**.

![Edit Domain Configuration wizard - Notification page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainEdit4.png)

**Step 13 –** To set notifications, select the Send email notifications check box and enter the
email address of one or more users and/or groups to receive the job start and end notifications. Use
a semicolon (;) to separate multiple recipients. See the [Notifications Page](/docs/recoveryforactivedirectory/3.1/admin/configuration/notifications.md) topic for additional information.

If notifications are not desired, skip this step.

![Edit Domain Configuration wizard - Confirm page](/images/recoveryforactivedirectory/3.1/IdentityImages_LatestDocs/Configuration/DomainEdit5.png)
