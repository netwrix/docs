...
([Setup and sync](/docs/passwordsecure/26.3/configuration/offlineclient/setup_and_sync.md)), the local copy of the server database will be
...
[Operation and setup](/docs/passwordsecure/26.3/configuration/servermanger/operation_and_setup_admin_client.md).
...
- The automatic login data entry can be performed via the
  [Autofill Add-on](/docs/passwordsecure/26.3/configuration/autofilladdon/autofill_add-on.md), independently of the Offline Add-on
...
[Seals](/docs/passwordsecure/26.3/configuration/advancedview/permissionconceptandprotective/protectivemechanisms/seals/seals.md)
