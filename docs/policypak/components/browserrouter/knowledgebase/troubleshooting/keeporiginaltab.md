...
turn it off in ALL ROUTES if you're having ANYNetwrix PolicyPak
Browser Router problems.

Problems which might arise are typically websites with "multiple tabs" like this:

![589_1_img-01_950x137](/images/policypak/troubleshooting/browserrouter/editpolicytemplate/589_1_img-01_950x137.webp)

In these cases, you would need to go through EACHPolicyPak Browser Router entry and
UN-check the Experimental flag checkbox.

Then you issues should be resolved.

![589_3_img-02_950x665](/images/policypak/troubleshooting/browserrouter/editpolicytemplate/589_3_img-02_950x665.webp)
