...
in the browser. See the [Log Into the Privilege Secure Console](/docs/privilegesecure/26.03/install/login.md) topic for
additional information.

![Browser Extension Interface](/images/privilegesecure/26.03/accessmanagement/enduser/browserextension/browserextensioninterface.webp)
...
access policies. See the [Access Policy Page](/docs/privilegesecure/26.03/admin/accesspolicy/accesspolicy.md) topic for
additional information.

![Browser Extension Activities tab](/images/privilegesecure/26.03/accessmanagement/enduser/browserextension/browserextensionactivities.webp)
...
[Start Web Session](/docs/privilegesecure/26.03/enduser/browserextension/interface/startwebsession.md) topic for additional information.
...
![Browser Extension Current tab](/images/privilegesecure/26.03/accessmanagement/enduser/browserextension/browserextensioncurrenttab.webp)
...
![Browser Extension Settings tab](/images/privilegesecure/26.03/accessmanagement/enduser/browserextension/browserextensionsettings.webp)
