...
| File Log Location                | If you selected to write logs to file, the CSV log files will be stored at this location.                                                                                                                               | The file log location is _C:\ProgramData\Netwrix Data Classification\Logs_. This cannot be manually changed.                                               |
| File Log Retention Period        | Number of days that file logs should be kept for before deletion (after last write).                                                                                                                 | To keep all logs (without automatic deletion), specify _0_ .                                               |
