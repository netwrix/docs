...
![Edit Rules window Variables tab](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/analysis/businessrules/variables.webp)
...
- To delete a variable, select it and click **Delete**
    ...
    ![JobVariables TSV file](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/analysis/businessrules/jobvariablestsv.webp)
