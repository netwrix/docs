...
Session recording lets you visually record of RDP and SSH sessions. These recordings
...
[Managing databases](/docs/passwordsecure/current/configuration/servermanager/managingdatabases/managing_databases.md)s.
