...
greatly depending on the content. The more that's done during the recorded session, the higher the
disk space usage.
...
recording process. Therefore, no recordings are lost even if the connection is terminated. They're
