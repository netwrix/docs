...
- Windows Server can be physical or virtual. See the
  [Virtual Environment Recommendations](/docs/threatprevention/8.1/requirements/application.md#virtual-environment-recommendations)topic for
  additional information.

:::info
As a best practice, Netwrix strongly recommends a dedicated database
server.
:::
...
[Restrict SQL Server Maximum Server Memory](/docs/threatprevention/8.1/troubleshooting/sqlserver.md) topic for additional
information.
:::
