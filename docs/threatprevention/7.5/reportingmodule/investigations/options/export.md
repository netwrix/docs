...
The Export option lets you export report results in a specified format. You can download, email, or schedule reports as desired.
...
Reports are downloaded to your local machine's Downloads folder, according to your browser settings. You can configure a folder on the application server to place copies of all exported
reports.
...
You can send the report data of an investigation as an attachment to an email. The attachment can be any of the file formats available for download.
...
**Step 6 –** Select the file format: CSV, PDF, or JSON.

**Step 7 –** Click **Send**. The Send as Email window closes and the recipients receive the report as an email attachment.
...
You can schedule to save the report data of an investigation to a shared folder. The file format can be any of the formats available for download.
...
`\{\{Investigation_Name\}\}`. The system replaces this variable with the name of the investigation.
...
- Timezone – This field opens a dropdown menu. Select a timezone.
