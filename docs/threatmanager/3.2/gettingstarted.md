...
See the [Integration with Other Netwrix Products](/docs/threatmanager/3.2/install/integration/overview.md) topic for additional
information.
...
[Netwrix Activity Monitor Integration](/docs/threatmanager/3.2/install/integration/activitymonitor.md) topic for additional
information.
...
- Activity Monitor – Monitored domain must be configured to stream data through the domain
  properties > Threat Manager tab
    - See the [Netwrix Activity Monitor Integration](/docs/threatmanager/3.2/install/integration/activitymonitor.md) topic for
...
- Threat Prevention – Threat Prevention Admin Console must be configured to stream data through the
  Threat Manager Event Sink feature
    - See the [Netwrix Threat Prevention Integration](/docs/threatmanager/3.2/install/integration/threatprevention/threatprevention.md) topic
...
complete. See the
[Netwrix Access Analyzer (formerly Enterprise Auditor) Integration](/docs/threatmanager/3.2/install/integration/accessanalyzer.md) topic
for additional information.
...
pages are located under the [Configuration Menu](/docs/threatmanager/3.2/administration/configuration/overview.md):

- The [Integrations Interface](/docs/threatmanager/3.2/administration/configuration/integrations/overview.md) provides the
  ability to add and configure external integrations for Threat Manager including:
    ...
    - [Entra ID Sync Page](/docs/threatmanager/3.2/administration/configuration/integrations/entraidsync.md)
    - [App Tokens Page](/docs/threatmanager/3.2/administration/configuration/integrations/apptoken.md)
    - [Authentication Provider Page](/docs/threatmanager/3.2/administration/configuration/integrations/page/page.md)
    - [Credential Profile Page](/docs/threatmanager/3.2/administration/configuration/integrations/credentialprofile.md)
    - [Email Page](/docs/threatmanager/3.2/administration/configuration/integrations/email.md)
    - [Folder Settings Page](/docs/threatmanager/3.2/administration/configuration/integrations/foldersettings.md)
