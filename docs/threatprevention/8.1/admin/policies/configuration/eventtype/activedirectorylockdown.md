...
- Classes area – The Add (+) buttons open the [Class List Window](/docs/threatprevention/8.1/admin/policies/configuration/eventtype/window/classlist.md).
- Attributes area – The Attributes Add (+) button opens the
  [Attribute List Window](/docs/threatprevention/8.1/admin/policies/configuration/eventtype/window/attributelist.md).
