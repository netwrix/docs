...
**Step 3 –** A notification appears to indicate that the session has ended. Click the **Close
...
closed, the Activity is automatically canceled if there are no remaining browser tabs for the
Activity. See the
