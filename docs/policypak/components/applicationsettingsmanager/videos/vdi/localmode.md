---
title: "PolicyPak and VMware Horizon View – Local Mode VDI"
description: "PolicyPak and VMware Horizon View – Local Mode VDI"
sidebar_position: 40
---
...
settings. With Netwrix PolicyPak in use with your VMware Local
Mode clients, you'll have the advatage.

PolicyPak ensures that your required IT settings are always adhered to, even when the
