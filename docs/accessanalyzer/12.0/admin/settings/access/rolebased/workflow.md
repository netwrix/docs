...
![Lock Job option in right-click menu](/img/product_docs/accessanalyzer/admin/settings/access/rolebased/lockjob.webp)
...
![Unlock Job option in right-click menu](/img/product_docs/accessanalyzer/admin/settings/access/rolebased/unlockjob.webp)
...
![Report under the Results Node in the Jobs Tree](/img/product_docs/accessanalyzer/admin/settings/access/rolebased/reportjobstree.webp)
