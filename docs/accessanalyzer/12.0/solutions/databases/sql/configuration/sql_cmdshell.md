...
`xp_cmdshell` lets users execute operating system commands when connected to the SQL or
the Azure SQL server, which attackers can use to launch malicious attacks. Microsoft recommends that the
