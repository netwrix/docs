...
| ---- | -------- | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| 80   | TCP/UDP  | Netwrix Auditor Server | For a full list of Microsoft Entra ID URLs, see the Microsoft support article: [Office 365 URLs and IP address ranges](https://support.office.com/en-us/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2) | login.windows.net graph.windows.net manage.office.com |
| 443  | TCP/UDP  | Netwrix Auditor Server | See the Microsoft support article [Office 365 URLs and IP address ranges](https://support.office.com/en-us/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2) for a full list of Microsoft Entra ID URLs | login.windows.net graph.windows.net manage.office.com |
