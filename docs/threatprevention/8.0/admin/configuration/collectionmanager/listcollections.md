...
[Collection Manager Window](/docs/threatprevention/8.0/admin/configuration/collectionmanager/overview.md). Then either double-click a Collection or select a
Collection and click the Manage button to open the List of Collections window.

![List of Collections window](/images/threatprevention/8.0/admin/configuration/collectionmanager/listofcollections.webp)
...
![Add New Collections window](/images/threatprevention/8.0/admin/configuration/collectionmanager/addnewcollection.webp)
...
- The _I want a list to come from the database table_ option button enables a dynamic collection.
  ...
  [Dynamic Collections](/docs/threatprevention/8.0/admin/configuration/collectionmanager/dynamic.md) topic for additional information.
...
click **OK**. See the [Selection Windows](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/window/overview.md) topic for
additional information.

![Select window](/images/threatprevention/8.0/admin/configuration/collectionmanager/selectadobjects.webp)
...
[Dynamic Collections](/docs/threatprevention/8.0/admin/configuration/collectionmanager/dynamic.md) topic for additional information. The Perpetrators and Lockdown
...
![Expand Groups option on the Add New Collection window](/images/threatprevention/8.0/admin/configuration/collectionmanager/expandgroups.webp)
...
![Edit Collection Window](/images/threatprevention/8.0/admin/configuration/collectionmanager/editcollection.webp)
...
![Confirm Removal window](/images/threatprevention/8.0/admin/configuration/collectionmanager/confirmremoval.webp)
...
![Collection Dependencies Window](/images/threatprevention/8.0/admin/configuration/collectionmanager/dependencies.webp)
