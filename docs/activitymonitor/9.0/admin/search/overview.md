...
![Search Tab](/images/activitymonitor/9.0/admin/search/searchtab.webp)
...
![Operations Filter Dropdown Menu](/images/activitymonitor/9.0/admin/search/operationssdropdownfiltermenu.webp)
...
![Sort Options](/images/activitymonitor/9.0/admin/search/sort.webp)
...
![Export Button](/images/activitymonitor/9.0/admin/search/exportbutton.webp)

After the search results are configured as desired, click the Export button located at the top left
