...
The Active sessions dashboard shows all active sessions. Create an Activity Session to
grant temporary privileges and gain access to the resources defined by a previously created Access
Policy. See the [Access Policy Page](/docs/privilegesecure/26.03/admin/accesspolicy/accesspolicy.md) topic for additional
information.

![Active Dashboard page](/images/privilegesecure/26.03/accessmanagement/admin/dashboard/active.png)
...
the [Install Remote Desktop Monitor Service on Target RDP Hosts](/docs/privilegesecure/26.03/install/servicesonadditional/rdpmonitor.md)
topic for additional information.

- Create Session — Open the Activity Request window. See the
[Create Activity Session](/docs/privilegesecure/26.03/enduser/dashboard/active/createsession.md) topic for additional
information.
...
[Session Logs Window](/docs/privilegesecure/26.03/admin/dashboard/historical/sessionlogs.md) topic for additional information.
- Lock Activity — Opens the Lock Session window to prevent the user from interacting with the host
but keeps the session active. See the [Lock Session](/docs/privilegesecure/26.03/admin/dashboard/active/locksession.md) topic for additional
information.
...
another user. See the [Live Session Viewer Window](/docs/privilegesecure/26.03/admin/dashboard/active/liveviewer.md) topic for additional
information.
...
watch a replay of the remote session. See the [Replay Viewer Window](/docs/privilegesecure/26.03/admin/dashboard/historical/replayviewer.md)
topic for additional information.
...
[Lock Session](/docs/privilegesecure/26.03/admin/dashboard/active/locksession.md) topic for additional information.
...
[User, Group, & Application Details Page](/docs/privilegesecure/26.03/admin/usersgroups/usergroupapplication/usergroupapplication.md) topic
for additional information.
- Host — Resource that the user run the activity on. Click the link to view additional
...
- [Secret Vault Details Page](/docs/privilegesecure/26.03/admin/resources/detailspages/secretvault.md)
