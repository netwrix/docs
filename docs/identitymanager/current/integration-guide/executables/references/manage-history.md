...
## Arguments
 ...
 | --- | --- | --- | 
 | <b>--clean-duplicates</b> optional | No Value | Removes duplicate historical data. | 
 | --entity-type required if --excluded-resource-columns is set | String | When using `<b>--clean-duplicates</b>` option, defines the entity type (Id or Identifier) that should have its duplicates removed from the `UR_Resources` table. | 
