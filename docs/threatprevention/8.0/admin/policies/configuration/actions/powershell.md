...
![addactionwindowforpowershell](/images/threatprevention/8.0/admin/policies/actions/addactionwindowforpowershell.webp)
...
![Script Editor for PowerShell Scripts](/images/threatprevention/8.0/admin/policies/actions/scripteditorforps.webp)

**Step 4 –** Create or copy/paste the custom script in the Threat Prevention Script Editor. See the
[Threat Prevention Script Editor Tools](/docs/threatprevention/8.0/admin/policies/configuration/actions/netscript.md#threat-prevention-script-editor-tools) topic
...
![Actions tab – PowerShell 4.0 Action Created](/images/threatprevention/8.0/admin/policies/actions/powershellaction.webp)
