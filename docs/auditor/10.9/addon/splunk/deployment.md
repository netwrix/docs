...
See the
[Configure Integration API Settings](/docs/auditor/10.9/api/prerequisites.md#configure-integration-api-settings)[Audit Database](/docs/auditor/10.9/admin/settings/auditdatabase.md)topic
