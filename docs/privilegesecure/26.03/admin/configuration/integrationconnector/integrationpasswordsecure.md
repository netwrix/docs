...
![Password Secure API Key Step 1](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/ps-api-step1.webp)

![Password Secure API Key Step 2](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/ps-api-step2.webp)

**Step 3** - Click **Create a new API key**.

![Password Secure API Key Step 3](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/ps-api-step3.webp)
...
![Password Secure API Key Step 4](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/ps-api-step4.webp)
...
![Password Secure AD User Step 2](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/ps-aduser-step2.webp)
...
![Password Secure AD User Step 3](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/ps-aduser-step3.webp)

![Password Secure AD User Step 4](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/ps-aduser-step4.webp)
...
![NPS Service Account](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/nps-serviceaccount.webp)
...
![NPS Connector Details](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/nps-connector-details.webp)

![NPS Connector Advanced](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/nps-connector-advanced.webp)
...
![NPS Activity Config](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/nps-activity-config.webp)

![NPS Activity Details](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/nps-activity-details.webp)
...
**Step 2** - Click the **Plus** icon and create a new Policy. See the [Add Access Policy](/docs/privilegesecure/26_03/admin/accesspolicy/addaccesspolicy) topic for additional information.
...
- **Users:** Assign users to the policy. See the [Users Tab for Resource Based Access Policies](/docs/privilegesecure/26_03/admin/accesspolicy/resourcebasedpolicyt/resourcebasedpolicy) topic for additional information.

![NPS Policy Config](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/nps-policy-config.webp)

- **Activity:** Add the activity you created for the Password Secure connector. See the [Activities Tab for Resource Based Access Policies](/docs/privilegesecure/26_03/admin/accesspolicy/resourcebasedpolicyt/resourcebasedpolicy) topic for additional information.

![NPS Policy Resources](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/nps-policy-resources.webp)

- **Resources:** Add resources for this Activity. See the [Resources Tab for Resource Based Access Policies](/docs/privilegesecure/26_03/admin/accesspolicy/resourcebasedpolicyt/resourcebasedpolicy) topic for additional information.
...
![Password Secure Vault Diagram](/images/privilegesecure/26.03/accessmanagement/admin/configuration/integrationdetails/ps-vault-diagram.webp)
