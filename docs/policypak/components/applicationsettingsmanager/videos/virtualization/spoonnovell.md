---
title: "PolicyPak extends Group Policy to Spoon / Novell ZENworks App Virtualization"
description: "PolicyPak extends Group Policy to Spoon / Novell ZENworks App Virtualization"
sidebar_position: 60
---
# PolicyPak extends Group Policy to Spoon / Novell ZENworks App Virtualization
...
And PolicyPak works with your real applications and your virtualized applications.

You can use one of our preconfigured Paks for lots of common applications like Firefox, Lync,
Acrobat, Java, Flash, Office and more. Or, you can use our PolicyPak DesignStudio and
create your own PolicyPaks for your own applications.

There's nothing extra to buy – this functionality is _all_included when you're a PolicyPak Professional customer.
