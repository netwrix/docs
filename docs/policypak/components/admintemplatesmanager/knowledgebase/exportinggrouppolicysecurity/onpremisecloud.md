---
title: "Why do I sometimes see PolicyPak Cloud security settings and sometimes see on-prem GPO security settings?"
description: "Why do I sometimes see PolicyPak Cloud security settings and sometimes see on-prem GPO security settings?"
sidebar_position: 30
---

# Why do I sometimes see PolicyPak Cloud security settings and sometimes see on-prem GPO security settings?
...
delivery methods: Group Policy and Netwrix PolicyPak Cloud, for
instance.

To illustrate this point let's assume you have a Domain-Joined computer that also receives a
Security Settings policy via PolicyPak Cloud (PPC). Then from the domain-based GPO you
...
![698_1_image-20200511225437-1](/images/policypak/troubleshooting/gpoexport/698_1_image-20200511225437-1.webp)

When PolicyPak Cloud settings are applied (PPCloud /sync, ppupdate etc.) the computer
will receive these settings below, note that there is nothing defined for "Enforce password history"
within the PPC policy.

![698_3_image-20200511225437-2](/images/policypak/troubleshooting/gpoexport/698_3_image-20200511225437-2.webp)
