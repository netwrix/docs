...
purpose. It's possible to print out records such as e.g. passwords or also information about
...
Firstly, it's necessary to select whether you want to print a table or a detailed view. The amount
...
They're printed out – as described above – in table form.
