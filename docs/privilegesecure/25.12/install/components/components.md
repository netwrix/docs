...
- The Extras folder – Contains additional standalone installers:
    ...
    - Enablement Toolkit.exe – Installs a utility that offers a GUI for common testing scenarios
      ...
      [Troubleshooting](/docs/privilegesecure/25.12/admin/troubleshooting.md) topic for additional information.
...
on the sames server. See the [Netwrix Setup Launcher](/docs/privilegesecure/25.12/install/components/setuplauncher.md) topic for instructions. If
...
[Application Silent Installer Option](/docs/privilegesecure/25.12/install/components/silent.md) topic for additional information.
