...
The AD_LargestGroups Job identifies groups with large effective member counts. These groups can
make it hard to determine who has access to resources or how much access these groups grant.
