...
| CommentActivationOnRequest default value: Inherited           | **Type** CommentActivationOnRequest **Description** Indicates if a comment is enabled when a role request. `0` - Disabled. `1` - Optional. `2` - Required. `3` - Inherited: comment activation in the associated policy.                                                                                                                                                                                                                                       |
