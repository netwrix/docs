...
![Navigation Options in the Recovery Console](/images/identityrecovery/2.6/admin/navigation.webp)
...
- User Profile – On clicking the profile icon, the following options are displayed:
    ...
    - Manage – Click it to open the MFA page, where you can set up multi-factor authentication for
      ...
      [Configure Multi-Factor Authentication](/docs/identityrecovery/2.6/admin/configuremfa.md) topic for additional information.
...
- [Active Directory Page](/docs/identityrecovery/2.6/admin/activedirectory/overview.md) – The Active Directory page lists the domains
  configured in Recovery for Active Directory. You can perform object rollback and recovery
  operations on this page.
- [Forest Page](/docs/identityrecovery/2.6/admin/forest/forest.md) – The Forest page displays your Active Directory forest with its
...
- [Audit Logs Page](/docs/identityrecovery/2.6/admin/audit.md) – The Audit Logs page provides an audit trail of the actions performed
  by users in Recovery for Active Directory.
- [Configuration Interface](/docs/identityrecovery/2.6/admin/configuration/overview.md) – The Configuration interface provides access
  ...
  licensing for Recovery for Active Directory.
    ...
    - [Domains Page](/docs/identityrecovery/2.6/admin/configuration/domain.md) – The Domains page provides a list of the domains
    ...
    - [Users and Roles Page](/docs/identityrecovery/2.6/admin/configuration/roles.md) – The Users and Roles page displays the
      accounts with access to Recovery for Active Directory.
    - [Notifications Page](/docs/identityrecovery/2.6/admin/configuration/notifications.md) – The Notifications page allows the
      configuration of notifications, which is required for sending an email when a collection
      (backup) job is completed.
    - [Netwrix Integrations Page](/docs/identityrecovery/2.6/admin/configuration/integration.md) – The Netwrix Integrations page
    ...
    - [Data Retention Policy Page](/docs/identityrecovery/2.6/admin/configuration/dataretention.md) – The Data Retention Policy page
    ...
    - [Licensing Page](/docs/identityrecovery/2.6/admin/configuration/licensing.md) – The Licensing page provides an overview of the
