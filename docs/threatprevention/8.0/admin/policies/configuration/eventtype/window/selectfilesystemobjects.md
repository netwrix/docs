...
![Select File System Objects Window](/images/threatprevention/8.0/admin/policies/eventtype/window/filesystemobjects.webp)
...
See the [Selection Windows](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/window/overview.md) topic for additional information.
...
![Select File System Objects Window - NAS Device added](/images/threatprevention/8.0/admin/policies/eventtype/window/filesystemobjectsnas.webp)

For NAS monitoring, the selected Agent needs to be deployed to a Windows server acting as a proxy
server for NAS activity. If the correct Agent is selected, the IP addresses of the NAS devices
