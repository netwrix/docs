...
[Notifications](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/notifications.md), reports also contain
...
[List view](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/list_view.md), there are currently three
