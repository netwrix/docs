...
As a reminder, PolicyPak Cloud is made up of components, such as PolicyPak Application Settings Manager, PolicyPak Least Privilege Manager, etc., which
...
**Base Products**. On this screen you can see how many PolicyPak Cloud licenses you
...
![web_interface_and_controls_1_624x138](/images/policypak/cloud/interface/web_interface_and_controls_1_624x138.webp)

When you click the number in the **Consumed** column, you can see the computers which are actively
taking on a PolicyPak Cloud license. You can then determine the first and last check
...
![web_interface_and_controls_2_624x190](/images/policypak/cloud/interface/web_interface_and_controls_2_624x190.webp)
...
![web_interface_and_controls_3_624x247](/images/policypak/cloud/interface/web_interface_and_controls_3_624x247.webp)

Computers may transition from a licensed state of **consumed** to a state of **waiting**. The
PolicyPak Cloud waiting list is used to describe two conditions:
...
PolicyPak Cloud service. After about 14 days, the computers will lose their licenses
...
![web_interface_and_controls_4_625x326](/images/policypak/cloud/interface/web_interface_and_controls_4_625x326.webp)
