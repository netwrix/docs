...
>       **See in your Jira Account in the Connected Tab in Netwrix Salesforce Forge**
...
2. Click **Push** to create the Change Request if you aren't using the
   [Automatic Synchronization](/docs/platgovsalesforce/integrations/jiraintegrationForge/jira_integration_forge.md) feature. The change request is created in
