...
won't be added. This happens because the Membership Life Cycle job didn't run on the particular
days for temporary membership update.

**Add**

To add members to the group, click **Add**. Enter a search string to locate the object to add as a
