...
- [FS_ResourceBasedGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/resourcebasedgroups/fs_resourcebasedgroups.md)
  – This job will transform permission on specified folders to a resource based groups model
- [FS_TraverseGroups Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/resourcebasedgroups/fs_traversegroups.md)
...
- [FS_ResourceBasedGroupAICImport Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/filesystem/resourcebasedgroups/fs_resourcebasedgroupaicimport.md)
...
[Schedule Jobs](/docs/accessanalyzer/11.6/accessanalyzer/admin/schedule/overview.md#schedule-jobs)
topic for additional information.
