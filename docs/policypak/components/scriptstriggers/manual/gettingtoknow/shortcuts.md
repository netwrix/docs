...
:::note
For some video overviews of PolicyPak Scripts & Triggers Manager, see
...
![getting_to_know_scripts_triggers_3](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_3.webp)

Figure 7. Using Group Policy to create and link a GPO to East Sales Users.

**Step 2 –** Edit the GPO, then go to User Configuration | PolicyPak | Scripts &
Triggers Manager as shown in Figure 8 and select Add | New Policy.

![getting_to_know_scripts_triggers_4](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_4.webp)

Figure 8. Using the Group Policy Editor to make a new PolicyPak Scripts & Triggers
Manager policy.

**Step 3 –** When you do this, the PolicyPak Scripts & Triggers Manager Wizard
...
![getting_to_know_scripts_triggers_5](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_5.webp)

Figure 9. Using PolicyPak Scripts & Trigger Manager to deliver a PowerShell script.
...
![getting_to_know_scripts_triggers_6](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_6.webp)
...
![getting_to_know_scripts_triggers_7](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_7.webp)
...
- Always: Will apply every time a policy processes.
  ...
  - For PolicyPak Cloud, this is every 60 minutes. (If you can see the PolicyPak Cloud service.)
  - For PolicyPak + MDM, this will apply user policies on login and on the computer
    side. "Switched" policies, explained later, should apply when the PolicyPak
...
![getting_to_know_scripts_triggers_8](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_8.webp)

Figure 12. PolicyPak Scripts & Triggers Manager Wizard final settings page.

The result of the policy you created can be seen in an entry like the one shown in Figure 13.

![getting_to_know_scripts_triggers_9](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_9.webp)

Figure 13. The new PolicyPak scripts policy in the Group Policy Editor.
...
![getting_to_know_scripts_triggers_10](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_10.webp)

Figure 14. PolicyPak Scripts & Triggers Manager items appear in the GPMC reports.
...
![getting_to_know_scripts_triggers_11](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_11.webp)

Figure 15. An example of a PolicyPak Scripts & Triggers Manager PowerShell script on
the endpoint.

**Step 9 –** To complete testing, go back to the GPMC, and un-link the GPO to make it stop applying,
as seen in Figure 16.

![getting_to_know_scripts_triggers_12](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_12.webp)
...
When you do, the "Off" script will run and the "Visit PolicyPak" icon will disappear.
