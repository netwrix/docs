---
title: "PolicyPak: Manage GoToMeeting using Group Policy, SCCM or your own management utility"
description: "PolicyPak: Manage GoToMeeting using Group Policy, SCCM or your own management utility"
sidebar_position: 100
---

# PolicyPak: Manage GoToMeeting using Group Policy, SCCM or your own management utility

Using Netwrix PolicyPak the sales team can deliver, enforce, and
lock down GoToMeeting settings. PolicyPak ensures your users' applications settings,
so that they get the right experience, every time they launch it. Keep your GoToMeeting
configuration settings enforced with PolicyPak. Check out this video to see how it is
done.
