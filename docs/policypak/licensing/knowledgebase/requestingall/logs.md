...
If you are having problems with the MMC editor (or other .NET Tools like the Netwrix PolicyPak License Tool) you will need to go to `%appdata%\local\PolicyPak`
...
- General and
- PolicyPak License Tool.

If you had an issue, with say, PolicyPak Least Privilege Manager editor, then you
would supply:
...
![182_1_1_950x786](/images/policypak/troubleshooting/license/182_1_1_950x786.webp)
