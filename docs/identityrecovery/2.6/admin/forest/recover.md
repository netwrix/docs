...
See the [Forest Page](/docs/identityrecovery/2.6/admin/forest/forest.md) topic for additional information.
...
- **Step 1 –** Prepare an isolated environment to restore the forest to.
    ...
    See the [Target Server Considerations](/docs/identityrecovery/2.6/requirements/targetserver.md) topic to understand
...
![Add to Recovery Playbook wizard - Domain Controller page](/images/identityrecovery/2.6/admin/forest/domaincontroller.webp)
...
See the
[Target Server and Operating System Requirements](/docs/identityrecovery/2.6/requirements/targetserver.md#target-server-and-operating-system-requirements)
topic for additional information.

**Step 5 –** Click **Next**.

![Add to Recovery Playbook wizard - Options page](/images/identityrecovery/2.6/admin/forest/options_1.webp)
...
![Add to Recovery Playbook wizard - Confirm page](/images/identityrecovery/2.6/admin/forest/confirm_1.webp)
...
![Recovery Playbook created on the Forest Page](/images/identityrecovery/2.6/admin/forest/recoveryplaybook.webp)
...
![Forest page showing a restored forest](/images/identityrecovery/2.6/admin/forest/forestrecovered.webp)
