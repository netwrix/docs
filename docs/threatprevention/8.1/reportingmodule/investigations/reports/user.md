...
Details and Top Resources sections (see the [Investigation Reports](/docs/threatprevention/8.1/reportingmodule/investigations/reports/reports.md) topic). Click a link
to land on the User Details page.

![userdetails](/images/threatprevention/8.1/reportingmodule/investigations/userdetails.webp)
