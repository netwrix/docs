...
policies see [Policy Templates ](/docs/passwordpolicyenforcer/evaluation/creating-a-password-policy/policy_templates.md).
...
![Make the policy the default](/images/passwordpolicyenforcer/evaluation/evaldefault.webp)
