...
<iframe width="560" height="315" src="https://www.youtube.com/embed/JR3r_i7scrg" title="PolicyPak Device Manager: Block and Allow USB and CD-ROMs with your MDM solution" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video, I'm going to show you how you can use Netwrix PolicyPak Device Manager to enable and restrict USB sticks using your MDM
service and PolicyPak. How do you do that? This machine is MDM enrolled. You could be
...
style that PolicyPak can deliver, which is enable specific users to use specifically
...
I've got it exported, the next step is to use our PolicyPak exporter tool.
...
we go. It's being managed by PolicyPak Device Manager. Read, write, and execute, no.
...
only available to you with PolicyPak. There you go. I hope this helps you out. Looking
forward to getting you started with PolicyPak and your MDM service real soon. Thanks
so much.
