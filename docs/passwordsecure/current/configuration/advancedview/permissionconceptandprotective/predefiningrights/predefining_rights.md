...
([Roles](/docs/passwordsecure/current/configuration/advancedview/clientmodule/roles.md)) have been defined within this IT department:
...
[Manual setting of permissions](/docs/passwordsecure/current/configuration/advancedview/permissionconceptandprotective/manualsettingofpermissions/manual_setting_of_permissions.md).
...
[Tags](/docs/passwordsecure/current/configuration/advancedview/operationandsetup/tags.md) for records.
