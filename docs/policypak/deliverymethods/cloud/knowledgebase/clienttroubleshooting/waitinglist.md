---
title: "PolicyPak Cloud Client: Why are computers appearing in WAITING LIST and how can I fix it?"
description: "PolicyPak Cloud Client: Why are computers appearing in WAITING LIST and how can I fix it?"
sidebar_position: 120
---

# PolicyPak Cloud Client: Why are computers appearing in WAITING LIST and how can I fix it?

The Netwrix PolicyPak Cloud WAITING LIST is used to describe TWO
conditions:
...
PolicyPak Cloud Service. Again, after about 14 days, a computer loses its license and
...
![382_1_ppcloud-status1-300x88](/images/policypak/troubleshooting/cloud/382_1_ppcloud-status1-300x88.webp)
