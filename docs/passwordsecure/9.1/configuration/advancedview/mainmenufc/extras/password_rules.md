...
It's generally recommended that passwords should consist of at least 12 different characters, be
...
- **Categories:** A password can consist of a total of four categories. It's possible to define
  which of these categories to use and also how many of them to use.
- **Forbidden characters**: It's also possible to exclude some special characters. These characters
...
way, it's possible to ensure that the required level of complexity is maintained for certain
passwords.
...
If one of these password rules is defined for a form, it's only possible to define a new random
