...
| Database Growth Statistics               | This report displays the top 10 Databases that grew over the last 30 days in pure MB. This report filters on the Rank column for the top 10 results, but you can modify it to show a different top number.                                                                                        | None         | This report is comprised of four elements: <ul><li>Stacked Bar Chart – Displays store size growth</li><li>Stacked Bar Chart – Displays WhiteSpace growth</li><li>Table – Provides details on store size growth</li><li>Table – Provides details on WhiteSpace growth</li></ul> |
