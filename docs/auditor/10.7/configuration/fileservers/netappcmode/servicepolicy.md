...
For older NetApp ONTAP versions use [System Service Firewall Policies](https://github.com/netwrix/docs/blob/update-docs-na-fsa-netapp/docs/auditor/10.7/configuration/fileservers/netappcmode/servicepolicy.md#configure-system-service-firewall-policies) instead.
