...
- IPv4 or IPv6 allowlist – Specify the IP addresses of Nutanix nodes that are allowed to
  ...
  semicolon (;), or on separate lines. Leave the box blank to accept connections from any hosts.
    ...
    :::note
    This setting is optional. Use it to improve security by limiting the number
