...
(cytray.exe) with the Netwrix PolicyPak CSE installed, you will
...
![23_1_image](/images/policypak/troubleshooting/applicationsettings/280_1_image-20191015113622-1.webp)

![23_2_image](/images/policypak/troubleshooting/error/applicationsettings/23_2_image.webp)

This is a problem with Microsoft Remote Assistance (MSRA) and/or Palo Alto Cortex XDR Tray Process
(cytray.exe) on Windows 10 1903 and later and also on Windows 11 when the PolicyPakCSE
is installed.
...
PolicyPakAppLock is the feature in PP App Manager which GRAYS or HIDES UI elements.

:::note
PolicyPak AppLock is NOT related to Microsoft AppLocker.
:::
...
:::note
IIn general it is NOT recommended to stop PolicyPak AppLock.
:::
...
Optional: FoFor Workaround 2 you can use PolicyPakScripts Manager to apply these
