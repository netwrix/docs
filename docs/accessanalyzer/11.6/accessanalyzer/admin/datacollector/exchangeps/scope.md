...
- No Scoping Target Host: Local Host – Returns all results for the entire targeted Exchange
  Organization
    ...
    - If this option is selected, then the data collector should be run against the host specified
      ...
      [ExchangePS: Summary](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangeps/summary.md) topic
...
- Scope by Database Target Host: Local Host – Scope query to return results for specific databases.
  ...
  [ExchangePS: Scope by DB](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangeps/scopedatabases.md) topic
  for additional information.
- Scope by Mailbox Target Host: Local Host – Scope query to return results for specific mailboxes.
  ...
  [ExchangePS: Scope by Mailboxes](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangeps/scopemailboxes.md) topic
  for additional information.
- Scope by Server Target Host: Exchange MB Server – Scope query to return results for specific
  servers selected in the job’s **Configure** > **Hosts** node
    ...
    - For Remote PowerShell, the data collector does not deploy anapplet and utilizes the WinRM
      ...
      [Remote PowerShell](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangeps/overview.md#remote-powershell)
      and
      [The Exchange Applet](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangeps/overview.md#the-exchange-applet)
...
- Scope by Public Folder – Scope query to return results for specific Public Folders. If this option
  ...
  [ExchangePS: Scope by Public Folders](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangeps/scopepublicfolders.md) topic
  for additional information.
