---
title: "PolicyPak Admin Templates Manager: Switched Policies (without Loopback)"
description: "PolicyPak Admin Templates Manager: Switched Policies (without Loopback)"
sidebar_position: 20
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/GRJBVV7yr8U" title="PolicyPak Admin Templates Manager: Switched Policies (without Loopback)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Let's use PolicyPak's Admin Template Manager to put the loopback issue to rest once
...
Over here on the computer side, we're going to go to PolicyPak and then Admin
