---
title: "Are there any special PolicyPak licensing issues for virtual desktops?"
description: "Are there any special PolicyPak licensing issues for virtual desktops?"
sidebar_position: 50
---
...
- Session Based / Citrix Shared machines can only be licensed when the customer is Netwrix PolicyPak Enterprise Edition or PolicyPak Professional
...
- However, full VDI single-session desktops are licensed in the same manner as physical desktops.
  ...
  account in Active Directory, and it's active, it counts your PolicyPak licensing. In
  this case you may use it with PolicyPak SaaS / Cloud.
