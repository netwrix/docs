...
![Analysis Tasks for the Db2 _EffectivePermissions Job](/img/product_docs/accessanalyzer/12.0/solutions/databases/db2/permissions/effectivepermissionsanalysis.webp)
