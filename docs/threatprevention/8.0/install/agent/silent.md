...
You can use command line options to install the Agent silently. Use these options to deploy the
Agent via custom batch files, login scripts, or for integrating with third-party software
