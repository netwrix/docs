...
- Supply the information contained within this KB article What must I send to PolicyPak support in order to get the FASTEST support?.
- Screenshots or a video of the problem (if there's something to see). Use an application like
  ScreenShot Pilot (What must I send to PolicyPak support in order to get the FASTEST
  support?) or Jing
