...
See the
[Device Manager Admin Approval and Automatic Rules Creation](/docs/policypak/components/devicemanager/videolearningcenter/gettingstarted/dmapprovalautorules.md)
...
- The PolicyPak Device Manager policies, which establish Admin Approval and its secret
  key
- Securing the secret key (if using Group Policy method)
- The PolicyPak Device Privilege Manager Admin Approval Tool
...
![aa15](/images/policypak/device/devicemanager/aa15.webp)
...
- General
  ...
  - Secure Desktop — PolicyPak Admin Approval Dialog will present itself by default
...
- Misc
  ...
  - Custom Message — Optional message to customers about what to do, who to call, what is
    permitted etc, to override the default PolicyPak Device Manager behavior.

![aa14](/images/policypak/device/devicemanager/aa14.webp)
...
![aa4](/images/policypak/device/devicemanager/aa4.webp)
...
![aa3](/images/policypak/device/devicemanager/aa3.webp)
...
pre-installed whenever the PolicyPak Admin Console MSI is installed. Its also
available as a standalone portable application and found in the PolicyPak Extras
folder in the download.

![aa5](/images/policypak/device/devicemanager/aa5.webp)
...
![aa6](/images/policypak/device/devicemanager/aa6.webp)
...
![aa7](/images/policypak/device/devicemanager/aa7.webp)
...
![aa8](/images/policypak/device/devicemanager/aa8.webp)
...
- Or on a single machine you may erase the value for the device you granted Permanent access to. See
  the
  [What are the registry settings for Device Manager (and how do I reset Device Manager Admin Approval)?](../../knowledgebase/troubleshooting.md)
...
[PolicyPak Device Manager and End-User Emails to Support](/docs/policypak/components/devicemanager/videolearningcenter/gettingstarted/enduser.md) topic
...
## ![aa9](/images/policypak/device/devicemanager/aa9.webp)
...
![aa10](/images/policypak/device/devicemanager/aa10.webp)
...
use permanently and deliver using Group Policy, MDM or PolicyPak Cloud.
...
![aa11](/images/policypak/device/devicemanager/aa11.webp)

In the Wizard you can use the default settings or change the Members and Permissions.

Finally, save your XML and import it into the MMC editor as a policy or use with PolicyPak Exporter or PolicyPak Cloud.

![aa12](/images/policypak/device/devicemanager/aa12.webp)
...
![aa13](/images/policypak/device/devicemanager/aa13.webp)

## Make a Rule Directly from an Event on the Endpoint

You can take Event IDs generated from PolicyPak Device Manager, such as this and use
it as the basis to start a rule.

![event1](/images/policypak/device/devicemanager/event1.webp)

# ![event2](/images/policypak/device/devicemanager/event2.webp)
