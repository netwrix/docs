---
title: "PolicyPak File Associations Manager: Manage Windows 10 & 11 File Associations"
description: "PolicyPak File Associations Manager: Manage Windows 10 & 11 File Associations"
sidebar_position: 10
---
# PolicyPak File Associations Manager: Manage Windows 10 & 11 File Associations

Windows 10 File Associations shouldn't be done via XML file. That's a total waste of time, and
doesn't help you out when your needs change. Instead, use PolicyPak File Associations
...
Hi, this is Jeremy Moskowitz, Founder and CTO of PolicyPak Software, and in this video
...
What we're going to say is everybody on this computer – we'll go to PolicyPak, File
...
let's go over to User Side, PolicyPak. We'll go over to File Associations Manager, and
...
We'll go over to User Side, PolicyPak, File Associations Manager again. Right-click
...
In this way, we can use File Associations Manager from PolicyPak on both the computer
