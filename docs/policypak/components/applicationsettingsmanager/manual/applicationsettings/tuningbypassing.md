...
PolicyPak Application Settings Manager will process both internal Item-Level Targeting
...
- Timeout. Sometimes processing `ILT `operations can take longer than desired. If the
  ...
  assumed to be True. If the value was previously determined, PolicyPak Application
...
- Lifetime. Every time a Pak is applied (or you launch an application), the ILTs (both internal and
  ...
  the ILT processing again and again, PolicyPak Application Settings Manager uses the
...
![troubleshooting_policypak_6](/images/policypak/troubleshooting/applicationsettings/itemleveltargeting/troubleshooting_endpointpolicymanager_6.webp)
