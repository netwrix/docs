...
the Nasuni Edge Appliance. After the API Key has been generated, configure and enable
...
**Step 3 –** From the Filer dropdown menu, select the Nasuni Edge Appliance you want to configure. Then enter a
