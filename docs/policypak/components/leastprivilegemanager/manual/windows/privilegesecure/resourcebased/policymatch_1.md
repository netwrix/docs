...
![resource_based_policy_match](/images/policypak/integration/privilegesecure/resourcebased/resource_based_policy_match.webp)

Here on the Netwrix Privilege Secure server, locate the Policy and verify that the name is an exact
match.

![resource_based_policy_match_1](/images/policypak/integration/privilegesecure/resourcebased/resource_based_policy_match_1.webp)

Then, to match a specific process configure the PolicyPak Least Privilege Manager
policy as a Combo rule:

- Path condition: %SYSTEMROOT%\System32\mmc.exe
- Command-line condition: Strict Equality for dsa.msc

![resource_based_policy_match_2](/images/policypak/integration/privilegesecure/resourcebased/resource_based_policy_match_2.webp)

Now whenever mmc.exe dsa.msc is run from the command line, PolicyPak Least Privilege
...
![resource_based_policy_match_3](/images/policypak/integration/privilegesecure/resourcebased/resource_based_policy_match_3.webp)

The result is that a new Domain Admin account is created for this one session and deleted after use.

![resource_based_policy_match_4](/images/policypak/integration/privilegesecure/resourcebased/resource_based_policy_match_4.webp)
