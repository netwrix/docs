...
Use the TSV log file format to send SharePoint activity monitoring data to Access Analyzer v10.0 and earlier consoles. The following lists all columns that SharePoint Activity Monitor generates into a TSV log file:
