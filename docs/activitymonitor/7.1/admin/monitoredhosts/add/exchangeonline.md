...
The added Exchange Online host is displayed in the monitored hosts table. After you add a host
for monitoring, configure the outputs you want to use. See the
