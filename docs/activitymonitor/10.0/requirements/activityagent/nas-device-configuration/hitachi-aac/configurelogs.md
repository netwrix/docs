...
[Configure Access to HNAS Audit Logs on Activity Agent Server](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/hitachi-aac/configureaccesstologs.md) topic for
