...
same information as the [Users & Groups Page](/docs/privilegesecure/26.03/admin/usersgroups/usersgroups.md).

![Users Dashboard Page](/images/privilegesecure/26.03/accessmanagement/admin/dashboard/usersdashboard.webp)
...
[Add Application](/docs/privilegesecure/26.03/admin/usersgroups/add/application.md) topic for additional information.
