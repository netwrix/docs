...
- [Box_FileMetrics Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/box/content/box_filemetrics.md)
...
- [Box_FolderMetrics Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/box/content/box_foldermetrics.md)
