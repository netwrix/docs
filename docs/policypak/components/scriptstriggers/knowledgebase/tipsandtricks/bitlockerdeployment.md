---
title: "How do I automate BitLocker deployment for my enterprise with Group Policy and PolicyPak?"
description: "How do I automate BitLocker deployment for my enterprise with Group Policy and PolicyPak?"
sidebar_position: 90
---

# How do I automate BitLocker deployment for my enterprise with Group Policy and PolicyPak?
...
Netwrix PolicyPak can automate the entire process with one GPO.
...
![66_1_image-20200725154035-1](/images/policypak/scriptstriggers/66_1_image-20200725154035-1.webp)
...
![66_3_image-20200725154035-2_626x151](/images/policypak/scriptstriggers/66_3_image-20200725154035-2_626x151.webp)
...
4. Click OK
   ...
   ![66_5_image-20200725154035-3_493x143](/images/policypak/scriptstriggers/66_5_image-20200725154035-3_493x143.webp)
...
3. Click OK
   ...
   ![66_7_image-20200725154035-4](/images/policypak/scriptstriggers/66_7_image-20200725154035-4.webp)

**Step 10 –** Click CLOSE

![66_9_image-20200725154035-5](/images/policypak/scriptstriggers/66_9_image-20200725154035-5.webp)
...
**Step 11 –** Still under PolicyPak, click on Scripts Manager
...
2. Select "Apply this policy to computer (default) and click NEXT
   ...
   ![66_11_image-20200725154035-6_489x65](/images/policypak/scriptstriggers/66_11_image-20200725154035-6_489x65.webp)
...
3. Configure "On apply action"
   ...
   1. On the dropdown that says "(None)", select "Batch Script" and type in the following text
      ...
      ![66_13_image-20200814161653-2](/images/policypak/scriptstriggers/66_13_image-20200814161653-2.webp)
...
4. Configure "On revert action"
   ...
   1. On the dropdown that says "(None)", select "Batch Script" and type in the following text
      ...
      ![66_14_image-20200725154035-8](/images/policypak/scriptstriggers/66_14_image-20200725154035-8.webp)

   2. Click NEXT

5. Select either "Once" or "Once or when forced" and click NEXT

   ![66_16_image-20200725154035-9](/images/policypak/scriptstriggers/66_16_image-20200725154035-9.webp)
