---
title: "What is the fastest way to get started in an PolicyPak trial, without running the License Request Tool?"
description: "What is the fastest way to get started in an PolicyPak trial, without running the License Request Tool?"
sidebar_position: 10
---

# What is the fastest way to get started in an PolicyPak trial, without running the License Request Tool?

We know you want to get started with a Netwrix PolicyPak trial
fast.
...
With PolicyPak, you don't even need a license file from us to get started.

:::note
This is the recommended  way to get going quickly with PolicyPak.
:::
...
Here's a video showing what happens when you rename a computer and how PolicyPak
reacts:[Testing and Troubleshooting By Renaming an endpoint Computer](/docs/policypak/deliverymethods/cloud/videos/testlabbestpractices/renameendpoint.md)

![812_1_image001](/images/policypak/license/812_1_image001.webp)
...
- Follow these directions to get started with on-Prem Active Directory/ Group Policy: Getting
  Started with Group Policy > [Knowledge Base](/docs/policypak/) and/or
- Follow these directions to get started with PolicyPak and Intune or another MDM
...
If you're trying our PolicyPak Enterprise, PolicyPak Professional or
PolicyPak SaaS, they all come with an included PolicyPak Cloud license. 
Your trial should automatically generate credentials
to [cloud.policypak.com](https://cloud.policypak.com/) (aka the PolicyPak Cloud
Service.)

When you install the PolicyPak Cloud client, a license is automatically taken from
PolicyPak Cloud (and also the PolicyPak Client Side Extension is
installed.) You install a new machine into PolicyPak cloud by installing the PolicyPak Cloud Client, as shown below.

![812_2_image002](/images/policypak/license/812_2_image002.webp)

To get started immediately with PolicyPak Cloud, check out the Getting Started with
Cloud > [Video Learning Center](/docs/policypak/deliverymethods/cloud/videos/videolearningcenter.md).

## Option 3: On-Prem / GPO Method: You give us your domain name, we give you back a Trial License File.

If you want to use Active Directory / GPO method to deliver PolicyPak settings, we
...
If you're using Intune specifically, we can turn on PolicyPak for your Intune
...
![812_4_sdfg](/images/policypak/license/812_4_sdfg.webp)
