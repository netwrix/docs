...
- [General Tab](/docs/threatprevention/8.0/admin/policies/configuration/general.md)
- [Event Type Tab](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/overview.md)
- [Actions Tab](/docs/threatprevention/8.0/admin/policies/configuration/actions/overview.md) (Event Consumers)
...
The [Recent Events Tab](/docs/threatprevention/8.0/admin/policies/configuration/recentevents/overview.md) provides information on the events that have been
