...
![validatefirewall](/images/activitymonitor/9.0/config/netappcmode/validatefirewall.webp)
...
agent's settings. The agent adds this port to Windows Firewall exclusions automatically. Ensure the port isn't blocked by other firewalls between ONTAP and the agent.
