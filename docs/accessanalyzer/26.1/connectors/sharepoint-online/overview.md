...
Access Analyzer generates the certificate during source group setup. You download it and upload it to your registered Microsoft Entra ID application before you can test the connection.
