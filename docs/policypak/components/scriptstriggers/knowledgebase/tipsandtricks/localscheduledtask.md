...
**Step 1 –** Create a Netwrix PolicyPak Scripts policy on the
computer side.

![879_1_image-20220916231626-1](/images/policypak/scriptstriggers/879_1_image-20220916231626-1.webp)

**Step 2 –** When creating the Policy choose the option to Apply this policy to computer (default).

![879_2_image-20220916231626-2](/images/policypak/scriptstriggers/879_2_image-20220916231626-2.webp)

**Step 3 –** Choose PowerShell from the dropdown.

![879_3_image-20220916231626-3](/images/policypak/scriptstriggers/879_3_image-20220916231626-3.webp)
...
![879_4_image-20220916231626-4_950x517](/images/policypak/scriptstriggers/879_4_image-20220916231626-4_950x517.webp)

**Step 5 –** Skip the on revert action screen by clicking next.

![879_5_image-20220916231626-5](/images/policypak/scriptstriggers/879_5_image-20220916231626-5.webp)

**Step 6 –** At the Specify process mode screen choose "Once or when forced" and then click next to
continue.

![879_6_image-20220916231626-6](/images/policypak/scriptstriggers/879_6_image-20220916231626-6.webp)
