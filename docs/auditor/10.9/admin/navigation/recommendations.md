...
the [Create a New Plan](/docs/auditor/10.9/admin/monitoringplans/create.md) topic for additional information about further
configuration.
...
![managerecommendations](/images/auditor/10.9/admin/navigation/managerecommendations.webp)
