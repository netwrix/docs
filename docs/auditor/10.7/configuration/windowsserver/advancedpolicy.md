...
Setting up both basic and advanced audit policies may lead to incorrect audit reporting. To make Windows ignore basic audit policies and prevent conflicts, enable the _Audit: Force audit policy subcategory settings_ policy.
...
Advanced audit policies integrate with Group Policies, so you can apply them via Group Policy
