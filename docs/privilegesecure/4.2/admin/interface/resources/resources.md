...
window displays. See the [Remove Resource Window](/docs/privilegesecure/4.2/admin/interface/resources/removeresource.md) topic
...
tasks. A confirmation window displays. See the [Platforms Page](/docs/privilegesecure/4.2/admin/interface/platforms/overview.md) topic
for additional information.
