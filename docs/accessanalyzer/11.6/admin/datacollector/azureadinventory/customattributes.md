...
![Entra ID Inventory Data Collector Wizard Custom Attributes page](/img/product_docs/accessanalyzer/11.6/admin/datacollector/adinventory/customattributes.webp)
