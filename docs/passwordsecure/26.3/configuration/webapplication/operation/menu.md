...
[Passwords](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/passwords/passwords.md)

7. Password Reset

The functions of the
[Password Reset](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/passwordreset/password_reset.md) can be found
here.
