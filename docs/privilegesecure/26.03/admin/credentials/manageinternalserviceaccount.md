...
![Manage internal service account](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/credentials/manageinternalserviceaccount.webp)
...
If the message “No matching user found” displays, Privilege Secure is unable to find a matching
user in Active Directory.

![No matching user found](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/credentials/matchinguserfalse.webp)
...
[Users & Groups Page](/docs/privilegesecure/26.03/admin/usersgroups/usersgroups.md) topic for additional information.
...
information.
- ensure the user is in Active Directory in the expected domain
...
![Set password for credential window](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/credentials/setpasswordcredential.webp)
...
![Manually Managed Account](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/credentials/credentialsmanuallymanageaccount.webp)
...
clipboard. The window stays open for 20 seconds. See the [View Password Window](/docs/privilegesecure/26.03/admin/credentials/viewpassword.md)
