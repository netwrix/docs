...
Hi, there. This is Jeremy Moskowitz, former Group Policy MVP and Founder of PolicyPak
Software. In this video, I'm going to show you how you can utilize PolicyPak's
automatic client side extension update feature.

Every once in a while, "PolicyPak Client Side Extension," which is the moving part
...
What we're going to do is go over to our server. If you've watched other videos on PolicyPak, you're probably familiar with the PolicyPak Central Store, which exists under
"sysvol/(domainname.com)/Policies/PolicyPak." This is where, of course, all of your PolicyPak DLLs live.
...
rotating circle thing, which is actually the MSI installer updating PolicyPak in the
background.
