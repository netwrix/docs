---
title: "Manage Firefox Plug-ins using PolicyPakand the PolicyPak DesignStudio"
description: "Manage Firefox Plug-ins using PolicyPakand the PolicyPak DesignStudio"
sidebar_position: 70
---
# Manage Firefox Plug-ins using PolicyPakand the PolicyPak DesignStudio

Netwrix PolicyPak can manage your Firefox plugins. And we start
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/fGhbeVQGPqI" title="PolicyPak: Manage Firefox Plug-ins Per Website" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### Manage Firefox Plugins using PolicyPak and the PolicyPak DesignStudio Video Transcript
