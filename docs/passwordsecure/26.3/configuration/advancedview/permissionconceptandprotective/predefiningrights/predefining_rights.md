...
[Permissions for organisational structures](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/organisationalstructure/permissionsfororganisational/permissions_for_organisational.md)
...
[Working with predefined rights](/docs/passwordsecure/26.3/configuration/advancedview/permissionconceptandprotective/predefiningrights/working_with_predefined_rights.md)
and their
[Scope of validity for predefined rights](/docs/passwordsecure/26.3/configuration/advancedview/permissionconceptandprotective/predefiningrights/scope_of_validity_for_predefined.md).
...
([Roles](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/roles.md)) have been defined within this IT department:
...
O[Organisational structure](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/organisationalstructure/organisational_structure.md)
...
[Manual setting of permissions](/docs/passwordsecure/26.3/configuration/advancedview/permissionconceptandprotective/manualsettingofpermissions/manual_setting_of_permissions.md).
...
[Tags](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/tags.md) for records.
