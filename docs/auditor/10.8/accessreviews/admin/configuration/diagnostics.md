...
When requested by [Netwrix Support](https://www.netwrix.com/support.html), complete the following steps to provide debug logs:
...
[Netwrix Support](https://www.netwrix.com/support.html). When your issue is resolved, don't forget
