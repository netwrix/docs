...
![Policy window - Authentication Lockdown Event Type](/images/threatprevention/8.0/admin/policies/eventtype/authenticationlockdown.webp)
...
![Policy window - Authentication Protocol filter for lockdown](/images/threatprevention/8.0/admin/policies/eventtype/authenticationprotocollockdown.webp)
...
![Policy window - Hosts (to) filter for lockdown](/images/threatprevention/8.0/admin/policies/eventtype/hoststolockdown.webp)
