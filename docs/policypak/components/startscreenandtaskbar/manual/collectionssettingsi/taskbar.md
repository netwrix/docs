...
Collections are also present (and required) for PolicyPak Taskbar Manager. In the
Quickstart, we created a collection by right-clicking within PolicyPak Start Screen
Manager or PolicyPak Taskbar Manager and selecting Add | New Collection. To see the
collection options, you can right-click on the name of the collection and select "Edit Collection,"
as seen in Figure 43.

![collections_policy_settings_10](/images/policypak/startscreentaskbar/settings/collections_policy_settings_10.webp)

Figure 43. Editing collections for Taskbar Manager.

The PolicyPak Taskbar Manager Pinned Collection Editor can be seen in Figure 44.

![collections_policy_settings_11](/images/policypak/startscreentaskbar/settings/collections_policy_settings_11.webp)

Figure 44. PolicyPak Taskbar Manager Pinned Collection Editor options.
...
![collections_policy_settings_12](/images/policypak/startscreentaskbar/settings/collections_policy_settings_12.webp)

Figure 45. Pinned desktop icons will appear in the PolicyPak Start Screen Manager
