---
title: "FulfillTask"
description: "Retrieves provisioning orders from the informed connector generated by GenerateProvisioningOrdersTask to make changes in a system. Instead of a connector, launch it with a list of TaskResourceTypes."
sidebar_position: 4
---
...
The following example reads all provisioning orders concerning the `InternalResources` connector to open manual provisioning tickets in Identity Manager, without archiving the values before the changes on resources.
