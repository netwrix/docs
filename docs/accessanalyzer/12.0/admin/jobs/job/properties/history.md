...
settings for the job. Then provide the Data Retention Period and Log Retention Period
settings you want. See the [History](/docs/accessanalyzer/12.0/admin/settings/history.md) topic for additional information.
