...
For SQL Server 2012+, restrict the maximum server memory value to 60-70% of the total physical RAM
to prevent SQL Server from starving other applications of memory. Follow these instructions to limit
