...
- Top Users – Displays the top five user addresses related to file system events which have
  been recorded in the specified timeframe
- Top Servers – Displays the top five client IP addresses/host names related to file system
