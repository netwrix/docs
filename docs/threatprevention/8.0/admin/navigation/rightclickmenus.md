...
| ------------------- | ----------------------- |
| Install Agent       | Opens the [Deploy Agents Wizard](/docs/threatprevention/8.0/admin/agents/deploy/overview.md#deploy-agents-wizard) |
...
![Policies and Templates Nodes - Right-click Menu](/images/threatprevention/8.0/admin/navigation/policiestemplatesnodes.webp)
...
![Folder Node - Right-click Menu](/images/threatprevention/8.0/admin/navigation/foldermenu.webp)
...
![`<Policy Name>` and `<Template Name>` Nodes - Right-click Menu](/images/threatprevention/8.0/admin/navigation/individualpolicytemplatenode.webp)
...
![Tags Node - Right-click menu](/images/threatprevention/8.0/admin/navigation/tagsnode.webp)
...
![Template Name Node under Tags - Right-click menu](/images/threatprevention/8.0/admin/navigation/templatenodeundertags.webp)
...
![Displays the data grid right-click menu. ](/images/threatprevention/8.0/admin/navigation/headerrightclickmenu.webp)
...
| Filter Editor       | Opens the Filter Editor window (see the [Filter Data](/docs/threatprevention/8.0/admin/navigation/datagrid.md#filter-data) topic)     |
| Show / Hide Find Panel     | Shows or hides the Find Panel, which is the search feature (see the [Search Data](/docs/threatprevention/8.0/admin/navigation/datagrid.md#search-data) topic)          |
