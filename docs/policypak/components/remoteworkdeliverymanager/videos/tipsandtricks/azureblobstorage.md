---
title: "PolicyPak: Use Azure Blob Storage to Deploy and Patch your software"
description: "PolicyPak: Use Azure Blob Storage to Deploy and Patch your software"
sidebar_position: 20
---
# PolicyPak: Use Azure Blob Storage to Deploy and Patch your software

Want to use Azure Blob Storage to deploy your software, and keep it up to date? With Netwrix PolicyPak, it's super easy. Here's how to create your Azure Blob,
upload your software, then use PolicyPak Remote Work Delivery Manager to deploy that
software (and keep it updated.)

<iframe width="560" height="315" src="https://www.youtube.com/embed/GPvAJLQEbVc" title="PolicyPak: Use Azure Blob Storage to Deploy and Patch your software" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz, and in this video, I'm going to show you how you can use PolicyPak Remote Work Delivery Manager with Azure Blob Storage. If you're not familiar with
...
Group Policy to do it, you can use PolicyPak MDM to do it, you can do any technique
...
demonstration happens to be using the Group Policy version. If you wanted to use PolicyPak Cloud you could do that. If you wanted to wrap up this policy and deploy it to your machines
using MDM, you could do that too. PolicyPak Remote Work Delivery Manager works across
...
Again, this would happen naturally with PolicyPak MDM or PolicyPak Cloud
...
applications and then use PolicyPak Remote Work Delivery Manager to deliver those
...
off to the races. Azure Blob Storage, PolicyPak Remote Work Delivery Manager, your
endpoints, it's a match made in heaven. Hope this video helps you out. Thanks for watching. Hope to
get you started with PolicyPak real soon. Bye-bye.
