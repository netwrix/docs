...
further activity while locked. The Users & Groups Details page for the user indicates that
the account is locked.

**Step 3 –** Click **Okay** to confirm.

The session is locked and the Lock Session message appears to the session user within their RDP
