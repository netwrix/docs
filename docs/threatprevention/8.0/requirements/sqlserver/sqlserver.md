...
- Windows Server can be physical or virtual. See the
  [Virtual Environment Recommendations](/docs/threatprevention/8.0/requirements/application.md#virtual-environment-recommendations)topic for
...
Prevention. See the [Database Maintenance Feature Requirements](/docs/threatprevention/8.0/requirements/sqlserver/dbmaintenance.md) topic for
additional information.
