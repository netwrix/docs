...
[MSSQL Server](/docs/passwordsecure/26.3/installation/requirements/mssql_server.md) for this process.

#### 2. Installing the server

The Netwrix Password Secure application server is installed next (see
[Application server](/docs/passwordsecure/26.3/installation/requirements/application_server.md)). The installation itself
is described under
[Installation Server Manager](/docs/passwordsecure/26.3/installation/installation_server_manager.md).

#### 3. Basic configuration

After the server has been installed, the
[Basic configuration](/docs/passwordsecure/26.3/configuration/servermanger/basic_configuration.md) is
...
under [License settings](/docs/passwordsecure/26.3/configuration/servermanger/mainmenu/license_settings.md). Now stop
...
[Certificates](/docs/passwordsecure/26.3/configuration/servermanger/certificates/certificates.md) are backed up.
...
the setup wizard. The [Setup wizard](/docs/passwordsecure/26.3/configuration/servermanger/setup_wizard.md) is
