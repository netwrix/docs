...
The goals of Netwrix PolicyPak Java Rules Manager are as follows:
...
:::note
See this video
[Use PolicyPak Cloud to choose which version of Java for what website](/docs/policypak/components/javaenterpriserules/videos/methods/cloud.md) for
an overview of PolicyPak Java Rules Manager.
:::
...
- Export policies or collections as XML files for use with PolicyPak Exporter and PolicyPak Cloud.
  See [Exporting Collections](/docs/policypak/components/javaenterpriserules/manual/usage/exportcollections.md) for additional information.
...
![about_policypak_java_rules](/images/policypak/javaenterpriserules/about_endpointpolicymanager_java_rules.webp)
