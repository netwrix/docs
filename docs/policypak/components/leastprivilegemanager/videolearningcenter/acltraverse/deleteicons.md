---
title: "PolicyPak: ACL Traverse to enable users to delete icons on desktop"
description: "PolicyPak: ACL Traverse to enable users to delete icons on desktop"
sidebar_position: 10
---
# PolicyPak: ACL Traverse to enable users to delete icons on desktop
