...
![fileshareswindowsservers](/images/auditor/10.9/admin/reports/types/stateintime/fileshareswindowsservers.webp)

Each report has a set of filters which help organize audit data in the most convenient way. See the
[View Reports](/docs/auditor/10.9/admin/reports/view.md) topic for additional information. You can also create a subscription
...
![windowsserverinventory_thumb_0_0](/images/auditor/10.9/admin/reports/types/stateintime/windowsserverinventory_thumb_0_0.webp)
