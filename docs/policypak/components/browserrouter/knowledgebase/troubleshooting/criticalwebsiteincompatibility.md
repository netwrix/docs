...
There are a few things you can do if you need to keep Netwrix PolicyPak running on the machine (in general) but disable Browser Router's interaction with the
machine.
That being said, here's the order we recommend in getting to the bottom of the issue.

**Step 1 –** What happens if you 100% uninstall the PolicyPak CSE…. Does the problem
go away? If NO, then this is unlikely to be a PolicyPak problem.
...
![814_1_img-01](/images/policypak/troubleshooting/browserrouter/814_1_img-01.webp)
...
![814_3_img-02](/images/policypak/troubleshooting/browserrouter/814_3_img-02.webp)
...
(KB shows killing PPPreferences, but in this case you would kill PolicyPak Browser
Router.)
