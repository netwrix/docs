...
Preferences has no way to reapply its settings. PolicyPak Preferences Manager fixes
this problem. To see this in action, delete the www.policypak.com icon from the desktop. Then, test
PolicyPak Preferences Manager's automatic compliance on the client machine by
...
PolicyPak Preferences Manager will automatically refresh any Group Policy Preference
