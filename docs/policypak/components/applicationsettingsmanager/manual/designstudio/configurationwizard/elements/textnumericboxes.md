...
changed to. See the figure here for an example of a numeric box.

![configuring_elements_using_27](/images/policypak/applicationsettings/designstudio/configurationwizard/elements/configuring_elements_using_27.webp)

The figure shown. Numeric box example.
