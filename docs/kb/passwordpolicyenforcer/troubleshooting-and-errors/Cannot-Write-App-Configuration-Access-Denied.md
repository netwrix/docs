---
description: >-
  Steps to configure permissions so the user attempting to run PPE Console can read/write the PPE configuration. 
keywords:
...
sidebar_label: Cannot write the app configuration settings (access denied)
tags:
  - kb
title: "Cannot write the app configuration settings (access denied)"
knowledge_article_id: 
---

# Cannot write the app configuration settings (access denied)
...
**Note** The version of the object only changes per major version number, it does not change for minor version number or build numbers. 
