...
<iframe width="560" height="315" src="https://www.youtube.com/embed/QZ_uSNABS30" title="Least Privilege Manager: Apply on Demand Rules" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video, I'm going to show you how you can use Netwrix PolicyPak to apply certain rules on demand.
...
PolicyPak, shebang. In this case, now you are applying On Demand. It's running with
