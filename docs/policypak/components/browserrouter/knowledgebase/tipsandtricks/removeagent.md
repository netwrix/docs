---
title: "How to remove the PolicyPak Browser Router Agent from the list of available Web Browser handlers under Default Apps in Windows 10"
description: "How to remove the PolicyPak Browser Router Agent from the list of available Web Browser handlers under Default Apps in Windows 10"
sidebar_position: 60
---

# How to remove the PolicyPak Browser Router Agent from the list of available Web Browser handlers under Default Apps in Windows 10

If you decide not to use Netwrix PolicyPak Browser Router in your
environment and your environment does not have any PolicyPak Browser Router (PPBR)
...
![483_1_image-20190911221425-1](/images/policypak/browserrouter/install/483_1_image-20190911221425-1.webp)
...
## SCENARIO 1: You have never used PolicyPak Browser Router and there are no PPBR policies enabled in your environment:

You can remove the PPBR Agent from this list by unlicensing the PolicyPak Browser
Router component and removing the PPBR Agent entry from the list of default Web Browsers utilizing
the steps below.

![483_2_image-20190911221425-2](/images/policypak/browserrouter/install/483_2_image-20190911221425-2.webp)

**Step 1 –** Add a new policy under **PolicyPak** > **Administrative Templates Manager**:

![483_3_image-20190911221425-3_950x559](/images/policypak/browserrouter/install/483_3_image-20190911221425-3_950x559.webp)
...
![483_4_image-20190911221425-4_950x354](/images/policypak/browserrouter/install/483_4_image-20190911221425-4_950x354.webp)

**Step 3 –** Next set the policy as enabled, and click **OK**.

![483_5_image-20190911221425-5_950x150](/images/policypak/browserrouter/install/483_5_image-20190911221425-5_950x150.webp)
...
![483_6_image-20190911221425-6](/images/policypak/browserrouter/install/483_6_image-20190911221425-6.webp)
...
## SCENARIO 2: You HAVE used PolicyPak Browser Router in Legacy Browser Mode (either currently or sometime in the past) but no longer wish to, AND currently have no PPBR policies enabled in your environment:

![483_7_image-20210105155954-1](/images/policypak/browserrouter/install/483_7_image-20210105155954-1.webp)

**Step 1 –** Follow steps 1-4 above from Scenario 1 then continue with the steps below.

![483_8_image-20190911221425-7_950x315](/images/policypak/browserrouter/install/483_8_image-20190911221425-7_950x315.webp)
...
![483_9_image-20190911221425-8](/images/policypak/browserrouter/install/483_9_image-20190911221425-8.webp)
...
![483_10_image-20190911221425-9](/images/policypak/browserrouter/install/483_6_image-20190911221425-6.webp)
