...
[EWSPublicFolder: SDD Options](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/ewspublicfolder/sddoptions.md) topic
...
[EWSPublicFolder: Filter](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/ewspublicfolder/filter.md) topic
for additional information.
...
page.  See the
[EWSPublicFolder: Results](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/ewspublicfolder/results.md) topic
for additional information.
