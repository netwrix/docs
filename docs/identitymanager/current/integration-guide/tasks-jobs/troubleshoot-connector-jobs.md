...
See the [Usercube-Export-Configuration](../../integration-guide/executables/references/export-configuration) topic for additional information on how to prepare the synchronization executable `Usercube-Prepare-Synchronization`.
