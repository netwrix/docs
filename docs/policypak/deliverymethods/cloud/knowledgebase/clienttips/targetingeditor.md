---
title: "Using Targeting Editor in PolicyPak Cloud Settings"
description: "Using Targeting Editor in PolicyPak Cloud Settings"
sidebar_position: 90
---

# Using Targeting Editor in PolicyPak Cloud Settings

How can I target a User or a Group membership with Netwrix PolicyPak Cloud based settings?

## Summary:

You have a requirement to target PolicyPak Cloud policies to a particular set of
groups of Users or a Group only. You want to use the built-in GP Preference method of choosing a
group or a user to target those settings via PPC (PolicyPak Cloud). In this topic we
will demonstrate how will you do that.

There is going to be two-part steps in targeting PolicyPak Cloud managed settings,
aka. Group Policies via PPC to those users or computers.

The process for targeting PolicyPak Cloud managed settings, aka. Group Policies via
...
2. Inserting the SID in PolicyPak Cloud based Internal Item-Level Targeting Filter
   window.
...
![732_1_image-20200213172020-1](/images/policypak/cloud/732_1_image-20200213172020-1.webp)
...
![732_3_image-20200213172020-2](/images/policypak/cloud/732_3_image-20200213172020-2.webp)
...
![732_5_image-20200213172020-3](/images/policypak/cloud/732_5_image-20200213172020-3.webp)
...
![732_7_image-20200213172020-4](/images/policypak/cloud/732_7_image-20200213172020-4.webp)
...
## 2:Inserting the SID inPolicyPakpoli PolicyPak Cloud based Internal Item-Level Targeting Filter window

In this section we will insert the SID we extracted by following any of the above step, in PolicyPak Cloud based Internal Item-Level Targeting Filter window.

**Step 1 –** Launch PolicyPak Cloud Portal.

**Step 2 –** Create a New Policy and select a i.e. Drive Maps from Microsoft Policy Preferences.

![732_9_image-20200213172020-5](/images/policypak/cloud/732_9_image-20200213172020-5.webp)

**Step 3 –** Click on **Mapped Drive** drop-down and select **Drive** option.

![732_11_image-20200213172020-6_950x630](/images/policypak/cloud/732_11_image-20200213172020-6_950x630.webp)

**Step 4 –** After filling out the details select the **ILT** button.

![732_13_image-20200213172020-7](/images/policypak/cloud/732_13_image-20200213172020-7.webp)
...
![732_15_sid_950x589](/images/policypak/cloud/732_15_sid_950x589.webp)
...
![732_16_image-20200213172020-9_950x629](/images/policypak/cloud/732_16_image-20200213172020-9_950x629.webp)
