...
![quickstart_start_screen_manager_18](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_18.webp)

Figure 23. Adding Edge tile policies.

**Step 2 –** You can type in a URL or click "Select from favorites," as shown in Figure 24.

![quickstart_start_screen_manager_19](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_19.webp)
...
![quickstart_start_screen_manager_20](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_20.webp)

Figure 25. Changing the background color of the icon.

**Step 4 –** The result of adding an Edge tile can be seen in Figure 26.

![quickstart_start_screen_manager_21](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_21.webp)
...
Figure 27. Note that recent builds of PolicyPak Start Screen & Taskbar Manager require
you to log off and log on again to see the Start Menu changes.

![quickstart_start_screen_manager_22](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_22.webp)
