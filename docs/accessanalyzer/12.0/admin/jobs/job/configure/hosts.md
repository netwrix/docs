...
![Host Selection page](/img/product_docs/accessanalyzer/12.0/admin/jobs/job/configure/hostselection.webp)
...
![Job's Configure > Hosts node](/img/product_docs/accessanalyzer/12.0/admin/jobs/job/configure/hostsnode.webp)

**Step 1 –** Navigate to the job’s **Configure** > **Hosts** node.

![Individual hosts section of the Host Selection view](/img/product_docs/accessanalyzer/12.0/admin/jobs/job/configure/hostselectionindividualhosts.webp)
