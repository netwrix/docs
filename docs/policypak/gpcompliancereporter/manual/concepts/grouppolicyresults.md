...
Netwrix PolicyPak GPCR gets information about if a Group Policy
...
![gpcr_concepts_and_quickstart](/images/policypak/grouppolicycompliancereporter/gpcr_concepts_and_quickstart.webp)
...
![gpcr_concepts_and_quickstart_1](/images/policypak/grouppolicycompliancereporter/gpcr_concepts_and_quickstart_1.webp)

Figure 2. The Group Policy Results Report.

PolicyPak GPCR can do three things that Microsoft's Group Policy Results Report
cannot:
...
PolicyPak GPCR allows you to define pass/fail settings compliance across your network,
