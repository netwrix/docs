...
![BYOV Connector for Privilege Secure](/images/privilegesecure/26.03/accessmanagement/admin/configuration/add/byovconnectornps.webp)
...
See the [Bring Your Own Vault (BYOV) Integration](/docs/privilegesecure/26.03/admin/configuration/integrationconnector/integrationbyov/integrationbyov.md) topic for additional
...
![Select a User to manage account](/images/privilegesecure/26.03/accessmanagement/admin/configuration/add/byovmanageuser.webp)

**Step 2 –** Search or scroll to find the user you want to manage. After identified, check the box
next to the account name.

![Select Manual manage account](/images/privilegesecure/26.03/accessmanagement/admin/configuration/add/byovmanualmanageaccount.webp)
...
See the [Credentials Dashboard](/docs/privilegesecure/26.03/admin/dashboard/credentials.md) topic for additional information on
...
![Managed User Wrench Icon](/images/privilegesecure/26.03/accessmanagement/admin/configuration/add/byovmanageuserwrench.webp)

**Step 2 –** Click the **Wrench** icon to set the password.

![Set password for the credential window](/images/privilegesecure/26.03/accessmanagement/admin/configuration/add/byovsetpassword.webp)
...
See the
[Manage Internal Service Accounts](/docs/privilegesecure/26.03/admin/credentials/manageinternalserviceaccount.md)
...
![BYOV create an Activity](/images/privilegesecure/26.03/accessmanagement/admin/configuration/add/byovconnectoractivity.webp)
...
See the [Add Activity](/docs/privilegesecure/26.03/admin/activities/activity/activity.md) topic for additional information on creating an
Activity.
...
![Create a new policy for the BYOV Connector](/images/privilegesecure/26.03/accessmanagement/admin/configuration/add/byovconnectorpolicy.webp)
...
[Users Tab for Resource Based Access Policies](/docs/privilegesecure/26.03/admin/accesspolicy/resourcebasedpolicyt/resourcebasedpolicy.md) topic for
...
See the [Add Access Policy](/docs/privilegesecure/26.03/admin/accesspolicy/addaccesspolicy.md) topic for additional information on
...
![My Activities BYOV Connector](/images/privilegesecure/26.03/accessmanagement/admin/configuration/add/byovconnectormyactivities.webp)
