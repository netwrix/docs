...
Most content will inherit the permissions configured at the root of the site collection.
Understanding how those permissions are assigned gives useful perspective on the overall
