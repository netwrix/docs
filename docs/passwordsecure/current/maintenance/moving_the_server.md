...
[Basic configuration](/docs/passwordsecure/current/configuration/servermanger/basic_configuration.md) is
...
under [License settings](/docs/passwordsecure/current/configuration/servermanger/mainmenu/license_settings.md). Now stop
...
[Certificates](/docs/passwordsecure/current/configuration/servermanger/certificates/certificates.md) are backed up.
...
the setup wizard. The [Setup wizard](/docs/passwordsecure/current/configuration/servermanger/setup_wizard.md) is
