...
![web_interface_and_controls_50_593x200](/images/policypak/cloud/interface/computergroups/web_interface_and_controls_50_593x200.webp)

This is an example of items and actions that are available when you click a policy.

![web_interface_and_controls_51_593x184](/images/policypak/cloud/interface/computergroups/web_interface_and_controls_51_593x184.webp)
...
![web_interface_and_controls_52_624x291](/images/policypak/cloud/interface/computergroups/web_interface_and_controls_52_624x291.webp)

For details and guidance on using the in-cloud editors, refer back to the previous section on
creating policies.

:::note
Not all PolicyPak nor all Group Policy Preferences types have in-cloud
editors. As such, you need to use your on-prem test lab to create and test the policy first. For
more information, refer to the **Creating a PolicyPak Cloud On-Prem Test Lab** and
...
![web_interface_and_controls_53_623x265](/images/policypak/cloud/interface/computergroups/web_interface_and_controls_53_623x265.webp)
