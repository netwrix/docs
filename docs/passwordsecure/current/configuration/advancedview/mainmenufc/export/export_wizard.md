...
[HTML WebViewer export](/docs/passwordsecure/current/configuration/advancedview/mainmenufc/export/html_webviewer_export.md), the resulting file is
...
- **Starting via the ribbon:** The export can also be started via the
  [Ribbon](/docs/passwordsecure/current/configuration/advancedview/operationandsetup/ribbon.md) in the
  [Passwords](/docs/passwordsecure/current/configuration/advancedview/clientmodule/passwords/passwords.md) module.
...
**CAUTION:** You must once again point out the sensitive nature of this export function
...
subject is even more relevant from a security perspective: You can export all passwords
