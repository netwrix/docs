...
![NoSQL Data Collector Wizard Filter page](/img/product_docs/accessanalyzer/11.6/admin/datacollector/ewsmailbox/filter.webp)
...
![Edit Existing Pattern window](/img/product_docs/accessanalyzer/11.6/admin/datacollector/nosql/editpattern.webp)
