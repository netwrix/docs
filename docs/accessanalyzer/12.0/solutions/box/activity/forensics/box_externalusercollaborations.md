...
![Analysis Tasks for the Box_ExternalUserCollaborations Job](/img/product_docs/accessanalyzer/12.0/solutions/box/activity/forensics/externalusercollaborationsanalysis.webp)
