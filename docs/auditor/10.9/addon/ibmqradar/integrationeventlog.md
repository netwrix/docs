...
See the [Define Parameters](/docs/auditor/10.9/addon/ibmqradar/parameters.md) topic for additional information.
...
Details are filled in only if this Activity Record field isn't empty.
