---
title: "Using File Association Manager in the PolicyPak Cloud environment"
description: "Using File Association Manager in the PolicyPak Cloud environment"
sidebar_position: 40
---
# Using File Association Manager in the PolicyPak Cloud environment

When you don't have a "Fake DC" to create file association policies on-prem to export to the cloud,
PolicyPak's File Association Manager Helper utility can be used to create the desired
associations on a sample workstation.

<iframe width="560" height="315" src="https://www.youtube.com/embed/DQt5Dkv2YBc" title="Using File Association Manager in the PolicyPak Cloud environment" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is John at PolicyPak, and in this video, we're going to take a look at
