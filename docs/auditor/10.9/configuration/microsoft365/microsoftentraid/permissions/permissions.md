...
See the [Using Basic Authentication with Microsoft Entra ID](/docs/auditor/10.9/configuration/microsoft365/microsoftentraid/permissions/basicauth.md) topic for additional
information.
...
See the [Using Modern Authentication with Microsoft Entra ID](/docs/auditor/10.9/configuration/microsoft365/microsoftentraid/permissions/modernauth/modernauth.md) topic for additional
information.
