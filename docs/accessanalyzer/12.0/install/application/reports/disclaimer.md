...
![Disclaimer.txt file added to the Web folder](/img/product_docs/accessanalyzer/install/application/reports/disclaimertxt.webp)
...
![File Explorer WebServer.exe.config](/img/product_docs/accessanalyzer/install/application/reports/webserverexeconfigfile.webp)

**Step 3 –** Locate the `WebServer.exe.config` file and open it.

![WebServer.exe.config file in Notepad](/img/product_docs/accessanalyzer/install/application/reports/webserverexeconfigdisclaimer.webp)
...
![Web Console login page with disclaimer message](/img/product_docs/accessanalyzer/install/application/reports/webconsolelogindisclaimer.webp)
