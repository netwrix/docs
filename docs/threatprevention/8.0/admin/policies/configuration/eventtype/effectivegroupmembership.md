...
![Policy window - Effective Group Membership Event Type](/images/threatprevention/8.0/admin/policies/eventtype/effectivegroupmembership.webp)
...
![Policy window - AD Groups filter](/images/threatprevention/8.0/admin/policies/eventtype/adgroups.webp)
