...
This step can also be carried out later “in the [License settings](/docs/passwordsecure/current/configuration/servermanger/mainmenu/license_settings.md)
...
[Advanced settings](/docs/passwordsecure/current/configuration/servermanger/mainmenu/advanced_settings.md) and can also be edited there later on.
...
the [Advanced settings](/docs/passwordsecure/current/configuration/servermanger/mainmenu/advanced_settings.md) should it be necessary to make changes
later on.
...
[Backup management](/docs/passwordsecure/current/configuration/servermanger/mainmenu/backupsettings/backup_management.md) are created
and the [Certificates](/docs/passwordsecure/current/configuration/servermanger/certificates/certificates.md) are backed up.
