...
PolicyPak File Associations Manager is contained within the PolicyPak
node. PolicyPak File Associations Manager MMC snap-in enables you to create a new
PolicyPak File Associations Manager policy or collection. You can create policies on
the Computer side or User side.

:::note
You will only see the PolicyPak File Associations Manager node when the
...
![about_policypak_file_associations_4](/images/policypak/fileassociations/collections/about_endpointpolicymanager_file_associations_4.webp)

If you want to follow along with the Quickstart for PolicyPak File Associations
...
![about_policypak_file_associations_5](/images/policypak/fileassociations/collections/about_endpointpolicymanager_file_associations_5.webp)

PolicyPak File Associations Manager is the quickest way to set up, test, and manage
...
![about_policypak_file_associations_6](/images/policypak/fileassociations/collections/about_endpointpolicymanager_file_associations_6.webp)

When installing Adobe Acrobat Reader DC, the installer asks to be the default PDF viewer.

![about_policypak_file_associations_7](/images/policypak/fileassociations/collections/about_endpointpolicymanager_file_associations_7.webp)
...
![about_policypak_file_associations_8](/images/policypak/fileassociations/collections/about_endpointpolicymanager_file_associations_8.webp)

After installing Claws Mail, the program tries to make itself the default for opening emails.

![about_policypak_file_associations_9](/images/policypak/fileassociations/collections/about_endpointpolicymanager_file_associations_9.webp)
...
![about_policypak_file_associations_10](/images/policypak/fileassociations/collections/about_endpointpolicymanager_file_associations_10.webp)

In order to successfully complete the Quickstart with PolicyPak File Associations
...
- An example endpoint machine with the PolicyPak CSE should have Acrobat Reader, Claws
