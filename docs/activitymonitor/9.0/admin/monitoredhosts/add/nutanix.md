...
[Nutanix Files Activity Auditing Configuration](/docs/activitymonitor/9.0/requirements/activityagent/nas-device-configuration/nutanix-activity.md) for more
information.
...
[Network Tab](/docs/activitymonitor/9.0/admin/agents/properties/network.md) topic for additional information.
...
The added Nutanix host is displayed in the monitored hosts/service table. After a host is added for
...
- [Nutanix Tab](/docs/activitymonitor/9.0/admin/monitoredhosts/properties/nutanix.md)
