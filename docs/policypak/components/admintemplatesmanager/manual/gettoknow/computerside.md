...
When using PolicyPak Admin Templates Manager to create a policy on the Computer side,
you can tap into both Computer and User policy settings.

![about_policypak_admin_templates_6](/images/policypak/adminstrativetemplates/gettoknow/about_endpointpolicymanager_admin_templates_6.webp)

With both computer and user policy settings available in PolicyPak Admin Templates
Manager you can deliver user-side settings to any computer that has this GPO.

:::note
For more information on the PolicyPak Admin Templates Manager delivering
