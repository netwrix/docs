...
Select this option to open the wizard for adding a new record.
...
[Passwords](/docs/passwordsecure/current/configuration/advancedview/clientmodule/passwords/passwords.md)

7. Password Reset

The functions of the
[Password Reset](/docs/passwordsecure/current/configuration/advancedview/clientmodule/passwordreset/password_reset.md) can be found
here.
