...
Customer portal. See the [Install Components & Methods](/docs/privilegesecure/26.03/install/components.md) topic for additional
information.
...
[Proxy Service Install](/docs/privilegesecure/26.03/install/servicesonadditional/proxyservice.md) topic for installation instructions.

Additionally, The Action Service must be installed on the same server that you plan to add the Host Scan service. This is because the Host Scan service relies on the Action Service Worker. See [Action Service Install](/docs/privilegesecure/26.03/install/servicesonadditional/actionservice.md)
:::


To install the NPS Host Scan Service on another server.
...
![licenseagreement](/images/privilegesecure/26.03/accessmanagement/install/licenseagreement_scan.png)

**Step 4 –** Enter the destination folder for installation and click OK. (Default usually easiest)

![installlocation](/images/privilegesecure/26.03/accessmanagement/install/installlocation_scan.png)

**Step 7 –** Click Install to begin the installation. The setup wizard displays the installation
progress.

![installcomplete](/images/privilegesecure/26.03/accessmanagement/install/installbegin_scan.png)
...
To configure the Host Scan Service.
