---
title: "Firefox: How do I troubleshoot adding Certificates with PolicyPak and Firefox?"
description: "Firefox: How do I troubleshoot adding Certificates with PolicyPak and Firefox?"
sidebar_position: 100
---

# Firefox: How do I troubleshoot adding Certificates with PolicyPak and Firefox?
...
**Step 2 –** Watch the Netwrix PolicyPak and Firefox cert video
for a how-to

**Step 3 –** The most common reason certificates fail to import is because they are the WRONG
FORMAT.

PolicyPak only imports certificates which are ALREADY in what's called the BINARY DER
format.

Full details on how to do this are in the document PolicyPak Application Settings
...
![214_1_image002](/images/policypak/troubleshooting/applicationsettings/firefox/214_1_image002.webp)
...
![214_2_image007](/images/policypak/troubleshooting/applicationsettings/firefox/214_2_image007.webp)
...
- When specifying a certificate and the number of days that PolicyPak should check for
...
![214_3_image008](/images/policypak/troubleshooting/applicationsettings/firefox/214_3_image008.webp)
