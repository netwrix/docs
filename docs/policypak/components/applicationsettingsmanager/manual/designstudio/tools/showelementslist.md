...
- Which elements work in PolicyPak Application Settings Manager Community Edition (if
...
To that end, PolicyPak DesignStudio has a "Show Elements List" feature (also known as
...
![using_designstudio_tools_7_624x330](/images/policypak/applicationsettings/designstudio/tools/using_designstudio_tools_7_624x330.webp)

The figure shown. Selecting the "Show Elements List" feature.

The List All Elements box shows you which elements will work in PolicyPak Application
...
![using_designstudio_tools_8](/images/policypak/applicationsettings/designstudio/tools/using_designstudio_tools_8.webp)
...
![using_designstudio_tools_9](/images/policypak/applicationsettings/designstudio/tools/using_designstudio_tools_9.webp)
...
![using_designstudio_tools_10](/images/policypak/applicationsettings/designstudio/tools/using_designstudio_tools_10.webp)
