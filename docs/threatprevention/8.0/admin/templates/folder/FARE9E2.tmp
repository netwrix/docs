...
Templates in the [Templates Interface](/docs/threatprevention/8.0/admin/templates/overview.md).
...
The templates are now available in the [Templates Interface](/docs/threatprevention/8.0/admin/templates/overview.md).
