...
- Integrations — Configure integrations with Netwrix products and third-party systems and applications. See the [Integrations Interface](/docs/threatprevention/7.5/reportingmodule/configuration/integrations/overview.md) topic for details.
