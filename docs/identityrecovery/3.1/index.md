---
title: "Netwrix Identity Recovery v3.1"
description: "Netwrix Identity Recovery v3.1"
sidebar_position: 1
---

# Netwrix Identity Recovery v3.1
...
- Delete the wrong account and an essential business process might stop.
...
Native tools don’t provide an efficient way to revert these critical changes — but Netwrix Identity Recovery
does. Administrators can quickly rollback and recover Active Directory objects or just a
