---
title: "How to silently install Firefox ESR, Chrome and WinZip 14.5 using PolicyPak Scripts Manager"
description: "How to silently install Firefox ESR, Chrome and WinZip 14.5 using PolicyPak Scripts Manager"
sidebar_position: 30
---

# How to silently install Firefox ESR, Chrome and WinZip 14.5 using PolicyPak Scripts Manager
...
**Step 3 –** Select "Computer Configuration > Netwrix PolicyPak >
Scripts Manager".
