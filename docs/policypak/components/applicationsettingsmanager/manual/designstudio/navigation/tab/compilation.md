...
![getting_around_7](/images/policypak/applicationsettings/designstudio/navigation/tab/getting_around_7.webp)

The figure shown. Setting the DLL name.

![getting_around_8_624x155](/images/policypak/applicationsettings/designstudio/navigation/tab/getting_around_8_624x155.webp)
...
- Compile to standard location (default): This will compile to what is set in `Tools | Options`.
  Usually, this is the PolicyPak local store or
