...
currently connected to PolicyPak Cloud. The following data is available: computer
name, installed OS, IP address, and computer status for Cloud.

![web_interface_and_controls_112_624x332](/images/policypak/cloud/interface/web_interface_and_controls_112_624x332.webp)
...
**Revoked**, and **Revoked by PolicyPak Software**. The table can be exported and
saved in MS Excel or Word format by clicking the **Save** button and selecting Excel or Word.

![web_interface_and_controls_114_624x196](/images/policypak/cloud/interface/web_interface_and_controls_114_624x196.webp)
...
![web_interface_and_controls_115_624x355](/images/policypak/cloud/interface/web_interface_and_controls_115_624x355.webp)
...
![web_interface_and_controls_116_468x353](/images/policypak/cloud/interface/web_interface_and_controls_116_468x353.webp)
...
![web_interface_and_controls_117_468x354](/images/policypak/cloud/interface/web_interface_and_controls_117_468x354.webp)
...
![web_interface_and_controls_118_499x373](/images/policypak/cloud/interface/web_interface_and_controls_118_499x373.webp)
