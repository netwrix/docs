...
must be met. See the [Panzura CloudFS Monitoring](/docs/activitymonitor/9.0/requirements/activityagent/nas-device-configuration/panzura-activity.md) topic for
additional information.
...
To add a Panzura host to be monitored, complete the following steps:
...
- [Panzura Tab](/docs/activitymonitor/9.0/admin/monitoredhosts/properties/panzura.md)
