...
the same time. Various mechanisms lets you select the records to be edited. You're able to
...
:::note
As the already granted permissions for the selected records may differ, it isn't possible to display the permissions here.
:::
...
:::note
Depending on the number of records, editing records may take a long time. This process is performed in the background for this reason. A hint will indicate that the permissions process has been completed.
:::
