...
PolicyPak File Associations Manager log files are found in
`%Programdata%\PolicyPak\PolicyPak File Associations Manager.` This is because PolicyPak File Associations Manager affects the computer (and all users on that computer).It's also
...
all PolicyPak File Associations Manager work happens on the Computer side.
...
- `ppUser_onPolicyChanged.log`: This log file is updated when Group Policy applies in the background
  ...
  [SCCM and Intune] and PolicyPak Cloud).
...
Figure 55 and Figure 56 are examples of PolicyPak File Associations Manager logs with
some important items highlighted.

![troubleshooting_1](/images/policypak/troubleshooting/fileassociations/troubleshooting_1.webp)

Figure 55. An example of a PolicyPak File Associations Manager log.

![troubleshooting_2](/images/policypak/troubleshooting/fileassociations/troubleshooting_2.webp)

Figure 56. Highlights from the PolicyPak k File Associations Manager log.
