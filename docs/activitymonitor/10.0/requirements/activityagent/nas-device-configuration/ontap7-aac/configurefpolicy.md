...
Relevant NetApp Documentation: For details on configuring file policies, see the
NetApp
...
- The Activity Monitor must register with the NetApp device as an FPolicy server. By default, it
  ...
  [Customize FPolicy Policy Name](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/ontap7-aac/customizefpolicy.md) section for information on using a different
  policy name.
