...
4. Enter the sender address in the **From** field. Access Analyzer uses this address as the sender for all notification emails.
...
Repeat these steps for each recipient you want to add.
...
:::warning
If the test email doesn't arrive, verify the SMTP settings and check your mail server's spam or quarantine folder. Access Analyzer logs SMTP errors in **Settings** > **Logs** > **Notifications**.
:::
