...
For Netwrix PolicyPak: All Components need a license to be
downloaded on endpoints in order to process PolicyPak components / instructions from
components such as:
...
![172_1_image001](/images/policypak/license/172_1_image001.webp)
...
![172_2_image002](/images/policypak/license/172_2_image002.webp)
...
- You do not need a license for anywhere the PolicyPak Group Policy Compliance
...
on PolicyPak -delivered specific component items. This is automatically licensed.
...
**Step 4 –** None of the PP Support tools like the PolicyPak Application Manager
Design Studio, Powershell add-ins, or GPOTouch utility need to be licensed.

To generate license request keys for PolicyPak On-Prem suite endpoints see the
...
[See PolicyPak Solution Methods: Group Policy, MDM, UEM Tools, and PolicyPak Cloud compared. for additional information on ](https://docs.netwrix.com/docs/policypak/licensing/knowledgebase/miscquestions/licensingmethods)
