---
title: "How to use Scripts Manager to manually install and enable PolicyPak Browser Router for new Edge Chromium?"
description: "How to use Scripts Manager to manually install and enable PolicyPak Browser Router for new Edge Chromium?"
sidebar_position: 30
---

# How to use Scripts Manager to manually install and enable PolicyPak Browser Router for new Edge Chromium?

The problem is that New Edge + PPC will not install the chrome extension. We have following steps
for Netwrix PolicyPak Scripts Manager that should work for Edge
Chromium.
...
1. CRX (chrome extension file) for PPBR will be downloaded from PolicyPak ShareFile
   link.
...
**Step 2 –** Select PolicyPak Scripts Manager form the Create Policy list
...
![856_1_image-20211130230540-1_950x555](/images/policypak/troubleshooting/nondomain/856_1_image-20211130230540-1_950x555.webp)
...
![856_2_image-20211130230540-2_950x436](/images/policypak/troubleshooting/nondomain/856_2_image-20211130230540-2_950x436.webp)
