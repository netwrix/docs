...
Admin Activity. See the [SIEM Folder Templates](/docs/threatprevention/8.0/admin/templates/folder/siem.md) topic
...
![Administrator Auditing Dashboard](/images/threatprevention/8.0/siemdashboard/splunk/activedirectory/dashboard/administratorauditing.webp)
