...
RECOMMENDED: Using MS SQL Server Express can lead to significant performance issues because of the various limitations. The recommendation is to use MS SQL Server Standard as a minimum.
