...
In Windows Server 2016, audit policies aren't integrated with Group Policies and can only be
deployed using logon scripts generated with the native Windows **auditpol.exe** command line tool.
Therefore, these settings aren't permanent and are lost after server reboot.
...
they can be applied via Group Policy Object or Local Security Policies. The following procedure describes how to apply Advanced policies via Local Security Policy console.
