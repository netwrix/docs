...
A **Discovery Service Task** is used to add a new [Discovery Service](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/discoveryservice/discovery_service.md) and
...
3. **Tags**: The use of tags is described in more detail in the section
   [Tag manager](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/extras/tag_manager.md). A special tag can be
