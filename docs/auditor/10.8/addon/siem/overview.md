...
1. The administrator enables and configures a response action for the selected alert, as described in the
   following topic:
   [Configure a Response Action for Alert](/docs/auditor/10.8/admin/alertsettings/responseaction.md). Ensure
