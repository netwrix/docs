...
![Enable MFA page](/images/identityrecovery/2.6/admin/enablemfa.webp)
...
![Configure authenticator app page](/images/identityrecovery/2.6/admin/configure.webp)
...
[Sign In](/docs/identityrecovery/2.6/install/login.md#sign-in) topic for additional information.

## Disable Authenticator for MFA

Follow the steps to disable MFA for your Recovery for Active Directory account.

![Disable MFA page](/images/identityrecovery/2.6/admin/disablemfa.webp)
