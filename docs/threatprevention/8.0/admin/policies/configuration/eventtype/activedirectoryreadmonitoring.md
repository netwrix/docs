...
![Policy window - Active Directory Read Monitoring Event Type](/images/threatprevention/8.0/admin/policies/eventtype/adreadmonitoring.webp)
...
![Policy window - AD Attributes Monitoring filter](/images/threatprevention/8.0/admin/policies/eventtype/adattributesmonitor.webp)
