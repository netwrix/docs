...
that shows the total number of threats on the host. The Threats List below the Historical
...
- Name – The name of the group. Click the link to view group details. See the
  [Group Details Page](/docs/threatmanager/3.3/administration/threats/activedirectoryobjects/group.md) topic for additional information.
