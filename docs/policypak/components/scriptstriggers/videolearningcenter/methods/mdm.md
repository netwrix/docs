---
title: "PolicyPak Scripts and YOUR MDM service: Un-real power"
description: "PolicyPak Scripts and YOUR MDM service: Un-real power"
sidebar_position: 10
---
# PolicyPak Scripts and YOUR MDM service: Un-real power

MDM services cannot deliver scripts and UN-deliver scripts. That's where Netwrix PolicyPak Scripts Manager AND your MDM service become awesome. Check out this
video for an overview of WHY you need it and some examples of PP Scripts + MDM in use.

<iframe width="560" height="315" src="https://www.youtube.com/embed/sosYsaPbWSo" title="PolicyPak Scripts and YOUR MDM service: Un-real power" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
PolicyPak with our PolicyPak Script Manager plus your MDM is probably
...
don't have any scripting ability, well, now you do with PolicyPak Script Manager.
...
The first thing is that PolicyPak Scripts is included with the On-Prem and MDM
...
created existing policies here in PolicyPak Scripts land. I have one here on the user
...
Like I said, PolicyPak can use not just "PowerShell" but it can use "Batch script,"
...
We're going to go to the "PolicyPak/PolicyPak Exporter Tool." The PolicyPak Exporter
...
We'll go ahead and click "Next" here, and we'll call this "Packaged PolicyPak Settings
...
MobileIron. We work with Intune. We work with other ones. I've already got the "PolicyPak Client-Side Extension" – that's the moving part to make PolicyPak do it's
...
You can also see that my MDM service has deployed my "PolicyPak Client-Side
Extension." That's the magic that makes this all go. There are the "Licenses" to light up PolicyPak. I'll leave this open for now.
...
results. The first thing is that here is the "Packaged PolicyPak Settings for SCRIPTS"
...
the preconfigured "Packaged PolicyPak Settings for SCRIPTS" here.
...
where PolicyPak Scripts plus your MDM solution equals way more awesome than you had
five minutes ago.
