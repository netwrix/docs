...
you can use PolicyPak Least Privilege Manager to elevate or block scripts from
running.

Kick off the process to create a policy for scripts by going to **Add** > **New Script Policy**.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/elevate/elevating_scripts.webp)
...
These script types can also be blocked automatically and universally by using the PolicyPak Least Privilege Manager SecureRun™ feature, as described in later topics.
