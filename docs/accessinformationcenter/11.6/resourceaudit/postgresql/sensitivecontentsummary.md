...
The Sensitive Content Summary report at the **PostgreSQL** node provides a count of databases that
contain criteria matches in the targeted environment. This report includes a Details table.
