---
title: "SYSPREP Error with PolicyPak Client-Side Extension"
description: "SYSPREP Error with PolicyPak Client-Side Extension"
sidebar_position: 200
---

# SYSPREP Error with PolicyPak Client-Side Extension

When updating the gold .wim file used for OS imaging, you may encounter the following error when
attempting to SYSPREP a system with the PolicyPak CSE 24.2.3799 or later installed.
...
package is absent, the Windows 11 modern menu will not contain PolicyPak commands.
...
At the first logon, Windows 11 will not have PolicyPak menus, but they should appear
at the second login.
