...
- Protection Policy — See the [Protection Policies Page](/docs/privilegesecure/26.03/admin/resources/protectionpolicies/protectionpolicies.md) topic for additional
information.
- Change Policy (credential rotation) — How often the password of a managed account is changed. See
the [Credentials Dashboard](/docs/privilegesecure/26.03/admin/dashboard/credentials.md) topic for additional information on
managed accounts.
...
![Schedule Policies Page](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/page_3.webp)
...
[Add Schedule Policy](/docs/privilegesecure/26.03/admin/platforms/schedulepolicies/schedulepolicy.md) topic for additional information.
...
[Edit Schedule Policy](/docs/privilegesecure/26.03/admin/platforms/schedulepolicies/schedulepolicy_1.md) topic for additional information.
