...
the Access Information Center and then assigns resource groups. This step is required if you want to
change access through entitlement reviews, self-service, or publishing resources to IAM.
...
imported into the Access Information Center.

:::warning
Run the .Active Directory Inventory Job Group and **File System** >
**0. Collection** Job Group again so that Enterprise Auditor captures the AD and permissions
changes.
:::
...
The import process imports the newly created resource based groups to the AIC and assigns the Owner
and Access Groups to the resources. The AIC can now be used to manage these
