...
:::note
This applies to the entire GPO (file) and not specific settings in the GPO.
:::
...
![New Policy window - GPO Setting Lockdown Event Type](/images/threatprevention/8.0/admin/policies/eventtype/ggposettinglockdown.webp)
...
![Policy window - AD Group Policy Object filter](/images/threatprevention/8.0/admin/policies/eventtype/adgrouppolicyobject.webp)
