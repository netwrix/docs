...
![About page](/images/privilegesecure/26.03/accessmanagement/admin/aboutpage.webp)

It displays your license information and details about the third party components used by the
application. It also lets you upload a new license file. See the
...
![About page showing additional Customer Info details](/images/privilegesecure/26.03/accessmanagement/admin/aboutcustomerdetails.webp)
...
![About third party components window](/images/privilegesecure/26.03/accessmanagement/admin/thirdpartycomponents.webp)
