...
![Add Domian Resource](/images/privilegesecure/26.03/accessmanagement/admin/policy/add/adddomain.webp)
...
The new domain has been on-boarded. See the [Domain Details Page](/docs/privilegesecure/26.03/admin/resources/detailspages/domain/domain.md) topic
