...
Figure 32. Creating collections with PolicyPak Start Screen & Taskbar Manager.

For PolicyPak Start Screen Manager, collections have two functions. As mentioned
previously, they hold policies that create Windows 10 groups. But a PolicyPak Start
Screen Manager collection also defines how those groups will react. The two options for a PolicyPak Start Screen Manager collection can be seen in Figure 33.
...
There are two layout modes for a PolicyPak Start Screen Manager collection. One is
...
![collections_policy_settings_2](/images/policypak/startscreentaskbar/settings/startscreen/collections_policy_settings_2.webp)
...
![collections_policy_settings_3](/images/policypak/startscreentaskbar/settings/startscreen/collections_policy_settings_3.webp)
...
Inside PolicyPak Start Screen Manager collections are policies for groups. You created
...
![collections_policy_settings_5](/images/policypak/startscreentaskbar/settings/startscreen/collections_policy_settings_5.webp)

Figure 38. PolicyPak Start Screen Manager groups have various options you can
configure.
