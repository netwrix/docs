...
![getting_around_5](/images/policypak/applicationsettings/designstudio/navigation/tab/getting_around_5.webp)
...
![getting_around_6](/images/policypak/applicationsettings/designstudio/navigation/tab/getting_around_6.webp)

The figure shown. You can use Item-Level Targeting to narrow your target scope.

Tip: PolicyPak has some AppSets that have pre-defined filters and others that do not.
For instance, all of the Internet Explorer AppSets and Java AppSets that PolicyPak
