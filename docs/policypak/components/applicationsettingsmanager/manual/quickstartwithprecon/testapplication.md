...
![policypak_application_settings_1](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_1.webp)

**Step 2 –** Edit the GPO, and then add in the AppSet for WinZip, as seen In the figure shown. To do this,
scroll down to User Configuration | PolicyPak | Application Settings Manager. Then
right-click on "Application Settings Manager" and select "New Application," and then choose the
PolicyPak for WinZip.

![policypak_application_settings_2](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_2.webp)
...
![policypak_application_settings_3](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_3.webp)
...
![policypak_application_settings_4](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_4.webp)

The figure shown. Suggested test settings.

**Step 7 –** When you right-click on any setting within PolicyPak Application Settings
Manager, you'll be given the options shown In the figure shown.

![policypak_application_settings_5](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_5.webp)

The figure shown. Settings options.

:::note
These modes and options are all explained in detail in the section, "PolicyPak Application Settings Manager Modes."
:::
...
![policypak_application_settings_6](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_6.webp)
...
![policypak_application_settings_7](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_7.webp)
...
![policypak_application_settings_8](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_8.webp)
...
![policypak_application_settings_9](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_9.webp)
...
![policypak_application_settings_10](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_10.webp)
...
![policypak_application_settings_11](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_11.webp)
