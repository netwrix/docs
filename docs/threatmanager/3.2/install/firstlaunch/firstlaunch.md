...
Manager Console opens. See the [Getting Started with Threat Manager](/docs/threatmanager/3.2/gettingstarted.md) topic for
next steps.
...
**Step 3 –** Threat Manager presents a list of recovery codes to restore access to the
...
[Getting Started with Threat Manager](/docs/threatmanager/3.2/gettingstarted.md) topic for next steps.
