...
The **5.Domains > 0.Collection** Job Group collects the data for further analysis to provide details
on domains, sites, and trusts.
...
- [AD_DomainControllers Job](/docs/accessanalyzer/12.0/solutions/activedirectory/domains/collection/ad_domaincontrollers.md) – Collects domain controller details for
  further analysis to provide information on domains, sites, and trusts.
- [AD_DSRM Job](/docs/accessanalyzer/12.0/solutions/activedirectory/domains/collection/ad_dsrm.md) – Collects data related to domain controller registry settings for the
  DSRMAdminLogonBehavior key. If this key is set to 1 or 2, the DSRM Admin Account can log in to
  the domain controller even if it has not been started in DSRM, which can present a
