---
title: "If multiple Least Privilege Manager rules would apply, which rule takes precedence?"
description: "If multiple Least Privilege Manager rules would apply, which rule takes precedence?"
sidebar_position: 50
---

# If multiple Least Privilege Manager rules would apply, which rule takes precedence?
