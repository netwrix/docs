...
This can occur if you're doing something else to manage the Start Layout \*\*BEFORE\*\* Netwrix PolicyPak Start Screen & Taskbar Manager is involved.
...
layout is applied by PolicyPak Start Screen & Taskbar Manager.
