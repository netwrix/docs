...
| Option              | Description                                                                                                                                                                                                                                                                  |
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Administrator Email | Enter the email for a Google Drive administrator account. The information entered here can't be edited after you save the configurations for this dynamic source group.                                                                                                     |
