...
![Investigations Interface showing the Timeframe dropdown menu](/images/threatprevention/8.0/reportingmodule/investigations/options/timeframe.webp)
...
![Attribute dropdown menu in the Filters section](/images/threatprevention/8.0/reportingmodule/investigations/options/attrributemenu.webp)
...
**Step 1 –** Navigate to your investigation's Filters section.
...
to test if your filter statement is working as you want. Save the investigation for reuse. You can
