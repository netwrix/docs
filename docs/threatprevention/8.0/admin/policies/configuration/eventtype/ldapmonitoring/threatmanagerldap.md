...
![honeytoken](/images/threatprevention/8.0/admin/policies/eventtype/usecase/honeytoken.webp)
...
![ldapfiltercopiedtoclipboard](/images/threatprevention/8.0/admin/policies/eventtype/usecase/ldapfiltercopiedtoclipboard.webp)
...
![Netwrix Threat Manager for AD LDAP template – Event Type tab with LDAP Query filter](/images/threatprevention/8.0/admin/policies/eventtype/usecase/ldapmonitoringfortm.webp)
...
[Netwrix Threat Manager Configuration Window](/docs/threatprevention/8.0/admin/configuration/threatmanagerconfiguration.md)
