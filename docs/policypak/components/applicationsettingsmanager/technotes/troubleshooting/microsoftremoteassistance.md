---
title: "How to use Scripts Manager to workaround the \"PPAppLockdr64.dll is either not designed to run on Windows or it contains an error\" message when running Microsoft Remote Assistance (MSRA.exe) and the PolicyPak CSE is installed on Windows 10 1903"
description: "How to use Scripts Manager to workaround the \"PPAppLockdr64.dll is either not designed to run on Windows or it contains an error\" message when running Microsoft Remote Assistance (MSRA.exe) and the PolicyPak CSE is installed on Windows 10 1903"
sidebar_position: 150
---

# How to use Scripts Manager to workaround the "PPAppLockdr64.dll is either not designed to run on Windows or it contains an error" message when running Microsoft Remote Assistance (MSRA.exe) and the PolicyPak CSE is installed on Windows 10 1903

![280_1_image-20191015113622-1](/images/policypak/troubleshooting/applicationsettings/280_1_image-20191015113622-1.webp)
...
![280_2_image-20191015113622-4](/images/policypak/troubleshooting/applicationsettings/280_2_image-20191015113622-4.webp)
...
![280_3_image-20191015113622-5](/images/policypak/troubleshooting/applicationsettings/280_3_image-20191015113622-5.webp)
...
![280_4_image-20191015113622-6](/images/policypak/troubleshooting/applicationsettings/280_4_image-20191015113622-6.webp)
...
![280_5_image-20191015113622-7](/images/policypak/troubleshooting/applicationsettings/280_5_image-20191015113622-7.webp)

![280_6_image-20191015113622-2](/images/policypak/troubleshooting/applicationsettings/280_6_image-20191015113622-2.webp)
