...
- sbpam-url.exe – Installs the sbpam-url URL handler. This automatically launches SSH
...
access to Privilege Secure consumes a license after their first login. This is true for all
