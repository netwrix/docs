...
Use the Nutanix tab to modify settings after you configure a Nutanix host. Once a
Nutanix host is added to the monitored hosts/services table, the configuration can be edited in the host
Properties.
