...
Microsoft Group Policy Preferences and other areas of Netwrix PolicyPak to target or filter where specific items will apply. Item-Level Targeting can be used in
the following ways:

- With PolicyPak Start Screen Manager and PolicyPak Taskbar Manager,
...
- With PolicyPak Taskbar Manager, Item-Level Targeting can be used within collections,
