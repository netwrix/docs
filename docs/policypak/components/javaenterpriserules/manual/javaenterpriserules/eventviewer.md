...
PolicyPak logs events to Windows Event log. In the Event Viewer | Application and
Services Log | PolicyPak look for PolicyPak k Java Rules Manager Client
events. Specifically, Event 8021 will show the XML used to write the Java Rules, as shown in
Figure 34.

![troubleshooting_policypak_5](/images/policypak/troubleshooting/javaenterpriserules/troubleshooting_endpointpolicymanager_5.webp)
