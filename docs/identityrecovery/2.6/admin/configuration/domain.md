...
![Domains Page](/images/identityrecovery/2.6/admin/configuration/domains.webp)
...
supported Windows Servers, see the [Target Domains](/docs/identityrecovery/2.6/requirements/targetdomain.md) topic.
...
![Add Domain Configuration wizard - Domain page](/images/identityrecovery/2.6/admin/configuration/domain.webp)
...
[Rollback Objects](/docs/identityrecovery/2.6/admin/activedirectory/rollback.md) and
[Recover an Object](/docs/identityrecovery/2.6/admin/activedirectory/recover.md#recover-an-object) topics for information on the
wizards.
:::
...
[Least Privilege Access Model](/docs/identityrecovery/2.6/requirements/targetdomain.md#least-privilege-access-model)
topic.

**Step 5 –** Click **Next**.

![Add Domain Configuration wizard - Backup Schedule page](/images/identityrecovery/2.6/admin/configuration/backupschedule.webp)
...
![Add Domain Configuration wizard - Options page](/images/identityrecovery/2.6/admin/configuration/options.webp)
...
![Add Domain Configuration wizard - Notification page](/images/identityrecovery/2.6/admin/configuration/notification.webp)
...
a semicolon (;) to separate multiple recipients. See the [Notifications Page](/docs/identityrecovery/2.6/admin/configuration/notifications.md)
...
![Add Domain Configuration wizard - Confirm page](/images/identityrecovery/2.6/admin/configuration/confirm_1.webp)
...
![Edit Domain Configuration wizard - Domain page](/images/identityrecovery/2.6/admin/configuration/domain_1.webp)
...
![Edit Domain Configuration wizard - Backup Schedule page](/images/identityrecovery/2.6/admin/configuration/backupschedule.webp)
...
![Edit Domain Configuration wizard - Options page](/images/identityrecovery/2.6/admin/configuration/options_1.webp)
...
![Edit Domain Configuration wizard - Notification page](/images/identityrecovery/2.6/admin/configuration/notification_1.webp)
...
![Edit Domain Configuration wizard - Confirm page](/images/identityrecovery/2.6/admin/configuration/confirm_2.webp)
