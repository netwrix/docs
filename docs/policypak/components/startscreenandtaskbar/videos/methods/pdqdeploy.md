---
title: "Taking Control of Your Taskbar and Start Menu with PolicyPak and PDQ Deploy"
description: "Taking Control of Your Taskbar and Start Menu with PolicyPak and PDQ Deploy"
sidebar_position: 50
---
...
manage both the Windows 10 Start Screen and Taskbar? Easy, when you add Netwrix PolicyPak.  
In this video, Kris from PDQ and Jeremy Moskowitz, former Group Policy MVP from PolicyPak Software show you how to get it "out there" and nicely manage that Windows 10 Start Screen
and Taskbar.
...
User side, "PolicyPak." We'll go ahead and dive down under the "Start Screen Manager
...
using PDQ. You have predefined or later put on your PolicyPak policy settings for your
...
can only do in PolicyPak land. We told you that we wanted to do Firefox, and this is
...
PDQ, but we made a small mistake. No problem. PolicyPak told us as the end user to
