...
**Step 8 –**   Check the Web Service Log File to ensure the Cert was found and loaded properly. The log file includes the following output:
...
properly. The log file includes the following output:
...
Re-registering the Action Service is good practice whenever you change the certificate in use.
