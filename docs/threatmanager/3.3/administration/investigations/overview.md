...
- New Investigation – Lets you run queries on available data with the filters you want for a
  specific timeframe. See the [New Investigation Page](/docs/threatmanager/3.3/administration/investigations/newinvestigation.md) topic for additional
  information.
- Favorites – Provides a list of saved queries the logged in user has tagged as a Favorite. See the
  [Favorites Page](/docs/threatmanager/3.3/administration/investigations/favorites.md) topic for additional information.
- Audit and Compliance – Provides a list of saved built-in investigations with applied filters
  ...
  [Audit and Compliance Page](/docs/threatmanager/3.3/administration/investigations/auditcompliance.md) topic for additional information.
- Predefined Investigations – Provides a list of saved built-in investigations with applied
  ...
  the [ Predefined Investigations Page](/docs/threatmanager/3.3/administration/investigations/predefinedinvestigations.md) topic for additional
  information.
- My Investigations – Provides a list of saved investigations created by the application users. See
  the [My Investigations Page](/docs/threatmanager/3.3/administration/investigations/myinvestigations.md) topic for additional information.
- Subscriptions and Exports – Provides a list of investigations that are either subscribed to or
  scheduled for export. See the [Subscriptions and Exports Page](/docs/threatmanager/3.3/administration/investigations/subscriptionsexports.md) topic for
  additional information.

Every investigation has the same options at the top of the page. See the
[Investigation Options](/docs/threatmanager/3.3/administration/investigations/options/overview.md) topic for additional information.
