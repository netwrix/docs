...
![Database Details page](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/details/databasedetailspage.webp)
...
which is only visible when scanning lets you stop the resource scan. This scan can also be
scheduled from the [Platforms Page](/docs/privilegesecure/26.03/admin/platforms/overview.md).
...
[Databases Tab](/docs/privilegesecure/26.03/admin/resources/detailspages/databases/databases_1.md) topic for additional information.
