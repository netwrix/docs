...
**Step 7 –** Uninstall most recent PolicyPak CSE (from Portal).

**Step 8 –** Install previous PolicyPak CSE (If you need it, ask your tech support
professional.)
...
**Step 11 –** Uninstall the previous PolicyPak CSE from previous step.
...
- You should be performing these steps ONLY as a test directed by PolicyPak technical
  staff.
...
- This will stop much of PolicyPak's inner workings such as:
  ...
  - PolicyPak Application Manager (Reapply on launch.)
  - PolicyPak Browser Router (FF extension installation in some cases).
  - PolicyPak Applock.
  - PolicyPak File Associations Manager. … And possibly other items.

![175_1_image002](/images/policypak/troubleshooting/install/175_1_image002.webp)
