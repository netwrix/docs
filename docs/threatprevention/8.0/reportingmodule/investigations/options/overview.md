...
![Options available for an Investigation](/images/threatprevention/8.0/reportingmodule/investigations/options/investigationoptions.webp)
...
- Subscriptions – Click the Subscriptions link to open the Subscription to window. You can specify
  ...
  [Add Subscription](/docs/threatprevention/8.0/reportingmodule/investigations/options/subscription.md) topic for additional information.
