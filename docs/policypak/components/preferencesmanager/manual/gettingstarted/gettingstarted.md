...
This Quickstart of Netwrix PolicyPak Preferences Manager will
...
:::note
See Appendix E:
[Installation Quick Start](/docs/policypak/gettingstarted/overviewinstall/overviewinstall.md) and User Guide for
additoinal information on PolicyPak Preferences Manager in use with PolicyPak Cloud
:::


:::note
To perform these demonstrations, Microsoft Group Policy Preference items must be
available. You can use some of our preconfigured items from the PolicyPak Portal, or
...
available inside the PolicyPak Portal for download in the Latest Manuals section.
Currently the file is called `ppprefs-shortcut.xml`.  You can get to it by accessing the customer
portal and navigating to Latest Manuals.  Then, click on PolicyPak Examples (to be
used with PP Cloud-MDM-SCCM-etc).zip.

![quickstart_using_policypak](/images/policypak/preferences/quickstart_using_endpointpolicymanager.webp)

Inside the download of the PolicyPak preferences and PolicyPak Cloud XML
examples, you'll see a file named `ppprefs-shortcut.xml`.

![quickstart_using_policypak_1](/images/policypak/preferences/quickstart_using_endpointpolicymanager_1.webp)
...
![quickstart_using_policypak_2](/images/policypak/preferences/quickstart_using_endpointpolicymanager_2.webp)
...
Another way to do this is to right-click either the PolicyPak or PolicyPak Preferences Manager node, as seen below, and use the Group Policy Preference Export wizard,
...
![quickstart_using_policypak_3](/images/policypak/preferences/quickstart_using_endpointpolicymanager_3.webp)
