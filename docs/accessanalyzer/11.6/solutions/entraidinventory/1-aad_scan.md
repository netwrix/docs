...
![Query Selection page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/solutions/entraidinventory/scanqueryselection.webp)
...
![Query Properties button on Query Selection page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/solutions/entraidinventory/scanqueryselectionproperties.webp)

**Step 2 –** In the Query Selection view, click on **Query Properties** to open the Query Properties
window.

![Query Properties window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/solutions/entraidinventory/scanqueryproperties.webp)

**Step 3 –** Select the **Data Source** tab, and click **Configure** to open the Entra ID Inventory
DC Wizard.

![Entra ID Inventory DC Wizard Options page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectoryinventory/scandcwizardoptions.webp)
...
![Entra ID Inventory DC Wizard Custom Attributes page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectoryinventory/scandcwizardcustomattributes.webp)
...
![Analysis Tasks for 1-AAD_Scan Job](/img/product_docs/accessanalyzer/11.6/accessanalyzer/solutions/entraidinventory/scananalysistasks.webp)
