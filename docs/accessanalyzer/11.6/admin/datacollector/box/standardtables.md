...
reference tables. The following table outlines these tables and their associated views:
...
Box Data Collector. They contain additional information for building queries. The following
