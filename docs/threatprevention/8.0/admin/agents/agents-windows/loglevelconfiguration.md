...
![Log Level Configuration Window](/images/threatprevention/8.0/admin/agents/window/loglevelconfiguration.webp)
...
![Save As window for Agent logs](/images/threatprevention/8.0/admin/agents/window/saveaswindow.webp)
...
![Enterprise Manager Log File Location](/images/threatprevention/8.0/admin/agents/window/emlogs.webp)
...
![Administration Console Log File Location](/images/threatprevention/8.0/admin/agents/window/consolelogs.webp)
