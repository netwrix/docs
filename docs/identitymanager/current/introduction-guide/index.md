...
Netwrix Identity Manager (formerly Usercube) strongly recommends starting here to fully benefit from the [Integration Guide](../integration-guide)'s or the [User Guide](../user-guide)'s contents.
...
Let's dive in with an [IGA and Netwrix Identity Manager](../introduction-guide/overview) of IGA and Identity Manager.
