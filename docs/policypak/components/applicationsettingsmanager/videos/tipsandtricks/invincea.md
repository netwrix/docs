---
title: "PolicyPak and Invincea Integration Demo"
description: "PolicyPak and Invincea Integration Demo"
sidebar_position: 30
---
# PolicyPak and Invincea Integration Demo

Invincea is great for Sandboxing the IE, FF, and Chrome browsers. But you can use Netwrix PolicyPak to manage all the in-browser settings. Here's a demonstration.

<iframe width="560" height="315" src="https://www.youtube.com/embed/8pye7kyPfNs" title="PolicyPak and Invincea Integration" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
