...
![Domian Users Tab](/images/privilegesecure/25.12/accessmanagement/admin/policy/tab/resources/usersdomain.webp)
...
- Password Reset Options — Customize password rotation options. This option is only available for
  ...
  [Password Reset Options Window](/docs/privilegesecure/25.12/admin/interface/resources/passwordresetoptions.md) for additional
  information.
...
- Schedule — Shows the schedule policy used to change the password of a manged account, the
  credential rotation. See the [Schedule Policies Page](/docs/privilegesecure/25.12/admin/interface/platforms/schedulepolicies/schedulepolicies.md) topic for
