...
![about_policypak_browser_router_15](/images/policypak/browserrouter/about_endpointpolicymanager_browser_router_15.webp)
...
You can also select **Block**, which means PolicyPak Browser Router won't launch the
