...
On the Report Roles tab, report role inheritance can't be broken. Access to reports is inherited
...
Options Administrator, the Access Administrator, and the Host Management Administrator don't have
access to reports.
...
- Inherited From – Indicates the level at which the account was granted access to reports. Remember,
  global inheritance can't be broken.
