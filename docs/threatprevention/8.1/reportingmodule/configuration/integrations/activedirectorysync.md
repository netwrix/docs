...
![Integrations interface on the Active Directory Sync page](/images/threatprevention/8.1/reportingmodule/configuration/integrations/page.webp)
...
![Add New Integration window with Active Directory Sync type selected](/images/threatprevention/8.1/reportingmodule/configuration/integrations/activedirectorysync.webp)
...
![Active Directory Sync details page for a specific domain showing the Sync History tab](/images/threatprevention/8.1/reportingmodule/configuration/integrations/synchistorytab.webp)
...
Use the following steps to modify the Active Directory Sync policy for the selected Active Directory
domain.
