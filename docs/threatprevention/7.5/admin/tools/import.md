...
Use the Import window to select an already exported XML file for import and configure the
import settings.
...
**Step 3 –** In the Destination Folders section, specify a folder from within the folder
