...
Several options let you navigate the Access Analyzer Console. This section
...
- [Activities Pane](/docs/accessanalyzer/12.0/admin/navigate/activitiespane.md) – Displays a list of activities which can be conducted within
 the selected console section

Access Analyzer Data Grids also have specific navigation options that let users filter, group,
