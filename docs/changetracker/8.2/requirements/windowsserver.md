...
![Software Requirements](/images/changetracker/8.2/requirements/performancecheckbox.webp)
...
- See the [Installation](/docs/changetracker/8.2/install/overview.md) topic for additional information on the
