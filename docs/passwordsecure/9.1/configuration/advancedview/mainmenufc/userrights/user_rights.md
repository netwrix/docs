...
receives a required right in one of the three ways mentioned above. It's recommended that you link
...
The **security level** is an essential element that's also specified in the user rights. This is
