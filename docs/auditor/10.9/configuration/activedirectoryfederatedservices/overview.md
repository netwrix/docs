  ...
  configure them manually:
    ...
    - Adjust log size and retention settings for **Security** log and for **AD FS Admin** log (under
      **Applications and Service logs**). See
      [Adjusting Event Log Size and Retention Settings](/docs/auditor/10.9/configuration/windowsserver/eventlog.md) for details.
...
- Configure Data Collecting Account as described in the
  [Permissions for AD FS Auditing](/docs/auditor/10.9/configuration/activedirectoryfederatedservices/permissions.md) topic.
- Configure ports as described in the [AD FS Ports](/docs/auditor/10.9/configuration/activedirectoryfederatedservices/ports.md) topic.
