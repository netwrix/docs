...
With PolicyPak Feature Manager for Windows, Item-Level Targeting can be placed on
collections, as well as policies within collections.

A collection enables you to group together PolicyPak Feature Manager for Windows
...
![using_item_level_targeting](/images/policypak/feature/itemleveltargeting/using_item_level_targeting_1.webp)

You can also right-click any PolicyPak Feature Manager for Windows policy, and select
**Edit Item Level Targeting**.

![using_item_level_targeting_1](/images/policypak/feature/itemleveltargeting/using_item_level_targeting_1.webp)
...
![using_item_level_targeting_2](/images/policypak/feature/itemleveltargeting/using_item_level_targeting_2.webp)
...
![using_item_level_targeting_3](/images/policypak/feature/itemleveltargeting/using_item_level_targeting_3.webp)
