...
Netwrix PolicyPak can import collections settings (STIGs) to make
applications like Java, Firefox, Internet Explorer and more … and make them more secure. These are
US Government recommendations. See how PolicyPak can deliver these settings to your
machines and lock them down using Group Policy.

<iframe width="560" height="315" src="https://www.youtube.com/embed/A5mq2IpU19g" title="PolicyPak: Import STIG files to make your applications more secure" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
