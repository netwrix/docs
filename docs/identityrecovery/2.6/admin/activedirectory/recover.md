...
Click **Active Directory** in the left pane to open the [Active Directory Page](/docs/identityrecovery/2.6/admin/activedirectory/overview.md). Select
and expand a domain in the left pane and click Recycle Bin to get a list of deleted objects in the
domain.

![Recycle Bin](/images/identityrecovery/2.6/admin/activedirectory/recyclebin.webp)
...
[Active Directory Page](/docs/identityrecovery/2.6/admin/activedirectory/overview.md).
...
![Object Restore wizard - Object Backups page](/images/identityrecovery/2.6/admin/activedirectory/objectbackups_1.webp)

**Step 4 –** In the Backup Data section, select a backup date to restore from. Then click **Next**.

![Object Restore wizard - Domain Controller page](/images/identityrecovery/2.6/admin/activedirectory/domaincontroller.webp)
...
![Object Restore wizard - Recovery Options page](/images/identityrecovery/2.6/admin/activedirectory/recoveryoptions.webp)
...
![Object Restore wizard - User Options page](/images/identityrecovery/2.6/admin/activedirectory/useroptions.webp)
...
![Object Restore wizard - Credentials page](/images/identityrecovery/2.6/admin/activedirectory/credentials_1.webp)
...
![Object Restore wizard - Confirm page](/images/identityrecovery/2.6/admin/activedirectory/confirm_1.webp)
...
![Object Restore Complete message](/images/identityrecovery/2.6/admin/activedirectory/objectrestorecompleted.webp)
