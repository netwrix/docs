...
Alert notification via Event Log sends event notifications to the Windows Event Log.
...
**Step 5 –** Check the checkboxes for the events for which you want to trigger Windows Event Log notifications.
