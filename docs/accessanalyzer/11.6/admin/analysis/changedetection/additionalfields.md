...
![Change Detection Data Analysis Module wizard Additional Fields page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/analysis/changedetection/additionalfields.webp)
