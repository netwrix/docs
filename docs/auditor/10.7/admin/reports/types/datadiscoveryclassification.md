...
| State-in-time reports  | Most Exposed Sensitive Data Objects        | Lists the SharePoint objects (sites, lists, and documents) containing sensitive data that the most users — or even Everyone — can access, based on effective permissions. Use this report to identify data at high risk and plan corrective actions.            |
