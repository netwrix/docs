...
See the [Connection Tab](/docs/activitymonitor/10.0/admin/agents/properties/connection.md) topic for additional information.
...
See the [Archiving Tab](/docs/activitymonitor/10.0/admin/agents/properties/archiving.md) topic for additional information.
...
See the [Panzura Tab](/docs/activitymonitor/10.0/admin/agents/properties/panzura.md) topic for additional information.
...
See the [Nutanix Tab](/docs/activitymonitor/10.0/admin/monitoredhosts/properties/nutanix.md) topic for additional
information.
...
See the [Inactivity Alerts Tab](/docs/activitymonitor/10.0/admin/agents/properties/inactivityalerts.md) topic for additional
information.
...
See the [Inactivity Alerts Tab](/docs/activitymonitor/10.0/admin/monitoredhosts/properties/inactivityalerts.md) topic for
