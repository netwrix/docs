---
title: "PolicyPak Cloud and Security Settings (More examples)"
description: "PolicyPak Cloud and Security Settings (More examples)"
sidebar_position: 90
---
# PolicyPak Cloud and Security Settings (More examples)

Use the in-cloud editors to manage Netwrix PolicyPak Cloud
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/UsglBSa-oRg" title="PolicyPak Cloud and Security Settings" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
