...
Sensitive Data Collection category. You only need to set up the connection for the
Redshift_SensitiveDataScan Job once. After you establish the connection, it applies to any other
0.Collection job query. To customize configurations, complete the following steps.
...
:::note
Add SQL databases to the query before you scan them. Before you add a query, establish a
...
**Step 14 –** Add the databases and instances to audit, using any of the following methods:
