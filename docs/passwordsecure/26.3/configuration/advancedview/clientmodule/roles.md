...
[Creating new passwords](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/passwords/creating_new_passwords.md). Roles can be created via the
...
Just like the [Organisational structure](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/organisationalstructure/organisational_structure.md),
...
[Reading pane](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/reading_pane.md). All of the other users with
...
[Roles module](/docs/passwordsecure/26.3/configuration/webapplication/functionalscope/roles_module.md) of the Web
