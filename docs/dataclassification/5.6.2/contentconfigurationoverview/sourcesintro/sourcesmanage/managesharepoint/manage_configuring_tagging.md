...
1. Ensure you've set up the necessary term sets as described in
...
2. Configure the Term Sets that you want to auto-classify. Click the **Add** button and
   select the required Term Sets or fields:
...
5. After configuring the tagging you want, re-classify the appropriate content so the tags
   are written back to SharePoint.
