...
To install the Netwrix Threat Manager Reporting Module application:
...
![Stealthbits Setup Launcher for StealthINTERCEPT Reporting Powered by StealthDEFEND](/images/threatprevention/8.1/install/reportingmodule/setuplauncher.webp)

- Click PostgreSQL Setup to install the database. See the
  [Install the PostgreSQL Database Application](/docs/threatprevention/8.1/install/reportingmodule/database.md) topic for additional information.
