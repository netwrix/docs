...
data provided by a Microsoft native or third-party command line utility. Use it to
...
The CommandLineUtility Data Collector executes a command line utility and captures the output. You
