...
![Installation Welcome Page](/images/identityrecovery/3.1/product/installers/installer_page1.png)

**Step 3 –** On the Welcome page of the Identity Recovery Setup wizard, click Next to
begin the installation.

![Installation Destination Folder Page](/images/identityrecovery/3.1/product/installers/installer_page2.png)
...
![Installation License File Page](/images/identityrecovery/3.1/product/installers/installer_page3.png)
...
![Installation SQL Server Configuration](/images/identityrecovery/3.1/product/installers/installer_page4.png)
...
![Installation SQL Server Database Name](/images/identityrecovery/3.1/product/installers/installer_page5.png)
...
![serverconfiguration](/images/identityrecovery/3.1/product/installers/installer_page6.png)
...
![Installation Admin Role Page](/images/identityrecovery/3.1/product/installers/installer_page7.png)
...
![Installation Web Host Configuration](/images/identityrecovery/3.1/product/installers/installer_page8.png)
...
![Installation Ready to Install](/images/identityrecovery/3.1/product/installers/installer_page9.png)

**Step 11 –** Click **Install** to begin the installation process.

![completed](/images/identityrecovery/3.1/product/installers/installer_page10.png)
