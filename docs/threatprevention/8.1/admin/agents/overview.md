...
- ADMonitor Version – The installed SI.ActiveDirectoryMonitor.dll version
  ...
  major/minor version, such as 8.1.x.x, where x.x for the DLL can be equal or higher than that of
  the Agent. Example: Agent 8.1.0.123 and DLL 8.1.0.777
