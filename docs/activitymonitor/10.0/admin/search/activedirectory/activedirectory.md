...
select **Active Directory** from the magnifying glass dropdown menu, a New Search tab opens with
...
- To – Set the date and timestamp for the end of the activity range. The dropdown menu opens a
  calendar.
- Event Source – Set which query categories will be used. The dropdown menu displays a checkbox
  list of categories.
