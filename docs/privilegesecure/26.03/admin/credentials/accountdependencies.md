...
![Account Dependencies Window](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/credentials/accountdependencies.webp)
...
To update the service account password and then update all Windows services and
Scheduled tasks that run as the at account with the new password.

**Step 1 –** Navigate to the **Dashboards** > **Credentials** page.

**Step 2 –** In the Credentials table, select the account you want. You can apply the Type filter of
