...
- Use the account running this service — Local System, or computer account (NT AUTHORITY\SYSTEM)
  ...
  - A group Managed Service Account (gMSA) can be used by configuring it to run the Netwrix Access
    ...
    [Group Managed Service Account (gMSA) Configuration](/docs/accessinformationcenter/12.0/administration/advanced-configuration/gmsa.md) topic for
...
[Commit Active Directory Changes](/docs/accessinformationcenter/12.0/administration/advanced-configuration/commit-changes.md) topic for additional
