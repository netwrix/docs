...
Now you're ready to create Netwrix PolicyPak Taskbar policies.

:::note
For a video overview of Taskbar Manager, see
[](https://www.policypak.com/products/endpointpolicymanager-start-screen-manager.html)[PolicyPak Taskbar Manager: Quick Demo](/docs/policypak/components/startscreenandtaskbar/videos/gettingstarted/demotaskbar.md).
:::


Like the PolicyPak Start Menu policies, PolicyPak Taskbar Manager
policies also must reside within collections.

**Step 1 –** First, find the Taskbar Manager for Windows 10 node within the User | PolicyPak nodes in the Group Policy Editor. Then right-click to open the Taskbar Manager to create
your first PolicyPak Taskbar Manager collection, as shown in Figure 28.

![quickstart_taskbar_manager](/images/policypak/startscreentaskbar/quickstart_taskbar_manager.webp)

Figure 28. The PolicyPak Taskbar Manager Collection Editor.
...
![quickstart_taskbar_manager_1](/images/policypak/startscreentaskbar/quickstart_taskbar_manager_1.webp)
...
you'll see the two items inside the PolicyPak Taskbar Manager collection shown in
Figure 30.

![quickstart_taskbar_manager_2](/images/policypak/startscreentaskbar/quickstart_taskbar_manager_2.webp)
...
![quickstart_taskbar_manager_3](/images/policypak/startscreentaskbar/quickstart_taskbar_manager_3.webp)
...
This ends the PolicyPak Start Screen & Taskbar Manager Quickstart sections. Next,
we'll dive into more detail about the PolicyPak Start Screen & Taskbar Manager.
