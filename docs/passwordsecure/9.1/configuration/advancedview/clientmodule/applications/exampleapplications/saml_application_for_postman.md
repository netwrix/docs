...
This chapter explains how to configure the SAML application for **Postman**. It's assumed that
...
- After logging in, click the avatar, and select "**Settings**".
...
- Then click **Authentication**. Select a new method in the upper right corner.
...
:::note
A **Relay State** is required. This value can be created in the **Configure Identity Provider Details View**.
:::
