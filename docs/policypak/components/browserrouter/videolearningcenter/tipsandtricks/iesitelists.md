---
title: "Internet Explorer to PolicyPak Browser Router Site lists"
description: "Internet Explorer to PolicyPak Browser Router Site lists"
sidebar_position: 70
---
# Internet Explorer to PolicyPak Browser Router Site lists
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/UNvGz-fdJ3M" title="PolicyPak: Internet Explorer to PolicyPak Browser Router Site lists" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak:  Internet Explorer to PolicyPak Browser Router Site lists

Hi. This is Jeremy Moskowitz, former 15-year Group Policy MVP and Founder of Netwrix PolicyPak Software. In this video, I'm going to show you how you can take a
Microsoft Enterprise Mode Internet Explorer Site List and quickly convert it to be used in PolicyPak Browser Router.
