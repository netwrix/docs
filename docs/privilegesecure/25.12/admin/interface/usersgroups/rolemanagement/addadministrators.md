...
in the [Users & Groups Page](/docs/privilegesecure/25.12/admin/interface/usersgroups/usersgroups.md).

![Add Administrators Window](/images/privilegesecure/25.12/accessmanagement/admin/policy/window/usersgroups/addadministrators.webp)
