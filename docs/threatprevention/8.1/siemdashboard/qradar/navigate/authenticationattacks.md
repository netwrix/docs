...
![Authentication Attacks Dashboard](/images/threatprevention/8.1/siemdashboard/qradar/dashboard/authenticationattacks.webp)

- All Attacks (past week) – Timeline of all authentication attacks that started within the last
  week. See the [Graph Card Features](/docs/threatprevention/8.1/siemdashboard/qradar/navigate/navigate.md#graph-card-features) topic for additional
  information.
- Breakdown by Attack Type – Breakdown of authentication attacks that started within the last week.
  See the [Graph Card Features](/docs/threatprevention/8.1/siemdashboard/qradar/navigate/navigate.md#graph-card-features) topic for additional
  information.
