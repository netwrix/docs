...
![Add Resource Group](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/addresourcegroup.webp)
...
- Add resources to the resource group. See the
  [Add Resources Window for Resource Group](/docs/privilegesecure/25.12/admin/interface/resources/resourcegroups/addresourcestogroup.md) topic for
