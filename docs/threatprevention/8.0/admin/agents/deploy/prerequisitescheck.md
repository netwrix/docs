...
- Failed – Read the failure message and either click **Back** to provide new credentials or click
  **Finish** to close the window and fix any error messages before the next attempt
...
See the [Installing Window ](/docs/threatprevention/8.0/admin/agents/deploy/installing.md)topic for the next step.
