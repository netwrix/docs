...
to connect to either the SAM API Server or the host with the network share housing the
archived log files.
...
Multiple Enterprise Auditor Consoles aren't supported. This group should be run from a single
