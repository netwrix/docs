---
title: "PolicyPakCloud: How to deploy PolicyPak specific settings (using in-cloud editors and exporting from on-prem)"
description: "PolicyPakCloud: How to deploy PolicyPak specific settings (using in-cloud editors and exporting from on-prem)"
sidebar_position: 50
---
# PolicyPakCloud: How to deploy PolicyPak specific settings (using in-cloud editors and exporting from on-prem)

Its easy to do MANY things with Netwrix PolicyPak Cloud's
