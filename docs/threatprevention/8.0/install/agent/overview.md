...
[Agents Interface](/docs/threatprevention/8.0/admin/agents/overview.md) (with the exception of Harden Agent, Soften
...
Remember to check [Agent Server Requirements](/docs/threatprevention/8.0/requirements/agent/agent.md) before deploying an
Agent, including the
[Agent Compatibility with Non-Netwrix Security Products](/docs/threatprevention/8.0/requirements/agent/agent.md#agent-compatibility-with-non-netwrix-security-products)
list.
...
[Send Active Directory Event Data from Netwrix Threat Prevention to Netwrix Access Analyzer](/docs/threatprevention/8.0/admin/configuration/accessanalyzerconfiguration.md)
