...
![Server Backup Configuration Wizard - Server page](/images/identityrecovery/2.6/troubleshooting/updatepassword/server.webp)
...
[Add Backup Configurations for a Domain Controller](/docs/identityrecovery/2.6/admin/forest/forest.md#add-backup-configurations-for-a-domain-controller)
...
![Server Backup Configuration has been Saved](/images/identityrecovery/2.6/troubleshooting/updatepassword/serverbackupconfiguration.webp)
