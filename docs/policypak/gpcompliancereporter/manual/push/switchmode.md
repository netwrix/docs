...
becomes unavailable at this point because multi-user mode is enabled. Restart the PolicyPak GPCR client (admin console) to start using PolicyPak GPCR in multi-user mode
as shown in Figure 40.

![gpcr_server_with_push_mode_4](/images/policypak/grouppolicycompliancereporter/mode/push/gpcr_server_with_push_mode_4.webp)
...
![gpcr_server_with_push_mode_5](/images/policypak/grouppolicycompliancereporter/mode/push/gpcr_server_with_push_mode_5.webp)
