...
Configure False Positive exclusion filters using the options on the False Positives tab. Filters
listed here remove the corresponding matches from Access Analyzer and Access Information Center
reports.
