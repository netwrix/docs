...
Video: For a quick overview of how to manage IE Enterprise Mode using PolicyPak
...
PolicyPak enables you to create Enterprise Compatibility lists on the fly without the
...
In short, PolicyPak IE AppSet makes this process easy. You use the PolicyPak Browser Router component and not the PolicyPak Application Settings Manager
component, as shown In the figure shown.

![ie_appset_tab_by_tab_32](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_32.webp)

The figure shown. Setting up a dynamic list in Enterprise Mode using PolicyPak Browser
Router.
