...
entered when the host was added. You can prevent, monitor, or block LSASS code injections.
...
exclude. Double-click the text box beneath Type to enter the Active Directory objects you want to include or
