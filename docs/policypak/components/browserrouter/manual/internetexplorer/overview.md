...
PolicyPak Browser Router has special functions for managing Internet Explorer. First,
...
:::note
To get an overview of PolicyPak Browser Router and Internet Explorer 11's
...
:::warning
This PolicyPak Browser Router method is meant to replace the Microsoft
method of creating Enterprise Mode site lists. Do not try to use Microsoft's list (explained in the
Microsoft URL above) along with PolicyPak Browser Router's function. Only use PolicyPak Browser Router to perform this function.
:::


Using PolicyPak Browser Router, you can require particular websites to use a specific
Internet Explorer Enterprise Mode or Document Mode.

![about_policypak_browser_router_25](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_25.webp)

Internet Explorer 11's Enterprise Mode has two specifications: v1 and v2. PolicyPak
...
gives you the ability to use PolicyPak Browser Router to manage the Internet Explorer
Enterprise Mode site list without having to force users to specifically use Internet Explorer and
impose a route.

You can easily see if PolicyPak Browser Router and the Internet Explorer 11 Enterprise
...
![about_policypak_browser_router_26](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_26.webp)
...
we've set a page to display in IE5 Document Mode using PolicyPak Browser Router.

![about_policypak_browser_router_27](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_27.webp)

When users visit the website at this point, PolicyPak Browser Router correctly sets
...
![about_policypak_browser_router_28](/images/policypak/browserrouter/internetexplorer/about_endpointpolicymanager_browser_router_28.webp)
