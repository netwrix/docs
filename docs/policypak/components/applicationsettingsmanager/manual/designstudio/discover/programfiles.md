...
![discovering_configuration_1_624x213](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_1_624x213.webp)

The figure shown. Example of INI files.

However, if you try to select this file using Netwrix PolicyPak
DesignStudio, you will be provided a warning message, as shown In the figure shown.

![discovering_configuration_2](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_2.webp)
...
![discovering_configuration_3](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_3.webp)
