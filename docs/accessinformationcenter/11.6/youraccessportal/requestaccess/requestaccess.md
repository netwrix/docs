...
Click the **Request Access** button in the Your Access portal to open the Request Access wizard.
...
- Search Catalog – Begin typing the name of the resource:
    ...
    Center. Contact the Request Administrator if the resource you want doesn't come up with search
    filters.
    :::
...
indicated by the green plus (+) button, click the button to rotate through and select the access
level you want. Multiple resources can be selected using either the Ctrl or Shift key with mouse click
