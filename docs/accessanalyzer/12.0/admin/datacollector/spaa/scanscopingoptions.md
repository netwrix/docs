...
![Scan Scoping Options page](/img/product_docs/accessanalyzer/12.0/admin/datacollector/spaa/scanscopingoptions.webp)
...
![Enter URL on Scan Scoping Options page example](/img/product_docs/accessanalyzer/12.0/admin/datacollector/spaa/scanscopingoptionswebappurl.webp)
...
![Scan Scoping Options example](/img/product_docs/accessanalyzer/12.0/admin/datacollector/spaa/scanscopingoptionsexample.webp)
...
![CSV file with host and site collection information](/img/product_docs/accessanalyzer/12.0/admin/datacollector/spaa/virtualhostscsv.webp)
...
![Host List for targeting the Virtual Hosts](/img/product_docs/accessanalyzer/12.0/admin/datacollector/spaa/virtualhostshostlist.webp)
...
![SPAA Data Collector Wizard Scan Scoping Options page](/img/product_docs/accessanalyzer/12.0/admin/datacollector/spaa/scanscopingoptionsvirtualhosts.webp)
