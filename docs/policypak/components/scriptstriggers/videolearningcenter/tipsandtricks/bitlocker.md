---
title: "Implementing BitLocker through Group Policy Using PolicyPak Scripts Manager and Administrative Templates Manager"
description: "Implementing BitLocker through Group Policy Using PolicyPak Scripts Manager and Administrative Templates Manager"
sidebar_position: 60
---
# Implementing BitLocker through Group Policy Using PolicyPak Scripts Manager and Administrative Templates Manager

If you need to encrypt your company data to protect it against prying eyes, Netwrix PolicyPak can help configure and implement BitLocker into your existing
environment.
...
Hi, this is John from PolicyPak. We're going to look at deploying BitLocker. With more
...
group of users using PolicyPak Application Template Manager and Scripts Manager.
...
Let's go in and Edit. On the computer side we're going to expand PolicyPak. We're
