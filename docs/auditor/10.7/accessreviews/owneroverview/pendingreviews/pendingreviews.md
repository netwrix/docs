...
- Save Changes — Saves all recommended changes, enabling you to leave the review in progress and
  ...
  for the action.
- Remove Access — On the 1 Make changes tab, removes access from the selected trustees. Hold Ctrl
  and click to select multiple items. Current access blue icon with a checkmark will turn to an empty
  yellow icon.
