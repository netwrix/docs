...
![Attribute List Window](/images/threatprevention/8.0/admin/policies/eventtype/window/attributelist.webp)

- Select a server from the dropdown menu and click **Connect**. Schema attributes are fetched from
