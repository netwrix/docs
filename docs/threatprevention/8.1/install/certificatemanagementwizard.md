...
![Certificate Management Wizard on the Export Certificate Signing Request(s) to page](/images/threatprevention/8.1/install/exportcertificate.webp)
...
![Certificate Management Wizard on the Import Signed Certificate(s) page](/images/threatprevention/8.1/install/importsignedcertificates.webp)

**Step 3 –** On the Import Signed Certificate(s) page, select the folder containing the signed
certificates. Then click **Next**.

![Certificate Management Wizard - Import Certificate Authority Certificate(s) page](/images/threatprevention/8.1/install/importcertificateauthority.webp)
