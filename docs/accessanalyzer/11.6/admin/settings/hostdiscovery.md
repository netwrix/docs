...
![Host Discovery page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/settings/hostdiscovery.webp)
...
![Log level options](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/settings/hostdiscoveryloglevels.webp)
...
![Host Discovery Log under Host Discovery node](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/settings/hostdiscoverylog.webp)
