...
constantly enhanced. All of the available functions can be viewed in the
[Functional scope](/docs/passwordsecure/9.1/configuration/webapplication/functionalscope/functional_scope.md)
section.

![WebClient](/images/passwordsecure/9.1/configuration/web_application/installation_with_parameters_159.webp)

**Netwrix Password Secure Web Application** enables platform-independent access to the database via
a browser. It's irrelevant whether you're using Microsoft Windows, macOS, or Linux, it's only
