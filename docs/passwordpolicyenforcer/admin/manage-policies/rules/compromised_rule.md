...
![Compromised password rule](/images/passwordpolicyenforcer/administration/compromised.webp)
...
After you download the database, click **Browse** to select the database folder. You can also enter a path into the text box. Paths can include environment variables like `%ProgramFiles%`. You can configure the Compromised rule to use up to three databases if you have other compatible data sources.
