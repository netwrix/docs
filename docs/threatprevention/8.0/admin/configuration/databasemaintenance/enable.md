...
**Step 2 –** Select the tab you want (Event Type, Analytics, or Policy) and check the **Enabled** box
at the top of the tab.

![Database Maintenance window - Event Type tab](/images/threatprevention/8.0/admin/configuration/databasemaintenance/enablesettings.webp)
