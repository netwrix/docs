---
title: "How to import a WLAN / 802.11 / Wireless profile from Dropbox using PolicyPak Scripts Manager"
description: "How to import a WLAN / 802.11 / Wireless profile from Dropbox using PolicyPak Scripts Manager"
sidebar_position: 20
---

# How to import a WLAN / 802.11 / Wireless profile from Dropbox using PolicyPak Scripts Manager
...
**Step 4 –** Create the WLAN GPO and apply it to the OU where the Computers live, next use Netwrix PolicyPak Scripts Manager > on the Computer side to create a new
policy it

![658_1_img-1](/images/policypak/scriptstriggers/497_1_img-1.webp)

**Step 5 –** At the "Specify policy target screen be sure to use switched mode for the policy.

![658_2_img-2](/images/policypak/scriptstriggers/497_2_img-2.webp)
...
![658_3_img-3_950x601](/images/policypak/scriptstriggers/658_3_img-3_950x601.webp)

**Step 8 –** For the "Policy process mode configuration" screen specify "Once or when forced", then
click save.

![658_4_img-4](/images/policypak/scriptstriggers/658_4_img-4.webp)
