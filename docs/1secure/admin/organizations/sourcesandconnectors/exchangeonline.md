...
**To add an Exchange Online data source and connectors to your organization:**
...
**Step 4 –** Select **Exchange Online** and click **Next**. Because Exchange Online is a cloud
...
{/* TODO: Screenshot of Configure Source Details pane for Exchange Online */}
...
**Step 7 –** The Configure Connectors pane lists the connectors for Exchange Online.
...
{/* TODO: Screenshot of Configure Connectors pane for Exchange Online */}
