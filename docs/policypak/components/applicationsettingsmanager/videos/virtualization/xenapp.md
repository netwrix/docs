---
title: "PolicyPak & Citrix XenApp"
description: "PolicyPak & Citrix XenApp"
sidebar_position: 20
---
# PolicyPak & Citrix XenApp

Once your Citrix XenApp streaming application is launched by your users, they can do practically
whatever they want and DECREASE the security you want them to have. With Netwrix PolicyPak, you can dictate specific settings for each of your applications plus
lock users down so they can't work around your settings. See how PolicyPak enhances
...
### PolicyPak enhances Xenapp Streaming with Group Policy video transcript
