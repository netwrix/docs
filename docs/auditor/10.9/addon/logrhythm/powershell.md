...
To run the script with PowerShell, complete the following steps.
...
"_Overwrite events as needed_". See the [Integration Event Log Fields](/docs/auditor/10.9/addon/logrhythm/integrationeventlog.md) topic
