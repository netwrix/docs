---
title: "PolicyPak CSE Troubleshooting: Unlicense all components, and re-license the one to isolate"
description: "PolicyPak CSE Troubleshooting: Unlicense all components, and re-license the one to isolate"
sidebar_position: 60
---

# PolicyPak CSE Troubleshooting: Unlicense all components, and re-license the one to isolate

If directed by Netwrix PolicyPak support, you might need to set
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/FC2WRAbmx-o" title="PolicyPak CSE Troubleshooting: Unlicense all components, and re-license the one to isolate." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
