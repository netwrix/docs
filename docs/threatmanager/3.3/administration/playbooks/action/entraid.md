...
- Users – Select the users for whom to alter group membership. If you don't specify one, Threat Manager uses the
  user who triggered the threat.
...
- Group – Specify the identity of the group to manage. If you don't specify one, Threat Manager uses
  the group affected by the threat.
...
- Users –The users to disable. If you don't specify any, Threat Manager uses the user who triggered
  the threat
...
- Credential – Select a credential profile to execute this action. You configure credential profiles
  on the [Integrations Interface](/docs/threatmanager/3.3/administration/configuration/integrations/overview.md). If you don't
  specify one, the action runs as the credentials of the Action Service.
...
- New Password – Threat Manager resets the password to this value. If you don't specify one, Threat
  Manager generates a random password.
- Users – The users that will have their password reset. If you don't specify any, Threat Manager
