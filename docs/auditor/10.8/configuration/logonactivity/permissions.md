...
- Access this computer from the network. See the
  [Configure Access this computer from the network Policy](/docs/auditor/10.8/configuration/logonactivity/networkaccess.md) topic for additional information.
