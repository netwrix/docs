...
Next, use the [Planned Changes Tab](/docs/changetracker/8.2/admin/plannedchanges/plannedchanges.md) manage change events and filter any
...
Change Tracker, review the [Settings Tab](/docs/changetracker/8.2/admin/settingstab/settingstab.md).
