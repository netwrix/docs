...
know about it until the next hour. However, you can restart the PolicyPak GPCR Server
service as shown in Figure 60. Then the most recent Active Directory data will be pulled and used.

![tuning_and_troubleshooting_2](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_2.webp)

Figure 60. Restarting the PolicyPak GPCR server service.
...
Scheduler as an admin. Only then will you see the "PolicyPak GP Compliance Reporter
...
![tuning_and_troubleshooting_3](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_3.webp)
...
![tuning_and_troubleshooting_4](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_4.webp)
...
PolicyPak GPCR server on the command line, as shown in Figure 63.

![tuning_and_troubleshooting_5](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_5.webp)
...
that there was a communication problem between the PolicyPak GPCR client (admin
...
![tuning_and_troubleshooting_6](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_6.webp)
...
- DNS is not functioning between the PolicyPak GPCR client (admin console) and the
  target machine.

The PolicyPak GPCR client (admin console) must be able to contact each target machine
...
![tuning_and_troubleshooting_7](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_7.webp)
...
established, but a PolicyPak GPCR license was not found.

:::note
Target machines must be licensed for PolicyPak GPCR to return all data
(Microsoft and PolicyPak data).
:::


When a machine is licensed for PolicyPak GP Compliance Reporter, you should see its
...
![tuning_and_troubleshooting_8](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning_and_troubleshooting_8.webp)

Figure 66. The license status of the machines.

## Warning Messages

Just as Group Policy contains both user-side and computer-side items, the RCT does as well. PolicyPak GPCR helps test for compliance to your RCT. As such, an "OK" status is obtained only
...
![gpcr_concepts_and_quickstart_29_624x174](/images/policypak/troubleshooting/grouppolicycompliancereporter/gpcr_concepts_and_quickstart_29_624x174.webp)
