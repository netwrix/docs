...
The following kernel features must be available. The installer validates these automatically during installation (see [System Requirements](/docs/accessanalyzer/26_1/install/system/requirements)):
