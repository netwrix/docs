...
Netwrix PolicyPak Cloud has several roles:

- Acts as a licensing broker, enabling some computers to be licensed through the PolicyPak Cloud client MSI and connection to the Cloud service.
...
The PolicyPak Cloud web interface contains the following sections:

![web_interface_and_controls_624x229](/images/policypak/cloud/interface/web_interface_and_controls_624x229.webp)
