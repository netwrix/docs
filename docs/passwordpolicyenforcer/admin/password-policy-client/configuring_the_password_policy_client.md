...
cases. See the [Install Password Policy Enforcer Client](/docs/passwordpolicyenforcer/installation/installationclient.md) topic for
...
![ppc_configuration](/images/passwordpolicyenforcer/administration/ppc_configuration.webp)

**Step 3 –** Go to C:\Windows\Policy Definitions and paste the .admx file in the root of this
folder.

![ppc_configuration2](/images/passwordpolicyenforcer/administration/ppc_configuration2.webp)

**Step 4 –** Go to C:\Windows\Policy Definitions\en-US and paste the .adml file in the root of this
folder.

![ppc_configuration1](/images/passwordpolicyenforcer/administration/ppc_configuration1.webp)
...
![ppc_configuration3](/images/passwordpolicyenforcer/administration/ppc_configuration3.webp)
...
![ppc_configuration4](/images/passwordpolicyenforcer/administration/ppc_configuration4.webp)

**Step 9 –** Click **Netwrix Password Policy Client** to open a list of modification settings.

![ppc_configuration5](/images/passwordpolicyenforcer/administration/ppc_configuration5.webp)
...
![the_password_policy_client_3](/images/passwordpolicyenforcer/administration/the_password_policy_client_3.webp)
