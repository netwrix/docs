...
![Policy window - File System Enterprise Auditor Event Type](/images/threatprevention/8.0/admin/policies/eventtype/filesystemaccessanalyzer.webp)
...
[File System Changes Event Type](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/filesystemchanges/filesystemchanges.md) or the
[File System Lockdown Event Type](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/filesystemlockdown.md) are also available for consumption by
...
![Policy window - File System Enterprise Auditor filter](/images/threatprevention/8.0/admin/policies/eventtype/filesystemaccessanalyzer_1.webp)
...
![Policy window - File System Agents filter](/images/threatprevention/8.0/admin/policies/eventtype/filesystemagents.webp)
...
![Policy window - Processes and Configuration filter](/images/threatprevention/8.0/admin/policies/eventtype/processesandconfiguration.webp)
...
![Policy window - Perpetrators to Exclude filter](/images/threatprevention/8.0/admin/policies/eventtype/perpetratorstoexclude.webp)
