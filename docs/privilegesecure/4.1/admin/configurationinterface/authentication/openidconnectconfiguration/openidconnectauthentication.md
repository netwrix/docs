...
Password option to **Set by Admin** and configure the password directly. If the user is required to set (or reset)
their own password, Okta handles it – which won’t return control to
