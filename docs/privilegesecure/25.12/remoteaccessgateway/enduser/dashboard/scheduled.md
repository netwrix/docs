...
![Scheduled Dashboard](/images/privilegesecure/25.12/accessmanagement/enduser/dashboard/scheduleddashboarduser.webp)
...
- Create Session — Open the Activity Request window. See the
  [Create Activity Session](/docs/privilegesecure/25.12/remoteaccessgateway/enduser/dashboard/active/createsession.md) topic for additional information.
...
- Status — Shows status information for the session:
    ...
    - Available — The activity session is ready. Click the icon to begin the session, or log in
      through a client. See the [Sessions Interface](/docs/privilegesecure/25.12/remoteaccessgateway/enduser/dashboard/sessions.md) topic for additional information.
