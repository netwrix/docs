...
details for each of the following components.
...
The installer adds the following prerequisites if they aren't present:
...
**Step 4 –** Configure integration with one or more Netwrix products to feed the data type you need
into Threat Manager:
