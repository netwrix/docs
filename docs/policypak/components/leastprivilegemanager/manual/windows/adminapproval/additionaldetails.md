...
<iframe width="560" height="315" src="https://www.youtube.com/embed/0d7IZoWlUgQ" title="PolicyPak Least Priv Manager: Admin Approval Email method (with Notepad instead)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="1"></iframe>
