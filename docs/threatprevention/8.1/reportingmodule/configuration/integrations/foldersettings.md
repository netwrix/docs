...
![Local Folder settings on the Folder Settings page](/images/threatprevention/8.1/reportingmodule/configuration/integrations/localfolder.webp)
...
access to the shared folder. See the [Credential Profile Page](/docs/threatprevention/8.1/reportingmodule/configuration/integrations/credentialprofile.md) topic for
creating a profile.
:::
...
![Add New Shared Folder window](/images/threatprevention/8.1/reportingmodule/configuration/integrations/addnewsharedfolderwindow.webp)
