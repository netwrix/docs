...
Select the review on the Manage Reviews page and click **Delete**. The Delete Review window
...
Select the review instance from the dropdown menu on the Review Details page and click
