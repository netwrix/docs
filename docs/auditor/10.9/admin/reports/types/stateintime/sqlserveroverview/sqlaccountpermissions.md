...
![accountpermissionssqlserver_thumb_0_0](/images/auditor/10.9/admin/reports/types/stateintime/accountpermissionssqlserver_thumb_0_0.webp)
...
- Clicking a Object permissions link opens the
  [Object Permissions in SQL Server](/docs/auditor/10.9/admin/reports/types/stateintime/sqlserveroverview/sqlobjectpermissions.md) report.
- Clicking a Means granted link opens the **[SQL Server Means Granted](/docs/auditor/10.9/admin/reports/types/stateintime/sqlserveroverview/sqlmeansgranted.md)** report.
