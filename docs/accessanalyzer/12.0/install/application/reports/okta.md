...
To create an Access Analyzer Application in Okta using the WS-Fed template:
...
To configure multi-factor authentication for Access Analyzer:
...
You've now configured Multi-Factor Authentication for Access Analyzer.
