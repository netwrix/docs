...
![using_item_level_targeting_4](/images/policypak/feature/itemleveltargeting/using_item_level_targeting_4.webp)
...
PolicyPak Feature Manager for Windows will merge all policies that come from the Group
