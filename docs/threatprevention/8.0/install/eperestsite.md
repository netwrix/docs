...
![Threat Prevention Server Setup wizard - Custom Setup page](/images/threatprevention/8.0/install/customsetup.webp)
...
![Netwrix Threat Prevention EPE Rest Setup wizard - Database Login Information page](/images/threatprevention/8.0/install/database.webp)
...
![Netwrix Threat Prevention EPE Rest Setup wizard - Logon page](/images/threatprevention/8.0/install/windowsauthentication.webp)
...
See the [EPE Rest Site](/docs/threatprevention/8.0/eperestsite/overview.md) topic for additional information.
