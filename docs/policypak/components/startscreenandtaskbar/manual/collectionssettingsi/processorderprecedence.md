...
![collections_policy_settings_13](/images/policypak/startscreentaskbar/collections_policy_settings_13.webp)

Figure 46. The order in which collections are processed.

![collections_policy_settings_14](/images/policypak/startscreentaskbar/collections_policy_settings_14.webp)
...
![collections_policy_settings_15](/images/policypak/startscreentaskbar/collections_policy_settings_15.webp)
...
PolicyPak Start Screen & Taskbar Manager will merge all GPOs and collections, unless
there is a conflict. That means that instead of having one flat Start Menu and Taskbar XML file that
everyone must use and agree upon, you can distribute the directives across PolicyPak
...
conflicts between PolicyPak Start Screen policies and PolicyPak Taskbar
Manager policies.

For PolicyPak Start Screen policies, the following general rules apply:
...
- When using a GPO, multiple policies can affect the machine due to natural Group Policy precedence.
  ...
  will be evaluated.
- You can have multiple GPOs with PolicyPak Start Screen contents (and also get
  PolicyPak policies from other sources like MDM, Microsoft Endpoint Manager [SCCM and
...
For PolicyPak Taskbar Manager, the following general rule applies: in "Merge" mode,
