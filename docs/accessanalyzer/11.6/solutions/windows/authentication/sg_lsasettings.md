...
The SG_LSASettings job lists LSA settings on all targeted hosts. In particular, the job examines
the RunAsPPL, RestrictAnonymous, and ValidateKdcPacSignature keys. If these keys aren't set to 1, a
