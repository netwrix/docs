...
- Netwrix Threat Manager – Sends activity events to Netwrix Threat Manager or
  receives Active Directory monitoring events from Netwrix Threat Prevention for integration with
  Netwrix Access Analyzer

## Add File Output

**Step 1 –** On the Monitored Domains tab, select the domain you want and click **Add Output**.
...
[Netwrix Threat Manager Documentation](https://docs.netwrix.com/docs/threatmanager/3_0) for
