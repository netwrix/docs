...
For information on How It Works and Deployment Planning topics, see the
...
bottlenecks. Provide the recommended configuration, not the minimal one. The same applies to storage capacity,
especially if you plan to keep historical data for longer periods (for example, to support investigations
or compliance audits)—use SSD storage.
