---
title: "How does caching of Item Level Targeting work when PolicyPak ILT (ILT 2.0 Engine) is used?"
description: "How does caching of Item Level Targeting work when PolicyPak ILT (ILT 2.0 Engine) is used?"
sidebar_position: 30
---

# How does caching of Item Level Targeting work when PolicyPak ILT (ILT 2.0 Engine) is used?

The PolicyPak -specific (aka New ILT engine or ILT 2.0 engine) caches evaluation
