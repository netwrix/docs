---
title: "How do I make an Item Level Target for Server 2016 or Server 2019 (on-prem, MDM or PolicyPak Cloud) ?"
description: "How do I make an Item Level Target for Server 2016 or Server 2019 (on-prem, MDM or PolicyPak Cloud) ?"
sidebar_position: 60
---

# How do I make an Item Level Target for Server 2016 or Server 2019 (on-prem, MDM or PolicyPak Cloud) ?

Depending on the editor you are using, your Item Level Target (ILT) editor may show one of either
these two:

![88_1_image007](/images/policypak/itemleveltargeting/88_1_image007.webp)

![88_2_image008](/images/policypak/itemleveltargeting/88_2_image008.webp)

In both cases, they produce the same Item Level Targeting Filter in XML, like this:

![88_3_image009](/images/policypak/itemleveltargeting/88_3_image009.webp)

In this way, there is no distinction between 2016 and 2019 servers. This is not a Netwrix PolicyPak bug, because PolicyPak is using the underlying
...
![88_4_image010](/images/policypak/itemleveltargeting/88_4_image010.webp)

And match on Server 2019 like this:

![88_5_image012](/images/policypak/itemleveltargeting/88_5_image012.webp)
...
![88_6_image-20190927143735-1](/images/policypak/itemleveltargeting/88_6_image-20190927143735-1.webp)

**Step 2 –** Then set your ILT to something similar to this:

Windows 10 and BuildNumber \<= 17704

![88_7_image](/images/policypak/itemleveltargeting/88_7_image.webp)
