...
click on the wand, as shown In the figure shown.

![configuring_elements_using](/images/policypak/applicationsettings/designstudio/configurationwizard/configuring_elements_using.webp)

The figure shown. Starting the Configuration Wizard.
