...
See the [File Archive Repository Option](/docs/activitymonitor/9.0/requirements/adagent/activity/filearchive.md) topic for additional information on that
option.
...
## Set Up Integration Through API Server
