...
- Source – This menu provides a list of all integrations with the application. If there is only one
  ...
  [Netwrix Integrations Page](/docs/threatmanager/3.2/administration/configuration/integrations/netwrixintegrations.md) topic for
...
- Integrations (category group header in the menu):
    ...
    - Policy – The set of rules or configurations applied within the integration., which may require
      ...
      the [Netwrix Integrations Page](/docs/threatmanager/3.2/administration/configuration/integrations/netwrixintegrations.md) page
...
You can create a filter for a new investigation or modify a filter for a saved investigation. To build a filter statement:

**Step 1 –** Navigate to the Filters section of the investigation you want.
