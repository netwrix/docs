...
The issue of the CSE not allowing an uninstall or an updrage isn't a problem with the Netwrix PolicyPak CSE. This is a problem with the MSI database that
...
![116_1_msiuu2-image-005](/images/policypak/troubleshooting/install/116_1_msiuu2-image-005.webp)
...
![116_2_msiuu2-image-006](/images/policypak/troubleshooting/install/116_2_msiuu2-image-006.webp)

**Step 3 –** Manually install the latest PolicyPak CSE, and verify it worked as
expected.
...
If you don't already have a tool you use to deploy the PolicyPak CSE, we recommend you
