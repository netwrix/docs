...
- Action – This column has the following icons for conducting actions on the user or group:
    ...
    - Edit icon – Opens dropdown menus to edit the columns in the selected row.
    ...
    - Trash icon – Opens a Warning window to confirm the action of deleting the user or group.
      ...
      :::note
      You can't remove access for the built-in "ADMIN" account until you grant administrative
...
See the [Authentication Provider Page](/docs/threatmanager/3.2/administration/configuration/integrations/page/page.md) topic for
additional information.
...
information is updated. See the [Active Directory Sync Page](/docs/threatmanager/3.2/administration/configuration/integrations/activedirectorysync.md)
