...
![Add Dell VNX or Celerra Host](/images/activitymonitor/9.0/admin/monitoredhosts/add/addhostemcvnxcelerra.webp)
...
![Protocol Monitoring Options](/images/activitymonitor/9.0/admin/monitoredhosts/add/isilonprotocols.webp)
...
![Configure Operations Page](/images/activitymonitor/9.0/admin/monitoredhosts/add/configureoperationsforemcisilon.webp)
...
![Where to Log the Activity Page Generic](/images/activitymonitor/9.0/admin/monitoredhosts/add/wheretologgeneric.webp)
...
![Syslog Output Page](/images/activitymonitor/9.0/admin/monitoredhosts/add/syslogoutput.webp)
...
- [Dell Tab](/docs/activitymonitor/10.0/admin/monitoredhosts/properties/dell.md)
