...
![Administrator Auditing Dashboard](/images/threatprevention/8.0/siemdashboard/qradar/dashboard/administratorauditing.webp)
...
- All Administrator Activity – Tabular format of all events that have been recorded in the specified
  timeframe. See the [Table Card Features](/docs/threatprevention/8.0/siemdashboard/qradar/navigate/navigate.md#table-card-features) topic for additional
  information.
