...
>
> ![Identity Repository Example](/images/identitymanager/identityrepository-example.webp)

> In Identity Manager, the identity repository can look like the following:
>
> ![Identity Repository Result](/images/identitymanager/identityrepository_v602.webp)
>
> ![Identity Example](/images/identitymanager/identityrepository-person_v602.webp)
...
Then perform mass updates with the same kind of process, and update an Individual Identity via Identity Manager's workflows. See the [Update Identities in Bulk](../../user-guide/maintain/identity-data-modification/mass-update) and [Update an Individual Identity](../../user-guide/maintain/identity-data-modification/individual-update)topics for additional information.
