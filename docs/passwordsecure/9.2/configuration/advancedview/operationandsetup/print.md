...
:::note
The print preview accesses the functions of the printer driver. Depending on the printer or
...
They are printed out in table form.
...
Use this function to print out all filtered records in detailed view.
