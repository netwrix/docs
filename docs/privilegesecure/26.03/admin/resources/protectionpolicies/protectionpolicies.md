...
description: "Protection Policies"
sidebar_position: 30
---
...
[Allowed Members Tab for Protection Policies](/docs/privilegesecure/26.03/admin/resources/protectionpolicies/allowedmembers.md) are removed
from the resource.
...
![Protection policies page](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/page_4.webp)
...
- [Resources Tab for Protection Policies](/docs/privilegesecure/26.03/admin/resources/protectionpolicies/resources/resources.md)
- [Allowed Members Tab for Protection Policies](/docs/privilegesecure/26.03/admin/resources/protectionpolicies/allowedmembers.md)
- [Schedule Tab for Protection Policies](/docs/privilegesecure/26.03/admin/resources/protectionpolicies/schedule.md)
