...
which is linked to the Sales OU, which contains user accounts. Now, in User Configuration | PolicyPak | Start Screen Manager for Windows 10, select Add | New Collection, as seen in
Figure 6.

![quickstart_start_screen_manager_1](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_1.webp)

Figure 6. Creating a new collection using PolicyPak Start Screen Manager.

**Step 2 –** Next, you'll see the "Add new collection" dialog, as shown in Figure 7.

![quickstart_start_screen_manager_2](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_2.webp)

Figure 7. PolicyPak Start Screen Manager collections are used to group together
policies and configure the layout mode of all the groups.

There are two layout modes for a Netwrix PolicyPak Start Screen
...
![quickstart_start_screen_manager_3](/images/policypak/startscreentaskbar/settings/startscreen/quickstart_start_screen_manager_3.webp)

Figure 8. Selecting the "Partial (Preserve)" layout mode.

You'll see the collection created in both panels in Figure 9.

![quickstart_start_screen_manager_4](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_4.webp)

Figure 9. A PolicyPak Start Screen Manager collection can be seen in both MMC pane
views.

**Step 4 –** Double-click "Collection 1" to enter it. Then, right-click and select Add | New Group,
as shown in Figure 10.

![quickstart_start_screen_manager_5](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_5.webp)

Figure 10. PolicyPak Start Screen groups must be added to collections.

**Step 5 –** Next, you'll see the Start Screen Tile Group Editor, shown in Figure 11.

![quickstart_start_screen_manager_6](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_6.webp)
...
:::note
The Group Editor only applies to groups you make using PolicyPak, and
...
![quickstart_start_screen_manager_7](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_7.webp)
...
![quickstart_start_screen_manager_8](/images/policypak/startscreentaskbar/startscreen/quickstart_start_screen_manager_8.webp)
