---
title: "PolicyPak + FSLogix: Manage the Windows 10 Start Menu"
description: "PolicyPak + FSLogix: Manage the Windows 10 Start Menu"
sidebar_position: 30
---

# PolicyPak + FSLogix: Manage the Windows 10 Start Menu

Managing the Windows 10 Start Menu after using FSLogix is a piece of cake with Netwrix PolicyPak. Use FSLogix to hide/expose apps, then use PolicyPak to manage those applications on the Start Menu and on the TaskBar. AWESOME!

<iframe width="560" height="315" src="https://www.youtube.com/embed/UyL7wJTCgGE" title="PolicyPak+FSLogix: Manage the Windows 10 Start Menu" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
