...
settings in the [User settings](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/usersettings/user_settings.md) in the category:
...
Task**. The [Filter](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/filter/filter.md) can be used to select which data
