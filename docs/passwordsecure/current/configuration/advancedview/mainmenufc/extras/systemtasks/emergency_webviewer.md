...
[Backup management](/docs/passwordsecure/current/configuration/servermanger/mainmenu/backupsettings/backup_management.md).
...
**[System tasks](/docs/passwordsecure/current/configuration/advancedview/mainmenufc/extras/systemtasks/system_tasks.md)** and this task can be used to guarantee a regular backup of
