...
Use the SDD Criteria page to configure the criteria for discovering sensitive data. It
...
Select the checkbox for the criteria to use to search for sensitive data. You can also select
criteria using the **Select All** and **Select None** buttons.
