...
![Settings interface](/images/threatprevention/8.0/siemdashboard/qradar/settings.webp)

The More information link opens the IBM Knowledge Center with information on generating the QRadar
SEC token. After the token is generated, copy, and paste it here and click Save.
...
the [INTERCEPT Offenses in QRadar](/docs/threatprevention/8.0/siemdashboard/qradar/offenses.md) topic for additional information.
