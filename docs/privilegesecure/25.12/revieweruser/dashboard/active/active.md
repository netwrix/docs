...
![Active Dashboard](/images/privilegesecure/25.12/accessmanagement/revieweruser/dashboard/reviweractivedashboard.webp)
...
- Create Session — Open the Activity Request window. See the
  [Create My Activity Session](/docs/privilegesecure/25.12/revieweruser/myactivities/createsession.md) topic for additional information.
...
- View Logs — Opens the Session Logs window to view the action log for the selected session. See the
  [Session Logs Window](/docs/privilegesecure/25.12/revieweruser/dashboard/active/startsession/sessionlogs.md) topic for additional information.
...
- Status — Shows status information for the session:
    ...
    - Waiting for Approval — The session requires approval to begin. See the
      [Approvals Dashboard](/docs/privilegesecure/25.12/revieweruser/dashboard/approvals.md) topic for additional information.
    - Available — The activity session is ready. Click the icon to begin the session, or log in
      through a client. See the [Start Activity Session](/docs/privilegesecure/25.12/revieweruser/dashboard/active/startsession/startsession.md) topic for additional
      information.
