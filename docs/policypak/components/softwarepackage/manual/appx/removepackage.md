...
PolicyPak. These could include Company Portal, Cortana, Mail, Clock, Weather, and
others. You can use the PolicyPak Software Package Manager Helper Tool (see next
...
![appx_policies_and_settings_8](/images/policypak/softwarepackage/appx/appx_policies_and_settings_8.webp)

Then on the endpoint run GPUpdate to acquire the policy change. You should see Skype go from present
to removed.

![appx_policies_and_settings_9](/images/policypak/softwarepackage/appx/appx_policies_and_settings_9.webp)

![appx_policies_and_settings_10](/images/policypak/softwarepackage/appx/appx_policies_and_settings_10.webp)
