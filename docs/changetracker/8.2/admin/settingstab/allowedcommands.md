...
![allowedcommands](/images/changetracker/8.2/admin/settings/allowedcommands.webp)
...
![AllowedCommandsCategories](/images/changetracker/8.2/admin/settings/allowedcommandscategories.webp)
...
![AllowedCommandsTrustStatus](/images/changetracker/8.2/admin/settings/allowedcommandstruststatus.webp)

## Using the Allowed Commands Page

Navigate to **Settings** – **Allowed Commands**:

![AllowedCommandsPage](/images/changetracker/8.2/admin/settings/allowedcommandspage.webp)
