...
- Click Analytics in the left pane to launch the Analytics interface. Then click the gear icon for
  the analytic.
- Expand the Analytics node and click the Impersonation Logins analytic. On the analytic window, click the gear
...
![Impersonation Logins Analytic Type - Settings tab](/images/threatprevention/8.0/admin/analytics/concurrentloginssettings.webp)
...
![Impersonation Logins Analytic Type - Policy tab](/images/threatprevention/8.0/admin/analytics/policytab.webp)
...
![Impersonation Logins Analytic Type window](/images/threatprevention/8.0/admin/analytics/impersonationlogins.webp)
