...
![Protection policy resources tab](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/policyprotection/resources.webp)

The Resources table has the following features:

- Add — Opens the Add Resources window. See the
[Add Resources Window for Protected Policy](/docs/privilegesecure/26.03/admin/resources/protectionpolicies/resources/addresources.md) topic
