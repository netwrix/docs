...
As this new model is organized into XML elements called universes, Identity Manager refers to the new data model as the universe model.
...
![Process Schema](/images/identitymanager/powerbi_process.webp)
...
**Step 4 –** Customize the queries in Power BI, if needed, with the [M language](https://docs.microsoft.com/en-us/powerquery-m).
...
For example, the following M query removes the column Company Id from the table Directory_User_Records because it's not needed for future reports.
...
**Step 5 –** Generate reports and publish them for end-users by following the steps listed in the [Power BI documentation.](https://docs.microsoft.com/en-us/power-bi/create-reports/)
