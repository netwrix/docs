...
- [0.Collection Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/db2/collection/overview.md)
...
- [Configuration > Db2_DatabaseSizing Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/db2/db2_databasesizing.md)
  — Provides insight into Db2 server configuration settings

- [Permissions Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/db2/permissions/overview.md)—
...
- [Sensitive Data Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/db2/sensitivedata/overview.md)
