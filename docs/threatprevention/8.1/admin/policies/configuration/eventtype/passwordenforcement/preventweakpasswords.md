...
Feedback module. See the [ Enterprise Password Enforcer](/docs/threatprevention/8.1/solutions/epe.md) topic for
...
Refresh button to view blocked events. See the [Recent Events Tab](/docs/threatprevention/8.1/admin/policies/configuration/recentevents/overview.md)
topic for additional information.

![Recent Events Tab for weak password prevent](/images/threatprevention/8.1/admin/policies/eventtype/usecase/recenteventsprevent.webp)

## View Events in Investigate Interface

![Investigate Interface](/images/threatprevention/8.1/admin/policies/eventtype/usecase/invesitgatenodeblock.webp)
