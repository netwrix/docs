...
description: "Displays a form to update data for several resources simultaneously."
sidebar_position: 7
---
...
<!-- TODO:Seems like summaries don't appear in the UI. Once fixed, add a screenshot. -->
