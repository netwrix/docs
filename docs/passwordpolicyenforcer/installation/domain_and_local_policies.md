...
5. Right-click the **Registry** item, then select **New** > **Registry Wizard**.
   ...
   ![domain_and_local_policies](/images/passwordpolicyenforcer/administration/domain_and_local_policies.webp)
...
8. Click the **Password Policy Enforcer 11.0** item, then select the checkboxes beside each item in the bottom pane of the window.
   ...
   ![domain_and_local_policies_1](/images/passwordpolicyenforcer/administration/domain_and_local_policies_1.webp)
