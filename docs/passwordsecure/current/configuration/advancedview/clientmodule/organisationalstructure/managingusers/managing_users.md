...
only the differences will be covered in the following sections.
...
- **Restricted user**: Controlling entities exist in many companies that are only tasked with
  ...
  responsible for issuing permissions to other people but shouldn't be able to view the data
...
other editions you can only purchase Advanced view licenses. Licensed Basic view
