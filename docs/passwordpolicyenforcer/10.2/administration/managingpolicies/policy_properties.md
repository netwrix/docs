...
Password Policy Enforcer only enforces enabled policies. Select the **Enabled** checkbox if
...
The **Default character set** dropdown list specifies which character set Password Policy
...
:::note
Only Password Policy Enforcer 10.0 and later contain the Windows character set. Password Policy Enforcer 9, Netwrix Password Reset, and Password Policy Enforcer/Web 7 (and older for all products) always use the Password Policy Enforcer character set.
:::


:::warning
This value shouldn't be changed while using PPE9.x clients, APR 3.x and Password
...
The **Reject passwords that don't comply with** dropdown list specifies the required compliance
