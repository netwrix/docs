...
[SharePoint On-Premise Activity Auditing Configuration](/docs/activitymonitor/9.0/requirements/activityagent/sharepoint-onprem-activity.md)
topic for additional information.

:::tip
Remember, deploy the Activity Agent to the SharePoint Application server that hosts the
...
- [SharePoint Tab](/docs/activitymonitor/9.0/admin/monitoredhosts/properties/sharepoint.md)
