...
[Process Monitor 101](/docs/policypak/gettingstarted/misc/videos/troubleshooting/processmonitor.md)
:::
...
1. Run Process explorer to find the process. You want to find the PID of the process with a problem.
   ...
   ![525_1_image003](/images/policypak/troubleshooting/525_1_image003.webp)
