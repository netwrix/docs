...
![Recovery for Active Directory Setup wizard - Initial EULA page](/images/identityrecovery/2.6/install/eula.webp)
...
![Installation Welcome Page](/images/identityrecovery/2.6/install/welcome.webp)

**Step 3 –** On the Welcome page of the Recovery for Active Directory Setup wizard, click Next to
begin the installation.

![Installation Destination Folder Page](/images/identityrecovery/2.6/install/destinationfolder.webp)
...
![Recovery for Active Directory Setup wizard - Change destination folder page](/images/identityrecovery/2.6/install/changedestinationfolder.webp)
...
![Installation License File Page](/images/identityrecovery/2.6/install/licensefile.webp)
...
![Installation SQL Server Configuration](/images/identityrecovery/2.6/install/sqlserverconfiguration.webp)
...
![Installation SQL Server Database Name](/images/identityrecovery/2.6/install/sqlserverdatabase.webp)
...
![serverconfiguration](/images/identityrecovery/2.6/install/serverconfiguration.webp)
...
![Installation Admin Role Page](/images/identityrecovery/2.6/install/administratorrole.webp)
...
![Installation Web Host Configuration](/images/identityrecovery/2.6/install/webhost.webp)
...
![Installation Certificates Window](/images/identityrecovery/2.6/install/certificates.webp)
...
![Installation Ready to Install](/images/identityrecovery/2.6/install/ready.webp)

**Step 11 –** Click **Install** to begin the installation process.

![completed](/images/identityrecovery/2.6/install/completed.webp)
...
Recovery Console icon is located on the desktop. See the [First Launch](/docs/identityrecovery/2.6/install/firstlaunch.md) topic for
the next step.
