...
Intune, or an RMM tool to bootstrap the installation of the PolicyPak Cloud client and
...
![web_interface_and_controls_108_625x221](/images/policypak/cloud/interface/web_interface_and_controls_108_625x221.webp)

**Step 1 –** To do this, go to the Tools tab, then click on the Join Tokens action.

![web_interface_and_controls_109_624x306](/images/policypak/cloud/interface/web_interface_and_controls_109_624x306.webp)
...
![web_interface_and_controls_110_312x333](/images/policypak/cloud/interface/web_interface_and_controls_110_312x333.webp)

**Step 3 –** Click **Save**.

![web_interface_and_controls_111_623x205](/images/policypak/cloud/interface/web_interface_and_controls_111_623x205.webp)
