...
folder. See the [Install Components & Methods](/docs/privilegesecure/26.03/install/components.md) topic for additional
information.
...
![SbPAM Enablement Toolkit - EULA Agreement window](/images/privilegesecure/26.03/accessmanagement/admin/sbpamenablementtoolkit_-_1_-_eula_agreement.webp)
...
![SbPAM Enablement Toolkit - Default Interface](/images/privilegesecure/26.03/accessmanagement/admin/sbpamenablementtoolkit_-_2_-_main_interface.webp)
...
![Stealthbits Enablement Toolkit - Help Menu](/images/privilegesecure/26.03/accessmanagement/admin/sbpamenablementtoolkit_-_3_-_help_window.webp)
...
![Stealthbits Enablement Toolkit - Execution Complete](/images/privilegesecure/26.03/accessmanagement/admin/sbpamenablementtoolkit_-_4_-_execution_complete.webp)
...
![Troubleshooting - GPO Settings](/images/privilegesecure/26.03/accessmanagement/admin/troubleshootinggposettings.webp)
...
![Troubleshooting - SHA1](/images/privilegesecure/26.03/accessmanagement/admin/troubleshootingsha1.webp)
...
- Rest URL - This setting determines the Rest API URL that send REST calls to the Netwrix
