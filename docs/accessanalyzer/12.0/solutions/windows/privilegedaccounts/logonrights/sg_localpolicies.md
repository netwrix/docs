...
![Analysis Tasks for the SG_LocalPolicies Job](/img/product_docs/accessanalyzer/solutions/windows/privilegedaccounts/logonrights/localpoliciesanalysis.webp)
