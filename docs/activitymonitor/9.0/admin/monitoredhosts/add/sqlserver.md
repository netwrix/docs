...
[SQL Server Activity Auditing Configuration](/docs/activitymonitor/9.0/requirements/activityagent/sqlserver-activity.md) topic for
...
To add a SQL Server host to be monitored, complete the following steps:
...
- [MS SQL Server Tab](/docs/activitymonitor/9.0/admin/monitoredhosts/properties/mssqlserver.md)
- [Logon Trigger Tab](/docs/activitymonitor/9.0/admin/monitoredhosts/properties/logontrigger.md)
- [Tweak Options Tab](/docs/activitymonitor/9.0/admin/monitoredhosts/properties/tweakoptions.md)
