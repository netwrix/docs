...
- Informative APIs
  ...
  the [Agents Interface](/docs/threatprevention/8.1/admin/agents/overview.md) and a list of available PowerShell APIs the
  user can use.
  :::
...
To compare two XML files as exported from Threat Prevention:

**Step 1 –** Craft the policy you want in the Administration Console and export as a XML file.
