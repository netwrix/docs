...
displays the same information as the [Users Dashboard](/docs/privilegesecure/26.03/admin/dashboard/users.md).

![Users and Groups Page](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/usersgroupspage.png)
...
information.
- Add Application — Opens the Add Application page. See the [Add Application](/docs/privilegesecure/26.03/admin/usersgroups/add/application.md)
for additional information.
- Add Local User — Opens the Add Local User page. See [Add Local User](/docs/privilegesecure/26.03/admin/usersgroups/add/localuser.md) topic
for additional information.
