...
- For the AD_DeprovisionComputers Job, the target OU needs to be manually set in the Move Computers
  ...
  [Action Tasks for the AD_DeprovisionComputers Job](/docs/accessanalyzer/11.6/solutions/activedirectory/cleanup/computers/ad_deprovisioncomputers.md#action-tasks-for-the-addeprovisioncomputers-job)
