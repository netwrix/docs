...
the latest Netwrix PolicyPak version before using the steps in
this KB.
:::


PolicyPak Browser Router has a function called **User Selectable browser**. Learn more
about this feature first here:

[PolicyPak Browser Router User-Selected Default](/docs/policypak/components/browserrouter/videolearningcenter/gettingstarted/userselecteddefault.md)
...
You might need to have PolicyPak Browser Router indicate that a user specifically
...
![507_1_image-20201229224350-1_950x136](/images/policypak/browserrouter/507_1_image-20201229224350-1_950x136.webp)
...
For Example:
![507_2_image-20201229224350-2](/images/policypak/browserrouter/507_2_image-20201229224350-2.webp)
...
- Value Name: ProgID
- Value Type: REG_SZ
  ![507_3_image-20201229224350-3](/images/policypak/browserrouter/507_3_image-20201229224350-3.webp)-
...
![507_4_image-20201229224350-4](/images/policypak/browserrouter/507_4_image-20201229224350-4.webp)

![507_5_image-20201229224350-5_950x366](/images/policypak/browserrouter/507_5_image-20201229224350-5_950x366.webp)

Be sure to have entries which set HTTP and HTTPS like these two values here (i.e., Repeat Steps 1 &
2 above for HTTPS value)

![507_6_image-20201229224350-6](/images/policypak/browserrouter/507_6_image-20201229224350-6.webp)
