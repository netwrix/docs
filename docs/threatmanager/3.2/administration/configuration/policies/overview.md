...
- Host – The host on which the policy was applied. If the host exists in the Threat Manager
  database, click on the host link to go to the [Host Details Page](/docs/threatmanager/3.2/administration/threats/activedirectoryobjects/host.md)
...
configuration options for that policy. See [Policy Configuration](/docs/threatmanager/3.2/administration/configuration/policies/policiesconfiguration.md) for
...
[Configure Honeytoken Threats](/docs/threatmanager/3.2/administration/configuration/policies/honeytoken.md) for Honeytoken naming best practices.
:::
...
- Name – The name for the policy
    ...
    :::note
    See [Configure Honeytoken Threats](/docs/threatmanager/3.2/administration/configuration/policies/honeytoken.md) for best practices for naming a
    Honeytoken.
    :::
