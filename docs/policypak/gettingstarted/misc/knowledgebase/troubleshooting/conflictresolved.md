...
When you attempt to deliver policies from multiple sources, for example Group Policy and Netwrix PolicyPak Cloud everything is merely combined together for a
...
![717_1_img-01](/images/policypak/troubleshooting/717_1_img-01.webp)
...
called `RDP123.RDP `.. and you use both Group Policy and PolicyPak Cloud at the same
...
Security Settings are delivered from multiple sources like Group Policy and PolicyPak
