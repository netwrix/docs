---
title: "PolicyPak + WVD: Manage the Start Screen and Taskbar"
description: "PolicyPak + WVD: Manage the Start Screen and Taskbar"
sidebar_position: 40
---

# PolicyPak + WVD: Manage the Start Screen and Taskbar

WVD is great. But finding the icons to run applications can be hard. Use Netwrix PolicyPak to add visibility to your icons on the Start Screen and Taskbar!

<iframe width="560" height="315" src="https://www.youtube.com/embed/3I1M9kFznYk" title="PolicyPak + WVD: Manage the Start Screen and Taskbar" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
side at the right time. That's what the PolicyPak Start Screen & Taskbar Manager does.
...
itself. We're going to do this in the "PolicyPak" node in the "Start Screen Manager
...
applications they need either on the Start Screen or on the Taskbar using PolicyPak
