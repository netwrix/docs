...
**Step 2 –** Next, within the GPO Editor, go to User Configuration > PolicyPak > App
Delivery & Patching Pak > Software Package Manager. Right-click on New Windows Store (AppX) Policy.

![appx_policies_and_settings](/images/policypak/softwarepackage/appx/appx_policies_and_settings.webp)
...
![appx_policies_and_settings_1](/images/policypak/softwarepackage/appx/appx_policies_and_settings_1.webp)
