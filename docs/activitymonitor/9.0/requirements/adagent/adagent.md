...
domain and are compatible with Netwrix Access Analyzer and Netwrix
...
![nam_admodule](/images/activitymonitor/9.0/requirements/nam_admodule.webp)
...
![ntp](/images/activitymonitor/9.0/requirements/ntp.webp)
...
Deploy the AD Agent to every domain controller to monitor Active Directory domains. The server
...
- Agent Size – 150 MB
- Agent Queues – If a network outage occurs, the agent will cache up to 40 GB of event data
...
See the [Active Directory Activity Auditing Configuration](/docs/activitymonitor/9.0/requirements/adagent/activity/activity.md)
