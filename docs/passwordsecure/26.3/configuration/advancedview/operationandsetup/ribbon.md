...
[Main menu](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/main_menu_fc.md):
...
[Reading pane](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/reading_pane.md) is opened (1), further tabs will be visible in the
...
Double-clicking on an object in the [List view](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/list_view.md) opens a new tab with its
