---
title: "PolicyPak Start Screen Manager: Add IE links"
description: "PolicyPak Start Screen Manager: Add IE links"
sidebar_position: 50
---
# PolicyPak Start Screen Manager: Add IE links

Need to add IE links to the Start Menu? Here's the quick and easy way… With Netwrix PolicyPak!

<iframe width="560" height="315" src="https://www.youtube.com/embed/TV9XWZRdV80" title="PolicyPak Start Screen Manager: Add IE links" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak Start Screen Manager – Add IE links

Hi. This is Jeremy Moskowitz, former Group Policy MVP and Founder of PolicyPak
Software. In this video, I'm going to show you how you can use PolicyPak to create
Internet Explorer shortcuts in the Windows 10 start screen using PolicyPak Start
...
get started with PolicyPak Start Screen Manager real soon.  
Thanks so much.
