---
title: "PolicyPak Scripts: Automate Software deployments with PP Scripts and Chocolaty.org"
description: "PolicyPak Scripts: Automate Software deployments with PP Scripts and Chocolaty.org"
sidebar_position: 10
---
# PolicyPak Scripts: Automate Software deployments with PP Scripts and Chocolaty.org
...
Netwrix PolicyPak, and... bingo. You're done. Remotely install
just about any pre-packaged software from Choco's repository. And use PolicyPak
...
installation of software from Chocolaty.org using PolicyPak. Now what I'm about to
show you works across all of the PolicyPak platforms, either the Group Policy edition,
...
actually deploy, and I'm going to show you how to do it using PolicyPak, but I want to
do a little walk before I run test, as I do in lots of my videos. I'm going to just show you how
Chocolaty works without PolicyPak first and then we're going to add PolicyPak to it second.
...
hint, we're going to do this exact same thing using PolicyPak in just about three
...
Now that we we've done the walk before we run test, now, it's time to do this all on PolicyPak land. What I'm going to do is I'm going to pause the video and revert back to before the
...
my users. Again, you can do this on the computer side as well. Again, you could do this in PolicyPak Cloud. You can take what we're about to do here and export it for wrapping up to MDM.
...
it when it was running with admin rights, ha ha. Well, PolicyPak's Scripts Manager has
...
way for me to demonstrate to you that you can use PolicyPak scripts to automate the
...
boom, there you go. If you wanted to be fancy, of course you could use PolicyPak Start
...
that. I'm just going to unlink the GPO. If this were an MDM or a PolicyPak Cloud
...
That's all there is to it. you can use PolicyPak scripts to deliver the Choco guts,
