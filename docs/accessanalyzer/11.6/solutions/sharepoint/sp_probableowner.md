...
The SP_ProbableOwner Job identifies probable owners for Site Collections and Sites, which you can
use for entitlement reviews. Probable Owner calculation is based on file ownership, management
structure, and file activity. The goal of this report is to help you identify who most likely owns
the SharePoint resource or at least someone who can tell you who does.
