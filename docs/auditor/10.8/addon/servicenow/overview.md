...
1. The add-on comes with a special set of alerts developed by Netwrix industry experts. With the help
   of a straightforward command-line tool, you upload these alerts to Netwrix Auditor and enable
