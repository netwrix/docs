...
sections:[ Creating databases](/docs/passwordsecure/26.3/configuration/servermanger/creating_databases.md) and
...
[User settings](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/usersettings/user_settings.md). The synchronization is
