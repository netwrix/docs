...
![Integrations interface displaying the details for a Radius authneication provider](/images/threatprevention/8.1/reportingmodule/configuration/integrations/authenticationprovider/radius.webp)
