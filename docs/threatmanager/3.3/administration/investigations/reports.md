...
investigation. See the [Entra ID Sync Page](/docs/threatmanager/3.3/administration/configuration/integrations/entraidsync.md) topic for
additional information.
:::
...
An investigation resides in the folder where you saved it.
...
See the [Host Details Page](/docs/threatmanager/3.3/administration/threats/activedirectoryobjects/host.md) topic and the
[User Details Page](/docs/threatmanager/3.3/administration/threats/activedirectoryobjects/user.md) topic for additional information.
...
Click the link to view target details. See the [Host Details Page](/docs/threatmanager/3.3/administration/threats/activedirectoryobjects/host.md) topic
