...
![addoreditpath](/images/activitymonitor/9.0/admin/outputs/window/addoreditpath.webp)
...
Threat Prevention agent. That configuration is on the [Log Files Tab](/docs/activitymonitor/10.0/admin/outputs/logfiles.md). If the option
