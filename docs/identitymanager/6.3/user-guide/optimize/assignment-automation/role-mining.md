...
2. **suggested rules**, i.e. rules which don't assign roles directly, but suggest them during an entitlement request for a user.
    ...
    ![Suggested](/images/identitymanager/rolemining_suggested_v602.webp)
...
![Rule Types - Sensitivity](/images/identitymanager/rolemining_ruletype-sensitivity.webp)
...
2. Click on the addition button at the top right and fill in the fields.
    ...
    ![**new** Mining Rule](/images/identitymanager/rolemining_miningrule_v602.webp)

    - `Policy`: [Create a Policy](../../../user-guide/optimize/policy-creation) in which the mining rule exists.
    - `Entity Type`:
[Create an Entity Type](../../../user-guide/set-up/connect-system/entity-type-creation) on which the mining rule is applied, i.e. the entity type targeted by role mining's entitlement analysis.
    - `Category`:
[Create a Category](../../../user-guide/set-up/single-roles-catalog-creation/category-creation) containing the roles targeted by role mining's analysis.
    ...
    - `Rule Policy`: [Create a Policy](../../../user-guide/optimize/policy-creation) in which the single role rules will be generated.
...
Netwrix Identity Manager (formerly Usercube) recommends [Removing Redundant Assignments](../../../user-guide/optimize/assignment-automation/remove-redundant-assignments) after any assignment rule is created or updated.
