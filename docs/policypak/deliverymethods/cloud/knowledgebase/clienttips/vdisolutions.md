...
The end goal is to install the Netwrix PolicyPak Cloud (PPC)
...
**Step 3 –** Download the required PolicyPak Cloud Client MSI package (version
20.5.2449.838 or higher) to the Gold Image Desktop, and save it under the `C:\PPC Client` folder on
the Gold Image VM.

PolicyPak Cloud Client version 20.5.2449.838 and higher can be found within your PPC
...
![555_1_image-20200603123515-1](/images/policypak/integration/555_1_image-20200603123515-1.webp)

![555_3_image-20200603094325-1_1231x309](/images/policypak/integration/555_3_image-20200603094325-1_1231x309.webp)

**Step 4 –** On the Gold Image VM, while logged in as a local administrator, install the PolicyPak Cloud Client MSI that you copied under "`C:\PPC Client`", (double-click MSI to
install, etc.)
...
2. When testing using Logoff, remember to restart the PolicyPak **Cloud Clien**t
   service to have it register with the PPC portal again if needed.
3. PPCLOUD /SYSPREP requires local administrator rights. You need to use PolicyPak
...
![555_4_image-20230130144125-1](/images/policypak/integration/555_4_image-20230130144125-1.webp)
...
policies, and stops the PolicyPak **Cloud Client** service. The machine will be
registered with the PolicyPak Cloud portal after a reboot (i.e. after the image is
...
![555_5_image-20200603123515-3](/images/policypak/integration/555_5_image-20200603123515-3.webp)
...
![555_7_image-20200603123515-4](/images/policypak/integration/555_7_image-20200603123515-4.webp)

![555_9_image-20200603123515-5](/images/policypak/integration/555_9_image-20200603123515-5.webp)
...
![555_11_image-20200603123515-6](/images/policypak/integration/555_11_image-20200603123515-6.webp)
...
![555_13_image-20200603123515-7_950x260](/images/policypak/integration/555_13_image-20200603123515-7_950x260.webp)
