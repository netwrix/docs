...
![tierescalation](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/tierescalation.webp)
...
![Tier 1 Escalation Example](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/tier1escalationexample.webp)

**Step 8 –** Click the **Add Approvers** icon to open the Add Users and Groups as Approvers window.

![Add Users and Groups as Approvers](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/addusersandgroupsasapprovers.webp)
...
![Tier 1 Example](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/tier1example.webp)
