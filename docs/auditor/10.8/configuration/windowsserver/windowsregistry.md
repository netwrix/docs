...
**Step 6 –** Set **Type** to _"Success"_ and **Applies to** field to _"This key and subkeys_.
...
Using Group Policy for configuring registry audit isn't recommended, as registry DACL settings may
be lost.
