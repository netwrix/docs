...
**1.\_\_**Before proceeding\_\_, you should go through the [Overview](../../installation-guide/overview) and [Requirements](../../installation-guide/requirements) sections to make fundamental decisions about Identity Manager setup, including:
