...
OpenID is an open standard for authentication that lets you log into multiple websites using
...
After have added an authentication provider, as discussed in the
...
- Action – This column has the following icons for conducting actions on the user or group:
  ...
  - Edit icon – You can edit the columns in the selected row by enabling dropdown menus.
