...
![AD Attributes filter - serAccountControl attribute selected](/images/threatprevention/8.0/admin/policies/eventtype/window/useraccountcontrolattribute.webp)
...
![User Account Control Window](/images/threatprevention/8.0/admin/policies/eventtype/window/useraccountcotrol.webp)
