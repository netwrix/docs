...
Privilege Secure database, and therefore aren't dependent on Active Directory authentication when
...
![addlocalusers](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/addlocalusers.webp)

To add a New Local Users.
...
Once saved, users can view the new Local User on the [Users & Groups Page](/docs/privilegesecure/25.12/admin/interface/usersgroups/usersgroups.md).
