...
investigation criteria to function as a threat detection mechanism that Threat Manager monitors like built-in threats.
...
- New Investigation – Lets you run queries on available data with desired filters for a
...
Type in the search box. As you type, a dropdown populates with saved investigations containing matches.
