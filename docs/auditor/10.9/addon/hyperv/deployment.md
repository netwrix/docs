...
deployment scenarios. Possible deployment options are as follows (this assumes that the add-on
...
the [Add-On Parameters](/docs/auditor/10.9/addon/hyperv/parameters.md)topic for additional information.
