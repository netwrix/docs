...
DaysToKeepEventsFor system setting. See the [System Settings](/docs/changetracker/8.2/admin/settingstab/systemsettings/systemsettings.md) topic
...
See the [Overview Tab](/docs/changetracker/8.2/compliance/complianceoverviewtab.md) topic for additional information.
