...
:::note
Use the update check on the server or the client to install the latest version.
...
The right to install updates is acquired with the software maintenance package. You must 
You are permitted to install all updates as long as the software maintenance package is
...
[License settings](/docs/passwordsecure/current/configuration/servermanager/mainmenu/license_settings.md).
...
data that Password Secure sent to you by email to log in.
...
([Installation Web Application](/docs/passwordsecure/current/installation/installationwebapplication/installation_web_application.md)
