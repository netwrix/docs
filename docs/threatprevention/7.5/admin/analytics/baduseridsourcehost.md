...
:::info
The recommended day limit is 30 days.
:::
...
- Click Analytics in the left pane to launch the Analytics interface. Then click the gear icon for
  the analytic.
- Expand the Analytics node and click the analytic you want to configure. On the analytic window, click the gear
...
- Event Type tab – Configured the same way a regular policy’s
  ...
  - _Optional:_ Scope the protocol to be monitored on the Authentication Protocol filter. If
    ...
    minimum of ‘3 passwords remembered’ or it won't have an effect.
    :::
...
[Event Tracker Window](/docs/threatprevention/7.5/admin/policies/configuration/recentevents/eventtracker.md) topic for more information.
