...
[Domains Page](/docs/identityrecovery/2.6/admin/configuration/domain.md). You can rollback and recover objects in these
domains through the [Active Directory Page](/docs/identityrecovery/2.6/admin/activedirectory/overview.md).
