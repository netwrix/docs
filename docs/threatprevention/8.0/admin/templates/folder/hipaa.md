...
| HIPAA: Successful Account Authentications | Gathers successful AD authentications. <br />Uses built-in “Successful Authentications” – use the Include Perpetrators Collection to specify which accounts to monitor for successful authentications. Add accounts to this collection. | None |
...
| HIPAA: Successful AD PHI Account Authentications | Gathers Successful AD Authentications. <br />Uses built-in “Successful HIPAA PHI Account Authentications” – use the Include Perpetrators Collection to specify which accounts to monitor for successful authentications. Add accounts to this collection. | None |
