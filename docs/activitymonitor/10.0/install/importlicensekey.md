...
![Trial License Information](/images/activitymonitor/9.0/install/triallicenseinfo.webp)

**Step 2 –** Click Load New License File and navigate to where the key is located. A Windows file
explorer opens.

![Open Dialog Box to load New License File](/images/activitymonitor/9.0/install/loadlicense.webp)

**Step 3 –** Select the `.lic` file and click Open. The selected license key is then read.

![Activity Monitor License Information](/images/activitymonitor/9.0/install/licenseinfo.webp)

**Step 4 –** In the License Information window, click **Apply** to import the License Key.

![Activity Monitor with License](/images/activitymonitor/9.0/install/licenseadded.webp)
