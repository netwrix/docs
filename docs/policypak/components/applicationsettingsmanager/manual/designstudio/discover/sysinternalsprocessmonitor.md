...
:::note
PolicyPak DesignStudio is a lite capture tool and needs to be instructed on
...
easy to learn where it stores its data. Then we can tell PolicyPak DesignStudio where
...
![discovering_configuration_15_499x277](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_15_499x277.webp)

The figure shown. Selecting the option to capture events.

![discovering_configuration_16](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_16.webp)
...
![discovering_configuration_17](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_17.webp)
...
![discovering_configuration_18_624x105](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_18_624x105.webp)
...
![discovering_configuration_19](/images/policypak/applicationsettings/designstudio/configurationdata/discover/discovering_configuration_19.webp)

The figure shown. Applying changes.

Knowing this, you can use PolicyPak DesignStudio to use this location (in this case, a
