...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Ew6cdP0oAzM" title="PolicyPak: Prevent Users Running some commands with command lines" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak: Prevent Users Running some commands with command lines

Hi. This is Jeremy Moskowitz. In this video, I'm going to show you how you can use Netwrix PolicyPak
...
running. How do we do this with PolicyPak Least Privilege Manager? It's actually
pretty easy to do.
...
So just like that, using PolicyPak Least Privilege Manager it's as simple as pie to
