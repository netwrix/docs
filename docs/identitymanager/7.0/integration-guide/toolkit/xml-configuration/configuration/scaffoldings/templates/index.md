...
# Templates
- [ConnectorsAccessControlRules](./connectorsaccesscontrolrules)

Gives the permissions to manage the connector pages.
- [CreateAdministratorProfile](./createadministratorprofile)
...
- [EntityReportDefault](./entityreportdefault)

Creates all configuration items to add a ReportQuery for an EntityType and profile.
- [JobExecutionAccessControlRules](./jobexecutionaccesscontrolrules)
...
- [UpdateResourcesTemplate](./updateresourcestemplate)

 
- [ViewSourceResourceTemplate](./viewsourceresourcetemplate)
...
- [ViewTargetResourceTemplate](./viewtargetresourcetemplate)
...
- [ViewTemplateAdaptable](./viewtemplateadaptable)
