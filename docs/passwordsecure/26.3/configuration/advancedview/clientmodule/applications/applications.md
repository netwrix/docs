...
- Automatic logins to websites are covered by the
  [Autofill Add-on](/docs/passwordsecure/26.3/configuration/autofilladdon/autofill_add-on.md).
...
opens in its own tab in the [Reading pane](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/reading_pane.md).
...
[Learning the applications](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/applications/learningtheapplications/learning_the_applications.md). In contrast,
