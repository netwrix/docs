...
With PolicyPak File Associations Manager, Item-Level Targeting can be used on
collections, as well as PolicyPak File Associations Manager policies within
collections.

A collection enables you to group together PolicyPak File Associations Manager
...
![using_item_level_targeting](/images/policypak/fileassociations/itemleveltargeting/using_item_level_targeting.webp)

![using_item_level_targeting_1](/images/policypak/fileassociations/itemleveltargeting/using_item_level_targeting_1.webp)
...
![using_item_level_targeting_2](/images/policypak/fileassociations/itemleveltargeting/using_item_level_targeting_2.webp)

To change the Item-Level Targeting, right-click any PolicyPak File Associations
Manager policy, and select **Edit Item Level Targeting**.

![using_item_level_targeting_3](/images/policypak/fileassociations/itemleveltargeting/using_item_level_targeting_3.webp)
...
PolicyPak File Associations Manager cannot filter by user group since the node is only
available on the Computer side, and PolicyPak File Associations Manager is only valid
for Windows 8.1 and later.

![using_item_level_targeting_4](/images/policypak/fileassociations/itemleveltargeting/using_item_level_targeting_4.webp)
...
![using_item_level_targeting_5](/images/policypak/fileassociations/itemleveltargeting/using_item_level_targeting_5.webp)
