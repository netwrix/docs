---
title: "Are PolicyPak Cloud policies processed on User or Computer side (and why do I only sometimes see User or Computer side ILT?)"
description: "Are PolicyPak Cloud policies processed on User or Computer side (and why do I only sometimes see User or Computer side ILT?)"
sidebar_position: 140
---

# Are PolicyPak Cloud policies processed on User or Computer side (and why do I only sometimes see User or Computer side ILT?)

There are really two levels of Policy type in Netwrix PolicyPak
Cloud:

- Top level policies, which are created in-cloud and linked over to a Company Group. The Top level
  policies are always a specific type, say, PolicyPak Admin Templates Manager,
  PolicyPak Least Privilege Manager or PolicyPak Browser Router, etc.
...
![913_1_image001_950x505](/images/policypak/cloud/policy/913_1_image001_950x505.webp)
...
![913_2_image002_950x906](/images/policypak/cloud/policy/913_2_image002_950x906.webp)
...
PolicyPak Admin Templates Manager is a good example. After you look at the entries,
you will get the following example settings.

![913_3_image003_950x419](/images/policypak/cloud/policy/913_3_image003_950x419.webp)
...
![913_4_image004_950x387](/images/policypak/cloud/policy/913_4_image004_950x387.webp)
...
In general for those which operate in either(PolicyPak Admin Templates Manager,
PolicyPak Least Privilege Manager, etc.) the Internal policies will have ILT which is
...
![913_5_image005_950x610](/images/policypak/cloud/policy/913_5_image005_950x610.webp)

![913_6_image006_950x569](/images/policypak/cloud/policy/913_6_image006_950x569.webp)

There is one exception to the rules above. Note the small difference between a policy which is
created onlytusing PolicyPak Cloud editor. The Top-Level policy will show Machine like
what's seen here:

![913_7_image007_950x316](/images/policypak/cloud/policy/913_7_image007_950x316.webp)

But if a policy is uploaded from on-prem MMC, specifically the USER side, the XML will look like
this:

![913_8_image008_950x443](/images/policypak/cloud/policy/913_8_image008_950x443.webp)

This does not affect the operation of the policy in any way. The policy is still downloaded by
PolicyPak Cloud to `\programdata\policypak\Xmldata\cloud`, and processed by a licensed
