...
| VNX, Isilon, Unity | ✔          | Activity Monitor - Dell\Events Received              | Number of events received from CEE (Common Event Expression)                                                                                                                                                                                                                                                                                                       |
...
| Outputs | | Activity Monitor - Outputs\Events Reported to AMQP | Total number of events reported to AMQP (Advanced Message Queuing Protocol) servers (not used ) |
...
Resolved SIDs Time, and Translated UIDs Time helps you estimate the response time.
:::
