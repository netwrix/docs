...
Center service. You can then use it to connect to the database, email server, and Active
Directory.

Before configuring the Access Information Center to use a
gMSA, complete the following pre-requisites:

- Add the gMSA to the Local Administrator Group on the host where the Access Information Center is installed
...
The Netwrix Access Information Center service now runs using the provided gMSA account.
