...
**Step 3 –** Read the End User License Agreement, select the license agreement acceptance checkbox,
and click **Next**.
...
The Threat Manager application is now installed and the database has been created. Complete the following post-installation tasks that apply to your environment:
...
- During the first launch, set up the built-in Administrator account. See the
  [First Launch](/docs/threatmanager/3.1/install/firstlaunch/firstlaunch.md) topic for additional information.
