...
[License settings](/docs/passwordsecure/26.3/configuration/servermanger/mainmenu/license_settings.md).

### Creating a backup

An update always involves making a profound change to the existing software. A corresponding
[Backup management](/docs/passwordsecure/26.3/configuration/servermanger/mainmenu/backupsettings/backup_management.md)
...
([Installation Web Application](/docs/passwordsecure/26.3/installation/installationwebapplication/installation_web_application.md)
...
chapter [Webserver](/docs/passwordsecure/26.3/installation/requirements/webserver/webserver.md). This applies to version 8.5.0.14896
or newer.
