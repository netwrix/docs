...
[Historical Dashboard](/docs/privilegesecure/25.12/admin/dashboard/historical/historical.md).

![Historical dashboard showing available recordings](/images/privilegesecure/25.12/accessmanagement/admin/dashboard/window/recordingavailable.webp)
...
![Replay Viewer window for an RDP session](/images/privilegesecure/25.12/accessmanagement/admin/dashboard/window/replayviewerrdp.webp)
...
![replayviewerssh](/images/privilegesecure/25.12/accessmanagement/admin/dashboard/window/replayviewerssh.webp)
...
![Replay Viewer window for a Website host session](/images/privilegesecure/25.12/accessmanagement/admin/dashboard/window/replayviewerwebsite.webp)
