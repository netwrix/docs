...
([Setup and sync](/docs/passwordsecure/current/configuration/offlineclient/setup_and_sync.md)), the local copy of the server database will be
...
- More on this subject…::https://technet.microsoft.com/en-the team/library/gg592949(v=sql.110).aspx
...
[Operation and setup](/docs/passwordsecure/current/configuration/servermanager/operation_and_setup_admin_client.md).
...
- The automatic login data entry can be performed via the
  [Autofill Add-on](/docs/passwordsecure/current/configuration/autofilladdon/autofill_add-on.md), independently of the Offline Add-on
