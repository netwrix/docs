...
This is an advancedNetwrix PolicyPak topic showing how to
reconnect a DLL if the inner name was changed, and someone deleted the existing DLL.

<iframe width="560" height="315" src="https://www.youtube.com/embed/unz-8F9ohWo" title="PolicyPak: Reconnecting DLLs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
