...
![7.Sensitive Data > FS_DLPResults Job in the Jobs Tree](/img/product_docs/accessanalyzer/12.0/solutions/databases/db2/sensitivedata/sensitivedatajobstree.webp)
