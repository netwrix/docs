...
the [Users & Groups Page](/docs/privilegesecure/4.2/admin/interface/usersgroups/usersgroups.md). It lets users be added to a custom role.
...
**Step 4 –** Select the checkbox for the users you want in the Available Role Users table.

**Step 5 –** Click **Add** to add one or more user roles.

**Step 6 –** Click **Add** to add the role users to the role.
