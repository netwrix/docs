...
available data with the filters you want for a specific timeframe.
...
the [Filters Section](/docs/threatmanager/3.2/administration/investigations/options/filters.md) topic for additional information.
...
available from the New Investigation page. See the [Export Report](/docs/threatmanager/3.2/administration/investigations/options/export.md) topic for
...
See the [Investigation Options](/docs/threatmanager/3.2/administration/investigations/options/overview.md) topic for additional information.
