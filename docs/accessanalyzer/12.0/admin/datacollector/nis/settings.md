...
Use the NIS Settings page to configure the NIS domain and a NIS server for testing. It is a wizard
page for both categories.
...
- (Optional) Sample NIS Server – Enter the host name or IP address of a NIS server for the NIS domain
  to use for testing. This system should be running the `ypserv` process and be accessible
