...
First of all, note how the synchronization has been configured in the
[Settings](/docs/passwordsecure/9.3/configuration/mobiledevices/settings_mobileapp.md). A prerequisite for successful synchronization is that
...
The configuration is described in the chapter [Settings](/docs/passwordsecure/9.3/configuration/mobiledevices/settings_mobileapp.md)
