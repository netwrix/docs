...
File change events can be viewed from the [Events Tab](/docs/changetracker/8.2/admin/events/events.md). See the
[Dashboard Tab](/docs/changetracker/8.2/admin/dashboardoverview.md) topic for additional information on how to view FIM
change events.
