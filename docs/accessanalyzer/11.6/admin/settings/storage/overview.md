...
![Storage Node](/img/product_docs/accessanalyzer/11.6/admin/settings/storage/storage.webp)
...
![Operations on the Storage view](/img/product_docs/accessanalyzer/11.6/admin/settings/storage/storageoperations.webp)
