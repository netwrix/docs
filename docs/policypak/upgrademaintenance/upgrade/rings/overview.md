...
The most important part of upgrading Netwrix PolicyPak is to
avoid updating of all your computers at once. You should be performing your updates and rollouts in
a controlled fashion. PolicyPak acts as part of the operating system and helps you
manage important security and configuration items, but since no product is bug free, PolicyPak cannot guarantee that any updated client-side extension (CSE) will work 100% with what you
...
- That version goes into the PolicyPak Portal and is also available for use within
  PolicyPak Cloud.
...
- Whichever is the latest CSE in the Portal or PolicyPak Cloud, is the only version of
  the PolicyPak CSE that is supported.
...
MDM service, the latest CSE isn't magically pushed from us to your PCs. For PolicyPak
