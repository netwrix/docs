...
![Azure SQL MI Activity Records in Netwrix Auditor](/images/auditor/10.9/addon/azuresqlmi/netwrix-auditor-search.png)
...
- [Alerts](/docs/auditor/10.9/admin/alertsettings/overview.md)
- [View and Search Collected Data](/docs/auditor/10.9/admin/search/overview.md)
- [Subscriptions](/docs/auditor/10.9/admin/subscriptions/overview.md)
