...
- Policy Template – select a custom notiﬁcation from the drop-down list or create one from System
  ...
  [Custom Content Aware Protection Notiﬁcations](/docs/endpointprotector/5.9.4/system-management/system-parameters.md#custom-content-aware-protection-notiﬁcations)
  section
...
![Block & Report policies to handle Social Security Numbers (SSN) and phone numbers](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/policyinformation.webp)
...
![Monitor transfers from the following exit points](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/policyexistpoints.webp)
...
![From the storage devices tab, you can select to monitor transfers](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/policyexitstoragedevices.webp)
...
![The Clipboard functionality enables you to monitor all content captured through Copy & Paste or Cut & Paste operations](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/policyexitclipboard.webp)
