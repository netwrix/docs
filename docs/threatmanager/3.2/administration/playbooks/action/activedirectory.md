...
- Credential – Select a credential profile that contains valid Active Directory credentials.
  ...
  [Integrations Interface](/docs/threatmanager/3.2/administration/configuration/integrations/overview.md). If not specified, the
...
See the [Integrations Interface](/docs/threatmanager/3.2/administration/configuration/integrations/overview.md) topic for additional
information.
