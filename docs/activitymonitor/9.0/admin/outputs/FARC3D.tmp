...
Select an output for a SQL Server host on the Monitored Hosts & Services tab and click **Edit** to open the
output Properties window.

![Objects Tab](/images/activitymonitor/9.0/admin/outputs/objectstab.webp)
