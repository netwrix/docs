...
Netwrix PolicyPak can add or remove certificates within Firefox.
...
Video: To see a video of PolicyPak managing Firefox's add-ons, go to
...
![certificates](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates.webp)
...
![certificates_1](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_1.webp)
...
![certificates_2](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_2.webp)
...
![certificates_3](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_3.webp)

The figure shown. SHA Fingerprint location.

## Exporting Certificates to the Binary-Encoded DER Format

PolicyPak can only work with binary-encoded DER certificates. If you have a
...
![certificates_4](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_4.webp)
...
![certificates_5](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_5.webp)

The figure shown. Exporting via Explorer.

## Troubleshooting Certificates

If you are not seeing the results you expect, you can look in PolicyPak's logs (see
the Application Settings Manager documentation for more information) as well as Firefox's log. An example of
PolicyPak's log showing that certificates are correctly being added can be seen in
The figure shown.

![certificates_6](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_6.webp)

The figure shown. The PolicyPak log with certificate details.
...
![certificates_7](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_7.webp)
...
- When specifying a certificate and the number of days after which PolicyPak should
  check for updates, you have transposed the values. The correct way to specify a certificate and
  have PolicyPak check for updates every two days is
...
![certificates_8](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_8.webp)
