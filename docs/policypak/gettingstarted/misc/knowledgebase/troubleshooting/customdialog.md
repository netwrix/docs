...
Using the Netwrix PolicyPak ADMX files, you can use the "Show
...
2. Enabled: You can specify your own dialog title and text. NOTE that HTML is NOT supported. Must be
   straight text.
3. Disabled: No dialog will appear if PolicyPak PolicyPak Browser Router
   or the CSE has a problem. This could be desirable, but also means that functions will just stop
   with no notification.

![780_1_img-01_950x653](/images/policypak/troubleshooting/780_1_img-01_950x653.webp)
