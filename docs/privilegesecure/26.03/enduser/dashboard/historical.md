...
![Historical Dashboard](/images/privilegesecure/26.03/accessmanagement/enduser/dashboard/historicaldashboard.webp)
...
session. See the [Session Logs Window](/docs/privilegesecure/26.03/enduser/dashboard/active/startsession/sessionlogs.md) topic for additional
information.
