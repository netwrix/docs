---
title: "PolicyPak for Microsoft Skype for Business (formerly Lync)"
description: "PolicyPak for Microsoft Skype for Business (formerly Lync)"
sidebar_position: 70
---
# PolicyPak for Microsoft Skype for Business (formerly Lync)
...
Except now you can, with the pre-configured Netwrix PolicyPak for
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Jpakwb0a-d8" title="PolicyPak: Manage Microsoft Lync using Group Policy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
![50_1_manage-lync-with-group-policy-fig1](/images/policypak/video/applicationsettings/50_1_manage-lync-with-group-policy-fig1.webp)

You can dictate the Inactive and Away times for the Lync Client, like what is seen here.

![50_2_manage-lync-with-group-policy-fig2](/images/policypak/video/applicationsettings/50_2_manage-lync-with-group-policy-fig2.webp)
...
![50_3_manage-lync-with-group-policy-fig3](/images/policypak/video/applicationsettings/50_3_manage-lync-with-group-policy-fig3.webp)
