...
![Policy - Recent Events tab](/images/threatprevention/8.1/admin/policies/recentevents/recenteventstab.webp)
...
- Export Data– Opens the Export Data window with export actions and options. See the
  [Export Data](/docs/threatprevention/8.1/admin/navigation/datagrid.md#export-data) topic for additional information.
...
See the [Event Tracker Window](/docs/threatprevention/8.1/admin/policies/configuration/recentevents/eventtracker.md) topic for additional information.
