...
You should also click **Settings** in the Configuration Console, then **License** to check your license key. If the **License type** is _Evaluation_, then you will need to install a new license key before the **Valid to** date. You can download your license key from the [Netwrix Customer Portal](https://customer.netwrix.com/sign_in.html?rf=customer-portal.html). If you don't install a new key, then Password Policy Enforcer will stop checking passwords when the evaluation license expires.
