...
In the [Passwords](/docs/passwordsecure/current/configuration/advancedview/clientmodule/passwords/passwords.md), the newly created application can now be directly
...
passwords, roles, or documents. You can separately define which group of users is permitted
