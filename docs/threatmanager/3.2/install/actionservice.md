...
[Credential Profile Page](/docs/threatmanager/3.2/administration/configuration/integrations/credentialprofile.md) topic
...
and credentials you want. If desired, select the Browse button to open the Select User window to select an
account.
