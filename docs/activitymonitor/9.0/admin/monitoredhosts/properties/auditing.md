...
Use the Auditing tab to modify the Isilon Options settings that were populated when you added the Dell Isilon host to the Monitored Hosts & Services list.
...
been completed, don't enable these options. This option requires credentials for an Administrator
