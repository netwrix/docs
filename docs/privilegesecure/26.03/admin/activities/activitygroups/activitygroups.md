...
![addactivitygroup](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/addactivitygroup.webp)
...
[Add Activity Groups](/docs/privilegesecure/26.03/admin/activities/activitygroups/activitygroup.md) topic for additional information.
...
[Activities Page](/docs/privilegesecure/26.03/admin/activities/activities.md) topic for additional details.
