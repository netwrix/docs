...
See [Planned Changes Tab](/docs/changetracker/admin/plannedchanges/plannedchanges.md)
...
[Raise a ServiceNow Incident](/docs/changetracker/integration/itsm/syncserviceadmin.md#raise-a-servicenow-incident)
for the setup steps.
