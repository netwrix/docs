...
in the [Users & Groups Page](/docs/privilegesecure/26.03/admin/usersgroups/usersgroups.md).

![Add Administrators Window](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/usersgroups/addadministrators.webp)
