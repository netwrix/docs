...
The following NetSuite objects are partially documented. They aren't fully documented for one or
...
These record types don't have a NetSuite API to enable Platform Governance for NetSuite to capture
customization data.
...
| Integration            | External System/Integration | Information relating to integrations to external systems aren't documented.                                                                                                                 | Changes to objects in NetSuite could impact functionality in other systems. |
...
that don't represent configuration changes, such as changes to item account settings and violations
