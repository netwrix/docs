---
title: "PolicyPak: Use the DesignStudio to manage FireFox's about:config settings"
description: "PolicyPak: Use the DesignStudio to manage FireFox's about:config settings"
sidebar_position: 50
---

# PolicyPak: Use the DesignStudio to manage FireFox's about:config settings

Firefox is easy to manage using Netwrix PolicyPak. Here is the
how-to using the PolicyPak **DesignStudio** to implement about:config settings within
your Paks.
