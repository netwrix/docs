...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  configure them manually:
    ...
    - The Remote Registry and the Windows Management Instrumentation (WMI) service must be started.
      See the
      [Enable Remote Registry and Windows Management Instrumentation Services](/docs/auditor/10.9/configuration/windowsserver/remoteregistry.md)
      topic and the [Configure Windows Registry Audit Settings](/docs/auditor/10.9/configuration/windowsserver/windowsregistry.md) topic for
      additional information.
    - The following advanced audit policy settings must be configured:

        - The Audit: Force audit policy subcategory settings security option must be enabled.
        - Audit Security Group Management, Audit User Account Management, Audit Handle
          Manipulation, Audit Other Object Access Events, Audit Registry, Audit File Share, and
          Audit Audit Policy Change advanced audit policies must be set to _"Success"_.
        - See the [Configure Local Audit Policies](/docs/auditor/10.9/configuration/windowsserver/localpolicy.md) topic and the
          [Configure Advanced Audit Policies](/docs/auditor/10.9/configuration/windowsserver/advancedpolicy.md) topic for additional information.
    ...
    - The Enable Persistent Time Stamp local group policy must be enabled. This policy should be
      ...
      [Configure Enable Persistent Time Stamp Policy](/docs/auditor/10.9/configuration/windowsserver/persistenttimestamp.md) topic for additional
      information.
    - The Application, Security, and System event log maximum size must be set to 4 GB. The
      ...
      [Adjusting Event Log Size and Retention Settings](/docs/auditor/10.9/configuration/windowsserver/eventlog.md) topic for additional
      information.
    ...
    - For auditing DHCP, the Microsoft-Windows-Dhcp-Server/Operational event log must be enabled and
      ...
      _“Overwrite events as needed”_. See the [Adjust DHCP Server Operational Log Settings](/docs/auditor/10.9/configuration/windowsserver/dhcp.md)
    ...
    - If the audited servers are behind the Firewall, review the list of protocols and ports
      ...
      [Windows Server Ports](/docs/auditor/10.9/configuration/windowsserver/ports.md) topic for additional information.
    - For auditing removable storage media, two Event Trace Session objects must be created. See the
      [Configure Removable Storage Media for Monitoring](/docs/auditor/10.9/configuration/windowsserver/removablestorage.md) topic for additional
      information.
...
[Windows Server Monitoring Scope](/docs/auditor/10.9/admin/monitoringplans/windows/scope.md) topic for
additional information.
...
When monitoring a Windows Server, Netwrix Auditor needs to audit some registry settings. See
[Windows Server Registry Keys](#windows-server-registry-keys) for additional information. If you
...
| --- | --- | --- |
| General computer settings | Computer | <ul><li>System state changed to Started</li><li>System state changed to Stopped. Reason: Reason type</li><li>System state changed to Stopped. Reason: unexpected shutdown or system failure</li></ul> |
...
|  | System Time | <ul><li>System time changed from ... to ...</li><li>Time zone changed</li></ul> |
| Add/Remove programs | Add or Remove Programs | <ul><li>Installed For\*\*</li><li>Version</li></ul> |
| Services | System Service | <ul><li>Action in case of failed service startup</li><li>Action in case of service stopping</li><li>Allow service to interact with desktop</li><li>Caption</li><li>Created</li><li>Deleted</li><li>Description</li><li>Name</li><li>Path to executable</li><li>Service Account</li><li>Service Type</li><li>Start Mode</li><li>Error Control</li></ul> |
| Audit policies | Local Audit Policy | <ul><li>Added Audit settings Only for the Global Object Access Auditing advanced policies.</li><li>Successful audit enabled/disabled</li><li>Failure audit enabled/disabled</li></ul> |
...
| Hardware | Base Board\*\* | <ul><li>Hosting Board</li><li>Status</li><li>Manufacturer</li><li>Product</li><li>Version</li><li>Serial Number</li></ul> |
...
| DHCP configuration | Server role | <ul><li>Added</li><li>Removed</li></ul> |
...
| DNS resource records | DNS AAAA\*\* | <ul><li>Container name</li><li>IPv6 Address</li><li>Owner name</li><li>Record class</li><li>TTL</li><li>Zone type</li></ul> |
...
- To configure the audit settings manually, refer to the
  [Configure Windows Registry Audit Settings](/docs/auditor/10.9/configuration/windowsserver/windowsregistry.md) topic for additional information.
...
![customregistrykey](/images/auditor/10.9/configuration/windowsserver/customregistrykey.webp)
