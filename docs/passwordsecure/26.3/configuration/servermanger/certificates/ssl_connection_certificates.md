...
[Basic configuration](/docs/passwordsecure/26.3/configuration/servermanger/basic_configuration.md) in the AdminConsole. The
...
[Basic configuration](/docs/passwordsecure/26.3/configuration/servermanger/basic_configuration.md). Please note that a server
