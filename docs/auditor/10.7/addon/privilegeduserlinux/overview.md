...
1. The add-on listens to the specified UDP ports and captures designated Syslog messages.
    ...
    By default, messages from Red Hat Enterprise Linux 7 and 6, SUSE Linux Enterprise Server 12,
...
See the [Integration API](/docs/auditor/10.7/api/overview.md) topic for additional information on the
