...
![History Tab for Host Resource](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/resources/historyhost.webp)
...
the [Access Policy Page](/docs/privilegesecure/26.03/admin/accesspolicy/accesspolicy.md) topic for additional information.
