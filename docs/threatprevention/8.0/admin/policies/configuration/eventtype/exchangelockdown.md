...
![Policy window - Exchange Lockdown Event Type](/images/threatprevention/8.0/admin/policies/eventtype/exchangelockdown.webp)
...
See the [Exchange Lockdown Considerations](/docs/threatprevention/8.0/troubleshooting/exchangelockdown.md) topic for
...
![Policy window - Exchange Event filter for lockdown](/images/threatprevention/8.0/admin/policies/eventtype/exchangeeventlockdown.webp)
...
![Policy window - Exchange Mailbox Objects and Containers filter ](/images/threatprevention/8.0/admin/policies/eventtype/exchangemailboxobjectsandcontainers.webp)

Select the **Include** or **Exclude** button and then edit the list.

- The **Add** (+) button opens the
  [Select Exchange Objects from Active Directory Window](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/window/exchangeobjects.md).
...
![Policy window - Exchange Trustees filter for lockdown](/images/threatprevention/8.0/admin/policies/eventtype/exchangetrusteeslockdown.webp)
...
- The Trustees **Add** (+) button opens the
  [Select Active Directory Trustees Window](/docs/threatprevention/8.0/admin/policies/configuration/eventtype/window/trustees.md).
- The Collection button opens the
  [List of Collections Window](/docs/threatprevention/8.0/admin/configuration/collectionmanager/listcollections.md) to the
  appropriate Collection category.
- The Remove (x) button deletes the selected item(s) from that box.
