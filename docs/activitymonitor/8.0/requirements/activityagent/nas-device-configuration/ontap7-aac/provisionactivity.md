...
Relevant NetApp Documentation: For information about node access controls, see the
...
After the role is created, it must be attached to a group. The following command needs to be
