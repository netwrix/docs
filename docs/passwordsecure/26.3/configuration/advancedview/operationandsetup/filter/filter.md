...
For example, an employee can only filter for the [Forms](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/forms/forms.md) password
if he has the read permission for that form.

**CAUTION:** There are no permissions for [Tags](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/tags.md). This means that any employee can
