...
You can [Filter](/docs/activitymonitor/10.0/admin/search/overview.md#filter) and [Sort](/docs/activitymonitor/10.0/admin/search/overview.md#sort) the results using the column
headers. Below the Search button is the [Export](/docs/activitymonitor/10.0/admin/search/overview.md#export) option.

![Active Directory Search Results](/images/activitymonitor/9.0/admin/search/results/activedirectorysearchresults.webp)
