...
[Template Configuration](/docs/threatprevention/8.0/admin/templates/configuration/configuration.md).
...
managed on the [Collection Manager Window](/docs/threatprevention/8.0/admin/configuration/collectionmanager/overview.md) and
...
Use the `Export-SICollection` and `Import-SICollection` commands to export and edit the XML file of an existing collection, and then import (add or replace) the edited collection. See the
[Not a Policy XML Expert](/docs/threatprevention/8.0/api/overview.md#not-a-policy-xml-expert) topic for additional information on
...
[Export Policies and Templates Window](/docs/threatprevention/8.0/admin/tools/exportpoliciestemplates.md) topic for
...
function. See the [Import Window](/docs/threatprevention/8.0/admin/tools/import.md) topic for additional information.
...
:::tip
Remember, the Collection ID and Collection GUID aren't the same as those in the source XML file.
