...
- [1.Users and Roles Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/usersroles/overview.md)–
...
- [2.Activity Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/activity/overview.md)
...
- [3.Permissions Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/permissions/overview.md)
...
- [4.Configuration Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/configuration/overview.md)
...
- [SQL_SecurityAssessment Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/sql_securityassessment.md)
