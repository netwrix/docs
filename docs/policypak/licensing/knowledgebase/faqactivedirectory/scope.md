---
title: "Why does License Tool ask Who am I and Where do I want to use PolicyPak?"
description: "Why does License Tool ask Who am I and Where do I want to use PolicyPak?"
sidebar_position: 80
---

# Why does License Tool ask Who am I and Where do I want to use PolicyPak?
...
Scope is where you might ever possibly use Netwrix PolicyPak.
Typically, this is (and should be) the whole domain. This doesn't mean you will be using PolicyPak anywhere/everywhere in the whole domain. You select the Scope in this window:

![317_1_licfaq1](/images/policypak/license/activedirectory/317_1_licfaq1.webp)

SOM_Name is the specific places you will be licensing PolicyPak. This is what you are
selecting here:

![317_2_licfaq2](/images/policypak/license/activedirectory/317_2_licfaq2.webp)
...
- You can see that the Scope is the whole domain (fabrikam.com). This is where we could use PolicyPak.
...
- You can see that the Scope is the Sales OU. This is where we could use PolicyPak.
- You can see that the SOM is two specific OUs (and their children.) Specifically East Sales OU and
  West Sales OU. This is where you will be licensing PolicyPak.
...
to use PolicyPak (and pay for it separately).
...
When LT goes to install the license you receive from PolicyPak, it will create a new
...
- Nothing happens in PolicyPak until the CSE is installed on client systems. Nothing
...
- The GPO that LT creates only has PolicyPak Licensing Data(see image below).
...
![317_3_licfaq3](/images/policypak/license/activedirectory/317_3_licfaq3.webp)
...
- If you think you might ever want to license computers to use PolicyPak in another OU
...
Last thought: Remember that all client computers must have the PolicyPak CSE
installed. Without the CSE installed, PolicyPak directives are ignored. So, just
because there's a GPO linked to the domain doesn't mean that computers will be able to do anything.
They have to be in scope of management and also have the CSE installed to pick up PolicyPak directives.
