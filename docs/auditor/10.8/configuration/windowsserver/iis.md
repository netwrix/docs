...
To process Internet Information Services (IIS) events, you must enable the Remote
Registry service on the target computers. See [Enable Remote Registry](/docs/auditor/10.8/configuration/windowsserver/remoteregistry.md) for more information.
