...
Some situations require you to use a script exclusively, without defining a data source. The Query
Properties window lets you add and run a script.
...
**Step 3 –** Select the **Data Source** tab, and select **SCRIPT** in the Data Collector dropdown
menu.
