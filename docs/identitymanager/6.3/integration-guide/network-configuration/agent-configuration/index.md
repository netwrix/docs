...
1. The [Application Settings](../../../integration-guide/network-configuration/agent-configuration/appsettings) set is written either to the Agent's working
directory appsettings.json file or as environment variables. See the [Architecture](../../../integration-guide/architecture) topic for additional information.
2. The [appsettings.agent](../../../integration-guide/network-configuration/agent-configuration/appsettings-agent) set is written as environment variables or to
