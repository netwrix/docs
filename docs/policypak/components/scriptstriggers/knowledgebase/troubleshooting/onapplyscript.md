---
title: "What is the expected behavior after an PolicyPak Script \"ON/APPLY\" script is modified?"
description: "What is the expected behavior after an PolicyPak Script \"ON/APPLY\" script is modified?"
sidebar_position: 20
---

# What is the expected behavior after an PolicyPak Script "ON/APPLY" script is modified?
...
These two actions will occur in the same (next) Group Policy, MDM or Netwrix PolicyPak Cloud  process.
