...
[Connection Profiles Page](/docs/privilegesecure/26.03/admin/accesspolicy/connectionprofiles/connectionprofiles.md) topic for additional information on
Approval Workflows.

![Dashboard Approvals Page](/images/privilegesecure/26.03/accessmanagement/admin/dashboard/approvals.webp)
