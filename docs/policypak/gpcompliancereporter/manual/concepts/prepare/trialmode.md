...
Enabling trial mode is optional. When you do this, PolicyPak GPCR will act as if fully
...
![gpcr_concepts_and_quickstart_3](/images/policypak/grouppolicycompliancereporter/prepare/gpcr_concepts_and_quickstart_3.webp)
...
the ones you want to collect data from. It does not apply to the machine running the PolicyPak GPCR client (admin console). That machine can be named anything. In addition, we suggest
