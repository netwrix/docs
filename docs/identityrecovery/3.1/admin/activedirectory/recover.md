...
Click **Active Directory** in the left pane to open the [Active Directory Page](/docs/identityrecovery/3.1/admin/activedirectory/overview.md). Select
and expand a domain in the left pane and click Recycle Bin to get a list of deleted objects in the
domain.

![Recycle Bin](/images/identityrecovery/3.1/product/active_directory/recovery/active_directory_recovery.png)
...
![Object Restore wizard - Object Backups page](/images/identityrecovery/3.1/product/active_directory/recovery/active_directory_recovery_page1.png)

**Step 4 –** In the Backup Data section, select a backup date to restore from. Then click **Next**.

![Object Restore wizard - Domain Controller page](/images/identityrecovery/3.1/product/active_directory/recovery/active_directory_recovery_page2.png)
...
![Object Restore wizard - Recovery Options page](/images/identityrecovery/3.1/product/active_directory/recovery/active_directory_recovery_page3.png)
...
- Naming Conflict – A naming conflict can occur if an object was created post-deletion that has
  ...
  a naming conflict occurs:
    ...
    - Automatically use alternative values – If there is a conflict with naming, Identity Recovery
      appends a numeric value to the name of the object being restored to create a unique name

**Step 8 –** Click **Next**.

![Object Restore wizard - User Options page](/images/identityrecovery/3.1/product/active_directory/recovery/active_directory_recovery_page4.png)

**Step 9 –** The User Options page appears when you restore user objects. When a user
object is included as a child object being restored, this page also appears. Select the check
...
![Object Restore wizard - Credentials page](/images/identityrecovery/3.1/product/active_directory/recovery/active_directory_recovery_page5.png)
...
![Object Restore wizard - Confirm page](/images/identityrecovery/3.1/product/active_directory/recovery/active_directory_recovery_page6.png)
...
![Object Restore Complete message](/images/identityrecovery/3.1/product/active_directory/recovery/active_directory_recovery_finished.png)
