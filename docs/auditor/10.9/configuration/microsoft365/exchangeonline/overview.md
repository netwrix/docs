...
- Prepare a Data Collecting Account as described in the
  [Permissions for Exchange Online Auditing](/docs/auditor/10.9/configuration/microsoft365/exchangeonline/permissions.md) topic
- Configure required protocols and ports, as described in the [Exchange Online Ports](/docs/auditor/10.9/configuration/microsoft365/exchangeonline/ports.md)
  topic
...
| ExchangeSecurityGroup                                                                                                                                       | RecipientTypeDetails ExchangeObjectId ExternalDirectoryObjectId Name                                                                                                                                                                                                                                                             |
