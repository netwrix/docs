...
the account you'll use for data collection – it should meet the following requirements. Then you
will provide this account in the monitoring plan wizard (or monitored item settings).
...
These group Managed Service Accounts should meet the following related requirements.
...
To assign the Qumulo Cluster permissions to the account:
