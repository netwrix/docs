...
description: >-
  How to verify your current version of Netwrix Access Analyzer 26.1 and update to the latest release. Applies to both auto-update and targeted version installations.
sidebar_label: "Updating to the Latest Version"
keywords:
  - access analyzer 26.1
...
ArgoCD deploys Netwrix Access Analyzer 26.1, and you update it using the `dspmctl` command-line tool over an SSH connection to the host server. How you update Access Analyzer depends on how it was originally installed:
