...
The PolicyPak Device Manager Help Tool can help you gather details from Devices,
...
The PolicyPak Device Manager Help Tool can be found in the download in the PolicyPak Extras folder.

![helper1](/images/policypak/device/devicemanager/helper1.webp)

:::note
The PolicyPak Device Manager Helper tool may need local administrative
...
![helper2](/images/policypak/device/devicemanager/helper2.webp)

**Step 1 –** Open the PolicyPak Device Manager Helper.
...
![helper3](/images/policypak/device/devicemanager/helper3.webp)

**Step 2 –** On the Select Disk Devices window, right-click to automatically copy the detail to the
buffer for later pasting.

![helper4](/images/policypak/device/devicemanager/helper4.webp)
...
![helper5](/images/policypak/device/devicemanager/helper5.webp)
