...
- The _Use list from the database table_ option button enables a dynamic collection.
...
Example table entry that excludes IP v6 Address:
...
| Column Name    | Column Type     | Column Description                                                                   |
| -------------- | --------------- | --------------------- |
| Path           | NVARCHAR (1024) | File path to monitor. Can't be null.                                                 |
