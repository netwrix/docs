...
- [0.Collection > EX_IISLogs Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/exchange/casmetrics/ex_iislogs.md)
  ...
  logs to return the data to the Enterprise Auditor database.
- [ActiveSync > EX_ActiveSync Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/exchange/casmetrics/ex_activesync.md)
  – Provides visibility into ActiveSync Traffic in the Organization
- [Outlook Anywhere > EX_RPCTraffic Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/exchange/casmetrics/ex_rpctraffic.md)
  – Provides visibility into Outlook Anywhere or RPC\HTTPs Traffic in the organization
- [Outlook Web Access > EX_OWATraffic Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/exchange/casmetrics/ex_owatraffic.md)
  – Provides visibility into Outlook Web Access Traffic in the organization
- [EX_ASPolicies Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/exchange/casmetrics/ex_aspolicies.md)
