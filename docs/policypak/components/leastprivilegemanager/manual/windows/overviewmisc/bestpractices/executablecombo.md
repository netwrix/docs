...
Previous examples reviewed Simple rules and introduced Combo Rules.
...
However, you can start correctly by making your own Combo rules.

:::note
See the
[More security with Combo Rules](/docs/policypak/components/leastprivilegemanager/videolearningcenter/howtoandtechsupport/securitycomborules.md) video for an
overview of using PolicyPak Least Privilege Manager and Combo rules.
:::
...
To do this, create a Combo rule and select the two (or more) types of characteristics. Again,
...
The Combo rule wizard is different from the Simple rule wizard. For this combo rule, you need to
complete two steps. Specify a file as a reference file for Signature Condition.
