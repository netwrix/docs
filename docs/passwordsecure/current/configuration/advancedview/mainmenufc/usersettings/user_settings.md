...
You can configure user settings similarly to [User rights](/docs/passwordsecure/current/configuration/advancedview/mainmenufc/userrights/user_rights.md). Here too,
...
Global settings are configured as usual in the [Main menu](/docs/passwordsecure/current/configuration/advancedview/mainmenufc/main_menu_fc.md). The organisational
...
[Search](/docs/passwordsecure/current/configuration/advancedview/operationandsetup/search.md) mechanisms.
...
The [User rights](/docs/passwordsecure/current/configuration/advancedview/mainmenufc/userrights/user_rights.md) define who has the required permissions to change
