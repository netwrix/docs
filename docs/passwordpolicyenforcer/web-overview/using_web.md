...
![Web Welcome page](/images/passwordpolicyenforcer/web/webwelcome.webp)
...
![using_ppe_web](/images/passwordpolicyenforcer/web/using_ppe_web.webp)

**Step 2 –** Enter a **Username** and **Domain**, then click **Next**.

![introduction_4](/images/passwordpolicyenforcer/web/introduction_4.webp)
...
![using_ppe_web_1](/images/passwordpolicyenforcer/web/using_ppe_web_1.webp)
...
![using_ppe_web_2](/images/passwordpolicyenforcer/web/using_ppe_web_2.webp)

Validation and critical error messages are stored in the HTML templates. You can modify the default
messages by editing the templates. See the [Edit HTML Templates](/docs/passwordpolicyenforcer/web-overview/editing_html_templates.md) topic
