...
Your selections are displayed in the appropriate box of the filter tab from where you opened the
Select… window.
...
- After selecting your options, click **Search Now**. The Results pane begins to populate
