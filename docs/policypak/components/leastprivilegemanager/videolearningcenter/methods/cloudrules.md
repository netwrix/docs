---
title: "Use PolicyPak Cloud to deploy PP Least Privilege Manager rules"
description: "Use PolicyPak Cloud to deploy PP Least Privilege Manager rules"
sidebar_position: 10
---
# Use PolicyPak Cloud to deploy PP Least Privilege Manager rules

Why would you want people using domain joined or non-domain joined machines to have local admin
rights? Is this 1998? No, and with PolicyPak Cloud and PolicyPak Least
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/RDxfSzpZxlM" title="Use PolicyPak Cloud to deploy PP Least Privilege Manager rules" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Whitney with PolicyPak Software. Have you seen the latest and greatest
Least Privilege Manager features and you're wondering how that works with our PolicyPak Cloud edition? We've got you covered. You can use the Cloud service to deliver all of the
...
We are going to be creating a new policy, and we're going to go select PolicyPak
...
the PolicyPak Cloud, we have managed to elevate this application on a non-domain
