...
![Recovery Desktop Icon](/images/identityrecovery/2.6/install/desktopicon.webp)
...
On [First Launch](/docs/identityrecovery/2.6/install/firstlaunch.md) of the Recovery Console, the administrator must add users who can
...
![MFA at Login](/images/identityrecovery/2.6/install/loginmfa.webp)
