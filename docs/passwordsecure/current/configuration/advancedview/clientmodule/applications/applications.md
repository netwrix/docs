...
- Automatic logins to websites are covered by the
  [Autofill Add-on](/docs/passwordsecure/current/configuration/autofilladdon/autofill_add-on.md).
...
opens in its own tab in the [Reading pane](/docs/passwordsecure/current/configuration/advancedview/operationandsetup/reading_pane.md).
...
[Learning the applications](/docs/passwordsecure/current/configuration/advancedview/clientmodule/applications/learningtheapplications/learning_the_applications.md). In contrast,
