...
2. Click **Push** if you are not using [Automatic Synchronization](/docs/platgovsalesforce/integrations/jiraintegrationForge/jira_integration_forge.md) to push
   status changes.
...
3. Click **Push** if you are not using [Automatic Synchronization](/docs/platgovsalesforce/integrations/jiraintegrationForge/jira_integration_forge.md) to push
   status changes.
