...
- [1.Users and Roles Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/oracle/usersroles/overview.md)
...
- [2.Activity Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/oracle/activity/overview.md)
...
- [3.Permissions Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/oracle/permissions/overview.md)
...
- [4.Configuration Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/oracle/configuration/overview.md)
...
- [5.Sensitive Data Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/oracle/sensitivedata/overview.md)
...
- [Oracle_SecurityAssessment Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/oracle/oracle_securityassessment.md)
