...
[Basic configuration](/docs/passwordsecure/9.2/configuration/servermanager/basic_configuration.md) in the AdminConsole. The
...
[Basic configuration](/docs/passwordsecure/9.2/configuration/servermanager/basic_configuration.md). Please note that a server
