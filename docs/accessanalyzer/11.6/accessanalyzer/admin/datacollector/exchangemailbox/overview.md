...
the [Exchange](/docs/accessanalyzer/11.6/accessanalyzer/admin/settings/exchange.md)
...
- Welcome
- [ExchangeMailbox: Category](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangemailbox/category.md)
- [ExchangeMailbox: Scope](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangemailbox/scope.md)
- [ExchangeMailbox: Properties](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangemailbox/properties.md)
- [ExchangeMailbox: SDD Criteria](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangemailbox/sddcriteria.md)
- [ExchangeMailbox: Options](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangemailbox/options.md)
- [ExchangeMailbox: Summary](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/exchangemailbox/summary.md)
