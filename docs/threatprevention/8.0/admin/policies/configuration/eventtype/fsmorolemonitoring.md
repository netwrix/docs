...
![Policy window - FSMO Role Monitoring Event Type](/images/threatprevention/8.0/admin/policies/eventtype/fsmorolemonitoring.webp)
...
![Policy window - FSMO Operations filter](/images/threatprevention/8.0/admin/policies/eventtype/fsmooperations.webp)
