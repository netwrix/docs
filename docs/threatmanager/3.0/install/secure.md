...
**Step 2 –**   Copy the thumbprint of the certificate as you need it when editing
the configuration files.

## Web Service Configuration File

 configure the Web Service Configuration file.
...
## Active Directory Service Configuration File
 ...
 configure the Active Directory Service Configuration file.
...
**Step 4 –** The utility outputs "Success!" if the Action Service registered correctly. Verify
