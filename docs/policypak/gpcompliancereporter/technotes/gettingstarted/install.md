---
title: "Installing and Configuring PolicyPak GPCR for use with SQL Server using SQL Authentication"
description: "Installing and Configuring PolicyPak GPCR for use with SQL Server using SQL Authentication"
sidebar_position: 40
---

# Installing and Configuring PolicyPak GPCR for use with SQL Server using SQL Authentication
...
![673_1_image-20200430140138-1](/images/policypak/grouppolicycompliancereporter/673_1_image-20200430140138-1.webp)
...
3. Uncheck "Enforce password policy"
   ...
   ![673_3_image-20200430140138-2](/images/policypak/grouppolicycompliancereporter/673_3_image-20200430140138-2.webp)

**Step 3 –** Click on "Server Roles" tab and select "public" and "sysadmin" roles

![673_5_image-20200430140138-3](/images/policypak/grouppolicycompliancereporter/673_5_image-20200430140138-3.webp)
...
![673_7_image-20200430140138-4_471x171](/images/policypak/grouppolicycompliancereporter/673_7_image-20200430140138-4_471x171.webp)
...
The following is run on both the Netwrix PolicyPak GPCR Client
...
![673_9_image-20200430140138-5](/images/policypak/troubleshooting/error/gpocompilancereporter/669_3_image-20200327172830-3.webp)
...
![673_11_image-20200430140138-6](/images/policypak/troubleshooting/error/gpocompilancereporter/669_5_image-20200327172830-4.webp)
...
5. Click OK
   ...
   ![673_13_image-20200430140138-7](/images/policypak/troubleshooting/error/gpocompilancereporter/669_7_image-20200327172830-5.webp)
...
Enable DTC through the firewall on both PolicyPak GPCR Server and the remote SQL
Server
...
![673_15_image-20200430140138-8](/images/policypak/troubleshooting/error/gpocompilancereporter/669_9_image-20200327172830-6.webp)

**Step 3 –** Find "Distributed Transaction Coordinator", check and check the appropriate Network
profile (e.g. Domain).

![673_17_image-20200430140138-9](/images/policypak/troubleshooting/error/gpocompilancereporter/669_11_image-20200327172830-7.webp)

**Step 4 –** Click OK to save and close

## Installing GPCR

When installing GPCR, download the latest bits from PolicyPak. It is our
...
**Step 1 –** In the downloaded ISO or ZIP, open "PolicyPak Group Policy Compliance
Reporter" folder and run PolicyPak GP Compliance Reporter (Server).msi
...
![673_19_image-20200430140138-10](/images/policypak/grouppolicycompliancereporter/673_19_image-20200430140138-10.webp)

**Step 7 –** Select "Microsoft SQL Server and "Next >"

![673_21_image-20200430140138-11](/images/policypak/grouppolicycompliancereporter/673_21_image-20200430140138-11.webp)
...
5. Next >
   ...
   ![673_23_image-20200430140138-12](/images/policypak/grouppolicycompliancereporter/673_23_image-20200430140138-12.webp)
...
**Step 1 –** In the downloaded ISO or ZIP, open "PolicyPak Group Policy Compliance
Reporter" folder and run PolicyPak GP Compliance Reporter (Admin Console).msi
...
[Installing Compliance Reporter Server and Client](/docs/policypak/gpcompliancereporter/videos/gettingstarted/install.md)
