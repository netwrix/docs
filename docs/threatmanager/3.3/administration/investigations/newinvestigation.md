...
available from the New Investigation page. See the [Export Report](/docs/threatmanager/3.3/administration/investigations/options/export.md) topic for
...
See the [Investigation Options](/docs/threatmanager/3.3/administration/investigations/options/overview.md) topic for additional information.
