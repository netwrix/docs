...
events. See the [Settings](/docs/threatprevention/8.0/siemdashboard/qradar/navigate/settings.md) topic for additional information.
...
![policyreporting](/images/threatprevention/8.0/siemdashboard/qradar/dashboard/policyreporting.webp)
...
enter the date and time you want or use the calendar buttons to set the interval. Then click **Search** to refresh the card data.
