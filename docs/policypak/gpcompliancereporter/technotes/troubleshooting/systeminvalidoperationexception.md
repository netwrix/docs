...
When using a remote SQL server as the database for Netwrix PolicyPak Group Policy Compliance Reporter, the snapshot operation may fail with the following
error.

![794_1_image-20200327171540-1](/images/policypak/troubleshooting/error/gpocompilancereporter/669_1_image-20200327172830-2.jpeg)
...
[How do I turn on enhanced logging for PolicyPak Group Policy Compliance Reporter if asked to do so?](/docs/policypak/gpcompliancereporter/technotes/troubleshooting/logenhanced.md)g-for-ppgpcr-server-if-asked/
