...
| Filename        | Content                                                                                                                                |
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| en_default.htm  | Static HTML for the Welcome page. See the [Launch Password Policy Enforcer Web](/docs/passwordpolicyenforcer/web-overview/using_web.md) topic for additional information.        |
...
![editing_the_html_templates_1](/images/passwordpolicyenforcer/web/editing_the_html_templates_1.webp)
