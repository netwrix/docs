...
<iframe width="560" height="315" src="https://www.youtube.com/embed/5Z0vb2XXz8A" title="PolicyPak Remote Work Delivery Manager: Automatic Patching and Updates" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Hi, this is Jeremy Moskowitz, and in a previous video, you saw me use Netwrix PolicyPak Remote Work Delivery Manager to deploy new software to endpoints. I did
...
to kick in, or if you're using PolicyPak Cloud or MDM for that to automatically kick
...
That's how you can keep software updated and patched all automatically using PolicyPak
Remote Work Delivery Manager. Hope this video helps you out. Looking forward to getting you started
real soon with PolicyPak. Thanks.
