...
onboarded in the [Credentials Page](/docs/privilegesecure/25.12/admin/interface/credentials/credentials.md).

![Add credentials window](/images/privilegesecure/25.12/accessmanagement/admin/policy/window/accesspolicy/addcredentials.webp)
