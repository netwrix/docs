...
using account names that can't be found in Active Directory. These incidents are grouped per source
...
- Click Analytics in the left pane to launch the Analytics interface. Then click the gear icon for
  the analytic.
- Expand the Analytics node and click your analytic. On the analytic window, click the gear
...
![Bad User ID (by Source Host) Analytic Type - Settings tab](/images/threatprevention/8.0/admin/analytics/baduseridsettings.webp)
...
![Bad User ID (by Source Host) Analytic Type - Policy tab](/images/threatprevention/8.0/admin/analytics/policytab.webp)
...
![Bad User ID by Source Host window](/images/threatprevention/8.0/admin/analytics/baduseridsourcehost.webp)
