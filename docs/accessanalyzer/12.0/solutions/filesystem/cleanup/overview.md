...
default, the actions don't execute as part of the job group. You must select the actions you want
to run before execution. See the [Action Modules](/docs/accessanalyzer/12.0/admin/action/overview.md) topic for
...
- Successfully execute the **.Active Directory Inventory** job group before running this job group
