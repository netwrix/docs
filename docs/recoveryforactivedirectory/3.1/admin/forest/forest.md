...
> ![Forest Configuration page](/images/recoveryforactivedirectory/3.1/product/forest/forest.png)
...
[Firewall Rules for Forest Server Backups](/docs/recoveryforactivedirectory/3.1/requirements/firewallrules.md) topic for additional
information.
:::
...
![Server Backup Configuration wizard - Server page](/images/recoveryforactivedirectory/3.1/product/forest/backup/forest_backup_page1.png)
...
![Server Backup Configuration wizard - Schedule page](/images/recoveryforactivedirectory/3.1/product/forest/backup/forest_backup_page2.png)
...
![Server Backup Configuration wizard - Options page](/images/recoveryforactivedirectory/3.1/product/forest/backup/forest_backup_page3.png)
...
![Server Backup Configuration wizard - Options page](/images/recoveryforactivedirectory/3.1/product/forest/backup/forest_backup_page4.png)
...
![Server Backup Configuration wizard - Confirm page](/images/recoveryforactivedirectory/3.1/product/forest/backup/forest_backup_page5.png)
...
![Server Backup Configuration Saved](/images/recoveryforactivedirectory/3.1/product/forest/backup/forest_backup_finished.png)
...
![Forest Server Backup History](/images/recoveryforactivedirectory/3.1/product/forest/backup_history.png)
...
See the [Recover a Forest](/docs/recoveryforactivedirectory/3.1/admin/forest/recover.md) topic for information on how to recover a forest.
