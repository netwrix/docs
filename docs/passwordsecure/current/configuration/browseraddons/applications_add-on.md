...
are thus necessary. For websites where data can't be entered directly, you must create an
...
possible via [Browser Add-ons](/docs/passwordsecure/current/configuration/browseraddons/browser_add-ons.md). The procedure remains the same.
