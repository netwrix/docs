...
To install the Dell CEE, complete the following:
...
:::info
The latest version of .NET Framework and Dell CEE is recommended for the
...
**Step 7 –** Click OK. The Edit String window closes, and you can close Registry Editor.
