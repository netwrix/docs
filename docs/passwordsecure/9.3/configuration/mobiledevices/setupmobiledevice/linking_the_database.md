...
Then click the button for the QR code in the app. In the following dialog, photograph the QR code
from the monitor. The mobile database is now created directly in the background and
