...
questions of your choice (questions that aren't in the global pool), and (c) by removing questions
from it.
...
4. On the **Security Questions** page, click in the box at the top and select a security question
   from the list of global security questions. You can also enter a search string to filter the
...
2. On the **Identity Stores** page, click the ellipsis button for an identity store and select
   **Edit**.
3. Click **Configurations** under **Settings** in the left pane. Then click **Security Questions**.
4. On the **Security Questions** page, click in the box at the top and enter a security question.
