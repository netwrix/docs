...
- [Logon Activity](/docs/auditor/10.9/configuration/logonactivity/overview.md) – Configure data source as
...
| Specify data collection method                     | You can enable **network traffic compression.** If enabled, a Compression Service automatically launches on the audited computer to collect and prefilter data. This significantly improves data transfer and minimizes the impact on the target computer performance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
