...
Once the change request is approved, you will not be able to change the customizations associated with it or make any other type of modifications to the record.
