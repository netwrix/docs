---
title: "Deploy software with PolicyPak Cloud"
description: "Deploy software with PolicyPak Cloud"
sidebar_position: 10
---
...
a cloud web service then let Netwrix PolicyPak do the rest of the
work!

<iframe width="560" height="315" src="https://www.youtube.com/embed/CftQhMqdeFY" title="PolicyPak Remote Work Delivery Manager: Deploy software with PolicyPak Cloud" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz and in this video, I'm going to show you how you can deploy software to
your domain-joined or non-domain joined machines using PolicyPak Cloud. To get started
...
and link a new policy here and I'm going to pick a PolicyPak Remote Work Delivery
...
PPCloud/sync, what we're doing at this point is getting that new directive from PolicyPak Cloud. That directive is then going to go out and perform the install we staged, those files
...
Just like that, using PolicyPak Cloud to deliver software to your domain-joined and
your non-domain joined machines. Hope this video helps you out. Looking forward to getting you
started with PolicyPak Cloud and Remove Work Delivery Manager real soon. Thanks so
much.
