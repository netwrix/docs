...
Successfully execute the .Active Directory Inventory Solution before installing the
Access Information Center.
...
Enabling Secure Sockets Layer (SSL) for secure remote connections to the Access Information Center
requires a password-enabled certificate with a private key. This certificate should reside in a
...
:::note
If you use any of the Access Information Center workflows (Resource Reviews or
