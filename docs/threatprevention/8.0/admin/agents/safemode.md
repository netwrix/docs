...
modules on one domain controller (see the [Start Pending Modules](/docs/threatprevention/8.0/admin/agents/agent-management/startpendingmodules.md)
...
[System Alerting Window](/docs/threatprevention/8.0/admin/configuration/systemalerting/overview.md) has been configured and email
...
![Netwrix Threat Prevention System Alerting window](/images/threatprevention/8.0/admin/agents/adpendingmodealert.webp)
