...
Inside the PolicyPak GPCR download is the PPGPCR Diagnostics ADMX.ZIP. When unpacked
from the ZIP file, you can use the ADMX files to manage and tune PolicyPak GPCR or for
...
![tuning_and_troubleshooting_624x274](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning/tuning_and_troubleshooting_624x274.webp)

Figure 58. Copying the ADMX files to the PolicyDefinitions folder.

Now when you edit Group Policy Objects (GPOs), you will see PolicyPak GPCR policy
...
![tuning_and_troubleshooting_1_624x272](/images/policypak/troubleshooting/grouppolicycompliancereporter/tuning/tuning_and_troubleshooting_1_624x272.webp)
...
to keep the default setting, which will only send PolicyPak GPCR auditor data in the
...
which would automatically run the PolicyPak GPCR auditor and deliver latest data to
