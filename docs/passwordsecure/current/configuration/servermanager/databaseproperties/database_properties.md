...
The properties of a database can be opened by double-clicking on the database. No log in to the
...
- [Syslog](/docs/passwordsecure/current/configuration/servermanager/databaseproperties/syslog.md)
- [Database firewall](/docs/passwordsecure/current/configuration/servermanager/databaseproperties/database_firewall.md)
