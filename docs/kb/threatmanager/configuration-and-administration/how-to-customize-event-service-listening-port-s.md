...
2. Connect to the Netwrix Threat Prevention database. Create a “Master” password for PGAdmin and enter the Netwrix Threat Prevention database password: `DEFEND124!!`
