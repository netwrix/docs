...
- A third-party package containing a vulnerability was updated. There are no known instances where the vulnerability was exploited.
...
- Fixed an issue where the native Windows App could become unresponsive. You no longer need to end the application via Task Manager.
