...
[Application Server Install](/docs/threatprevention/8.1/install/application.md) topic for installing v8.0.
...
**Step 3 –** Use the [Agents Interface](/docs/threatprevention/8.1/admin/agents/overview.md) in v8.0 to upgrade the
Agent.
...
**Step 4 -** Use the [EPE Settings](/docs/threatprevention/8.1/admin/configuration/epesettings.md) in v8.0 to update the HIBP database.
