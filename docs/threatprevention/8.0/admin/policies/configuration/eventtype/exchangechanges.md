...
![Policy window - Exchange Changes Event Type](/images/threatprevention/8.0/admin/policies/eventtype/exchangechanges.webp)
...
![Policy window - Exchange Event filter for monitoring](/images/threatprevention/8.0/admin/policies/eventtype/exchangeevent.webp)
...
![Policy window - Exchange Trustees filter](/images/threatprevention/8.0/admin/policies/eventtype/exchangetrustees.webp)
...
![Policy window - Exchange Perpetrator filter](/images/threatprevention/8.0/admin/policies/eventtype/exchangeperpetrator.webp)
