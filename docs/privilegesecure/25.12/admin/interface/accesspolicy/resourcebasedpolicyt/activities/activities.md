...
![Activities Tab for Resource based Policies](/images/privilegesecure/25.12/accessmanagement/admin/policy/tab/policyresource/activitiestab.webp)
...
- Add — Opens the Add Activities and Activity Groups window. See the
  [Add Activities and Activity Groups Window](/docs/privilegesecure/25.12/admin/interface/accesspolicy/resourcebasedpolicyt/activities/addactivitiesandactivitygroups.md)
