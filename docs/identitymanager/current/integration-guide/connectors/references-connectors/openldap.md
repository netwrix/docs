...
This page is about [OData](../../../integration-guide/connectors/references-packages/odata).

![Package: Directory/Open LDAP](/images/identitymanager/integration-guide/connectors/references-connectors/openldap/packages_ldapopen_v603.webp)
...
To perform a complete export without the SyncProv Overlay enabled, use rather the [LDAP](../../../integration-guide/connectors/references-connectors/ldap) connector.
...
- a
[Connection](../../../integration-guide/toolkit/xml-configuration/connectors/connection) able to store OpenLDAP's `Login`, `Password` and `Server`.
