...
[Resources Page](/docs/privilegesecure/26.03/admin/resources/resources.md).

![Resources Dashboard Page](/images/privilegesecure/26.03/accessmanagement/admin/dashboard/resources.webp)
...
tenant. See the [Add New Microsoft Entra ID Tenant](/docs/privilegesecure/26.03/admin/resources/entraidtenant.md) topic for
...
[Remove Resource Window](/docs/privilegesecure/26.03/admin/resources/removeresource.md) topic for additional
information.
...
view additional details. See the [Service Accounts Page](/docs/privilegesecure/26.03/admin/configuration/serviceaccounts/serviceaccounts.md)
