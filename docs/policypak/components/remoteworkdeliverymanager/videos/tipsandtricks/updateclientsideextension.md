---
title: "Using Remote Work Delivery Manager to Update the PolicyPak Client Side Extension"
description: "Using Remote Work Delivery Manager to Update the PolicyPak Client Side Extension"
sidebar_position: 30
---
# Using Remote Work Delivery Manager to Update the PolicyPak Client Side Extension
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/M3Tm1mbK6wg" title="Using Remote Work Delivery Manager to Update the PolicyPak Client Side Extension" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is John with Netwrix PolicyPak Software. Today, we're
going to walk through updating your PolicyPak client-side extension using Remote Work
...
come back over here. Dccore is where it resides. Location CSE, and it is the PolicyPak
