...
The Audit and Compliance page in the Investigations interface list of saved pre-configured
...
![Investigations interface on the Audit and Compliance page](/images/threatprevention/8.0/reportingmodule/investigations/auditcompliance.webp)
