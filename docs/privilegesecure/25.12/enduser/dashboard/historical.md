...
![Historical Dashboard](/images/privilegesecure/25.12/accessmanagement/enduser/dashboard/historicaldashboard.webp)
...
session. See the [Session Logs Window](/docs/privilegesecure/25.12/enduser/dashboard/active/startsession/sessionlogs.md) topic for additional
information.
