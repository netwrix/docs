...
Video: For a quick overview of how to manage certificates in IE using PolicyPak
...
:::note
PolicyPak can only deploy binary/DER type certificates. If you need to
...
![ie_appset_tab_by_tab_25](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_25.webp)
...
![ie_appset_tab_by_tab_26](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_26.webp)
...
location like `c:\Certificates`. PolicyPak then accesses the file in that location and
determines which certificate store you want to put it in. The available stores and the corresponding
word to specify within PolicyPak can be seen in Table 1.

Table 1: Certificate stores and corresponding terms.

| IE Certificate Store                   | Word to specify in PolicyPak AppSet |                          |
| -------------------------------------- | ------------------------------------------------- | ------------------------ |
...
![ie_appset_tab_by_tab_27](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_27.webp)
...
PolicyPak can only work with binary-formatted/DER certificates. If you have a
...
![ie_appset_tab_by_tab_28](/images/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_28.webp)
...
![ie_appset_tab_by_tab_29](/images/policypak/applicationsettings/preconfigured/firefox/certificate/certificates_5.webp)
