...
Netwrix PolicyPak Applock™ is the ability to gray out or remove
...
![195_1_image003](/images/policypak/troubleshooting/applicationsettings/applock/195_1_image003.webp)

And also here.

![195_2_image004](/images/policypak/troubleshooting/applicationsettings/applock/195_2_image004.webp)

Note that PolicyPak AppLock options can only work on well-behaved Win32 applications.
...
So the Paks we create and capture at PolicyPak, we use:
...
:::note
 it IS possible re-capture the UI using the PolicyPak DesignStudio and then
...
![195_3_image009](/images/policypak/troubleshooting/applicationsettings/applock/195_3_image009.webp)

This same option with the Java Paks.

![195_4_image010](/images/policypak/troubleshooting/applicationsettings/applock/195_4_image010.webp)
