---
title: "Microsoft User Experience Virtualization (UE-V) enhanced by PolicyPak"
description: "Microsoft User Experience Virtualization (UE-V) enhanced by PolicyPak"
sidebar_position: 30
---
# Microsoft User Experience Virtualization (UE-V) enhanced by PolicyPak

Microsoft's User Experience Virtualization (UE-V) product is great and it does something Netwrix PolicyPak doesn't do. On the other hand PolicyPak
does something that Microsoft UE-V doesn't do, too. And that makes a perfect "better together"
story.

Here's the video to show how PolicyPak and Microsoft UE-V (or, really, any User
...
- PolicyPak dictates settings, enforces them and ensures that IT standards are
...
- PolicyPak doesn't roam users' changed preference settings — ever. That's not its
  job.

Let users roam what they think are important settings (UE-V). You dictate and enforce what you know
are important business and IT settings (PolicyPak.)

Like Microsoft U-EV, PolicyPak works with regular installed applications and also
Microsoft App-V applications. Both Microsoft U-EV and PolicyPak work with real
desktop, laptops, Terminal Services (RDS) and VDI.

When you're ready to manage try out PolicyPak with your UE-V, and manage your
