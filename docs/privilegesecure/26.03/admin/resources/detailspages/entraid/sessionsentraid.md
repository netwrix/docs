...
![Sessions Tab Entra ID](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/resources/sessionsazuread.webp)
...
- Activity — Displays the name of the activity. See the [Activities Page](/docs/privilegesecure/26.03/admin/activities/activities.md)
