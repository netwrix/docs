...
The Password Policy Enforcer server installer detects existing installations and upgrades them to version 12.0. Follow the [Install the Server Components](installationserver.md) instructions to upgrade an existing installation. You don't need to uninstall the old version first.
...
The Password Policy Client installer detects existing installations and upgrades them to version 12.0. Follow the [Install the Password Policy Client](installationclient.md) instructions to upgrade an existing installation. You don't need to uninstall the old version first.
