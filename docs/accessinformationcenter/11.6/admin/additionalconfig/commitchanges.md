...
When File System or SharePoint resources will be managed through the AIC, configure access groups for those resources in the target environment. An access group provides one
