...
Microsoft Intune doesn't help you there. But there's good news: that's where Netwrix PolicyPak comes in.

Simply take PolicyPak directives then utilize Microsoft Intune to deploy those
directives.
...
applications PolicyPak and Intune:
...
the best part: Create your PolicyPak directives once, and what you do for one customer
you can implement for all customers, easy peasy.

You can create your own PolicyPak for your applications to manage all your customers'
...
When you're ready to manage your applications and settings using Microsoft Intune, PolicyPak is here for you.
