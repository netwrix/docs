...
| IsMultivalued <span class="optionalAttribute">default value: false</span> | **Type:** Boolean **Description:** Defines if the attribute is multi-valued. |
| KeyType <span class="optionalAttribute">default value: 0</span> | **Type:** ConnectionColumnKeyType **Description:** Defines the key type of the column. - 0: not a key - 1: primary key - 2: unique key |
...
| ValueLength <span class="optionalAttribute">default value: 0</span> | **Type:** Int32 **Description:** Maximum length of the attribute value. |
| ValueType <span class="optionalAttribute">default value: 0</span> | **Type:** ConnectionColumnValueType **Description:** Defines the format of the attribute value. - 0: String - 1: Bytes - 2: Int32 - 3: Int64 - 4: DateTime - 5: Bool - 6: Guid - 7: Double - 8: Binary - 9: Byte - 10: Int16 |
