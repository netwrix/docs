...
The most common problem users experience with Netwrix PolicyPak
Feature Manager for Windows is that they don't see a feature installed or uninstalled as expected.
Here are some tips when trying to troubleshoot PolicyPak Feature Manager for Windows.

The log files for PolicyPak Feature Manager for Windows's are found in the following
folder:

`%Programdata%\PolicyPak\PolicyPak Feature Manager for Windows`. This is because PolicyPak Feature Manager for Windows affects the Computer side (and all users on that computer). It's
...
because all work related to PolicyPak Feature Manager for Windows happens on the
Computer side.

There are several files to check in the folder. These files are as follows:

- `ppComputerOperational.log`. This is the log where you can see exactly what PolicyPak Feature Manager for Windows believes it has accomplished, any error conditions, and if the
...
Figure 45 shows an example of a PolicyPak Feature Manager for Windows log with some
annotations during a single run/GPupdate.

![troubleshooting](/images/policypak/troubleshooting/feature/troubleshooting.webp)

![troubleshooting_1](/images/policypak/troubleshooting/feature/troubleshooting_1.webp)

![troubleshooting_2](/images/policypak/troubleshooting/feature/troubleshooting_2.webp)

Figure 45. An example of a PolicyPak Feature Manager for Windows log.

Then, to see details of what PolicyPak Feature Manager for Windows is trying to do,
...
![troubleshooting_3](/images/policypak/troubleshooting/feature/troubleshooting_3.webp)

![troubleshooting_4](/images/policypak/troubleshooting/feature/troubleshooting_4.webp)
