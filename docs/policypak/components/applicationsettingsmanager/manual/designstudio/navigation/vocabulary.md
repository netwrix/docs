...
Let's continue with a little vocabulary for working with PolicyPak DesignStudio. All
...
Your goal with PolicyPak DesignStudio is to bring in as much of the applications' user
...
![getting_around](/images/policypak/applicationsettings/designstudio/navigation/getting_around.webp)

The figure shown. Some of the main PolicyPak DesignStudio components.
