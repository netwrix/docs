...
3. Press the Last 24 hours button and choose Last 15 minutes time range.

4. Press the search button; you should see list of the events with Splunk service information.
