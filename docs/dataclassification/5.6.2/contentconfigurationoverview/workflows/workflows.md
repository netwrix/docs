...
Use a workflow to configure an automated action that will be performed on a document,
...
Looking for real-life use cases and walk-through examples? Check out Netwrix training materials. Visit the [Netwrix website](https://www.netwrix.com/data_remediation_workflows.html) to find out how you
