...
and Top Resources sections (see the [Investigation Reports](/docs/threatprevention/8.1/reportingmodule/investigations/reports/reports.md) topic). Click a link to land
on the Host Details page.

![Host Details page](/images/threatprevention/8.1/reportingmodule/investigations/hostdetails.webp)
...
- Group – The name of the group. Click the link to view group details. See the
  [Group Details Page](/docs/threatprevention/8.1/reportingmodule/investigations/reports/group.md) topic for additional information.
