---
title: "PolicyPakand Workspace One (Airwatch) MDM: Deploy Group Policy and PolicyPak superpowers today"
description: "PolicyPakand Workspace One (Airwatch) MDM: Deploy Group Policy and PolicyPak superpowers today"
sidebar_position: 50
---
# PolicyPakand Workspace One (Airwatch) MDM: Deploy Group Policy and PolicyPak superpowers today

Workspace One (Airwatch) is awesome, but it doesn't have real group policy, or extra Windows 10
desktop management features. Watch this video and learn how to useNetwrix PolicyPak to deliver REAL Group Policy settings and PolicyPak's extra
settings to all your Workspace One (Airwatch) MDM joined Windows 10 machines.

<iframe width="560" height="315" src="https://www.youtube.com/embed/URF_gKbs6kc" title="PolicyPak and Workspace One (Airwatch) MDM: Deploy Group Policy and PolicyPak superpowers today." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
"Policies," "Preferences" and PolicyPak's special settings like "Application Settings
Manager,"
...
"AirWatch Console" as applications. The first thing is the "PolicyPak Client-Side
Extension." It's a little MSI that gets deployed to all of your endpoints. It's the thing that does
work.

You're also going to upload the license file that we give you (" PolicyPak MDM
...
anyone at the "PolicyPak.com" domain name can join AirWatch and get Group Policy
settings or PolicyPak special settings.

Then lastly are the actual "Packaged PolicyPak Settings" themselves. These are the
...
PolicyPak Browser Router" so I can manage browsers and ensure that the right browser
...
again, our first goal is to deploy real Group Policy settings and PolicyPak's magic.
...
I'm going to be doing is showing you an example of how you can us PolicyPak to deliver
...
none of the configuration is set or delivered. PolicyPak is going to deliver a bunch
...
PolicyPak through AirWatch, and at this point now it has been renamed as "PolicyPak Guest."

Again, almost every security setting that can be touched using Group Policy can be delivered through
AirWatch because of PolicyPak now.

So that was all the policy stuff. If we take a look at other PolicyPak superpower
settings, for instance, if we take a look at "WinZip" and we take a look at "Settings/Options" here,
you can see that PolicyPak has delivered these settings. And not only can we rip the
...
This is all PolicyPak settings delivered through AirWatch because of the MDM join.
