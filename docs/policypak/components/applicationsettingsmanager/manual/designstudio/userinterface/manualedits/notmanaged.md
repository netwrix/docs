...
PolicyPak Application Settings Manager can control a lot of items; however, there are
some UI elements that it cannot manage. In the figure shown, the "Reset All Warnings" button in this
application, which might reset settings within the application, isn't something that PolicyPak Application Settings Manager can control. Inside PolicyPak Application
...
![crafting_the_user_interface_15_624x362](/images/policypak/applicationsettings/designstudio/userinterface/manualedits/crafting_the_user_interface_15_624x362.webp)
...
Group Policy. For this element, if you do nothing here in PolicyPak DesignStudio, then
