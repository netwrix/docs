...
- Server Installation: install on each server and domain controller in the domain you are
  ...
  [Install Password Policy Enforcer on a Server](/docs/passwordpolicyenforcer/12.0/installation/installationserver.md) or automatically
  with [Install with Group Policy Management](/docs/passwordpolicyenforcer/12.0/installation/installationgpm.md) procedure. Installing
...
- Client Installation: install on each workstation you are evaluating. The Password Policy Client is
  ...
  the [Install Password Policy Enforcer Client](/docs/passwordpolicyenforcer/12.0/installation/installationclient.md) procedure, or
  [Install with Group Policy Management](/docs/passwordpolicyenforcer/12.0/installation/installationgpm.md).
...
[Password Policy Client](/docs/passwordpolicyenforcer/12.0/admin/password-policy-client/password_policy_client.md) topic for additional
information.
