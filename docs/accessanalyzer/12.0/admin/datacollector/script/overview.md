...
inadequate for demanding auditing tasks. The Script Data Collector lets you add a custom
script to a query. Access Analyzer implements Microsoft Visual Basic Script (VB Script) with
extensions that let script writers interface directly with Access Analyzer.
...
- Compound Queries – A query you can't perform using a single query. See the
...
The Script Data Collector is a core component of Access Analyzer, but Access Analyzer
