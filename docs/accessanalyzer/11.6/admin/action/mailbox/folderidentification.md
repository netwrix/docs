...
- Yes, the query results contain a mailbox folder identification column
    ...
    - Select the mailbox identification column using the dropdown menu
...
- No, the query results don't contain a mailbox folder identification column – Selecting this
