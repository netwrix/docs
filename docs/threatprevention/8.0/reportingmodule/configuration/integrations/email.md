...
![Integrations interface on the Email page](/images/threatprevention/8.0/reportingmodule/configuration/integrations/page_3.webp)
...
![Integrations interface on the Email page showing details](/images/threatprevention/8.0/reportingmodule/configuration/integrations/details_3.webp)
...
- Use TLS – Toggle the button to **ON** if you want to use TLS for email
  notifications
...
field for the connection test completed in Step 4. After the test succeeds, replace your email
with the recipient email addresses.
:::
