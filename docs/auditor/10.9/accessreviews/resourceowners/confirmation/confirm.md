...
The **Request Confirmation** button in the Resource Owners interface opens the Confirm Ownership
wizard. You can open it for one or multiple resources.
...
-   1. Select Owners — Lists the current owners for each selected resource and confirmation status

## Request Ownership Confirmation

To request ownership confirmation:
...
**Step 2 –** On the Select Owners page, you can optionally remove owners you don't want or need
ownership confirmation from. Select those owners and click **Remove**. Those owners will not receive
the confirmation email. When the list is set the way you want, click **Finish**. The Access Reviews
...
[Ownership Confirmation Request Email](/docs/auditor/10.9/accessreviews/owneroverview/confirmationrequest.md) topic for additional
information.
