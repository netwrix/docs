...
:::note
Before configuring your monitoring plan, read and complete the instructions in the following topics:
:::
...
- Configures alerts related to VMware data source. Netwrix Auditor includes one predefined alert
  ...
  the [Create Alerts](/docs/auditor/10.8/admin/alertsettings/create/create.md) topic.
