...
be used in the same way as the [History](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/passwords/history.md). The interplay between the
