...
![Host Details Page](/images/privilegesecure/26.03/accessmanagement/admin/policy/page/details/hostdetailspage.webp)
...
[Test Resource Connectivity Window](/docs/privilegesecure/26.03/admin/resources/detailspages/host/testresourceconnectivity.md) topic
...
[Platforms Page](/docs/privilegesecure/26.03/admin/platforms/overview.md).
- WinRM Config button — Opens the Configure Secure WinRM Connection window. See the
[Configure Secure WinRM Connection Window](/docs/privilegesecure/26.03/admin/resources/detailspages/host/configuresecurewinrmconnection.md)
...
- Allow Connection — This setting allow a connection to the host. (No event is generated.)
- Log Event and Allow — This setting allow a connection to the host and log an event in the
...
- [Sessions Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/sessionshost.md)
- [Access Policies Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/accesspolicieshost.md)
- [Protection Policies Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/protectionpolicieshost.md)
- [Users Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/usershost.md)
- [Groups Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/groupshost.md)
- [Services Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/serviceshost.md)
- [Scheduled Tasks Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/scheduledtaskshost.md)
- [History Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/historyhost.md)
- [Installed Software Tab for Host](/docs/privilegesecure/26.03/admin/resources/detailspages/host/installedsoftwarehost.md)
