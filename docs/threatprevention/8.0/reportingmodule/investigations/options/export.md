...
![Export option in the Investigation interface](/images/threatprevention/8.0/reportingmodule/investigations/options/export.webp)
...
See the [Folder Settings Page](/docs/threatprevention/8.0/reportingmodule/configuration/integrations/foldersettings.md) topic for
...
message will appear in the window. See the[Email Page](/docs/threatprevention/8.0/reportingmodule/configuration/integrations/email.md)
topic for additional information.
:::


You can send the report data of an investigation as an attachment to an email. The attachment can be
any of the file formats available for download.
...
![Send as Email window](/images/threatprevention/8.0/reportingmodule/investigations/options/sendasemail.webp)
...
[Folder Settings Page](/docs/threatprevention/8.0/reportingmodule/configuration/integrations/foldersettings.md) section for additional
information.
:::


You can schedule to save the report data of an investigation to a shared folder. The file format can
be any of the formats available for download.
...
![Schedule export window](/images/threatprevention/8.0/reportingmodule/investigations/options/scheduleexport.webp)
...
See the [Subscriptions and Exports Page](/docs/threatprevention/8.0/reportingmodule/investigations/subscriptionsexports.md) topic for additional
information.
