...
- Welcome
- [ADInventory: Category](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/adinventory/category.md)
- [ADInventory: Results](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/adinventory/results.md)
- [ADInventory: Options](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/adinventory/options.md)
- [ADInventory: Index Update Options](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/adinventory/indexupdateoptions.md)
- [ADInventory: Custom Attributes](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/adinventory/customattributes.md)
- [ADInventory: Summary](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/adinventory/summary.md)
