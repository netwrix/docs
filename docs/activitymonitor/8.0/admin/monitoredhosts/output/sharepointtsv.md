...
The TSV log file format sends SharePoint activity monitoring data to Access Analyzer v10.0
and earlier consoles. The following information lists all of the columns that SharePoint
Activity Monitor generates into a TSV log file:
