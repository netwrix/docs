...
[Agent Information](/docs/threatprevention/8.0/install/agent/overview.md) topic for specifics on where to deploy.
...
See the [Agents Interface](/docs/threatprevention/8.0/admin/agents/overview.md) topic and the
[Deploy Agents](/docs/threatprevention/8.0/admin/agents/deploy/overview.md) topic for additional information to deploy
...
the
[Enrollment Secret Configuration Window](/docs/threatprevention/8.0/admin/agents/agents-windows/enrollmentsecretconfiguration.md)
...
![Threat Prevention Windows Agent Setup wizard - Welcome page](/images/threatprevention/8.0/install/agent/welcome.webp)

**Step 2 –** On the Welcome page, click **Install**. The Setup Progress page is displayed, followed
by another Welcome page.

![welcome2](/images/threatprevention/8.0/install/agent/welcome.webp)

**Step 3 –** Click **Next**.

![Threat Prevention Windows Agent Setup wizard - End-User License Agreement page](/images/threatprevention/8.0/install/agent/license.webp)

**Step 4 –** On the End-User License Agreement page, check the **I accept the terms in the License
Agreement** box and click **Next**.

![Threat Prevention Windows Agent Setup wizard - Destination Folder page](/images/threatprevention/8.0/install/agent/destinationfolder.webp)
...
![Change Destination Folder Page](/images/threatprevention/8.0/install/agent/changedestination.webp)
...
![Threat Prevention Windows Agent Setup wizard - CA Certificate Configuration page](/images/threatprevention/8.0/install/agent/cacertconfig.webp)
...
![Threat Prevention Windows Agent Setup wizard - Enterprise Manager Location Information page](/images/threatprevention/8.0/install/agent/enterprisemanager.webp)
...
![StealthINTERCEPT Windows Agent Setup wizard on the Certificates page](/images/threatprevention/8.0/install/agent/certificates.webp)
...
![Threat Prevention Windows Agent Setup wizard - Select Event Sources page](/images/threatprevention/8.0/install/agent/eventsources.webp)
...
![Threat Prevention Windows Agent Setup wizard – Ready page](/images/threatprevention/8.0/install/agent/readytoinstall.webp)
...
![Threat Prevention Windows Agent Setup wizard – Operation Successful page](/images/threatprevention/8.0/install/agent/success.webp)
