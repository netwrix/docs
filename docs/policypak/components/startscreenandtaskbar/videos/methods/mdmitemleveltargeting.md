---
title: "PolicyPak Start Screen Manager: Manage Windows 10 Start Screen & Taskbar with your MDM (Advanced scenarios with ILT)"
description: "PolicyPak Start Screen Manager: Manage Windows 10 Start Screen & Taskbar with your MDM (Advanced scenarios with ILT)"
sidebar_position: 30
---
# PolicyPak Start Screen Manager: Manage Windows 10 Start Screen & Taskbar with your MDM (Advanced scenarios with ILT)

Making an MDM policy to manage the Start Menu and Taskbar can be a NIGHTMARE. But not with Netwrix PolicyPak Start Screen Manager. With us you can have ONE policy
which can be used again and again. See how it's done.

<iframe width="560" height="315" src="https://www.youtube.com/embed/amWoU2LMiBk" title="PolicyPak Start Screen Manager and MDM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak Start Screen Manager and MDM

Hi. This is Jeremy Moskowitz. In this video, I'm going to show you how you can use PolicyPak Start Screen Manager to manage your machines out in the field with your own MDM service.
...
need to wrap it up into an MSI. PolicyPak comes with a little utility to help you with
that the "PolicyPak Exporter Tool."
...
video while I do this and by the time it's over we'll see a thing called "Packaged PolicyPak Settings" just like we have here. Then like I said, when I come back to the video we're
...
everybody. With PolicyPak you can autosense and figure out what people should get what
groups based on what conditions, upload that and use your MDM service to deliver the PolicyPak Start Screen Manager settings.
