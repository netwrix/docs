...
**IMPORTANT!** Make sure you created and configured a Dropbox app before adding the source. See the linked [Configure Dropbox for Crawling](/docs/dataclassification/5.7/introduction/introduction/dropbox.md) page for app requirements.
...
| Source Group                 | Netwrix recommends creating a dedicated source group for Dropbox. If no source group exists, a source group named Dropbox Sources will be created automatically.                                                                                                                                                                                                                                                                                                                                     |
