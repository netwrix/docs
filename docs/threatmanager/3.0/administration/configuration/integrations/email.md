...
Use the Email page in the Integrations interface to configure the application to send
email notifications.
...
- Mail Server – The IP address or server name of the mail server used to send email notifications
- Port – The Port used by the mail server
- Use TLS – Indicates whether the TLS protocol is in use for email notifications
- Ignore Certificate Errors – Indicates whether the application ignores certificate errors when sending email
- User Name – The user name of the credentials used when TLS is enabled
- Password – The password for the credentials used when TLS is enabled
- Send From Address – The email address listed as the sender of notifications
- Send Alerts To – The email address(es) that receive alert notifications; use a semicolon as a separator
...
- Mail Server – Enter the IP address or server name of the mail server used to send email notifications
- Port – Enter the Port used by the mail server. The default port is 25.
- Use TLS – Toggle the button to **ON** to enable TLS for email notifications
- Ignore Certificate Errors – Toggle the button to **ON** to ignore certificate errors when sending email
- User Name – If applicable, enter the user name of the credentials used when TLS is enabled
- Password – If applicable, enter the password for the credentials used when TLS is enabled
- Send From Address – Enter the email address listed as the sender of notifications
- Send Alerts To – Enter the email address(es) that receive alert notifications; use a semicolon as a separator
...
field for the connection test in Step 4. After the test succeeds, replace your email
with the recipients you want to notify.
:::
