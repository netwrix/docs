...
job doesn't require a host to target, select **Local host** on the Hosts page of the Enterprise
...
**Step 1 –** In the Analysis Selection Pane, click **Select All** to check all tasks.
...
The tasks have now dropped all of these tables from the SQL Server database, and the data is no
longer available.
