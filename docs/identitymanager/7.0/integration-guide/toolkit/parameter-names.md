...
Identity Manager uses flavor of base32 known as **base32hex** described in the [RFC4648](https://tools.ietf.org/html/rfc4648#rfc4648).
...
The [Context Rule](../../integration-guide/toolkit/xml-configuration/provisioning/contextrule.md) support _128_ dimension parameters going from `B0` to `B3V` using the **base32hex**`0` to `3V` numbers to identify a dimension.
