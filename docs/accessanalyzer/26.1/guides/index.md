...
| [Scan SharePoint Online](./microsoft-365.md) | **SharePoint Online** | **Client ID/certificate** | Access scan, then Sensitive data scan | Data security dashboard, SharePoint reports |
