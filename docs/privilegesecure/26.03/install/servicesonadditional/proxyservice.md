...
![Netwrix Privileged Secure Proxy Service Setup wizard on the EULA page](/images/privilegesecure/26.03/accessmanagement/install/licenseagreement_2.webp)
...
![Netwrix Privileged Secure Proxy Service Setup wizard on the Setup Options page](/images/privilegesecure/26.03/accessmanagement/install/setupoptions.webp)
...
![Netwrix Privileged Secure Proxy Service Setup wizard on the Successfully Completed page](/images/privilegesecure/26.03/accessmanagement/install/completed_2.webp)
...
```
![Proxy Registered ](/images/privilegesecure/26.03/accessmanagement/install/registerproxy.png)
