---
title: "I see the PolicyPak Browser Router Chrome Extension is being installed, but it's not active. What can I do?"
description: "I see the PolicyPak Browser Router Chrome Extension is being installed, but it's not active. What can I do?"
sidebar_position: 130
---

# I see the PolicyPak Browser Router Chrome Extension is being installed, but it's not active. What can I do?

From time to time it's possible that the Netwrix PolicyPak
Browser Router extension for Chrome will be installed, but not active, like in this example.

![489_1_dfg_950x593](/images/policypak/troubleshooting/browserrouter/chrome/489_1_dfg_950x593.webp)
