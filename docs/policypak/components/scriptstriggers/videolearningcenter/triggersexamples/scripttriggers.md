---
title: "PolicyPak Scripts and Triggers: Get to understand login script trigger with GP and MDM systems !"
description: "PolicyPak Scripts and Triggers: Get to understand login script trigger with GP and MDM systems !"
sidebar_position: 10
---
# PolicyPak Scripts and Triggers: Get to understand login script trigger with GP and MDM systems !

No login scripts in MDM and Intune got your down? Looking to have something faster and more reliable
(and something that works offline) for GPO and Netwrix PolicyPak
cloud? Then check out PolicyPak Scripts + Login Script Triggers... right here!

<iframe width="560" height="315" src="https://www.youtube.com/embed/y14Q4qUndxM" title="PolicyPak Scripts and Triggers: Get to understand login script trigger with GP and MDM systems !" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video, we're going to learn how to use triggers with regards
to PolicyPak scripts. There's a bunch of problems we want to overcome. The first one
...
to show you both of those things right now with PolicyPak Scripts Manager.

What we're going to do is our our east sales users, we're going to create a GPO called PolicyPak Scripts and Triggers. Of course this GPO name could be whatever you want. Then I'll
go ahead and click Edit here and this is just built right into PolicyPak. You can do
...
InTune, and you can see we've already pre-staged and assigned the PolicyPak client set
extension and the PolicyPak license. Now it's time to add in the exported group policy
...
left is to sign out, sign back on, and see that our log-on script is now hitting with PolicyPak scripts and triggers.

If we go ahead and log back on here, give it a second to catch up, and here we are. We'll all logged
on. There it is, the Visit PolicyPak item, and like I said, if we decide – a user
...
If you like the idea of PolicyPak scripts and triggers, you're welcome to watch some
