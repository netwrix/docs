...
Checklist Item 2:
[Install Dell CEE](/docs/accessanalyzer/11.6/config/dellunity/installcee.md)
...
- Configure initial setup for a Unity device
    ...
    - [Unity Initial Setup with Unisphere](/docs/accessanalyzer/11.6/config/dellunity/setupunisphere.md)
...
- See the [Validate Setup](/docs/accessanalyzer/11.6/config/dellunity/validate.md)
