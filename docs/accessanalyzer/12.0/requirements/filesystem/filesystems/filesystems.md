...
Azure Files is a fully managed, cloud-based file sharing service from Microsoft that provides access
to file shares from anywhere as a virtual network drive. Access Analyzer supports Access
