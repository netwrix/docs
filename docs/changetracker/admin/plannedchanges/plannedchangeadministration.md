...
[Events Tab](/docs/changetracker/admin/events/events.md), or by recording events directly from a device group. Note that an
...
![PlannedChangesRules](/images/changetracker/admin/tabs/plannedchangesrules.webp)
