...
You can sort policies in ascending or descending order by clicking a column
...
![Enabled and Disabled Policies in the Navigation pane](/images/threatprevention/7.5/admin/policies/enableddisabledpolicies.webp)
