...
- [1.Groups Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/cleanup/groups/overview.md)
...
- [2.Users Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/cleanup/users/overview.md)
  – Provides an automated workflow to deprovision stale and unused user accounts
- [3.Computers Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/cleanup/computers/overview.md)
  – Provides an automated workflow to deprovision stale computer accounts
- [AD_CleanupProgress Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/cleanup/ad_cleanupprogress.md)
