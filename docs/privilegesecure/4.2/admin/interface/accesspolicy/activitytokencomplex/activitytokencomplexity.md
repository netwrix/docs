...
- Must Start With / Must End With — Lists cases the activity token complexity policy enforces.
...
- Length — The maximum number of characters the activity token complexity policy enforces
