...
:::note
For some video overviews of Netwrix PolicyPak Feature
...
![quickstart_adding_and_removing](/images/policypak/feature/addremove/quickstart_adding_and_removing.webp)

Then click **Edit** to edit the GPO.

:::note
Even if you're using PolicyPak Cloud or MDM edition, you still need to
