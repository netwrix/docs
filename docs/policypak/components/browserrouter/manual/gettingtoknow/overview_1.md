...
![about_policypak_browser_router_11](/images/policypak/browserrouter/defaultbrowser/about_endpointpolicymanager_browser_router_11.webp)

The **User Selectable** option enables the user to specify their desired default browser as Internet
Explorer, Edge, Chrome, or Firefox. The PolicyPak engine "learns" this setting at the
...
re-applies to capture their desired setting. If this is the case, PolicyPak cannot
...
![about_policypak_browser_router_12](/images/policypak/browserrouter/defaultbrowser/about_endpointpolicymanager_browser_router_12.webp)
...
![about_policypak_browser_router_13](/images/policypak/browserrouter/defaultbrowser/about_endpointpolicymanager_browser_router_13.webp)
