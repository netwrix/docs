...
application server on the server you are installing the Action Service before installation.
...
![licenseagreement](/images/privilegesecure/26.03/accessmanagement/install/licenseagreement_3.webp)

**Step 4 –** To install the Action Service in an alternate location, click **Options**.

![installlocation](/images/privilegesecure/26.03/accessmanagement/install/installlocation.webp)
...
![installcomplete](/images/privilegesecure/26.03/accessmanagement/install/installcomplete.webp)
