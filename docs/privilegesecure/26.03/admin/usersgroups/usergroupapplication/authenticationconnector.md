...
Authentications page. See the [Authentication Page](/docs/privilegesecure/26.03/admin/configuration/authentication/authentication.md)
topic for additional information.

![Users Authentication Connector Tab](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/usersgroups/userauthenticationtab.webp)
