...
the [ Policy Interface](/docs/privilegesecure/25.12/admin/interface/interface.md).

![Add Policies to a Custom Role Window](/images/privilegesecure/25.12/accessmanagement/admin/policy/window/usersgroups/addaccounttopolicies.webp)
