...
To add credentials to the selected access policy.
...
**Step 6 –** Click **Add** to add the credentials to the access policy.

The new credentials are added to the access policy and are shown in the
