...
scenario and security policies. See [Choose Appropriate Execution Scenario](/docs/auditor/10.9/addon/siemeventlogexport/deployment.md) for
...
parameters— the script uses a default value unless you explicitly define one.
