...
![add_ons](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons.webp)
...
![add_ons_3](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_3.webp)
...
![add_ons_4](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_4.webp)
...
![add_ons_5](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_5.webp)
...
![add_ons_6](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_6.webp)

The figure shown. Example 1 showing only GUIDs.

![add_ons_7](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_7.webp)

The figure shown. Example 2 showing the friendly name and GUID.

**Step 6 –** Then, inside the PolicyPak MMC console, you will add the ID you want
(without quotes), as shown In the figure shown.

![add_ons_8](/images/policypak/applicationsettings/preconfigured/firefox/addons/add_ons_8.webp)

The figure shown. Adding the ID within the PolicyPak MMC console.
