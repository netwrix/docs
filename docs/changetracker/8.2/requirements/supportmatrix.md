...
| ----- | ---------- | ------------- | ------------ | ------- | ------------ |
| 8.2.0 | 7.3.0      | 2.1.2         | 2.2.2        | 8.2.3   | 8.0.0        |
| 8.1.3 | 7.2.3      | 2.1.2         | 2.2.2        | 8.2.3   | 8.0.0        |
| 8.1.2 | 7.2.2      | 2.1.2         | 2.2.2        | 8.2.3   | 8.0.0        |
| 8.1.1 | 7.2.1      | 2.1.2         | 2.2.0        | 8.0.5   | 8.0.0        |
...
\* CentOS 7, RHEL 7, Fedora 39, and Oracle Linux 7 require agent v7.1.4; later versions don't support these legacy OS releases.
