...
![Create Activity Session Interface](/images/privilegesecure/26.03/accessmanagement/enduser/dashboard/createsessionuser.webp)
...
![Create Session window Resource Selection](/images/privilegesecure/26.03/accessmanagement/enduser/dashboard/createsessionresourceselection.webp)
...
![Create Session Notes Page](/images/privilegesecure/26.03/accessmanagement/enduser/dashboard/createsessionnotes.webp)
...
![Create Session Schedule Page](/images/privilegesecure/26.03/accessmanagement/enduser/dashboard/createsessionscheduling.webp)
...
![Create Session Review Page](/images/privilegesecure/26.03/accessmanagement/enduser/dashboard/createsessionreview.webp)
...
See the [Start Activity Session](/docs/privilegesecure/26.03/enduser/dashboard/active/startsession/startsession.md) topic for additional information.
