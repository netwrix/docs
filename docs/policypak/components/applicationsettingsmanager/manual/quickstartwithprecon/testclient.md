...
- The user is logging onto the machine with PolicyPak CSE.
...
**Step 2 –** Let's inspect what PolicyPak Application Settings Manager was able to
perform.
...
![policypak_application_settings_12](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_12.webp)
