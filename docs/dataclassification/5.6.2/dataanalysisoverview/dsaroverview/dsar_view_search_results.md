...
Depending on assigned DSAR role, a user can view their searches or searches that other users submitted even when the search status is "_queued_" or "_in progress_". To view a search query results, do the
following:
