...
Use the SP_TrusteeAccess job to scope a list of users and audit their access across the
SharePoint environment. You can also accomplish this by looking users up in the Access Information
Center. However, use this job when you want to generate a report on multiple users’ effective access
at once.
