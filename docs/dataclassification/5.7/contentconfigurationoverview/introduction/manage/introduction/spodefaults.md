...
Use the Source Defaults tab to configure defaults that will be used in the absence of list /
...
| Write classifications?                                                                                                                                       | Select the checkbox if you want to use tagging.                                                                                                                                | See the [Configuring Tagging](/docs/dataclassification/5.7/contentconfigurationoverview/introduction/manage/introduction/spotagging.md) article. |
| **Date Field Mappings**                                                                                                                                      |                                                                                                                                                                                |                                        |
