...
![permissions_and_pop_ups](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups.webp)

The figure shown. To see permissions and pop-ups click, one must click on the lock icon and then on the
right arrow.

![permissions_and_pop_ups_1](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups_1.webp)

The figure shown. The next step to see the permissions and pop-ups is to click on "More Information."

![permissions_and_pop_ups_2](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups_2.webp)
...
![permissions_and_pop_ups_3](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups_3.webp)

The figure shown. Firefox's pop-up exceptions.

![permissions_and_pop_ups_4](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups_4.webp)

The figure shown. The pop-up exceptions page.

Netwrix PolicyPak can manipulate most areas of permissions and
...
![permissions_and_pop_ups_5](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups_5.webp)

The figure shown. Using PolicyPak to configure the Permissions tab.

To see a video of PolicyPak managing permissions and pop-ups, to go
...
| PolicyPak Keyword (case sensitive) | Possible Verbs | Item in About:Permissions for a website |
| ------------------------------------------------ | -------------- | --------------------------------------- | ------------------- | ------------------------ |
...
![permissions_and_pop_ups_6](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups_6.webp)
...
![permissions_and_pop_ups_7](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups_7.webp)
...
![permissions_and_pop_ups_8](/images/policypak/applicationsettings/preconfigured/firefox/permissions_and_pop_ups_8.webp)
