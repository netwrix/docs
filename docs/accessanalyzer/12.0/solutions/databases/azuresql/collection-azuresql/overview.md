...
- [2-AzureSQL_SensitiveDataScan Job](/docs/accessanalyzer/12.0/solutions/databases/azuresql/collection-azuresql/2-azuresql_sensitivedatascan.md) — Discovers sensitive data in
  Azure SQL databases across all targeted Azure SQL database servers based on pre-defined or
  user-defined search criteria
- [3-AzureSQL_ActivityScan Job](/docs/accessanalyzer/12.0/solutions/databases/azuresql/collection-azuresql/3-azuresql_activityscan.md) — Captures user activity from all
  targeted Azure SQL instances and databases
- [4-AzureSQL_ServerSettings Job](/docs/accessanalyzer/12.0/solutions/databases/azuresql/collection-azuresql/4-azuresql_serversettings.md) — Collects Azure SQL instances and
