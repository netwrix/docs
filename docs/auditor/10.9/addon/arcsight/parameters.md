...
scenario and security policies. See the[Choose Appropriate Execution Scenario](/docs/auditor/10.9/addon/arcsight/deployment.md) topic
...
| ---------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| TCP                    | –                        | By default, the add-on uses the UDP protocol. Specify the switch during the add-on execution if you want to use the TCP protocol for transferring data. Via UDP, the add-on sends events one by one; via TCP, it sends them in a batch.                                                                                                                                                                                                  |
