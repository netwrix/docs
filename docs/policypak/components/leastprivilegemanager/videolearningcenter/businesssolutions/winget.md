---
title: "PolicyPak and WinGet: Overcome UAC prompts when standard users use Windows Package Manager"
description: "PolicyPak and WinGet: Overcome UAC prompts when standard users use Windows Package Manager"
sidebar_position: 10
---
# PolicyPak and WinGet: Overcome UAC prompts when standard users use Windows Package Manager
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/kgp0dKhHuew" title="PolicyPak and WinGet: Overcome UAC prompts when standard users use Windows Package Manager" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video, I'm going to show you how you can use Netwrix PolicyPak with winget. Winget is also known as the Windows Package Manager
...
ahead and run gpupdate to just get that from PolicyPak land. Give this a second to
...
we're not a local admin and if you don't have PolicyPak, then you can't do this magic.
...
to do. I could do PPLPM Let Wireshark install via PolicyPak and WINGET.
...
Now I've got a rule in PolicyPak land that should let this kick off and winget is
...
going to try to redownload it and re-kick it off. This time PolicyPak is on the case
...
basically it. If you want to see how we do uninstalls by the way, PolicyPak has a
...
uninstall through PolicyPak Least Privilege Manager.

The other way that you can do what I'm showing you here is through PolicyPak Scripts
Manager. For instance, if I wanted to use PolicyPak's Scripts Manager to – let's pick
...
That's it. We're going to run Once in PolicyPak land and we'll call this install
...
the video called setting up the PolicyPak Least Privilege Manager Helper Tools.
Hopefully, in this video you got three great ideas on how to use PolicyPak to either
