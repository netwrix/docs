...
![System Settings interface on the Auditing page](/images/threatprevention/8.1/reportingmodule/configuration/systemsettings/interface.webp)

The Audit History table displays the following information:

- Log Level – The relative impact of the action. The application auto-assigns this feature.
...
- Resource – Where applicable, identifies the related resource that the event changed or accessed
