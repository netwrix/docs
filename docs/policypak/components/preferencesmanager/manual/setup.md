...
In the next section, you'll learn more about Netwrix PolicyPak
Preferences Manager and how to ensure that everything works the way you expect it to.

The goals of the PolicyPak Preferences Manager Quickstart in the next section are as
follows:
...
- See compliance for Group Policy Preference items be maintained by PolicyPak
  Preferences Manager.
...
- A client system (Windows 7 or later preferred) with "computer" in the name for Trial mode, or
  fully licensed.
- The PolicyPak 32-bit or 64-bit client-side extension on your client machine.
- A management station with the GPMC and PolicyPak Admin Console.MSI (MMC snap-in)
  installed on the machine where you have the GPMC installed (32-bit or 64-bit machines, as
  appropriate).
- The PolicyPak Exporter utility on the management station.

Now you're ready to test PolicyPak Preferences Manager.
