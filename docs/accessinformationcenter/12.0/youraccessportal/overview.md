...
and view the status of their requests. Where the Access Information Center opens depends on
...
- For domain user without an Access Information Center user role who aren't assigned ownership of a
...
The buttons above and below the table let you perform the following actions:
...
| Button         | Description                                                                                                                                                                                           |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Request Access | Opens the Request Access wizard, which lets you submit access requests. See the [Request Access Wizard](/docs/accessinformationcenter/12.0/youraccessportal/requestaccess/requestaccess.md) topic for additional information.                            |
...
| Remove Access  | Opens the Remove Access window, which lets you remove access for yourself for the selected resource. See the [Remove Access Window](/docs/accessinformationcenter/12.0/youraccessportal/removeaccess.md) topic for additional information. |
