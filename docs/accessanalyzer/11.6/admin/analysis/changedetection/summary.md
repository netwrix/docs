...
Click **Finish** to save configuration changes. If you made no changes, click **Cancel** instead to
close the Change Detection Data Analysis Module wizard without saving accidental configurations.
