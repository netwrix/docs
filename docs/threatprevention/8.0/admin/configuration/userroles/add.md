...
![Add User button on the Users and Groups window](/images/threatprevention/8.0/admin/configuration/userroles/addbutton.webp)
...
![Select Users or Groups window](/images/threatprevention/8.0/admin/configuration/userroles/selectusersorgroups.webp)
...
**Step 4 –** The bottom of the Users and Roles window displays two user roles, Administrator and
Console Operator. Select the checkbox for a role to assign it to the user. Checking Administrator
automatically checks the Console Operator role.
...
The users now have the appropriate access rights.
