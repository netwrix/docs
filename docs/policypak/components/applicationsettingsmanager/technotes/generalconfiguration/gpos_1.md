...
Exporting and Importing Netwrix PolicyPak GPOs is simple and
fast. Simply go to the PolicyPak Management screen in the GPO edit console. Open up the PolicyPak and look for the PolicyPak button in the bottom left-hand corner. Click
