---
title: "Getting Started: Netwrix Privilege Secure + PolicyPak"
description: "Getting Started: Netwrix Privilege Secure + PolicyPak"
sidebar_position: 30
---

# Getting Started: Netwrix Privilege Secure + PolicyPak
...
video for an overview of Netwrix Privilege Secure + PolicyPak better together.
:::


The first policy type to enable theNetwrix Privilege Secure server and PolicyPak
...
![getting_started_netwrix_privilege](/images/policypak/integration/privilegesecure/gettingstarted/getting_started_netwrix_privilege.webp)

Next, you’ll create a PolicyPak rule like you did earlier to perform an operation.

Remember:

- The PolicyPak part is about matching on an application or process.
- The Netwrix Privilege Secure part is about matching on the Activity type (and name.)

With PolicyPak performing the work, you can Elevate an application (if needed), or
...
![getting_started_netwrix_privilege_1](/images/policypak/integration/privilegesecure/gettingstarted/getting_started_netwrix_privilege_1.webp)
