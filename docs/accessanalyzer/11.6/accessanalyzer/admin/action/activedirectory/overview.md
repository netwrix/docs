...
- Welcome
- [Active Directory Action Target](/docs/accessanalyzer/11.6/accessanalyzer/admin/action/activedirectory/target.md)
- [Active Directory Action Operations](/docs/accessanalyzer/11.6/accessanalyzer/admin/action/activedirectory/operations.md)
- [Active Directory Action Options](/docs/accessanalyzer/11.6/accessanalyzer/admin/action/activedirectory/options.md)
- [Active Directory Action Summary](/docs/accessanalyzer/11.6/accessanalyzer/admin/action/activedirectory/summary.md)
