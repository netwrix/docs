...
You can use the Netwrix PolicyPak Group Policy Compliance
Reporter "standalone" which means NOT connected to a PolicyPak Group Policy Compliance
...
You can use the PolicyPak Group Policy Compliance Reporter "server" which enables your
