...
- Threats – Opens the [Threats Page](/docs/threatmanager/3.3/administration/threats/threats.md)
...
- [Configuration Menu](/docs/threatmanager/3.3/administration/configuration/overview.md) – Displays a menu with the configuration pages
- Help – Accesses help
...
The Threat Manager [Threats Page](/docs/threatmanager/3.3/administration/threats/threats.md) is where end users and analysts investigate possible
