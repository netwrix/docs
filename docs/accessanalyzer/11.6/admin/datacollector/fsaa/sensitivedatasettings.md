...
![FSAA Data Collector Wizard Sensitive Data Settings page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/install/application/upgrade/sensitivedata.webp)
