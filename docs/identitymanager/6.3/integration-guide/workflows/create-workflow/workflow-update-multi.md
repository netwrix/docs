...
This [Workflow](../../../integration-guide/toolkit/xml-configuration/workflows/workflow) is made of three activities:
...
the update of record data specific to each record individually. Thus it calls the same form as `RecordUniqueItemControl`.
...
fields, for the update of record data shared with all records. Thus it calls the same form as `RecordControl`.
...
![UI Form](/images/identitymanager/howto_resourceupdatemulti_form_v603.webp)
