---
title: "PolicyPak enhances XenApp with Group Policy"
description: "PolicyPak enhances XenApp with Group Policy"
sidebar_position: 50
---
# PolicyPak enhances XenApp with Group Policy
...
Watch this video to see how you can use Group Policy and Netwrix PolicyPak to ensure that users' XenApp application settings. Settings will be automatically
...
These kinds of costs are easily preventable. Because PolicyPak is always ensuring the
application's settings – within XenApp. PolicyPak works naturally with Group Policy —
when connected to their XenApps.

PolicyPak prevents users from manipulating important settings, but also quietly
reapplies misconfigured settings if a user or application happens to work around them.

In short, PolicyPak protects your XenApp investment. And it protects your users from
themselves.

PolicyPak was designed by former Group Policy MVP Jeremy Moskowitz – who "wrote the
...
let us know you're like a free trial of PolicyPak.
