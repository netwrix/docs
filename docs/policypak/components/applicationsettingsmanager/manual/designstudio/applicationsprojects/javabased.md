...
In the previous section called "Java Tab," we talked about the Java tab and how PolicyPak DesignStudio can be enabled to capture the user interface (UI) of Java-based applications.
...
![special_applications_and_project](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project.webp)
...
![special_applications_and_project_1](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_1.webp)

The figure shown. Changing the slider to "Never notify."

At this point, reboot your PolicyPak DesignStudio machine. When you next run PolicyPak Application Settings Manager, the Tools|Options|Java tab will change to what's shown
...
![special_applications_and_project_2](/images/policypak/applicationsettings/designstudio/applicationsprojects/special_applications_and_project_2.webp)
