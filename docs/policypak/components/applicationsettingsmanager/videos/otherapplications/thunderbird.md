---
title: "PolicyPak for Thunderbird"
description: "PolicyPak for Thunderbird"
sidebar_position: 80
---
# PolicyPak for Thunderbird
...
Netwrix PolicyPak, you've got no enterprise-way to deliver these
settings and lock down Thunderbird. Watch this video to get a handle on the problem and where
PolicyPak can ease the pain.

<iframe width="560" height="315" src="https://www.youtube.com/embed/nEIoUqY0wvE" title="PolicyPak: Manage Thunderbird using Group Policy or your own management utility" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
