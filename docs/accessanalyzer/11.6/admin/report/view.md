...
![Report in the Results node](/img/product_docs/accessanalyzer/11.6/admin/report/viewresultsnode.webp)

Select the desired report to be viewed. The report displays in the Results pane of the console.

![Access report from configure page](/img/product_docs/accessanalyzer/11.6/admin/report/viewconfigure.webp)
...
![Web Console .Active Directory Inventory](/img/product_docs/accessanalyzer/11.6/admin/report/webconsolesolutioninventory.webp)
