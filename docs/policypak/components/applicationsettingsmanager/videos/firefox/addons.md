...
Firefox has four types of Add-ons: Extensions, Appearance, Plugins, and Services. And Netwrix PolicyPak can manage (enable or disable) ALL of these types.
...
### PolicyPak: Manage Firefox Add-ons using Group Policy
