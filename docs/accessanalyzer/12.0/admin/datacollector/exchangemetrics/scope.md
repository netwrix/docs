...
- Return data for section – Select the time period for which to collect data. Exchange Metrics
  uses GMT time to calculate the result.
...
- Return results section – Select the table design for the collected data
    ...
    - Add summary values as last row – Select this checkbox to add summary values as the last row.
      This option is enabled when you select **Day**, **Week**, or **Month**.
