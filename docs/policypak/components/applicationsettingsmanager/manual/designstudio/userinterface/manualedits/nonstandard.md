...
![crafting_the_user_interface_3](/images/policypak/applicationsettings/designstudio/userinterface/manualedits/crafting_the_user_interface_3.webp)
...
categories bar isn't something you can use inside PolicyPak DesignStudio, you might
...
another tab, PolicyPak DesignStudio realizes that this application doesn't really use
...
![crafting_the_user_interface_4_624x410](/images/policypak/applicationsettings/designstudio/userinterface/manualedits/crafting_the_user_interface_4_624x410.webp)

The figure shown. The prompt to manually enter the name of the categories.

![crafting_the_user_interface_5_624x185](/images/policypak/applicationsettings/designstudio/userinterface/manualedits/crafting_the_user_interface_5_624x185.webp)

The figure shown. Manually adding the categories.

You can see In the figure shown that PolicyPak Capture Wizard also captures the categories
bar even though it is not an element we want on the page.

![crafting_the_user_interface_6](/images/policypak/applicationsettings/designstudio/userinterface/manualedits/crafting_the_user_interface_6.webp)
...
![crafting_the_user_interface_7](/images/policypak/applicationsettings/designstudio/userinterface/manualedits/crafting_the_user_interface_7.webp)
...
![crafting_the_user_interface_8](/images/policypak/applicationsettings/designstudio/userinterface/manualedits/crafting_the_user_interface_8.webp)
...
![crafting_the_user_interface_9](/images/policypak/applicationsettings/designstudio/userinterface/manualedits/crafting_the_user_interface_9.webp)
