...
The window for creating a new record always open in a separate tab. As shown in the following example, the
...
them have already been described in the Authorization concept section. You must note here
