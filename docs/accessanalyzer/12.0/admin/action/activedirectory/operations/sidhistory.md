...
- Insert Field – This dropdown list is enabled when the Overwrite or Append radio buttons are
  selected. Use the dropdown list to select a field (column) from the source table. Then, click the
