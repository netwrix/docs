...
[Similarity Rule](/docs/passwordpolicyenforcer/11.2/admin/manage-policies/rules/similarity_rule.md) can't be enforced. Users only see the default Windows error
