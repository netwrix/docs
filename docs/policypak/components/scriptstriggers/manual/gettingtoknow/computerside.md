---
title: "Using PolicyPak Scripts on the Computer Side"
description: "Using PolicyPak Scripts on the Computer Side"
sidebar_position: 20
---

# Using PolicyPak Scripts on the Computer Side

In the Quickstart example, we delivered scripts to users, but PolicyPak can also
...
![getting_to_know_scripts_triggers_13](/images/policypak/scriptstriggers/gettoknow/getting_to_know_scripts_triggers_13.webp)

Figure 17. Using PolicyPak Scripts & Triggers Manager Wizard on the Computer side.
...
- All policies with "Always apply" selected will reapply when the PolicyPak service
  starts up.
