...
Identity Manager supports right to left languages in preview mode. See [Activating Preview Features](../../preview-features#activating-preview-features) for setup instructions.
...
A translation key is an identifier for a given translation: Identity Manager uses those keys to find the translation it needs in the interface.
...
Place the JSON file described in the previous part in your XML configuration folder: you can place it anywhere in it, but the root is recommended.
...
If you need to export the custom product translations of your languages, export your configuration as usual but add the `--export-translation` argument to your command line.
