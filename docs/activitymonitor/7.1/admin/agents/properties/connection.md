...
Use the Connection tab to modify the agent host server name and the credentials used for
...
Select the Specify account or group window from a field where a Windows account is needed.
