...
![Exchange Online - Search Quary Bar](/images/activitymonitor/9.0/admin/search/query/searchquerybar.webp)
...
![Exchange Online - General Category](/images/activitymonitor/9.0/admin/search/query/general.webp)
...
![Exchange Online Search - User Filter](/images/activitymonitor/9.0/admin/search/query/user.webp)
...
![Exchange Online Search - Target Filter](/images/activitymonitor/9.0/admin/search/query/target.webp)
...
![Exchange Online Search - DLP Filter](/images/activitymonitor/9.0/admin/search/query/dlp.webp)
