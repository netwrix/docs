---
title: "Firefox: Is PolicyPak compatible with Firefox when installed to non-standard (and portable) locations?"
description: "Firefox: Is PolicyPak compatible with Firefox when installed to non-standard (and portable) locations?"
sidebar_position: 210
---

# Firefox: Is PolicyPak compatible with Firefox when installed to non-standard (and portable) locations?

Netwrix PolicyPak Application Manager will apply settings and
...
If Firefox is writing to a location other than AppData, then PolicyPak may not be able
