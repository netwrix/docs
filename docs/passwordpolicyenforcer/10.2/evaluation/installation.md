...
software distribution tool. Installing Password Policy Enforcer doesn't extend the Active Directory
schema.
...
**Step 4 –** Select the **Password Policy Server** checkbox, if unchecked.
...
:::note
The Password Policy Client doesn't replace or modify any Windows system files. You can
