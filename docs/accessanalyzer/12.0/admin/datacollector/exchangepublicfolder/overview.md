...
**Settings > Exchange** node, which you must enable and configure. See the
[Exchange](/docs/accessanalyzer/12.0/admin/settings/exchange.md) topic for additional information.

The Exchange Solution preconfigures the ExchangePublicFolder Data Collector. Both this data
...
You configure the ExchangePublicFolder Data Collector through the Exchange Public Folder Data
...
In the Sampling server section, enter the Exchange server that Access Analyzer will use to test the
