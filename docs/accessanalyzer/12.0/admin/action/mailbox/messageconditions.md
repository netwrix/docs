...
![MessageClasses Window](/img/product_docs/accessanalyzer/12.0/admin/action/mailbox/messageclasseswindow.webp)

Modify message classes using the following options:

- Click **Add** to populate a field to add a message class

    ![New class added in MessageClasses Window](/img/product_docs/accessanalyzer/12.0/admin/action/mailbox/messageclasseswindownew.webp)
...
![Data Range Selection Window](/img/product_docs/accessanalyzer/12.0/admin/action/mailbox/datarangeselectionwindow.webp)
...
![Values Window](/img/product_docs/accessanalyzer/12.0/admin/action/mailbox/valueswindow.webp)
