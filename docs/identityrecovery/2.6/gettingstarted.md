...
[Requirements ](/docs/identityrecovery/2.6/requirements/overview.md)topic for additional information.

Installation

Install and configure Recovery for Active Directory. See the
[Install the Application](/docs/identityrecovery/2.6/install/application.md) topic for additional information.
...
account that was configured during installation. See the [First Launch](/docs/identityrecovery/2.6/install/firstlaunch.md)
...
- Configure Domain Backup – On logging into the Recovery Console, you land on the
  [Domain Backup Configuration Page](/docs/identityrecovery/2.6/admin/domainbackupconfig.md), that directs you
  to configure a domain to be backed up. It is recommended a start a backup of the domain after
  configuring it. See the [Domains Page](/docs/identityrecovery/2.6/admin/configuration/domain.md) topic for additional
...
- Configure Forest Backup – Configure a forest and then configure backup settings for domain
  ...
  configuring backup settings. See the [Forest Page](/docs/identityrecovery/2.6/admin/forest/forest.md) topic for additional
...
- _(Optional)_ Install RSAT Extension on Additional Servers – The `RSAT Extension.msi` is
  ...
  [Install the RSAT Extension](/docs/identityrecovery/2.6/install/installation.md) topic for additional information.
- Configure Additional Users – The user or group configured during installation of the product has
  ...
  assigned roles. See the [Users and Roles Page](/docs/identityrecovery/2.6/admin/configuration/roles.md) topic for additional
  information.
- _(Optional)_ Configure Notifications – Email notifications require configuration before they can
  be enabled. See the [Notifications Page](/docs/identityrecovery/2.6/admin/configuration/notifications.md) topic for
