...
- You must register the RSAT Extension on the Recovery Application Server to add the Rollback and
  ...
  [Register/Unregister the RSAT Extension](/docs/identityrecovery/2.6/install/configurationutility.md#registerunregister-the-rsat-extension)
  topic for additional information.
- At least one backup of the domain must be available in the Recovery for Active Directory Console.
  See the [Domains Page](/docs/identityrecovery/2.6/admin/configuration/domain.md) topic for additional information.
...
![ADUC with the Restore option selected](/images/identityrecovery/2.6/rsatextension/aducrestore.webp)
...
![Object Recovery Wizard - Object Backups page](/images/identityrecovery/2.6/rsatextension/objectbackups_1.webp)
...
![Object Recovery Wizard - Recovery Options page](/images/identityrecovery/2.6/rsatextension/recoveryoptions.webp)
...
![Object Recovery Wizard - User Options page](/images/identityrecovery/2.6/rsatextension/useroptions.webp)
...
![Object Recovery Wizard - Domain Controller page](/images/identityrecovery/2.6/rsatextension/domaincontroller.webp)
...
![Object Recovery Wizard - Alternate Credentials page](/images/identityrecovery/2.6/rsatextension/alternatecredentials.webp)
...
[Least Privilege Access Model](/docs/identityrecovery/2.6/requirements/targetdomain.md#least-privilege-access-model) topic.

![Object Recovery Wizard - Confirm page](/images/identityrecovery/2.6/rsatextension/confirm_1.webp)

**Step 8 –** On the Confirm page, review the summarized object restore settings. Click **Finish** to
start the recovery.

![Recovery Success Status](/images/identityrecovery/2.6/rsatextension/recvoerysuccessful.webp)
