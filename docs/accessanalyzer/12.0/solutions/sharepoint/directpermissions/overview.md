...
permissions are configured within the targeted SharePoint environment. It depends on data
...
- [SP_EmptyDomainGroupPerms Job](/docs/accessanalyzer/12.0/solutions/sharepoint/directpermissions/sp_emptydomaingroupperms.md) – Identifies empty security groups
  with directly assigned permissions to resources. Delete these groups from SharePoint
...
- [SP_SiteCollectionPerms Job](/docs/accessanalyzer/12.0/solutions/sharepoint/directpermissions/sp_sitecollectionperms.md) – Most content will inherit the
  permissions configured at the root of the site collection. Understanding how those
  permissions are assigned gives you perspective on the overall SharePoint permission
  configuration.
