...
[Configure ConnectWise ](/docs/auditor/10.9/addon/connectwise/configure.md)topic for additional information.

**Step 6 –** (optional) To adjust the add-on operation and data flow settings, edit the
ITSMSettings.xml file. See the [Operational Settings](/docs/auditor/10.9/addon/connectwise/operationalsettings.md) topic for additional
information.
