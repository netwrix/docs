...
![Investigations interface on the Subscriptions and Exports page](/images/threatprevention/8.1/reportingmodule/investigations/subscriptionsexports.webp)
...
- Actions – Menu option per table row. This column doesn't have a header. Three dots represent it,
  and it shows up when you hover over a row.

Click a row to open the Subscription to or Schedule export window where you can edit the
subscription or export.

See the [Add Subscription](/docs/threatprevention/8.1/reportingmodule/investigations/options/subscription.md) topic and the [Export Report](/docs/threatprevention/8.1/reportingmodule/investigations/options/export.md)
...
![Table column menu](/images/threatprevention/8.1/reportingmodule/investigations/tableoptions.webp)
...
The table filters to matches of the filter statement.

## Actions Menu

The Actions column holds a menu with actions that apply to the selected subscription or export.

![Actions menu](/images/threatprevention/8.1/reportingmodule/investigations/subscriptionsexportsactions.webp)
