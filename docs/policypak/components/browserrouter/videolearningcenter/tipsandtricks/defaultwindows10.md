---
title: "PolicyPak Browser Router: Set the Windows 10 Default Browser (once) then drift"
description: "PolicyPak Browser Router: Set the Windows 10 Default Browser (once) then drift"
sidebar_position: 10
---
# PolicyPak Browser Router: Set the Windows 10 Default Browser (once) then drift
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/HJbn69MS6WM" title="PolicyPak Browser Router: Set the Windows 10 Default Browser (once) then drift" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video, I'm going to show you how you can use Netwrix PolicyPak Browser Router to set a default browser policy and let it drift
after that, so apply once and drift. Here's a bunch of PolicyPak Browser Router rules
...
using Group Policy and you're using say PolicyPak Cloud or PolicyPak
...
Then PolicyPak is going to snapback. The operating system is going to see that Browser
Router is in charge but the user is going to feel that they are in charge. This is PolicyPak deploying the default browser one time and then letting the user drift. Now that we set it
...
default browser here. Choose a default browser. What do we see? We see once again, PolicyPak is in charge. Managed by your organization but the user selected is Firefox.
...
forward to getting started real soon with PolicyPak. Thanks.
