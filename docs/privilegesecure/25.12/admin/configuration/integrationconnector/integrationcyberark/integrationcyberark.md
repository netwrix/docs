...
CyberArk vault. CyberArk connectors is useful for the following purposes:
...
![Add CyberArk Connector Integration](/images/privilegesecure/25.12/accessmanagement/admin/configuration/add/addcyberark.webp)
