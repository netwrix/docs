...
The report below displays changes for all audited systems made by the DS\Administrator2 user on the
DC domain controller for a month sorted by the action type.
