...
![PowerShell Action Module Wizard Script page](/img/product_docs/accessanalyzer/12.0/admin/action/powershell/script.webp)
...
![Columns tab](/img/product_docs/accessanalyzer/12.0/admin/action/powershell/scriptcolumns.webp)
...
![Right-click menu](/img/product_docs/accessanalyzer/12.0/admin/action/powershell/scriptrightclickoption.webp)
...
![Parameters tab](/img/product_docs/accessanalyzer/12.0/admin/action/powershell/scriptparamters.webp)
...
![Add/Edit Variable Window](/img/product_docs/accessanalyzer/12.0/admin/action/powershell/addeditvariable.webp)
...
![Input Data tab](/img/product_docs/accessanalyzer/12.0/admin/action/powershell/scriptinputdata.webp)
