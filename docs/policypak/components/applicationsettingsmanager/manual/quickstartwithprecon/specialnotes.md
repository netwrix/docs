...
![policypak_application_settings_18](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_18.webp)
...
![policypak_application_settings_19](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_19.webp)

![policypak_application_settings_20](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_20.webp)
...
Explorer because they act a little differently. In the PolicyPak Portal, in the
...
- Appendix C: PolicyPak Application Settings Manager—Using the Firefox `AppSet.pdf`
- Appendix D: PolicyPak Application Settings Manager—Using the Internet Explorer
  `AppSet.pdf`
