...
![gpcr_concepts_and_quickstart_13](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_13.webp)
...
![gpcr_concepts_and_quickstart_14](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_14.webp)
...
![gpcr_concepts_and_quickstart_15](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_15.webp)
...
![gpcr_concepts_and_quickstart_16](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_16.webp)

Figure 15. Creating a snapshot of the computer set.

When you right-click on the computer set, PolicyPak GPCR will query all machines in
the computer set to determine what Group Policy information is on them, also known as the resultant
set of policy (RSOP).

:::note
Creation of computer sets is optional when using the PolicyPak GPCR server
...
![gpcr_concepts_and_quickstart_17](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_17.webp)
...
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| OK or OK Full License | This endpoint has a full PolicyPak GPCR license. This license could come from a file, a GPO, or PolicyPak Cloud. | Everything supported (Microsoft data and all PolicyPak data) |
| OK: Trial Mode        | This endpoint has "computer" in the name and is in trial mode.                                                                               | Everything supported (Microsoft data and all PolicyPak data) |
| No License            | The endpoint responded, but has neither a PolicyPak GPCR license nor an Application Settings Manager license.                  | Nothing will be reported                                                   |
...
![gpcr_concepts_and_quickstart_18](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_18.webp)
...
![gpcr_concepts_and_quickstart_19](/images/policypak/grouppolicycompliancereporter/mode/pull/gpcr_concepts_and_quickstart_19.webp)
