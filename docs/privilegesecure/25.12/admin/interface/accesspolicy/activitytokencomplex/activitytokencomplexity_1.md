...
Follow these steps to add an Activity Token Complexity policy to the console. See the Activity
...
![Add Activity Token](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/add.webp)
