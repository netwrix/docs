...
- Configure multi-factor authentication (MFA). See the [First Launch](/docs/privilegesecure/26.03/install/firstlaunch.md) topic
for additional information.
- Log in to the Privilege Secure Console. See the
[Log Into the Privilege Secure Console](/docs/privilegesecure/26.03/install/login.md) topic for additional information.
...
- Import the license file. See the [Import the License File](/docs/privilegesecure/26.03/admin/navigation/importlicense.md) topic for
...
![Resource-based Access Policy Components](/images/privilegesecure/26.03/accessmanagement/requirements/resource-based.png)
...
- [Service Accounts Page](/docs/privilegesecure/26.03/admin/configuration/serviceaccounts/serviceaccounts.md) — Add the account credentials
that grant access to the required resources
- [Add New Domain](/docs/privilegesecure/26.03/admin/resources/domain.md) — Add the Active Directory domains that contain the
...
- [Users & Groups Page](/docs/privilegesecure/26.03/admin/usersgroups/usersgroups.md) — Add the Users and Groups from AD that
use the Privilege Secure Console
- [Resources Page](/docs/privilegesecure/26.03/admin/resources/resources.md) — Add the resources such as Windows or Linux
servers that the users access through the Privilege Secure Console
- [Activities Page](/docs/privilegesecure/26.03/admin/activities/activities.md) — Add the actions that Privilege Secure
...
- [Connection Profiles Page](/docs/privilegesecure/26.03/admin/accesspolicy/connectionprofiles/connectionprofiles.md) — Add the connection profile
to use with the access policy
- [Access Policy Page](/docs/privilegesecure/26.03/admin/accesspolicy/accesspolicy.md) — Create the access policies to control
...
- [Create My Activity Session](/docs/privilegesecure/26.03/enduser/myactivities/createsession.md) — Create a session to grant
temporary privileges and gain access to the resources defined by the previously created access
policy
- [Browser Extension Interface](/docs/privilegesecure/26.03/enduser/browserextension/interface/interface.md) — Access all of
...
![Credential-based Access Policy Components](/images/privilegesecure/26.03/accessmanagement/requirements/credential-based.png)
...
To add a vault, see [Adding a vault](/docs/privilegesecure/26.03/admin/resources/secretvault.md). Then, to add credentials or files to the vault, see [Vault Details](/docs/privilegesecure/26.03/admin/resources/detailspages/secretvault.md).

To grant users access to credentials or files in the vault, see [Access Policy](/docs/privilegesecure/26.03/admin/accesspolicy/addaccesspolicy.md) and create an Access Policy that is Credential based. Then see [Credential-based Access Policy](/docs/privilegesecure/26.03/admin/accesspolicy/credentials.md).
