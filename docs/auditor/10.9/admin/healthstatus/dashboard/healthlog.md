...
![healthlog](/images/auditor/10.9/admin/healthstatus/dashboard/healthlog.webp)
...
- Configure alerts triggered by specific events in the product's health log.
  [Create Alerts on Health Status](/docs/auditor/10.9/admin/alertsettings/create/createhealthstatus.md)
