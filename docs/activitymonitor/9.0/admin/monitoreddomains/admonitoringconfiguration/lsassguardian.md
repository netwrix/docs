...
Use the LSASS Guardian tab to modify settings that were populated with the information
...
After checking the Enable LSASS Guardian box, you can modify the following event filters on the
sub-tabs:
...
![Servers Tab in the LSASS Guardian Tab](/images/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/servers.webp)
...
![Users Tab in the LSASS Guardian Tab](/images/activitymonitor/9.0/admin/monitoreddomains/admonitoringconfiguration/userstab.webp)
...
exclude. Double-click the text box beneath Type to enter the AD you want object to include or
