...
In the [Passwords](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/passwords/passwords.md), the newly created application can now be directly
