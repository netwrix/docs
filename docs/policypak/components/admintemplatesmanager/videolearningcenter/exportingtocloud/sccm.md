---
title: "PolicyPak Exporter and SCCM: Deploy real GPOs via SCCM"
description: "PolicyPak Exporter and SCCM: Deploy real GPOs via SCCM"
sidebar_position: 40
---
# PolicyPak Exporter and SCCM: Deploy real GPOs via SCCM

If you want to deploy real Microsoft GPO settings via SCCM this is how to do it. Export with Netwrix PolicyPak Export manager then wrap up and deploy using SCCM.

<iframe width="560" height="315" src="https://www.youtube.com/embed/H9rMyRF1VVQ" title="PolicyPak Exporter and SCCM: Deploy real GPOs via SCCM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
super-duper easy. We're simply going to run our PolicyPak Exporter tool.

The PolicyPak Exporter tool takes the things that you exported using the PolicyPak Export Manager and lets you create an MSI for use to deploy using SCCM. We're simply
going to add the existing files, the things that we exported earlier. You can also inject here any
kind of PolicyPak settings as well if you wanted to augment your existing group policy
...
Then I'm going to call this PolicyPak -Exports-Demo1. Now I've got this ready to go.
...
existing group policy settings, anything that you've got in group policy land or PolicyPak land, export them with the exporter, drop them into XMLs, wrap them up as an MSI, and use
the know-how you already have with SCCM to get those deployed over using SCCM. Hope this video helps
you out. Looking forward to getting you started with PolicyPak Exporter real soon.
Thanks so much.
