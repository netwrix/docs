...
| **Numbered lists** | Use numbered lists for sequential steps. | 1. Open Netwrix Auditor.<br>2. Navigate to **Monitoring Plans**.<br>3. Click **Add**. | • Open Netwrix Auditor.<br>• Navigate to **Monitoring Plans**.<br>• Click **Add**. |
