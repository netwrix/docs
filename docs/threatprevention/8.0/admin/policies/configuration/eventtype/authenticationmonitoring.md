...
![Policy window - Authentication Monitoring Event Type](/images/threatprevention/8.0/admin/policies/eventtype/authenticationmonitoring.webp)
...
![Policy window - Authentication Protocol filter for monitoring](/images/threatprevention/8.0/admin/policies/eventtype/authenticationprotocolmonitoring.webp)
...
:::warning
Saving all TGT and/or TGS authentication data results in the bloating of the Threat Prevention database. Configure policy filters and use Database Maintenance while monitoring these protocols to retain data for the necessary timeframe. See the [Database Maintenance Window](/docs/threatprevention/8.0/admin/configuration/databasemaintenance/overview.md) topic for additional information.
...
- The **Exclude failed authentications with previously valid (N-2) passwords** option, if enabled,
  ...
  **Windows Settings** > **Security Settings** > **Account Policies** > **Password Policy** (shown
  ...
  ![Default Domain Policy](/images/threatprevention/8.0/admin/policies/eventtype/gpo.webp)
...
![ipaddressesto](/images/threatprevention/8.0/admin/policies/eventtype/ipaddressesto.webp)
...
![Policy window - Hosts (to) filter for monitoring](/images/threatprevention/8.0/admin/policies/eventtype/hoststo.webp)
