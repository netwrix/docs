...
reference tables. The following table describes these tables and their associated views:
...
Views are the recommended way for Access Analyzer users to obtain the information the
Box Data Collector gathers. They contain additional information for building queries. The following
table explains the views the Box Data Collector creates for some of its
tables:
