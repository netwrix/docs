...
![System Alerting window - Email tab - Configure SMTP Host and Message Profile](/images/threatprevention/8.1/admin/configuration/systemalerting/smtphost.webp)
...
![Email Template window](/images/threatprevention/8.1/admin/configuration/systemalerting/emailtemplate.webp)
