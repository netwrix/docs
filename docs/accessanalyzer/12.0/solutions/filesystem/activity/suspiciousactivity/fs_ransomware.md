...
![Analysis Tasks for the FS_Ransomeware Job](/img/product_docs/accessanalyzer/12.0/solutions/filesystem/activity/suspiciousactivity/ransomewareanalysis.webp)
