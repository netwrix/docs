...
![Service Accounts list showing existing accounts by name, type, source group, and creation date](/images/accessanalyzer/26.1/configurations/service-accounts-list.png)
