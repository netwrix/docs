...
[Notifications](/docs/passwordpolicyenforcer/11.2/admin/configconsole.md#notifications) topic for additional information.
...
Follow the procedure in [Install Password Policy Enforcer on a Server](/docs/passwordpolicyenforcer/11.2/installation/installationserver.md),
