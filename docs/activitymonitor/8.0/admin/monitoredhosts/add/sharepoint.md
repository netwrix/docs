...
To add a SharePoint host to be monitored, complete these steps:
...
- Log file format – Select whether to save the log file as a JSON or TSV file
...
monitoring, configure the outputs. See the [Output for Monitored Hosts](/docs/activitymonitor/8.0/admin/monitoredhosts/output/output.md) topic
