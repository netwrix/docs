...
The section [Certificates](/docs/passwordsecure/9.2/configuration/servermanager/certificates/certificates.md) explains how to back up the certificate and link it
again.
