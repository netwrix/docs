---
title: "How are DRIVE MAPS and UNC paths supported in Least Privilege Manager?"
description: "How are DRIVE MAPS and UNC paths supported in Least Privilege Manager?"
sidebar_position: 60
---

# How are DRIVE MAPS and UNC paths supported in Least Privilege Manager?
...
![pathconditiondfs](/images/policypak/troubleshooting/leastprivilege/pathconditiondfs.webp)
...
- You do not need to make any explicit "Drive map" rules. So, don't elevate "S:" in PolicyPak
...
- So, for instance, if you want to elevate all files in S: (which is mapping to
  ...
  - You DO need to have a Netwrix PolicyPak Least Privilege
    Manager rule to "`Elevate\\fabrikam.com\share`" and select Folder or Folder (Recursive) as
    shown here.

    ![502_1_image-20200121124504-1](/images/policypak/troubleshooting/leastprivilege/502_1_image-20200121124504-1.jpeg)
...
- You should create a PolicyPak Least Privilege Manager rule to Elevate the path to
  the folder using the S: drive and then select Folder or Folder (Recursive) as shown below.

![502_3_image](/images/policypak/troubleshooting/leastprivilege/502_3_image.webp)

To cover all bases you can also create the rule with all possible paths:

![502_4_image](/images/policypak/troubleshooting/leastprivilege/502_4_image.webp)
...
- If an elevation rule does NOT work, you can create a simple path rule for any of the Non-EXE
  ...
  running` gpupdate` on the target machine and then check the PolicyPak event log to
  see which path was shown for the MSI (see screenshot below). Lastly, use that path for your
  Non-EXE rule:

![502_5_image-20200121124504-4](/images/policypak/troubleshooting/leastprivilege/502_5_image-20200121124504-4.webp)

![502_7_image-20200121124504-5](/images/policypak/troubleshooting/leastprivilege/502_7_image-20200121124504-5.webp)
