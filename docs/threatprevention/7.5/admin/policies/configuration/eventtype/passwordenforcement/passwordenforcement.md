...
Configure one Password Enforcement event type with the password you want rules for all users:
...
Configure the other Password Enforcement event type with the password you want rules for the senior
executives:
...
These settings let you enforce all or X number of rules that a candidate password must pass.
