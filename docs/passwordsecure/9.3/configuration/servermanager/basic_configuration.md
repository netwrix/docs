...
If the option “Service user” is selected, enter the user that logs on to the SQL Server. that “dbCreator” rights are necessary to create a configuration database. “dbOwner” rights are
