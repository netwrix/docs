...
![Export on False Positives tab](/img/product_docs/accessanalyzer/11.6/admin/settings/sensitivedata/exclusions/exportfilter.webp)

**Step 1 –** Select the false positive exclusion filters to export and click **Export**. The File
Explorer opens.

![Select False Positive Exclusion filter file to export File Explorer window](/img/product_docs/accessanalyzer/11.6/admin/settings/sensitivedata/exclusions/exportfileexplorer.webp)
