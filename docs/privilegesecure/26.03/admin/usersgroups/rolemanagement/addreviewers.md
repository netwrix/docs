...
the [Users & Groups Page](/docs/privilegesecure/26.03/admin/usersgroups/usersgroups.md).

![Add Reviews Window](/images/privilegesecure/26.03/accessmanagement/admin/policy/window/usersgroups/addreviewers.webp)
...
[Role Management Page](/docs/privilegesecure/26.03/admin/usersgroups/rolemanagement/rolemanagement.md) section for a list of roles and their
functions.
