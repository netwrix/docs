...
Netwrix PolicyPak Scripts Manager goes beyond in-box Group Policy
...
Software. In this video, you can learn all about PolicyPak Scripts Manager with using
Group Policy. Now if you have PolicyPak Cloud or PolicyPak with your MDM
service, there will be other videos for that. This one is just about using PolicyPak
...
with PolicyPak. In those cases, you may need to script it, so that's why we've created
...
Policy Preferences but through PolicyPak Scripts which is going to use PowerShell.
...
If that wasn't awesome enough, PolicyPak Scripts has even more superpowers. This is
...
computer side, "PolicyPak /Scripts Manager." You can right click, "Add/New Policy"
...
PolicyPak Scripts, new component, it's fantastic and ready for you to use right now.

Thanks so much for watching. If you're using PolicyPak Cloud or PolicyPak with your MDM service, we have other videos to show you how that works.
