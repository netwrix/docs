...
The following table describes these tables and their associated views:
...
Views are the recommended way for you to obtain the information the AzureADInventory
Data Collector gathers. They contain additional information for building queries. The following table
explains the views the AzureADInventory Data Collector creates for some of its tables:
...
The following table explains the exception types.
