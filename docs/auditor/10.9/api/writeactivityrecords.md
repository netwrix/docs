...
[/netwrix/api/v1/activity_records/search](/docs/auditor/10.9/api/searchactivityrecords.md) and
[/netwrix/api/v1/activity_records/enum](/docs/auditor/10.9/api/retrieveactivityrecords.md) endpoints.

| Method | Endpoint                                                             | POST Data                                       |
| ------ | -------------------------------------------------------------------- | ----------------------------------------------- |
| `POST` | `https://{host:port}/netwrix/api/v1/activity_records/{?format=json}` | [Activity Records](/docs/auditor/10.9/api/postdata/activityrecords.md) |
...
| Error          | The header status code is an error code. Depending on the error code, the response body may contain an error object. [See Response Status Codes for more information.](/docs/auditor/10.9/api/responsestatuscodes.md)                                          |
...
[Activity Records](/docs/auditor/10.9/api/postdata/activityrecords.md) For example:
...
**Step 4 –** Check that posted data is now available in the Audit Database. Run a search request to [/netwrix/api/v1/activity_records/search](/docs/auditor/10.9/api/searchactivityrecords.md) endpoint or use interactive search in the Netwrix Auditor client. For example:
