...
:::note
See [Group Policy Preferences: Item Level Targeting](/docs/policypak/archive/itemleveltartgeting.md)
...
Preferences shortcut item to the desktop for every user. With Netwrix PolicyPak Preferences Manager, there are two ways you can limit or target which users and
computers will receive Group Policy Preferences directives by doing the following:

- Use PolicyPak Exporter and specify certain users and groups instead of computer/all
  users
...
- Use PolicyPak Exporter to specify that only the Sales group within Active Directory
...
![group_policy_preferences_item](/images/policypak/preferences/group_policy_preferences_item.webp)

You can then choose which item you want to target:

![group_policy_preferences_item_1](/images/policypak/preferences/group_policy_preferences_item_1.webp)
...
![group_policy_preferences_item_2](/images/policypak/preferences/group_policy_preferences_item_2.webp)
...
![group_policy_preferences_item_3](/images/policypak/preferences/group_policy_preferences_item_3.webp)

![group_policy_preferences_item_4](/images/policypak/preferences/group_policy_preferences_item_4.webp)
