...
PolicyPakLeast Privilege Manager is located within the Netwrix Privilege Secure node.

![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/rules/rules_1.webp)

:::note
You will only see all components of PolicyPak if you download the PolicyPak Admin Console from Portal.policypak.com, but not if you are using only the Netwrix
Privilege Secure console.
:::


PolicyPakLeast Privilege Manager is within the Netwrix Privilege Secure node and not
within the Netwrix PolicyPak node to demonstrate the relationship
between PolicyPak and Netwrix Privilege Secure. That is, you can use all of PolicyPak (all PolicyPak components) or you may wish to use PolicyPak alongside Netwrix Privilege Secure. For more information, see the
...
PolicyPak MMC snap-in enables you to create new PolicyPak Least
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/rules/rules_2.webp)

PolicyPakLeast Privilege Manager can elevate (or block) the following:
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/rules/rules_3.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/rules/rules_4.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/rules/rules_5.webp)
...
![A screenshot of a computer Description automatically generated](/images/policypak/leastprivilege/rules/rules_6.webp)

In the Quick Start examples with PolicyPak Least Privilege Manager, the goals are as
follows:
...
![A computer screen shot of a computer Description automatically generated](/images/policypak/leastprivilege/rules/rules_7.webp)
