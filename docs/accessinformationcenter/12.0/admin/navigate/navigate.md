...
workflows. Upon login, the system brings users with console access to the Home page.

![Administrator user home page](/images/accessinformationcenter/12.0/admin/homeadmin.webp)

The system displays the signed-in user name in the upper-right corner, along with the **Sign out** link. The
