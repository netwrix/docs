...
[To do for Administration](/docs/passwordsecure/26.3/configuration/basicview/todoforadministration/to_do_for_administration.md).
...
chapter[Installation Client](/docs/passwordsecure/26.3/installation/installationclient/installation_client.md)
