...
![Package: Storage/Shared Folders](/images/identitymanager/packages_sharedfolders_v603.webp)
...
- **Log on as a batch job** in the local group policy, when the connector's authentication mode is
  batch.
    ...
    ![SharedFolder - Permission for Batch Authentication](/images/identitymanager/sharedfolder_permission.webp)
