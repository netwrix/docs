...
![Scheduled Dashboard](/images/privilegesecure/26.03/accessmanagement/enduser/dashboard/scheduleddashboarduser.webp)
...
[Create Activity Session](/docs/privilegesecure/26.03/enduser/dashboard/active/createsession.md) topic for additional information.
