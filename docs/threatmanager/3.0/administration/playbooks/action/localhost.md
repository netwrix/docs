...
The PowerShell Script action executes a specified PowerShell script. This action lets you
...
- Credential – Select a credential profile using the dropdown list. This provides the
...
- Computers – The computers to log a user out of a RDP session. If not specified, only the
  perpetrator client is used. Select computers from the dropdown list:
