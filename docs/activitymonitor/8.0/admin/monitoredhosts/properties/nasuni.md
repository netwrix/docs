...
After a Nasuni host is added to the monitored hosts table, you can edit the configuration settings using the tabs in the Properties window.

![Nasuni Host Properties - Nasuni Tab](/images/activitymonitor/8.0/admin/monitoredhosts/properties/nasunitab.webp)

The **Nasuni** tab lets you modify settings which were populated with the information entered
