...
![Domain Resource Computers Tab](/images/privilegesecure/25.12/accessmanagement/admin/policy/tab/resources/computersdomain.webp)
...
resource. See
[Enroll Hosts in Management Window](/docs/privilegesecure/25.12/admin/interface/resources/detailspages/domain/computersdomain/enrollhostsinmanagement.md) for
additional information.
- Remove as NPS Managed Resource — Removes the selected resource from being managed by the
application. A confirmation window displays.
