...
The Threat Manager [Home Page](/docs/threatmanager/3.0/administration/home.md) provides a summary overview of the possible threats
detected in an organization's environment for the past 24 hours. Interactive graphs and a rollup count enable tracking and response for new threats
...
Click a threat to exclude it from the chart. The threat has a black line through it to show
...
Data grids let you search for data and configure how data is presented.
