...
![quickstart_using_policypak_9](/images/policypak/preferences/quickstart_using_endpointpolicymanager_9.webp)
...
Next, the Group Policy Preferences XML file is placed within a PolicyPak directory on
...
![quickstart_using_policypak_10](/images/policypak/preferences/quickstart_using_endpointpolicymanager_10.webp)

:::note
This demonstration will only work successfully when the computer is in Licensed or Trial
mode (with "computer" in the name) and the PolicyPak Preferences Manager client-side
