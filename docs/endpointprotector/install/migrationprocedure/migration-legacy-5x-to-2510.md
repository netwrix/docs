---
title: "Migrating from a Legacy 5.x Server to 2510/2604 (Temporary)"
description: "Netwrix Endpoint Protector — migrating a legacy 5.7.0.0–5.9.4.2 Server to the 2510/2604 image-based platform. Temporary path, valid until the 2608 image ships."
sidebar_position: 11
---
...
:::info Temporary Article — Valid Until the 2608 Image Ships
Netwrix expects to release the **2608** image in **late August 2026**. This article documents the previous target platform (2510/2604) for customers who need to migrate **before** 2608 ships.
...
:::tip
You can upgrade both the **2509** and **2510** base images directly to 2604. **Netwrix recommends the 2510 image** for new deployments — it includes improvements to disk sizing (320 GB) and resolves DHCP/DNS configuration issues present in 2509. If you already have a 2509 image available, Netwrix fully supports it and you can reach 2604 without any intermediate image migration.
:::
