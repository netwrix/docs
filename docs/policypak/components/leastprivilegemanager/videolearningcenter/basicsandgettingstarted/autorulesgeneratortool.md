...
free tool from Netwrix PolicyPak !
...
Here's the "PolicyPak LPM Auto Rule Generator Tool." I'll go ahead and run it. Again,
...
that qualifies as something that PolicyPak can elevate, block or enable.
...
you can export these if you want to for use with PolicyPak Cloud. Here are the rules.
...
You could if you want to "Export as XML file for later import" for use in PolicyPak
