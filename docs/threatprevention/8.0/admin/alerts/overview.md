...
![Alerts interface](/images/threatprevention/8.0/admin/alerts/alertsinterface.webp)
...
- Message – Description and details about the event. The **Policy updated on server
  ...
  [Policy Comparison Window](/docs/threatprevention/8.0/admin/alerts/policycomparison.md) where you can view any changes made to the
