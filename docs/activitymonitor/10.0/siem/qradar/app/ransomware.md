...
The offenses generated within QRadar are based upon the Netwrix: Ransomware Detected rule that
is packaged with this application. to adjust this rule to better suit an organization’s
needs, refer to the IBM QRadar
