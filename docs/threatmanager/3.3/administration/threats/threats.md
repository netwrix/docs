...
[User Details Page](/docs/threatmanager/3.3/administration/threats/activedirectoryobjects/user.md) or the [Group Details Page](/docs/threatmanager/3.3/administration/threats/activedirectoryobjects/group.md) and a
host link which opens the [Host Details Page](/docs/threatmanager/3.3/administration/threats/activedirectoryobjects/host.md). In addition, threats have an
Edit button which opens the Edit Threats window. The View Details button opens the
[Threat Details Page](/docs/threatmanager/3.3/administration/threats/threatdetails/overview.md).
