...
[Ribbon](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/ribbon.md). A record marked as a favourite is indicated with a star in list view.
...
about both the password quality and the [Tags](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/tags.md) used. Mouseover tooltips provide
...
[Client Module](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/client_module.md)
