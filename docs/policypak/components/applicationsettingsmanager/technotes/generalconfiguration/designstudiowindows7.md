...
It is best policy to create the Netwrix PolicyPak s from the same
operating systems as the client computers. In this case, you may want to install Design Studio on an
XP and Vista machine as well and create the designated PolicyPak s. Or, you can first
create the paks on one machine type and then re-capture the AppLock codes on the second machine
type. See the section "How to Merge PolicyPak s using the pXML Merge Wizard" in the
PolicyPak Design Studio guide.
