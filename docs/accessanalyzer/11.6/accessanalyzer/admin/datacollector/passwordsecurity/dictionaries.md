...
![Password Security Data Collection Wizard Dictionary options page](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/datacollector/passwordsecurity/dictionaries.webp)
