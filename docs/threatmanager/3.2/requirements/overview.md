...
- Threat Manager Database Server – This is where the Threat Manager PostgreSQL database is
  installed.
- Threat Manager Application Server – This is where the v3.2 application is installed.
...
- [Database Server Requirements](/docs/threatmanager/3.2/requirements/database.md)
- [Application Server Requirements](/docs/threatmanager/3.2/requirements/server.md)
- [Action Service Requirements](/docs/threatmanager/3.2/requirements/actionservice.md)
- [Client Requirements](/docs/threatmanager/3.2/requirements/client.md)
- [Ports Requirements](/docs/threatmanager/3.2/requirements/ports.md)
