...
- IPv4 or IPv6 whitelist – Enter the IP addresses of the Clustered Data ONTAP nodes that are allowed
  to connect to the FPolicy server in the box. Enter addresses as separate items separated by space, comma,
