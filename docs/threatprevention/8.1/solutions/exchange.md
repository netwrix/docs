...
- For business owners, enhanced mailbox security capabilities protect their most sensitive mailboxes
  against rogue administrator or compromised account access.

Understand who accessed a mailbox and what occurred once in the mailbox. Did someone read, modify,
delete, or forward a sensitive email? All are critical to achieving a compliant Exchange infrastructure.
