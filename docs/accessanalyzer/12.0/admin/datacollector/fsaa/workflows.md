...
![FSAA Data Collector Wizard Query Selection page with Remove scan executables and data option selected](/img/product_docs/accessanalyzer/12.0/admin/datacollector/fsaa/queryselectionremovescanexecutablesdata.webp)
...
![FSAA Data Collector Wizard Query Selection page with Remove host data option selected](/img/product_docs/accessanalyzer/12.0/admin/datacollector/fsaa/queryselectionremovehostdata.webp)
...
![FS_SDD_DELETE Job in Job's Tree](/img/product_docs/accessanalyzer/12.0/admin/datacollector/fsaa/sdddelete.webp)
...
![FS_SDD_DELETE Job Analysis Selection page](/img/product_docs/accessanalyzer/12.0/admin/datacollector/fsaa/sdddeleteanalysistasks.webp)
...
![ FS_SDD_DELETE Job Analysis Task in SQL Script Editor](/img/product_docs/accessanalyzer/12.0/admin/datacollector/fsaa/sdddeletesqlscripteditor.webp)
...
![SQL Script Editor Edit Table window](/img/product_docs/accessanalyzer/12.0/admin/datacollector/fsaa/sdddeletesqlscripteditoredittable.webp)
...
![FS_DropTables Job in Job's Tree](/img/product_docs/accessanalyzer/12.0/admin/datacollector/fsaa/droptables.webp)
...
![FS_DropTables Job Analysis Selection page](/img/product_docs/accessanalyzer/12.0/admin/datacollector/fsaa/droptablesanalysistasks.webp)
