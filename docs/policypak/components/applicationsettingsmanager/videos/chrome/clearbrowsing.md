...
plug in data, along with Cached images and files, Password and Autofill form data. Use Netwrix PolicyPak to manage these items in Chrome.
...
### PolicyPak: Google Chrome: Clear Browsing History, Cookies, Password, Images and more
