---
title: "How do I license PolicyPak if I use Azure / Azure Active Directory / Azure Active Directory Domain Services / AD Domain Controllers in Azure?"
description: "How do I license PolicyPak if I use Azure / Azure Active Directory / Azure Active Directory Domain Services / AD Domain Controllers in Azure?"
sidebar_position: 40
---

# How do I license PolicyPak if I use Azure / Azure Active Directory / Azure Active Directory Domain Services / AD Domain Controllers in Azure?

You might want to license Netwrix PolicyPak when you are using
Azure. The challenge is knowing what you mean and need by Azure.

As such, there are a few scenarios where you could possibly need to license PolicyPak
along with Azure.
...
![515_1_image-20191025230525-1](/images/policypak/license/mdm/515_1_image-20191025230525-1.webp)

In this case, you can license PolicyPak with PolicyPak Group Policy
Edition or PolicyPak Cloud Edition.

- See All Things Licensing > [Knowledge Base](/docs/policypak/)
- See Cloud edition: [PolicyPak Cloud: QuickStart](/docs/policypak/deliverymethods/cloud/videos/gettingstarted/quickstart.md)
- See[PolicyPakCloud and PolicyPak OnPremise – Together using PPCloud Licenses](/docs/policypak/deliverymethods/cloud/videos/usingwithothermethods/onpremise.md)
...
![515_3_image-20191025230525-2](/images/policypak/license/mdm/515_3_image-20191025230525-2.webp)
...
![515_5_image-20191025230525-3](/images/policypak/license/mdm/515_5_image-20191025230525-3.webp)

As such, you might want to add PolicyPak to your existing MDM service to give you the
ability to take existing traditional AD Group Policy settings and migrate them to MDM. Additionally,
you get all the PolicyPak features as well.

For this method, you are not licensing Azure Active Directory, but rather your MDM service.

- See
  [When licensing PolicyPakwith an MDM provider, what do I need to send in to PolicyPak? ](/docs/policypak/licensing/knowledgebase/requestingmdm/setup.md)for
...
- See Getting Started with MDM > [Video Learning Center](/docs/policypak/deliverymethods/mdm/videos/videolearningcenter.md)

2 — Azure AD with no MDM service

Many PolicyPak customers choose to go with Azure AD and no MDM serviceThis is because
PolicyPak can provide much of what customers need of an MDM service, without the extra
cost and moving parts.

To do this, you would need to add PolicyPak Cloud to your Azure AD by installing the
PolicyPak Cloud client on your .

See [PolicyPak Cloud: QuickStart](/docs/policypak/deliverymethods/cloud/videos/gettingstarted/quickstart.md) for additional
information on getting started and licensing with PolicyPak Cloud edition
...
Azure AD Domain Services is something we rarely ever see at PolicyPak, but we will
support it.
...
PolicyPak can be used with Azure AD Domain Services, because the servers you have
lifted and shifted are joined to Azure AD Domain Services, just like they would be in a traditional
AD domain.

You need to license the PolicyPak Group Policy edition and enumerate the whole domain
...
Regardless, PolicyPak will work in this setup just fine when you license the PolicyPak Group Policy Edition.
...
support at policypak.com so we can try to express how to license PolicyPak with your
scenario.
