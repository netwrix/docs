---
title: "PolicyPak Feature Manager for Windows doesn't appear to be working and we're getting error code 0x800f0954. What can I try?"
description: "PolicyPak Feature Manager for Windows doesn't appear to be working and we're getting error code 0x800f0954. What can I try?"
sidebar_position: 10
---

# PolicyPak Feature Manager for Windows doesn't appear to be working and we're getting error code 0x800f0954. What can I try?

Underneath the hood …PPFMW is calling the DISM command.

The error you're getting, 0x800f0954… would be happening if Netwrix PolicyPak Feature Manager for Windows -or- DISM by itself was doing the work.
...
![648_1_2019-03-13_1112](/images/policypak/troubleshooting/error/feature/648_1_2019-03-13_1112.webp)
...
**Step 3 –** MAYBE PolicyPak Feature Manager for Windows is expressly having problems
