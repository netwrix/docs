...
Netwrix Activity Monitor App for QRadar (File Activity Monitor tab) contains several
...
![file_activity_monitor_app](/images/activitymonitor/9.0/siem/qradar/file_activity_monitor_app.webp)
