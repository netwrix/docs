...
## Set up Netwrix Auditor Access Reviews

1. Install Access Reviews on the same computer where Netwrix Auditor is installed. See the
[Installation Overview](/docs/auditor/10.7/accessreviews/installation/overview.md) topic for prerequisites and
additional information.

2. Configure Access Reviews. The Configuration interface is only available to users with
...
3. Use the Access reviews configuration tool to set up the data flow from the Auditor
...
:::note
Data upload speed depends on the amount of collected data and Auditor collectors configuration.
:::

4. Configure resource ownership through the Access Reviews Console. The Resource Owners
interface is available to users with either the Security Team or Administrator role. Managing
ownership is a core component of the Access Reviews workflow. See the
[Resource Owners Overview](/docs/auditor/10.7/accessreviews/resourceowners/overview.md) topic for additional
information.

:::note
The [Owners & Access Reviews](/docs/auditor/10.7/accessreviews/owneroverview/owneroverview.md) topic and
...
5. Configure and run reviews. The Entitlement Reviews interface is available to users with
...
4. If there are errors in upload of data to the Access Reviews database, these errors are reflected
   ...
   isn't affected by these errors.
...
Ownership of resources must be assigned to use the Access Reviews workflow:
