...
![Require a number in position 2](/images/passwordpolicyenforcer/11.2/administration/chargranularrestrict2.webp)
...
![Require a numeric value](/images/passwordpolicyenforcer/11.2/administration/chargranularrestrict3.webp)

Set **Characters (Granular)** to not contain numeric values in the first two positions.

![Don't allow numeric values in first two positions](/images/passwordpolicyenforcer/11.2/administration/chargranularrestrict4.webp)
