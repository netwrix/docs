...
entered under [Backup settings](/docs/passwordsecure/current/configuration/servermanger/mainmenu/backupsettings/backup_settings.md) will be used by default.
