...
![policypak_application_settings_16](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_16.webp)
...
- Users can manage all settings now that PolicyPak Application Settings Manager ACL
  Lockdown™ has been removed.

Results are shown In the figure shown.

![policypak_application_settings_17](/images/policypak/applicationsettings/preconfigured/quickstart/endpointpolicymanager_application_settings_17.webp)

The figure shown. The settings have been reverted to their original values.

Congratulations! This completes your initial Quickstart of PolicyPak Application
Settings Manager with PolicyPak DesignStudio. Continue onward to learn about
additional PolicyPak Application Settings Manager features.

Jump to the section, "PolicyPak Application Settings Manager: DesignStudio
Quickstart," in Appendix B: PolicyPak Application Manager DesignStudio Guide if you'd
