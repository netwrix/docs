...
groups, and hosts (computers). Use these pages to discover more information about the various
...
3. Magnifying Glass Icon : This magnifying glass icon opens the investigation page to
