...
![SQL Script Editor](/img/product_docs/accessanalyzer/11.6/admin/analysis/sqlscripteditor.webp)
...
![Edit Table window](/img/product_docs/accessanalyzer/11.6/admin/analysis/sqlscriptedittablewindow.webp)
