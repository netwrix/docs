...
![Import License](/images/threatprevention/8.0/install/importlicense.webp)
...
on the [License Manager Window](/docs/threatprevention/8.0/admin/navigation/licensemanager.md).
