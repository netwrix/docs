---
title: "Understanding and fixing PolicyPak DLL Orphans"
description: "Understanding and fixing PolicyPak DLL Orphans"
sidebar_position: 50
---
# Understanding and fixing PolicyPak DLL Orphans

If a DLL that supports a GPO is removed, you need a way to discover and quickly fix it. The Netwrix PolicyPak GPOTouch utility has a function called Find & Repair
Orphaned Paks within GPOs. Here's how it works.

<iframe width="560" height="315" src="https://www.youtube.com/embed/zBlHNLLB7oo" title="PolicyPak: Understanding and fixing PolicyPak DLL Orphans" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
