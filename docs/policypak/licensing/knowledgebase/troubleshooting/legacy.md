---
title: "Action Required for PolicyPak Customers using Legacy Licenses"
description: "Action Required for PolicyPak Customers using Legacy Licenses"
sidebar_position: 60
---

# Action Required for PolicyPak Customers using Legacy Licenses

## What is happening:

- The Netwrix PolicyPak CSE (endpoint piece) is hardcoded to stop
...
- Please watch this video to help you determine your position and situation plus some advice on what
  to do.
- Video: [Legacy License Retirement Guidance (for Feb 28, 2023)](/docs/policypak/licensing/videolearningcenter/troubleshooting/legacy.md)
...
- Therefore: You should be able to pick up your existing keys at portal.policypak.com. Example of
  ...
  ![840_1_1](/images/policypak/troubleshooting/license/840_1_1.webp)
...
- Example download of valid dates with both Universal and Legacy keys, but only Universal keys will
  ...
  ![840_2_2_950x572](/images/policypak/troubleshooting/license/840_2_2_950x572.webp)
...
- GOOD, but not as good as BEST:
  ...
  - Use a PolicyPak ADMX setting which will give you +90 days to implement the
    Universal license. See screen shot below:

![1231_licenseadmxsetting](/images/policypak/troubleshooting/license/1231_licenseadmxsetting.webp)
...
- If you are using LEGACY licenses and/or very old CSEs which ONLY process LEGACY licenses (so CSEs
  before 21.1.2687.802), then PolicyPak will keep working because CSEs before
  21.1.2687.802 don't understand Universal licenses anyway.
- If you're using LEGACY licenses and NEWER CSEs (21.1.2687.802 or later), you can expect PolicyPak to stop processing and stop working as if your license file expired on Feb
  28, 2023.
...
- Example of a machine getting Universal licenses successfully:
  ...
  ![840_3_3_950x610](/images/policypak/troubleshooting/license/840_3_3_950x610.webp)
...
- **NOTE:** The Latest CSE in the portal (build 3375) will also express Invalid licenses if any are
  ...
  ![840_4_4_950x675](/images/policypak/troubleshooting/license/840_4_4_950x675.webp)
...
![840_5_image-20230126194031-1](/images/policypak/troubleshooting/license/840_5_image-20230126194031-1.webp)
...
![840_6_image-20230126194031-2_950x764](/images/policypak/troubleshooting/license/840_6_image-20230126194031-2_950x764.webp)
...
![840_7_image_950x724](/images/policypak/troubleshooting/license/840_7_image_950x724.webp)
