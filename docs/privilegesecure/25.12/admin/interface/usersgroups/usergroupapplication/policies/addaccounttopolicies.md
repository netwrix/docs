...
created in the [ Policy Interface](/docs/privilegesecure/25.12/admin/interface/interface.md).

![usersgroupsaddaccounttopoliciespage](/images/privilegesecure/25.12/accessmanagement/admin/policy/window/usersgroups/usersgroupsaddaccounttopoliciespage.webp)
