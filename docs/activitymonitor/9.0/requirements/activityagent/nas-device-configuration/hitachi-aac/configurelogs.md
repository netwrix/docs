...
Configure access to the HNAS audit logs on the Hitachi device by following these steps:
...
[Configure Access to HNAS Audit Logs on Activity Agent Server](/docs/activitymonitor/9.0/requirements/activityagent/nas-device-configuration/hitachi-aac/configureaccesstologs.md) topic for
