...
If a [Password Reset](/docs/passwordsecure/26.3/configuration/advancedview/clientmodule/passwordreset/password_reset.md) is created,
...
The section [Certificates](/docs/passwordsecure/26.3/configuration/servermanger/certificates/certificates.md)explains how to back up the certificate and link it
again.
