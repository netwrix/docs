...
![Libraries window](/img/product_docs/accessanalyzer/admin/action/libraries.webp)
...
![PowerShell Action Module Wizard](/img/product_docs/accessanalyzer/admin/action/powershellmodulewizard.webp)
...
![Add custom library on Libraries window](/img/product_docs/accessanalyzer/admin/action/librariescustom.webp)

**Step 4 –** In the pop-up window, specify a name for the library and click **OK**.

![Libraries window paste button](/img/product_docs/accessanalyzer/admin/action/librariescustompaste.webp)
