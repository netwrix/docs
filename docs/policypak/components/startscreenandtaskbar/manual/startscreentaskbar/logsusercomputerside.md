...
PolicyPak Start Screen & Taskbar Manager settings can be delivered on the User side,
...
Here is the process the PolicyPak client-side extension (CSE) uses when combining
