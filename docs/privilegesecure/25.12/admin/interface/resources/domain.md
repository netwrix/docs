...
![Add Domian Resource](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/adddomain.webp)
...
The new domain has been on-boarded. See the [Domain Details Page](/docs/privilegesecure/25.12/admin/interface/resources/detailspages/domain/domain.md) topic
