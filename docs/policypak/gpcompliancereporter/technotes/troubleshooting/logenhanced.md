---
title: "How do I turn on enhanced logging for PolicyPak Group Policy Compliance Reporter if asked to do so?"
description: "How do I turn on enhanced logging for PolicyPak Group Policy Compliance Reporter if asked to do so?"
sidebar_position: 70
---

# How do I turn on enhanced logging for PolicyPak Group Policy Compliance Reporter if asked to do so?

If asked by Netwrix PolicyPak Support to turn on enhanced
...
**Step 3 –** If getting server logs, Stop and Start "PolicyPak GP Compliance Reporter
Server Service"
...
**Step 7 –** If getting server logs, Stop and Start "PolicyPak GP Compliance Reporter
Server Service"
