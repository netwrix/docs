---
title: "Deploy PolicyPak Settings Using SCCM or Other Management System!"
description: "Deploy PolicyPak Settings Using SCCM or Other Management System!"
sidebar_position: 30
---

# Deploy PolicyPak Settings Using SCCM or Other Management System!

Do you want to deploy Netwrix PolicyPak settings, but hate the
idea of using Group Policy to do it? You're in luck–this video tells you how to create, export, and
deploy PolicyPak magic using your own desktop management system like SCCM or LanDesk!

<iframe width="560" height="315" src="https://www.youtube.com/embed/n1ZZpUbbNd0" title="Deploy PolicyPak Settings Using SCCM or Other Management System!" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
