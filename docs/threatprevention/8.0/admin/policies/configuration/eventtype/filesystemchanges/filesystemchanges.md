...
When you add server1 and server3 to the Additional Agents filter, they monitor both folder paths, but server2 still only monitors the C:\Users\All Users folder.
