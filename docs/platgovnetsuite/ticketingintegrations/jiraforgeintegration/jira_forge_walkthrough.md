...
If you have reached this part it means that you have completed the ALL prerequisites found in the Jira Forge Setup page. If NOT, please go through the setup steps for a smooth walkthrough of the integration's features.
