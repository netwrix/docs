...
[LDAP Lockdown Event Type](/docs/threatprevention/8.1/admin/policies/configuration/eventtype/ldaplockdown.md), use the LDAP filter to enable the LDAP Ping
option.

![LDAP filter for the LDAP Monitoring and LDAP Lockdown event types](/images/threatprevention/8.1/admin/policies/eventtype/usecase/ldapping.webp)
