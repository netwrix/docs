...
selecting the threat from the list on the [Threats Page](/docs/threatmanager/3.2/administration/threats/threats.md) and clicking View Details.
...
In the Threat Activity Diagram, click the user to view the [User Details Page](/docs/threatmanager/3.2/administration/threats/activedirectoryobjects/user.md) page. Click
the host to view the [Host Details Page](/docs/threatmanager/3.2/administration/threats/activedirectoryobjects/host.md) page.
