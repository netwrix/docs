...
The OpenPortScan job group reveals all open ports and the associated executable on the targeted
systems by remotely executing a netstat command on the target hosts and collecting the results for
reporting.
