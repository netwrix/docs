...
You can deselect particular tasks as specified, but doing so isn't recommended. The following
...
Customizable parameters let you set the values used for classification during the job’s
