...
includes both the visibility of individual [Client Module](/docs/passwordsecure/current/configuration/advancedview/clientmodule/client_module.md), as
...
functionalities, on the other hand, should be available to all users. To do this, Netwrix
...
1. The **personal user right** only applies to a specific user. This is always configured via
   the[Organisational structure](/docs/passwordsecure/current/configuration/advancedview/clientmodule/organisationalstructure/organisational_structure.md).
...
receives a required right in one of the three ways previously mentioned. Netwrix recommends that you link
...
the basis for the configuration of the [User settings](/docs/passwordsecure/current/configuration/advancedview/mainmenufc/usersettings/user_settings.md).
...
- The user can also issue rights that he doesn't possess himself.
