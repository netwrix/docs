...
![Netwrix Threat Manager Setup window](/images/threatmanager/3.2/intsall/upgrade/setup-launcher.webp)
...
![Netwrix PostgreSQL Setup wizard on the EULA page](/images/threatmanager/3.2/intsall/upgrade/postgres-eula.webp)
...
![Connect to a Threat Manager Database page](/images/threatmanager/3.2/intsall/upgrade/ntm-db.webp)
