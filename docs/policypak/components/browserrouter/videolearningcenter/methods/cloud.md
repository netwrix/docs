...
Deliver your routes to traveling and non-domain joined machines to Use Netwrix PolicyPak Cloud to manage your browsers and make routes to your domain joined and
non-domain joined machines.

<iframe width="560" height="315" src="https://www.youtube.com/embed/HsbcWLV1_aQ" title="PolicyPak Cloud: Using In-Cloud Editors to Manage PolicyPak Browser Router" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video we're going to use PolicyPak Cloud's
...
Here I am in the PolicyPak Cloud universe. If I click on a group like my Work from
Home Group, I want to Create and Link a New Policy here. I can then pick the policy type. We've got
all the Microsoft Group Policy stuff, all the PolicyPak things. We're going to focus
...
Edge. Go to that. Next on the list, why don't we just jump to something unusual, PolicyPak.com. We want to do Internet Explorer in Edge mode and set IE8 mode at the same time. That's
a tall order.

What are we going to do? Let's go ahead and go to New Policy here, New Browser Router Policy. We'll
call this PolicyPak Example Site. If you want to use Internet Explorer Special Mode,
...
This computer is already ready to rock. He is joined to PolicyPak Cloud. All we're
going to do is run ppcloud/sync or you can wait about an hour, and then you're off to the races.
What we're going to do is we're going to make sure we got the setting. There we go, PolicyPak Browser Router Demo 1.
...
we were to be in this browser and we wanted to Google for PolicyPak, that's all fine.
You're allowed to do that.

When you click on PolicyPak, that's where you should open up the correct browser. We
...
Let's try that one more time. We'll go to Chrome land. We'll go Googling for PolicyPak. Let's do that one more time. We'll Google for PolicyPak. Then googling is
...
default web browser; what we will do is PolicyPak takes over being the default
...
We'll go back over to PolicyPak Cloud. Here's our browser router policy. We'll click
...
PolicyPak Cloud. I have one more little magic trick I want to talk about, which is
...
PolicyPak Cloud and maybe for my west sales team or something I want to not Create and
...
Then take those directives and slam them into PolicyPak Cloud just like that.

Once you've done that, if you want to edit it later, you're more than welcome to using the in-cloud
editor. That way you can take your on-prem directive, if you have them, bring them to PolicyPak Cloud, and continue to edit them here in PolicyPak Cloud land. I hope
this video helps you out. Looking forward to getting you started with PolicyPak
Browser Router and PolicyPak Cloud real soon. Thanks so much.
