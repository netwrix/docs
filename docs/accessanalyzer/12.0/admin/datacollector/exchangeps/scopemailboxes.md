...
Use the Scope by Mailboxes page to define specific mailboxes to search. This page is enabled
when you select the **Scope by Mailbox Target Host: Local Host** option on the Scope page. See the
...
**Add** to add them to the Selected Mailboxes list. To remove undesired
mailboxes from Selected Mailboxes, select them and click **Remove**. Use the Select All and Clear All
