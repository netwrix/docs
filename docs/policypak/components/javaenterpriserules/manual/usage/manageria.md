...
:::note
PolicyPak Java Rules manager only works for websites and not when a user
...
![using_policypak_java_rules](/images/policypak/javaenterpriserules/using_endpointpolicymanager_java_rules.webp)
...
![using_policypak_java_rules_1](/images/policypak/javaenterpriserules/using_endpointpolicymanager_java_rules_1.webp)
...
![using_policypak_java_rules_2](/images/policypak/javaenterpriserules/using_endpointpolicymanager_java_rules_2.webp)
...
![using_policypak_java_rules_3](/images/policypak/javaenterpriserules/using_endpointpolicymanager_java_rules_3.webp)
...
![using_policypak_java_rules_4](/images/policypak/javaenterpriserules/using_endpointpolicymanager_java_rules_4.webp)
...
![using_policypak_java_rules_5](/images/policypak/javaenterpriserules/using_endpointpolicymanager_java_rules_5.webp)

Be sure to use only the first SHA256 displayed and not the others listed in the output. Note that
when you paste it into the PolicyPak Java Rules Manager MMC snap in, the colons are
automatically stripped.

![using_policypak_java_rules_6](/images/policypak/javaenterpriserules/using_endpointpolicymanager_java_rules_6.webp)
