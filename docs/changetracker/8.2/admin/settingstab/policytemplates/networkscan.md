...
![NetworkScan](/images/changetracker/8.2/admin/settings/policytemplates/networkscan.webp)
...
![EditNetwork](/images/changetracker/8.2/admin/settings/policytemplates/editnetwork.webp)
...
![EditNetworkCredentialName](/images/changetracker/8.2/admin/settings/policytemplates/editnetworkcredentialname.webp)
...
![page_guide_53](/images/changetracker/8.2/admin/settings/policytemplates/page_guide_53.webp)

**Step 3 –** Once the initial poll has completed the duration will be required as a communications
Event.

![page_guide_54](/images/changetracker/8.2/admin/settings/policytemplates/page_guide_54.webp)
...
![EventDetailsNetwork](/images/changetracker/8.2/admin/settings/policytemplates/eventdetailsnetwork.webp)
