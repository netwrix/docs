...
See the [Agents Tab](/docs/activitymonitor/10.0/admin/agents/overview.md) topic for additional information on how to deploy agents using the Console.

The Activity Monitor Agent may also be deployed manually. Use one of the following to manually install an agent:

- [Manually Install the Windows Agent](/docs/activitymonitor/10.0/install/agents/manual.md)
- [Manually Install the Linux Agent](/docs/activitymonitor/10.0/install/agents/manuallinux.md)
- [Manually Install the Agent for Active Directory](/docs/activitymonitor/10.0/install/agents/manualad.md)
