...
Because PolicyPak Java Rules Manager automates Java's Deployment Rule Set, you should
...
is valid; this determines which PolicyPak Rules Manager should automatically apply.

![troubleshooting_policypak_4](/images/policypak/troubleshooting/javaenterpriserules/troubleshooting_endpointpolicymanager_4.webp)
