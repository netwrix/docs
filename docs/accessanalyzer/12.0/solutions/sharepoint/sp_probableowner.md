...
The SP_ProbableOwner Job identifies probable owners for Site Collections and
Sites, which you can use for entitlement reviews. Probable Owner calculation is based on file
