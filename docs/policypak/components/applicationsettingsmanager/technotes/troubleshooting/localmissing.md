...
While Upgrading from a build prior to 785 all AppSets stored in Local Storage for Netwrix PolicyPak Extension could be deleted.
...
![409_1_image002](/images/policypak/troubleshooting/applicationsettings/appset/409_1_image002.webp)
