...
This requires a registered application in your Entra ID tenant. The certificate is generated by the source group wizard — you don't create or upload it here.
