...
[ServiceNow Action Module](/docs/accessanalyzer/11.6/accessanalyzer/admin/action/servicenow/overview.md)
topic for additional information.

![ServiceNow node](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/servicenow.webp)
