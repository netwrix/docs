...
Built-in Netwrix Auditor self-audit tracks changes to the product configuration,
including monitoring plans, data sources, audit scope, and details about it (before-after values).
This helps ensure that monitoring scope is complete and changed only in line with the
workflows adopted by your organization.
...
A Netwrix Auditor Self-Audit report is available under Organization Level Reports in
