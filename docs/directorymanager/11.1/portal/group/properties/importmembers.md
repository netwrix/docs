...
The **Import Members** wizard lets you add members to the group using an external file.
...
1. On the **Lifecycle** page, select whether the imported members should be added permanently or
   temporarily to the group membership. You can also import members from an existing group.
    ...
    - **Import Members From Groups**: to add all members of another group or groups to the
    ...
    - **External Data Source**
        ...
        1. On the **Providers** page, select [Query Designer](/docs/directorymanager/11.1/portal/group/querydesigner/overview.md) to
           create a query. The query will fetch all those members that match the set criteria.
            ...
            The Query Designer isn't working. After adding provider in the data source, it is
...
8. If you don't want existing group members to be deleted during import, ensure that the
   **Append existing items (uncheck to replace)** checkbox is selected.
...
1. On the **Lifecycle** page, select the **Import Members From Groups** option to add all members
...
2. Click the **Search Groups** button; the [Find Dialog Box](/docs/directorymanager/11.1/portal/generalfeatures/find.md) is displayed,
   where you can search and select the groups whose members you want to import into the membership
   of this group.
3. Click **Next**.
...
5. If you don't want existing group members to be deleted during import, ensure that the
   **Append existing items (uncheck to replace)** checkbox is selected.
6. Click **Finish** to import members from the selected groups.
