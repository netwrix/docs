...
Auditor to SIEM. Provide connection details and schedule the script for
execution.
...
API, refer to the [Integration API](/docs/auditor/10.9/api/overview.md) topic.
...
[Integration API](/docs/auditor/10.9/api/overview.md) topic for additional information about schema updates.
