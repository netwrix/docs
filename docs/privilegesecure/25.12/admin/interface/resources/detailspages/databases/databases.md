...
![Database Details page](/images/privilegesecure/25.12/accessmanagement/admin/policy/page/details/databasedetailspage.webp)
...
scheduled from the [Platforms Page](/docs/privilegesecure/25.12/admin/interface/platforms/overview.md).
