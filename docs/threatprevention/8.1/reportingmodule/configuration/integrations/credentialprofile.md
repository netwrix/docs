...
![Integrations interface on the Credential Profile page](/images/threatprevention/8.1/reportingmodule/configuration/integrations/page_1.webp)
...
See the [Reporting Module Server Requirements](/docs/threatprevention/8.1/requirements/reportingserver.md) topic for a
...
![Add New Integration window with Credential Profile type selected](/images/threatprevention/8.1/reportingmodule/configuration/integrations/credentialprofile.webp)
...
To edit a Credential Profile name and/or description:
...
![Name and Description box for a Credential Profile in Edit mode](/images/threatprevention/8.1/reportingmodule/configuration/integrations/editprofile.webp)
...
![Credential Settings window](/images/threatprevention/8.1/reportingmodule/configuration/integrations/credentialsettingswindow.webp)
