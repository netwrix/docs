...
[Install with Group Policy Management](/docs/passwordpolicyenforcer/11.2/installation/installationgpm.md) top for details on installing the client
...
**Step 2 –** Click the **Netwrix_PPE_Client**version**x64.msi** (64 bit OS) or
...
Follow the steps to create the port exception on all domain controllers.
...
![the_password_policy_client_3](/images/passwordpolicyenforcer/11.2/install/the_password_policy_client_3.webp)

**Step 5 –** Select the **Enabled** option, and then click **Show...**.

![the_password_policy_client_4](/images/passwordpolicyenforcer/11.2/install/the_password_policy_client_4.webp)

**Step 6 –** Select the **Enabled** option, and then click **Show...**.

![the_password_policy_client_5](/images/passwordpolicyenforcer/11.2/install/the_password_policy_client_5.webp)
