...
you need Netwrix PolicyPak File Associations Manager, which can
be seen in this demo.

<iframe width="560" height="315" src="https://www.youtube.com/embed/nUCLWJ3VVNg" title="PolicyPak File Associations Manager: Manage User and Computer File Associations" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### Set, Change and Remove Windows 10 File Associations

Hi. This is Jeremy Moskowitz, former Group Policy MVP and Founder of PolicyPak
Software. In this article, I'm going to show you how you can manage Windows 10 file associations
using PolicyPak File Associations Manager.
...
![21_1_windows-10-file-association-demo-admin-machine](/images/policypak/video/fileassociations/21_1_windows-10-file-association-demo-admin-machine.webp)

Figure 1: Admin Machine

![21_2_windows-10-file-association-endpoint-machine](/images/policypak/video/fileassociations/21_2_windows-10-file-association-endpoint-machine.webp)
...
![21_3_windows-10-file-association-pdf-edge](/images/policypak/video/fileassociations/21_3_windows-10-file-association-pdf-edge.webp)
...
![21_4_windows-10-file-association-for-mp4-files](/images/policypak/video/fileassociations/21_4_windows-10-file-association-for-mp4-files.webp)
...
![21_5_windows-10-file-association-mailto-default](/images/policypak/video/fileassociations/21_5_windows-10-file-association-mailto-default.webp)

Figure 5: Prompt for MAILTO asking if you want to email this person

![21_6_windows-10-file-association-mailto-mailer](/images/policypak/video/fileassociations/21_6_windows-10-file-association-mailto-mailer.webp)
...
![21_7_windows-10-file-association-unknown-application](/images/policypak/video/fileassociations/21_7_windows-10-file-association-unknown-application.webp)
...
### How to Change Windows 10 File Associations with PolicyPak File Associations Manager

![21_8_policy-pak-file-association-manager-for-windows-10](/images/policypak/video/fileassociations/21_8_policy-pak-file-association-manager-for-windows-10.webp)

Figure 8: PolicyPak File Associations Manager for Windows 10

#### Step #1: Start with the Group Policy Management Console (GPMC)

![21_9_start-with-gpmc-policypak-file-association-manager](/images/policypak/video/fileassociations/21_9_start-with-gpmc-endpointpolicymanager-file-association-manager.webp)
...
way to do File Associations Manager with PolicyPak is for you to have the same
...
PolicyPak File Associations Manager. Once I right click and click "Edit," we'll knock
out all four problems.

#### Step 2: Create Windows 10 File Association Policy for PDF to Acrobat

![21_10_create-windows-10-file-association-policy-with-policypak](/images/policypak/video/fileassociations/21_10_create-windows-10-file-association-policy-with-endpointpolicymanager.webp)

Figure 10: Creating a Policy with PolicyPak File Associations Manager

PolicyPak File Associations Manager is on the computer side, and we'll dive into that
...
![21_11_windows-10-file-association-pdf-to-acrobat](/images/policypak/video/fileassociations/21_11_windows-10-file-association-pdf-to-acrobat.webp)
...
![21_12_create-windows-10-file-association-policy-for-mp4-with-policypak-file-associations-manager](/images/policypak/video/fileassociations/21_12_create-windows-10-file-association-policy-for-mp4-with-endpointpolicymanager-file-associations-manager.webp)
...
![21_13_windows-10-file-association-for-mp4-changed-to-vlc-player](/images/policypak/video/fileassociations/21_13_windows-10-file-association-for-mp4-changed-to-vlc-player.webp)

Figure 13: MP4 is now associated with VLC Media Player

#### Step 4: Set Windows 10 File Association Policy for Mailto to Outlook

![21_14_windows-10-file-association-changed-mailto-outlook](/images/policypak/video/fileassociations/21_14_windows-10-file-association-changed-mailto-outlook.webp)
...
![21_15_windows-10-file-association-for-mailto-set-with-policypak](/images/policypak/video/fileassociations/21_15_windows-10-file-association-for-mailto-set-with-endpointpolicymanager.webp)

Figure 15: Setting Windows 10 File Association from MAILTO to Outlook with PolicyPak
...
![21_16_windows-10-file-association-custome-application](/images/policypak/video/fileassociations/21_16_windows-10-file-association-custome-application.webp)
...
![21_17_windows-10-file-association-notepad-confirmation](/images/policypak/video/fileassociations/21_17_windows-10-file-association-notepad-confirmation.webp)
...
![21_18_windows-10-file-association-group-policy-update-successful](/images/policypak/video/fileassociations/21_18_windows-10-file-association-group-policy-update-successful.webp)
...
Get started by attending our daily webinar. Not only will this webinar review of how PolicyPak simplifies Windows 10 File Associations, but it also demonstrates the software's other
