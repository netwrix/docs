...
![Choose Agent window](/images/activitymonitor/9.0/admin/monitoredhosts/add/chooseagent.webp)

**Step 2 –** On the Choose Agent page, select the **Agent** to monitor the storage device.

![Add Host window with Dell Unity selected](/images/activitymonitor/9.0/admin/monitoredhosts/add/addnewhostemcunity.webp)
...
![Protocol Monitoring Page](/images/activitymonitor/9.0/admin/monitoredhosts/add/isilonprotocols.webp)
