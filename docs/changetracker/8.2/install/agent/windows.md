...
[First Run – HubDetails.xml File](/docs/changetracker/8.2/admin/settingstab/devicegroups.md) topic for additional
information.
...
is located. See the [First Run – HubDetails.xml File](/docs/changetracker/8.2/admin/settingstab/devicegroups.md) topic
