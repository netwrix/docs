...
be used in the same way as the [History](/docs/passwordsecure/current/configuration/advancedview/clientmodule/passwords/history.md). The interplay between the
