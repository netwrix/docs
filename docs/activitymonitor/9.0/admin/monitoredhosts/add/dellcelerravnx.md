...
The Monitored Hosts & Services table displays the added Dell Celerra or VNX host. After you add a host for monitoring, configure the outputs you want. See the
