...
Use the New Investigation page to run queries on available data with desired filters for a specific timeframe.
...
the [Filters Section](/docs/threatprevention/8.0/reportingmodule/investigations/options/filters.md) topic for additional information.
...
available from the New Investigation page. See the [Export Report](/docs/threatprevention/8.0/reportingmodule/investigations/options/export.md) topic for
...
To retain filter configuration after running a query and confirming the report displays the results you want, save the investigation with these steps:
...
![saveinvestigation](/images/threatprevention/8.0/reportingmodule/investigations/saveinvestigation.webp)
...
See the [Investigation Options](/docs/threatprevention/8.0/reportingmodule/investigations/options/overview.md) topic for additional information.
