...
This wizard has four pages. The wizard only displays pages applicable to your selection
on the first page:
...
-   **2. Add Access** — Select new user and identify access level. See the Add Access topic for
    ...
    - You can import new users in bulk from a CSV file. See the Import Users CSV File topic for
      additional information.
...
search field to find and select users from Active Directory, which populate in a dropdown menu as
