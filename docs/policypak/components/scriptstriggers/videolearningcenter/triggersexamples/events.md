---
title: "PolicyPak Scripts & Triggers: Events !"
description: "PolicyPak Scripts & Triggers: Events !"
sidebar_position: 70
---
# PolicyPak Scripts & Triggers: Events !

Use the Event Log to trigger when any kind of scriptable event should occur.

<iframe width="560" height="315" src="https://www.youtube.com/embed/ibHKk9frET4" title="PolicyPak Scripts &amp; Triggers: Events !" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz. In this video I'm going to show you how you can use Netwrix PolicyPak's Scripts & Triggers Manager to set off any kind of script you
