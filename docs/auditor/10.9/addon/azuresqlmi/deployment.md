...
<!-- Note: Add screenshots to static/images/auditor/10.9/addon/azuresqlmi/ directory:
     - azure-sql-mi-wizard.gif (wizard configuration screenshot)
     - netwrix-auditor-search.png (search results in Netwrix Auditor)
-->

![Azure SQL MI - Wizard](/images/auditor/10.9/addon/azuresqlmi/azure-sql-mi-wizard.gif)

![Netwrix Auditor - Search](/images/auditor/10.9/addon/azuresqlmi/netwrix-auditor-search.png)
