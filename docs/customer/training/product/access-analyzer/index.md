...
While <NAM /> is included in the above learning paths, there is also a learning path just for this application:

* [Netwrix Activity Monitor Learning Path](./activity-monitor.md)
