...
OpenID is an open standard for authentication that lets users log into multiple websites using
...
![Integrations interface displaying the details for an OpenID authneication provider](/images/threatprevention/8.1/reportingmodule/configuration/integrations/authenticationprovider/openid.webp)
...
- User Source – The source type to use to validate the user from the token. Use the dropdown menu
...
![UserGroups tab for an authneication provider](/images/threatprevention/8.1/reportingmodule/configuration/integrations/authenticationprovider/usersgroupstab.webp)
...
See the [User Access Page](/docs/threatprevention/8.1/reportingmodule/configuration/systemsettings/useraccess.md) topic for additional information.
