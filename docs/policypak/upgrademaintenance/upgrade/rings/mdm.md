---
title: "Rings with PolicyPak and an MDM Service"
description: "Rings with PolicyPak and an MDM Service"
sidebar_position: 20
---

# Rings with PolicyPak and an MDM Service
...
However, the specific idea of using rings to deploy any other software, like the PolicyPak CSE, is not something native to an MDM service. Therefore, you will need to create computer
...
of a new CSE. Then, because the PolicyPak CSE is an MSI, you can use the MSI
