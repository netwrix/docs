...
- Log file format – Indicates the file type used for the activity log. The default is JSON. See
  [SharePoint JSON Log File](/docs/activitymonitor/10.0/admin/monitoredhosts/output/sharepointjson.md) topic and the
  [SharePoint TSV Log File](/docs/activitymonitor/10.0/admin/monitoredhosts/output/sharepointtsv.md) topic for additional information.
- Period to keep Log files – Activity logs are deleted after the number of days entered. The default
  is 10 days.
