...
tasks. Users / group members with the Reviewer role sees the access certification tasks
assigned to them here.

![Access Certification Page](/images/privilegesecure/26.03/accessmanagement/admin/auditreporting/page/page.webp)
...
[Add Access Certification Task](/docs/privilegesecure/26.03/admin/AuditReporting/accesscertification/accesscertificationtask.md) topic for additional
information.
...
[Role Management Page](/docs/privilegesecure/26.03/admin/usersgroups/rolemanagement/rolemanagement.md) topic for additional information
- Status – Shows status information for the task
...
- [Users Tab for Access Certification](/docs/privilegesecure/26.03/admin/AuditReporting/accesscertification/users.md)
- [Entitlements Tab for Access Certification](/docs/privilegesecure/26.03/admin/AuditReporting/accesscertification/entitlements.md)
