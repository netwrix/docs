...
It depends on data collected by the 0.Collection Job Group, also housed in the Box Job Group.
...
- [Box_ExternalUserCollaborations Job](/docs/accessanalyzer/11.6/solutions/box/activity/forensics/box_externalusercollaborations.md)
  ...
  to ensure sensitive data isn't being shared outside of your organization.
