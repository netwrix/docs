---
title: "Firefox: How can I use PolicyPak to revert Firefox's Options back to the \"Old Style\" ?"
description: "Firefox: How can I use PolicyPak to revert Firefox's Options back to the \"Old Style\" ?"
sidebar_position: 130
---

# Firefox: How can I use PolicyPak to revert Firefox's Options back to the "Old Style" ?
...
### Firefox 28 and PolicyPak — Deliver and lockdown settings, and also switch back to old UI for Options

Hi. This is Sal from Netwrix PolicyPak technical support. In this
