...
![Survey Action Module Wizard Questions page](/img/product_docs/accessanalyzer/12.0/admin/action/survey/questions.webp)
...
![Select subjects window](/img/product_docs/accessanalyzer/12.0/admin/action/survey/selectsubjects.webp)
