---
title: "PolicyPak extends Group Policy to Microsoft App-V"
description: "PolicyPak extends Group Policy to Microsoft App-V"
sidebar_position: 10
---
# PolicyPak extends Group Policy to Microsoft App-V
...
using Group Policy using Netwrix PolicyPak:
...
So, we did it for them – with PolicyPak.

So now, if you need to change a setting, you don't have to re-open and re-sequence that package.

You can create your own PolicyPak for your applications to manage all the
...
When you're ready to manage your App-V packages using Group Policy, PolicyPak is here
for you.
