  ...
  configure them manually:
    ...
    - The following advanced audit policy settings must be configured:
        ...
        - Audit Security Group Management, Audit User Account Management, Audit Handle
          ...
          Audit Policy Change advanced audit policies must be set to _"Success"_.
    ...
    - For auditing removable storage media, two Event Trace Session objects must be created. See the
      ...
      information.
    - If you want to use Network traffic compression, ensure that the Auditor console computer is
...
monitoring scope. See the
[Windows Server Monitoring Scope](/docs/auditor/10.7/admin/monitoringplans/windows/scope.md) topic for
additional information.
...
[Monitor changes to system components](/docs/auditor/10.7/admin/monitoringplans/windows/overview.md)
...
Consider that audit data for the registry keys themselves will not appear in Netwrix Auditor reports, alerts, or search results, as the product uses it only as one of the sources for Activity Record formation.
