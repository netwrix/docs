---
title: "PolicyPak: Manage Internet Explorer (IE9) Using Group Policy"
description: "PolicyPak: Manage Internet Explorer (IE9) Using Group Policy"
sidebar_position: 220
---

# PolicyPak: Manage Internet Explorer (IE9) Using Group Policy

Internet Explorer's many settings, and users' tendency to want to tweak then to their taste, can be
a challenge to network administrators. WithNetwrix PolicyPak you
