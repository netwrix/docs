---
title: "Which Windows Client and Server are currently supported by PolicyPak?"
description: "Which Windows Client and Server are currently supported by PolicyPak?"
sidebar_position: 150
---

# Which Windows Client and Server are currently supported by PolicyPak?

Netwrix PolicyPak supports all current versions of Windows
...
Any exceptions, if any, to the above will be noted in the RELEASE-NOTES in the PolicyPak Portal.

:::note
  For complete clarity, PolicyPak is not supported on Server 2012 R2,
