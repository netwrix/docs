...
![Sessions Tab for Application Users](/images/privilegesecure/25.12/accessmanagement/admin/policy/tab/usersgroups/usersessionstab.webp)
...
resource. See the [Resources Page](/docs/privilegesecure/25.12/admin/interface/resources/resources.md) topic for additional information.
