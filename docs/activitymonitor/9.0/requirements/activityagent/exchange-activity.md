...
[Exchange Online](/docs/activitymonitor/9.0/admin/monitoredhosts/add/exchangeonline.md) topic for
...
Enable auditing for Exchange Online so the Activity Monitor can receive events.
