...
- Name – The name of the group. Click the link to view group details. See the
  [Group Details Page](/docs/threatmanager/3.1/administration/threats/entraidobjects/entraidgroup.md) topic for additional information.
...
The role assignments tab displays a table that lists the roles assigned to the Entra
ID application.
