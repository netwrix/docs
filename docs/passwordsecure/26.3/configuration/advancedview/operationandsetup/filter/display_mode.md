...
In addition to the already described [Filter](/docs/passwordsecure/26.3/configuration/advancedview/operationandsetup/filter/filter.md), it is possible to switch to structure
...
There are three relevant [User settings](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/usersettings/user_settings.md)
