...
The Password Policy Client helps users to choose a compliant password. You don't have to install
...
isn't installed, then users will see the default Windows error message when their password is
rejected.
