...
Double-click text box to enter specific **Relative Identifiers (RIDs)**. Click OK. The AD agent then compares against the
...
Double-click the text box beneath Distinguished Name to enter the group types to include or
exclude. Double-click the text box beneath **Type** to enter the AD object to include or
