...
Netwrix PolicyPak On-Prem licenses are contained within GPOs.
Since GPOs can be blocked using Block Inheritance, we always recommend you enforce the GPO's links
which contain PolicyPak licensing data.
...
Below all PolicyPak Licenses are contained within one GPO. But you might have multiple
licensing GPOs, all which need to be enforced.

![168_1_image0013](/images/policypak/license/activedirectory/168_1_image0013.webp)
