---
title: "PolicyPak File Associations Trick: Acro Reader AND Writer"
description: "PolicyPak File Associations Trick: Acro Reader AND Writer"
sidebar_position: 70
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/l-WS3otjkP0" title="PolicyPak File Associations Trick: Acro Reader AND Writer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak File Associations Trick – Acro Reader AND Writer

Hi. This is Jeremy Moskowitz, former Group Policy MVP and Founder of PolicyPak
Software. In this video, I'm going to show you how you can use PolicyPak File
...
under computer side, "PolicyPak /File Associations Manager for Windows 10," right
...
PolicyPak land here, when I click in the download here, we have a little program in
the "PolicyPak Extras" folder called the "PolicyPak File Associations
Manager Helper."
...
Just to lay it out one more time, using PolicyPak
for [PolicyPak File Associations Manager: Manage Windows 10 & 11 File Associations](/docs/policypak/components/fileassociationsmanager/videolearningcenter/gettingstarted/windows10.md) with
...
PolicyPak File Associations Manager. Looking forward to getting you started real
soon.  
