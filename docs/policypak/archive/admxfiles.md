...
them to. Jeremy demonstrates how a 3rd party tool like Netwrix PolicyPak can actually deliver settings, plus perform lockdown so your settings are ensured.
