...
views can be set via rights and settings. See
[To do for Administration](/docs/passwordsecure/9.3/configuration/basicview/todoforadministration/to_do_for_administration.md) for configuration details.
...
chapter[Installation Client](/docs/passwordsecure/9.3/installation/installationclient/installation_client.md)
