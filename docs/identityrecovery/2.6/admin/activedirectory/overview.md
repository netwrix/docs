...
[Domains Page](/docs/identityrecovery/2.6/admin/configuration/domain.md).

Click **Active Directory** in the left pane to open the Active Directory page.

![Active Directory page](/images/identityrecovery/2.6/admin/activedirectory/activedirectory.webp)
...
this object and select **Rollback** on the menu. See the [Rollback Objects](/docs/identityrecovery/2.6/admin/activedirectory/rollback.md) topic for
...
recover deleted objects in Active Directory. See the [Recover Objects](/docs/identityrecovery/2.6/admin/activedirectory/recover.md) topic for
additional information.
...
![Right-click menu on the Active Directory page](/images/identityrecovery/2.6/admin/activedirectory/rightclickmenu.webp)
...
- The user is logged in with an account that is specified in the Account section of the
  [Netwrix Integrations Page](/docs/identityrecovery/2.6/admin/configuration/integration.md)
...
![Audit History window](/images/identityrecovery/2.6/admin/activedirectory/audithistory.webp)
...
![Audit Activity window](/images/identityrecovery/2.6/admin/activedirectory/auditactivity.webp)
