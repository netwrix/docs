...
[Configuration Interface Overview](/docs/auditor/10.9/accessreviews/admin/configuration/overview.md) topic for additional information.
...
the [Resource Owners Interface](/docs/auditor/10.9/accessreviews/resourceowners/interface/interface.md) topic for additional information.
