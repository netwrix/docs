...
The most common problem with Netwrix PolicyPak Scripts & Triggers
Manager happens during the initial application. Here are some tips when trying to troubleshoot
PolicyPak Scripts & Triggers Manager.
...
Figure 33 shows an example of a PolicyPak Scripts & Triggers Manager log with some
annotations.

![troubleshooting](/images/policypak/troubleshooting/scriptstriggers/troubleshooting.webp)
