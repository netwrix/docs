...
![entitlementstab](/images/privilegesecure/26.03/accessmanagement/admin/auditreporting/tab/entitlementstab.webp)
...
the entitlements are committed, no further changes can be made and the task can't be deleted.
- Export Entitlements as CSV (only enabled when changes have been committed) – Export activity
details as CSV

Now the assigned Reviewer can accept or deny access. See [Audit and Reporting: Reviewer](/docs/privilegesecure/26.03/enduser/auditreviewer.md)
