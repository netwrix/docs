...
When using a remote SQL as the database for Netwrix PolicyPak
Group Policy Compliance Reporter, the snapshot operation may fail with the following error.

![669_1_image-20200327172830-2](/images/policypak/troubleshooting/error/gpocompilancereporter/669_1_image-20200327172830-2.jpeg)
...
The following is run on both the PolicyPak GPCR Client computer (Where the Admin
...
1. Open the "run" box (Win-R), type `"dcomcnfg"` and click OK
   ...
   ![669_3_image-20200327172830-3](/images/policypak/troubleshooting/error/gpocompilancereporter/669_3_image-20200327172830-3.webp)
...
![669_5_image-20200327172830-4](/images/policypak/troubleshooting/error/gpocompilancereporter/669_5_image-20200327172830-4.webp)
...
5. Click OK
   ...
   ![669_7_image-20200327172830-5](/images/policypak/troubleshooting/error/gpocompilancereporter/669_7_image-20200327172830-5.webp)
...
![669_9_image-20200327172830-6](/images/policypak/troubleshooting/error/gpocompilancereporter/669_9_image-20200327172830-6.webp)

**Step 3 –** Find "Distributed Transaction Coordinator", check and check the appropriate Network
profile (e.g. Domain).

![669_11_image-20200327172830-7](/images/policypak/troubleshooting/error/gpocompilancereporter/669_11_image-20200327172830-7.webp)
