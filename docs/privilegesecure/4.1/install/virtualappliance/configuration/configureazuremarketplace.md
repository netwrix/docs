...
**Step 5 –** after the image has been deployed successfully, select **Go to resource** on the right
pane.

**Step 6 –** Navigate to **Virtual machines** and ensure that your Netwrix Privilege Secure image
status is **Running**.
