...
4. In **Server Roles** tick **Web Server (IIS)**.
    ...
    ![Server Manager: Step 4](/images/identitymanager/prodagent_servermanager4.webp)
...
To continue,[Configure the Pool and Site](../../../user-guide/deploy/production-agent-installation/iis-configuration)and website via IIS.
