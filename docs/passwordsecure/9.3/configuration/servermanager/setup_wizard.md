...
This step can also be performed later “in the [License settings](/docs/passwordsecure/9.3/configuration/servermanager/mainmenu/license_settings.md)
...
:::warning
you only confirm the security notes when the corresponding point
