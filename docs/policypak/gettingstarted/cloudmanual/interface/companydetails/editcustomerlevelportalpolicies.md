...
![web_interface_and_controls_102_624x172](/images/policypak/cloud/interface/companydetails/web_interface_and_controls_102_624x172.webp)
...
- Require 2Fa for PPC Login: This will always be enabled and cannot be disabled, even by someone
  ...
  application-based authentication to be used for all admins in PolicyPak Cloud.
...
![web_interface_and_controls_103_625x304](/images/policypak/cloud/interface/companydetails/web_interface_and_controls_103_625x304.webp)
