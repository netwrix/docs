...
The auto-update feature is described in Appendix A of the Netwrix PolicyPak Application Manager guide.
...
**Step 1 –** Download the PolicyPak bits (721 or later) and locate the files named
PolicyPak **Client-Side Extension x86.MSI** and PolicyPak **Client-Side
Extension x64.msi**.

**Step 2 –** Copy / rename these files to the names that these build will recognize: PolicyPak **CSE Setup x64.MSI** and PolicyPak **CSE Setup x86.msi**.
...
**Step 1 –** Download the PolicyPak bits (721 or later) and locate the file named
PolicyPak **Client-Side Extension x86.MSI** and PolicyPak **Client-Side
Extension x64.msi**.

**Step 2 –** Copy / rename these files to the names that these build will recognize: PolicyPak **Application Manager CSE x86.msi** and PolicyPak **Application Manager CSE
x64.msi**.
...
**Step 2 –** Copy / rename these files to the names that these build will recognize:PolicyPak Application Manager CSE x86.msi and PolicyPak Application Manager CSE x64.msi.
