...
different folder, the application moves it from the original location to the new folder. You can also update
...
- Folder – The folder in the navigation pane where the application saves the investigation
...
The application saves the duplicated investigation to the selected folder, and the folder expands in the
