...
[Notifications](/docs/passwordsecure/9.3/configuration/advancedview/clientmodule/notifications.md), reports also contain
...
[List view](/docs/passwordsecure/9.3/configuration/advancedview/operationandsetup/list_view.md), there are three
...
The filter lets you define the scope of the report e.g. to focus on a certain OU or simply a
