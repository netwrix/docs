...
to share the folder that contains `PPGPCR.Auditor.exe`. By default, when you install PolicyPak GPCR Server the Auditor folder is created within
...
![gpcr_server_with_push_mode_12](/images/policypak/grouppolicycompliancereporter/mode/push/setup/gpcr_server_with_push_mode_12.webp)
...
![gpcr_server_with_push_mode_13](/images/policypak/grouppolicycompliancereporter/mode/push/setup/gpcr_server_with_push_mode_13.webp)
