---
title: "PolicyPak Scripts + Triggers: Map a printer or drive when a process runs and un-map it when closed."
description: "PolicyPak Scripts + Triggers: Map a printer or drive when a process runs and un-map it when closed."
sidebar_position: 20
---
# PolicyPak Scripts + Triggers: Map a printer or drive when a process runs and un-map it when closed.

How do you map a printer or drive when you launch an application like Acrobat Reader ? Using Netwrix PolicyPak Scripts + Triggers of course. Its easy to do... just
pre-try your script first, then use PolicyPak Scripts + Triggers to do the magic. Its
easy!

<iframe width="560" height="315" src="https://www.youtube.com/embed/5tOXS2buwKU" title="PolicyPak Scripts + Triggers: Map a printer or drive when a process runs and un-map it when closed." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz, and in this video, I'm going to show you how you can use PolicyPak scripts and triggers to map a drive, or map a printer, or do some other exciting
...
what we just learned and use PolicyPak scripts and triggers?
...
is automatically nuked because of PolicyPak scripts.
...
helps you out and you're ready to use PolicyPak scripts and triggers. Thanks very
much.
