---
title: "PolicyPak + FSLogix: Elevating applications when needed (and available by FSLogix)"
description: "PolicyPak + FSLogix: Elevating applications when needed (and available by FSLogix)"
sidebar_position: 70
---
...
administrator access! Instead, use FSLogix to hide/reveal apps users need, and use Netwrix PolicyPak to ELEVATE those applications and situations when needed.

<iframe width="560" height="315" src="https://www.youtube.com/embed/a8bq9EejG6U" title="PolicyPak + FSLogix: Elevating applications when needed (and available by FSLogix)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
