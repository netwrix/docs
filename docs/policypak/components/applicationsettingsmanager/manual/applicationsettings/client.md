...
PolicyPak CSE has several key log files. We mentioned them earlier when describing
what to send technical support. If you are interested in looking through the log files to help
diagnose your own problems, below is the list of PolicyPak log files in Table 2.

Table 2: PolicyPak Application Settings Manager log files.
...
![troubleshooting_policypak_5](/images/policypak/troubleshooting/applicationsettings/logs/troubleshooting_endpointpolicymanager_5.webp)
