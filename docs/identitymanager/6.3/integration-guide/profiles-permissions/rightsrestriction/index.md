...
1. Create the appropriate dimensions.
    ...
    See the [Dimension](/docs/identitymanager/6.3/integration-guide/toolkit/xml-configuration/metadata/dimension.md) topic for
...
2. Create an access control entity type to list all the properties whose visibility must be
   restricted, and link them to a visibility group.
    ...
    [Dimension](/docs/identitymanager/6.3/integration-guide/toolkit/xml-configuration/metadata/dimension.md) topic for
    additional information.
