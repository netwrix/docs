...
In the Select Search Mailbox Parameters section, select the filter parameters you want:
...
- Between – Select the numbers for the lower and upper range boundary, and the time units you want.
