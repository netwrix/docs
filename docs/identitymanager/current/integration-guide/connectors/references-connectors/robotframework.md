...
**This page is about [Robot Framework](../../../integration-guide/connectors/references-packages/robot-framework)**

![Package: Custom/Robot Framework](/images/identitymanager/integration-guide/connectors/references-connectors/robotframework/packages_robot_v603.webp)
...
correctly, `robot.exe` should be in your path. You can confirm this by running `gcm robot` in a powershell console.
...
See how to [Write a Robot Framework Script](../../../integration-guide/connectors/configuration-details/write-fulfill-robotframework-script) to allow provisioning with this connector.
