...
we want you to use your Netwrix PolicyPak investment the way your
company needs to, when you need to. You don't need to come to us every time your company grows or
uses PolicyPak products for more computers. However, we do require that your license
...
make a quick inspection of all GPOs within the scope of license that use PolicyPak
Group Policy Compliance Reporter.

We simply ask you to re-count where you want to use PolicyPak Group Policy Compliance
