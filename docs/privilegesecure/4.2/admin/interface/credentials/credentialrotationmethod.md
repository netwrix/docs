...
| Standard | None | Blank | N/A | N/A | 	Local or domain user account that isn't managed by Privilege Secure and no credentials have ever been stored.|
