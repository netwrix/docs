...
![Source group creation wizard step 3 showing scan type selection and cron schedule configuration fields](/images/accessanalyzer/26.1/migration/create-source-group-scan-config.png)
