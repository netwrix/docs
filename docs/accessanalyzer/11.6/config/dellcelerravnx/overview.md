...
[Dell Celerra & Dell VNX Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/11.6/config/dellcelerravnx/access.md)
...
See the
[Dell Celerra & Dell VNX Activity Auditing Configuration](/docs/accessanalyzer/11.6/config/dellcelerravnx/activity.md)
topic for instructions.
