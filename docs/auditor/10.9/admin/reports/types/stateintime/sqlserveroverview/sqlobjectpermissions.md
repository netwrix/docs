...
![objectpermissionssqlserver_thumb_0_0](/images/auditor/10.9/admin/reports/types/stateintime/objectpermissionssqlserver_thumb_0_0.webp)
...
- Clicking a User account link opens the
  [Account Permissions in SQL Server](/docs/auditor/10.9/admin/reports/types/stateintime/sqlserveroverview/sqlaccountpermissions.md) report.
