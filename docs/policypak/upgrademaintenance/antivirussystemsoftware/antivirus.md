---
title: "How must I configure my Anti-virus or system-level software to work with PolicyPak CSE?"
description: "How must I configure my Anti-virus or system-level software to work with PolicyPak CSE?"
sidebar_position: 20
---

# How must I configure my Anti-virus or system-level software to work with PolicyPak CSE?

With some Antivirus and other security engines it is necessary to exclude some Netwrix PolicyPak items.

PolicyPak acts as part of the operating system, and, as such, can occasionally
...
For SOPHOS users who receive: APCViolation exploit prevented in PolicyPak Watcher
Service:
...
![54_1_image](/images/policypak/install/54_1_image.webp)
...
During the installation of the PolicyPak  CSE, you may encounter the following error
message:

![54_2_image-20230330120114-2](/images/policypak/install/54_2_image-20230330120114-2.webp)

To work around this issue please add the following BYPASS policies for PolicyPak as
shown below.

![54_3_image-2](/images/policypak/install/54_3_image-2.webp)

## DEFENDER Customers

During installation or removal of the PolicyPak CSE you may run into this error:

![defendererror](/images/policypak/install/defendererror.webp)

The Windows Application log will also show the following Error:

Product: Netwrix PolicyPak Client-Side Extension -- Error 1721.
There is a problem with this Windows Installer package. A program required for this install to
complete could not be run.

![defendererrorevent](/images/policypak/install/defendererrorevent.webp)
...
![defendereditpolicy](/images/policypak/install/defendereditpolicy.webp)
...
If when installing the PolicyPak Cloud client, you get the experience below:

![netskopeandcloud](/images/policypak/install/netskopeandcloud.webp)
...
These steps above provide a workaround for Netskope + PolicyPak Cloud installation
issues.
