...
- Configuration pane – Displays configured settings for the currently selected criteria in the
  ...
  [Configuration Pane](/docs/accessanalyzer/11.6/accessanalyzer/sensitivedatadiscovery/criteriaeditor/configuration.md)
  topic for additional information.
...
- System Criteria – Lists all pre-configured criteria. For a list of pre-configured System Criteria,
  see the
  [Sensitive Data System Criteria](/docs/accessanalyzer/11.6/accessanalyzer/sensitivedatadiscovery/systemcriteria.md)
  topic for additional information.
