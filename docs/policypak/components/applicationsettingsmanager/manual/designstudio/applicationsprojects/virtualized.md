...
PolicyPak Application Settings Manager supports five application virtualization
...
already using an application virtualization solution, then PolicyPak Application
