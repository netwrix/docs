...
- [MySQL_Configuration Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/mysql/collection/mysql_configuration.md)
...
- [MySQL_SensitiveDataScan Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/mysql/collection/mysql_sensitivedatascan.md)
  – Designed to discover sensitive data in MySQL databases based on pre-defined or user-defined
  search criteria
- [MySQL_TablePrivileges Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/mysql/collection/mysql_tableprivileges.md)
