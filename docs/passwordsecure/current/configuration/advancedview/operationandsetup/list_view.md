...
[Ribbon](/docs/passwordsecure/current/configuration/advancedview/operationandsetup/ribbon.md). A record marked as a favourite is indicated with a star in list view.
...
about both the password quality and the [Tags](/docs/passwordsecure/current/configuration/advancedview/operationandsetup/tags.md) used. Mouseover tooltips provide
...
[Client Module](/docs/passwordsecure/current/configuration/advancedview/clientmodule/client_module.md)
