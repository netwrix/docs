...
[Database Maintenance Window](/docs/threatprevention/8.0/admin/configuration/databasemaintenance/overview.md) are executed
...
See the [Database Components](/docs/threatprevention/8.0/admin/overview.md#database-components) topic for a discussion of
these databases.

**Archive Database Permissions**

If the **Move** option is selected on the
[Archive Data](/docs/threatprevention/8.0/admin/configuration/databasemaintenance/archive.md) tab of the Database
