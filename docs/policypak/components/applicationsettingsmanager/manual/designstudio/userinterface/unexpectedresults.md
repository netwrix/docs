...
Most applications' UIs are captured correctly by PolicyPak DesignStudio; however, not
all are captured perfectly. Let's explore some circumstances where the PolicyPak
...
![crafting_the_user_interface_24](/images/policypak/applicationsettings/designstudio/userinterface/crafting_the_user_interface_24.webp)
...
![crafting_the_user_interface_25](/images/policypak/applicationsettings/designstudio/userinterface/crafting_the_user_interface_25.webp)

The figure shown. Some elements appear underlined when captured.

This means PolicyPak DesignStudio was able to capture the element correctly, but was
unable to acquire PolicyPak AppLock™ data for the item. Therefore, these items cannot
