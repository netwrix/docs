...
1. Create a monitoring plan with the wizard. Select the data source when you start the
...
2. Fine-tune data source settings, if necessary: use the data source properties to modify
data collection settings, customize the monitoring scope, and more.

3. Add items to be monitored. An item is a specific object you want to audit, for example, a
...
4. To view and modify your plans, in the main Auditor window click the **Monitoring Plans**
...
2. Select the required data source and click **Edit data source** on the right to open its
properties.
...
5. In the **Manage Snapshots** window, select the snapshots that you want to import. Use
