...
products:
  - activitymonitor
sidebar_label: "Cannot Add Account Exclusions from Untrusted Domain"
tags: []
title: "Cannot Add Account Exclusions from Untrusted Domain"
---


# Cannot Add Account Exclusions from Untrusted Domain
...
1. Obtain the **Domain2 user SID** from a system that can query Domain2:
   ```powershell
