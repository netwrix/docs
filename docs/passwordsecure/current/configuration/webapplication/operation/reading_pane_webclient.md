...
client. Therefore, Password Secure also refer you here to the corresponding
[Reading pane](/docs/passwordsecure/current/configuration/advancedview/operationandsetup/reading_pane.md) section.
