...
are configured via the [Access Certification](../../../integration-guide/governance/accesscertification) policies.
    - `Target Specificities`:
[AccessCertificationDataFilter](../../../integration-guide/toolkit/xml-configuration/access-certification/accesscertificationdatafilter) defines the campaign scope (e.g., by object type, category, approval state). The campaign uses the union of all specificities.
