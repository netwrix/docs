...
- Port number – Default port number is 8766
    - See
      [Custom Parameters for File System Proxy Service](/docs/accessanalyzer/11.6/accessanalyzer/install/filesystemproxy/wizard.md#custom-parameters-for-file-system-proxy-service)
      topic for additional information.
...
- Mechanism – Select one of the following options:
    ...
    - Manual – The FSSA Data Collector and applet server expect all certificates to be valid and in
      ...
      [FSAA Manual Certificate Configuration](/docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/fsaa/manualcertificate.md)
      topic for additional information.
