...
- [SQL_ControlServer Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/permissions/sql_controlserver.md)
...
- [SQL_DirectPermissions Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/permissions/sql_directpermissions.md)
  – This job will provide information about the permissions granted to users at the schema,
  database, and server levels
- [SQL_DomainUserPermissions Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/permissions/sql_domainuserpermissions.md)
...
- [SQL_ServerPermissions Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/sql/permissions/sql_serverpermissions.md)
