...
What happens if you're using the Netwrix PolicyPak File
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/4lutKddiiHs" title="PolicyPak MDM: File Associations Manager Helper Tool" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak MDM: File Associations Manager Helper Tool

Hi, this is Whitney with PolicyPak Software. In the last video, we learned how to
...
"PolicyPak Client-Side Extension" and the "PolicyPak MDM Licenses for
...
"PolicyPak Bits" folder. We're going to choose "PolicyPak Extras," and
we're going to go look at the "PolicyPak File Associations Manager Helper." Now make
...
"PolicyPak Exporter Tool." In this case, I don't actually want to "Create a new MSI
