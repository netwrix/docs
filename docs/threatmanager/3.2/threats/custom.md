...
- Save a new one. See the
  [New Investigation Page](/docs/threatmanager/3.2/administration/investigations/newinvestigation.md) for additional
  information.
...
[Fine Tune a Threat](/docs/threatmanager/3.2/administration/configuration/threatdetection/threatconfiguration.md) topic for additional
information.
...
See the [Threat Details Page](/docs/threatmanager/3.2/administration/threats/threatdetails/overview.md) topic for additional
information.
