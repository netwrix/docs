---
title: "PolicyPak and Quest (ScriptLogic) ActiveAdministrator"
description: "PolicyPak and Quest (ScriptLogic) ActiveAdministrator"
sidebar_position: 50
---

# PolicyPak and Quest (ScriptLogic) ActiveAdministrator

ActiveAdministrator by ScriptLogic is a great tool for managing your GPOs. The good news is, Netwrix PolicyPak is fully compatible with ActiveAdministrator, and works
right alongside it. Check out this video see how it all fits together!

<iframe width="560" height="315" src="https://www.youtube.com/embed/F3AsAgu2wDs" title="PolicyPak and Quest ActiveAdministrator" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
