...
On this page, you can view the current port settings and restrictions on the TLS (Transport Layer Security) version used when using an encrypted connection.

1. In the Netwrix Auditor main window, navigate to the **Integration** tile.
2. Make sure the **Leverage Integration API** option is enabled.
