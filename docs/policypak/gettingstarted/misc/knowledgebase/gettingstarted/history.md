---
title: "How has PolicyPak Evolved over the years?"
description: "How has PolicyPak Evolved over the years?"
sidebar_position: 30
---

# How has PolicyPak Evolved over the years?

Every year Netwrix PolicyPak continues to add new features for
customers. Here is a list of new functions and milestones along with their release years.

Before 2017

- PolicyPak Application Settings Manager: Manage 500+ applications and keep them
  secure
- PolicyPak Browser Router: Open the right browser for the right website
- PolicyPak Java Rules Manager: Map the right version of Java for the right website
...
- New Component: New PolicyPak Start Screen & Taskbar Manager: Manage Windows 10 tile
  layouts perfectly.

2018

- New Component: PolicyPak Scripts Manager: Perform any function via BAT, .JS or
  PowerShell
...
- Least Privilege Manager Block PowerShell Malware
  attacks:[Block PowerShell in General, Open up for specific items](/docs/policypak/components/leastprivilegemanager/videolearningcenter/bestpractices/powershellblock.md)
- New Component — PolicyPak Feature Manager for Windows. Quickly add / remove features
  from Windows 10 & Windows Server.

2020

- New Component — PolicyPak RDP Manager: Enable remote work users to have .RDP files
  to connect to your resources.
- Browser Router - New Edge Support / IE In Edge Mode
  [Manage Internet Explorer 11 and Edge Compatibility, Enterprise Modes and IE-in-Edge Mode](/docs/policypak/components/browserrouter/videolearningcenter/gettingstarted/ie.md)
...
- File Associations Manager Apply Once then Drift
  [PolicyPak File Associations Manager: Apply once (and drift)](/docs/policypak/components/fileassociationsmanager/videolearningcenter/gettingstarted/applyonce.md)
- File Associations Manager Apply settings on USER side
- Added Triggers to PolicyPak Scripts & Triggers: Run a script at VPN launch or many
  other events
...
- New Component: PolicyPak VPN Manager: Enable remote work users to have Always On and
  standard VPN connections.
- CSE and MMC are now Multi-Domain compatible
- Updated licensing where Professional and Enterprise customers can use PolicyPak with
  Active Directory, with SCCM, with MDM and/or PolicyPak Cloud
...
- ARM Client Support
- New Component: PolicyPak Shortcuts
...
- MMC: PolicyPak and Netwrix Auditor Integration
- MMC: Reporting History of PolicyPak items
- PolicyPak and Netwrix Privilege Secure: UI Updates, Lite licenses for Netwrix
  Privilege Secure customers and Netwrix Privilege Secure to PolicyPak upgrade path
...
- PolicyPak CSE Process Exclusions to actively exclude entanglement in other systems
