...
- Asked by Netwrix PolicyPak Tech support to troubleshoot when
...
![358_1_image004](/images/policypak/troubleshooting/128_4_image002.webp)

## Way #2 use when:

- Exporting to be used with PPExporter (then on to SCCM, Intune, etc.)
- Exporting to be used with PolicyPak Cloud.

![358_2_image0022](/images/policypak/troubleshooting/applicationsettings/export/358_2_image0022.webp)
