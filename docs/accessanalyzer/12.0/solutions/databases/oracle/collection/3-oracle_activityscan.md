...
Audit Events Collection category in the SQL Data Collector. To customize
...
**Step 2 –** In the Query Selection view, select the ActivityScan query and click Query
