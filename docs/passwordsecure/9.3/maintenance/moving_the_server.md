...
[MSSQL Server](/docs/passwordsecure/9.3/installation/requirements/mssql_server.md) for this process.

#### 2. Installing the server

The Netwrix Password Secure application server is installed next (see
[Application server](/docs/passwordsecure/9.3/installation/requirements/application_server.md)). The installation itself
is described under
