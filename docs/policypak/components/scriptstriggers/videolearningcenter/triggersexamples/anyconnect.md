---
title: "PolicyPak Scripts and AnyConnect: Run a script after you connect via VPN"
description: "PolicyPak Scripts and AnyConnect: Run a script after you connect via VPN"
sidebar_position: 60
---
# PolicyPak Scripts and AnyConnect: Run a script after you connect via VPN
...
VPN connection. This is part of Netwrix PolicyPak Scripts and
...
over to group policy land. You can do this in PolicyPak Group Policy, you can do this
PolicyPak MDM, you can do this in PolicyPak Cloud. It doesn't matter.
What we'll do here is we'll get started in the VPN editor here – I'm sorry – in the PolicyPak Scripts Manager here, and what we'll do is we'll right click Add a New Policy here. What
...
you've got it all set, bring it in to PolicyPak Scripts with the Trigger function, and
you can have a nice on script and a nice off script, and you are off to the races with PolicyPak and Cisco AnyConnect. Hope this video helps you out. Looking forward to getting you
started with PolicyPak real soon.
