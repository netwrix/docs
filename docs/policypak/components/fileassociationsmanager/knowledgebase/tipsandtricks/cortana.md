...
automatically and not the default system browser you set through Netwrix PolicyPak software.

How to solve it?

You will need to install EdgeDeflector before you can send search queries from Cortana to the
default browser, set through PolicyPak software. More
info: [What is meant by "Default Browser" within PolicyPak Browser router?](/docs/policypak/components/browserrouter/knowledgebase/tipsandtricks/defined.md)

Then set the Policy for PPFAM as shown in the following screenshot:

![730_1_ddfgdsfgfg](/images/policypak/troubleshooting/fileassociations/730_1_ddfgdsfgfg.webp)
