...
**Netwrix_Auditor_Alerts_to_Event_Log_Add-on.ps1**. See the [SIEM](/docs/auditor/10.9/addon/siem/overview.md) topic for additional
information.

## Export Activity Records in Bulk

Netwrix recommends exporting the most important data using the script described in the previous section.
However, if you need to export all Activity Records in bulk, follow these recommendations.
...
while. Ensure the script execution completed successfully. The script creates the Netwrix Auditor
...
_"Overwrite events as needed"_. See the [Integration Event Log Fields](/docs/auditor/10.9/addon/siem/integrationeventlog.md) topic
for additional information.

The script trims event records with more than 30,000 characters.
