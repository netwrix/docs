...
![Schedule node](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/schedule.webp)
...
![serviceaccounttypes](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/serviceaccounttypes.webp)
...
![Add User credential option in the Schedule view](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/addusercredential.webp)

**Step 1 –** Click **Add User credential** at the top of the Schedule view. The User Credentials
window opens.

![User Credentials window](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/usercredentialswindow.webp)
...
- Active Directory Account – Use this option to specify a domain account
    ...
    - Password Storage – Choose the option for credential password storage:
        ...
        - Managed Service Account – Use previously configured MSA and gMSAs for authentication. The
          ...
          [Group Managed Service Accounts (gMSA) Configuration](/docs/accessanalyzer/11.6/accessanalyzer/admin/settings/connection/gmsa.md)
          topic for additional information.
...
- Passwords Do Not Match Error
    ...
    ![Passwords Do Not Match Error](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/passwordsdontmatch.webp)
...
- Bad User Name or Password Error
    ...
    ![Bad User Name or Password Error](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/incorrectlogondetails.webp)
...
- Insufficient Rights Error
    ...
    ![Insufficient Rights Error](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/insufficientrights.webp)
...
- GPO Network Security Error
    ...
    ![GPO Network Security Error](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/gponetworksecurity.webp)
...
![Edit option in the Schedule view](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/edit.webp)
...
![Delete Credentials confirmation window](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/deletecredentials.webp)
