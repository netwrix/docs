...
![Concurrent Logins Analytic Type - Settings tab](/images/threatprevention/8.1/admin/analytics/concurrentloginssettings.webp)

Set the Number of Hosts and the Interval Duration that triggers the incident. The interval
duration uses (Hours:Minutes) and is capped at 23:59. When the specified number of hosts have
successful logins by the same individual user account within the specified interval duration,
Threat Prevention triggers an incident record.
...
![Concurrent Logins Analytic Type - Policy tab](/images/threatprevention/8.1/admin/analytics/policytab.webp)
...
![Concurrent Logins Analytic Type window](/images/threatprevention/8.1/admin/analytics/concurrentlogins.webp)
...
- Attacking Account SID – Security Identifier of the account used in the incident-triggering event
