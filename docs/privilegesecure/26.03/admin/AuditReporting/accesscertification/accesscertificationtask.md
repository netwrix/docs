...
![addtask](/images/privilegesecure/26.03/accessmanagement/admin/auditreporting/add/addtask.webp)
...
assigned as reviewer. See the [Role Management Page](/docs/privilegesecure/26.03/admin/usersgroups/rolemanagement/rolemanagement.md) topic
...
[Add Users to Review](/docs/privilegesecure/26.03/admin/AuditReporting/accesscertification/users.md#add-users-to-review) section.
