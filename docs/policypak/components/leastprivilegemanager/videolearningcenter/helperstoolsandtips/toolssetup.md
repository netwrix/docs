---
title: "PolicyPak Least Priv Manager Tools Setup"
description: "PolicyPak Least Priv Manager Tools Setup"
sidebar_position: 20
---
...
Netwrix PolicyPak Least Privilege Manager tools using
...
In the preconfigured downloads of PolicyPak we have the XMLs, so when you download
everything in PolicyPak land, you'll find the Least Privilege Manager XMLs. We've got
...
do PPLPM Helper Tools Elevate. Right click here and click Edit. We'll go to user side, PolicyPak. Again, you can do this on the computer side as well, but I'm going to just do it on
...
get those tools enlightened. The second part is if you want to configure this tool, the PolicyPak Programs – the Remove Programs Tool to show only specific publishers or only specific
...
eye on that. What we'll do is we've got an ADMX setting, so you'll have to copy in the PolicyPak ADMX settings, and then you'll go to user side or computer side, Policies, Admin
Templates, and then you're looking for the PolicyPak ADMX settings, and you're looking
