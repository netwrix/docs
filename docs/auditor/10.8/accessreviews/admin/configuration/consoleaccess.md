...
- Access is enabled – A user's account must be enabled to log into the console. Uncheck
  this option to configure access to be granted at a future time.
...
**Step 2 –** Modify the settings as needed and click **Finish**:
...
The Builtin Administrator account can be disabled or its password can be changed. To modify this account:
