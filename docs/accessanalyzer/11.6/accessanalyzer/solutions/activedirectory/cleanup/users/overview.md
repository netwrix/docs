...
- [AD_DeprovisionUsers Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/cleanup/users/ad_deprovisionusers.md)
  – Provides a simple and automated workflow to deprovisions stale and unused user accounts
- [AD_DeprovisionUsers_Status Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/cleanup/users/ad_deprovisionusers_status.md)
...
- For the AD_DeprovisionUsers Job, the target OU needs to be manually set in the Move Users Action
  ...
  [Action Tasks for the AD_DeprovisionUsers Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/activedirectory/cleanup/users/ad_deprovisionusers.md#action-tasks-for-the-ad_deprovisionusers-job)
