...
requires the specified port to be open. By installing PolicyPak GPCR Server, Port
50022 is automatically opened if the firewall is also on the server, as shown in Figure 50.

![gpcr_server_with_push_mode_14](/images/policypak/grouppolicycompliancereporter/mode/push/setup/gpcr_server_with_push_mode_14.webp)
