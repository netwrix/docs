...
![Sessions Tab Entra ID](/images/privilegesecure/25.12/accessmanagement/admin/policy/tab/resources/sessionsazuread.webp)
...
- Activity — Displays the name of the activity. See the [Activities Page](/docs/privilegesecure/25.12/admin/interface/activities/activities.md)
