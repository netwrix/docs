...
![New Mailbox Action Wizard Folder Conditions page](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/ewsmailbox/filterwizard/folderconditions.webp)
...
![Folder Type Window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/datacollector/ewsmailbox/filterwizard/foldertypewindow.webp)
...
![Folder Inclusion/Exclusion Window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/action/mailbox/folderinclusionexclusionwindow.webp)

Include/Exclude folders using the following options:

- Click **Add** to populate a field to add a folder path

    ![New field added on Folder Inclusion/Exclusion window](/img/product_docs/accessanalyzer/11.6/accessanalyzer/admin/action/mailbox/folderinclusionexclusionwindownew.webp)
