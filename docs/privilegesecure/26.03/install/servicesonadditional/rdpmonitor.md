...
The Netwrix Privilege Secure Remote Desktop Monitor service must be installed on the target host
...
within the [Live Session Viewer Window](/docs/privilegesecure/26.03/admin/dashboard/active/liveviewer.md) and the
[Replay Viewer Window](/docs/privilegesecure/26.03/admin/dashboard/historical/replayviewer.md) with keystroke details, which are
...
[Connection Profiles Page](/docs/privilegesecure/26.03/admin/accesspolicy/connectionprofiles/connectionprofiles.md) topic for additional
information.
