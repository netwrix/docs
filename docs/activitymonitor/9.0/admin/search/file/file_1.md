...
![File Search Results UI](/images/activitymonitor/9.0/admin/search/results/filesearchresults.webp)
...
![Search Results with Permissions listed in the Operations Column](/images/activitymonitor/9.0/admin/search/results/filesearchresultspermissionsimage.webp)
...
![File Search Results Permissions link popup window](/images/activitymonitor/9.0/admin/search/results/permissionslpopupwindow.webp)
