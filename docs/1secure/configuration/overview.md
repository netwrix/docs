...
include enabling certain built-in Windows services. Proper audit configuration is required to
...
- Automatically when creating a monitoring plan. This is the recommended method.
- Manually.
