---
title: "PolicyPak + FSLogix: Setting browser configuration based upon which browser you actually have."
description: "PolicyPak + FSLogix: Setting browser configuration based upon which browser you actually have."
sidebar_position: 60
---

# PolicyPak + FSLogix: Setting browser configuration based upon which browser you actually have.

FSLogix can hide/reveal applications, like browsers. Netwrix PolicyPak can actually SET the settings, like homepage and security settings INSIDE your browsers
and KEEP them secure. See how PolicyPak + FSLogix can work together.

<iframe width="560" height="315" src="https://www.youtube.com/embed/cgOtzgvnSlc" title="PolicyPak + FSLogix: Setting browser configuration based upon which browser you actually have." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
