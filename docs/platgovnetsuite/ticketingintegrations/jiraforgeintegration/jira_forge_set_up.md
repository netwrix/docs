...
![Jira Forge Bundle Search](/images/platgovnetsuite/integrations/jira_forge_jira_bunle_search.webp)
...
7. Click **Review**
8. You are now in the last step where you can review the app's Permissions and Data management. All of these have been stricly reviewed by the Atlassian team and adhere to their security policies. When ready, click **Get it now** button.
...
2. In this step, you should have the following credetials on hand
...
1. In Netsuite, go to Netwrix Configration and Stats by navigating in the main menu, **Netwrix > Netwrix Support > Installation Settings**. There should only be **ONE(1)** record displayed. Click 'Edit' and it should open the Configuration and Stats page.
