...
The **Update** button in the Resource Owners interface opens the Update resource wizard.
...
- Add new owners — Click **Add** to browse for a new owner. See the
  [Add Owner Window](/docs/auditor/10.9/accessreviews/resourceowners/interface/addowner.md) topic for additional information.
...
These updates to ownership configuration have been processed.
