...
The Netwrix PolicyPak Cloud Policy Editor allows you to create
and edit your own policies inside PolicyPak Cloud without having to pre-create, then
upload them.
...
Q:Why don't you have editors for all the other types: GPPrefs, Security, and PolicyPak
Settings?
