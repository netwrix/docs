...
this utility to automatically update your GPOs with Netwrix PolicyPak data to the latest versions. It installs alongside DesignStudio.

<iframe width="560" height="315" src="https://www.youtube.com/embed/ggYBVfzniro" title="PolicyPak GPO Touch Utility" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
