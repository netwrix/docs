---
title: "How can I \"stack\" PolicyPak MSIs so the XML items inside the MSI execute in a predictable order?"
description: "How can I \"stack\" PolicyPak MSIs so the XML items inside the MSI execute in a predictable order?"
sidebar_position: 10
---

# How can I "stack" PolicyPak MSIs so the XML items inside the MSI execute in a predictable order?

You use Netwrix PolicyPak Exporter tool to wrap up XMLs into an
MSI.
...
![749_1_1111_691x581](/images/policypak/mdm/749_1_1111_691x581.webp)
...
![749_2_222](/images/policypak/mdm/749_2_222.webp)
...
![749_3_image009_950x433](/images/policypak/mdm/749_3_image009_950x433.webp)
