...
## Upgrade PostgreSQL
 ...
 upgrade from PostgreSQL 14.8.x to 14.13.x.
...
**Step 2 –** Click **PostgreSQL Setup** to upgrade the PostgreSQL version. The following message appears, indicating the installed version:
...
your machine, exclude all files in the following directories from antivirus scans:
:::
