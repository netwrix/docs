...
![Policy window - AD Replication Monitoring Event Type](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adreplicationmonitoring.webp)
