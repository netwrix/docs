...
- Entering login data in Windows applications: Alongside the previously mentioned RDP and SSH sessions,
  other Windows applications can also be automated
  (![2](/images/passwordsecure/9.2/configuration/autofill_add-on/2.webp)).
  A major difference is that the two previously mentioned connections are set up and “embedded” in a
