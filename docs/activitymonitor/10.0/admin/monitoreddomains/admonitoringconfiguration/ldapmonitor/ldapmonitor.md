...
The LDAP Monitor tab on a domain’s Configuration window lets you scope monitoring by adding
...
Double-click the text box beneath Value to enter a string. Press the Enter or Tab key to
