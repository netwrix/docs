...
To create a monitoring plan to audit inactive users, complete the following steps:
...
| Option                                                    | Description                                                                                                                                                                                                                                                                                   |
| --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Use Netwrix Auditor notification settings                 | Select this option if you want to use modern authentication. Modern authentication must already be configured in the monitoring plan you are going to use. If you select this option, the fields below aren't needed.                                                       |
...
To review the report on inactive users, complete the following steps:
...
To exclude data from the Inactive Users monitoring scope, complete the following steps:
