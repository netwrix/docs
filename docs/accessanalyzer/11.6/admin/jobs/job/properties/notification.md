...
specific list of recipients for email notifications generated by this job. You can input multiple
email addresses by adding a semicolon (;) and space between entries. This is specific to
Notification analysis module tasks.
