---
title: "PolicyPak File Associations: Don't ask questions (even when you did it right)"
description: "PolicyPak File Associations: Don't ask questions (even when you did it right)"
sidebar_position: 80
---
# PolicyPak File Associations: Don't ask questions (even when you did it right)

How do I get Windows 10 to stop asking me to open PDFs in Microsoft Edge? When you use PolicyPak File Associations Manager, you might have done "everything right" but even then, it
still doesn't work as expected. See this video for a universal fix.

<iframe width="560" height="315" src="https://www.youtube.com/embed/cMioz4JQPYI" title="PolicyPak File Associations: Don't ask questions (even when you did it right)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
