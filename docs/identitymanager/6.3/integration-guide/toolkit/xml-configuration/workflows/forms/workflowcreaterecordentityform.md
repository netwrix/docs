...
description: "Displays a form to create a new resource with a record."
sidebar_position: 4
---
...
![Form Example - New User from HR](/images/identitymanager/formexample_workflowcreaterecordentityform_v603.webp)

The contents of `MainSummaryControl` and `RecordSummaryControl` are visible after the workflow's execution.
<!-- TODO:Seems like it doesn't appear in the UI. Once fixed, add a screenshot. -->
