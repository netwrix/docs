...
1. You create alerts on threat patterns specific to your company. You include these alerts in
   ...
   [Risk Score](/docs/auditor/10.9/admin/alertsettings/create/create.md)how to set a risk score for an alert.
...
4. To learn more about user activity, you can drill-down to a user profile to review all alerts
   ...
   reduces. [Review User Profiles and Process Anomalies](/docs/auditor/10.9/admin/behavioranomalies/userprofile.md)
