...
In the main menu in [Extras](/docs/passwordsecure/current/configuration/advancedview/mainmenufc/extras/extras.md) you can find the image management. Here, you have the
