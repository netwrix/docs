...
How to apply custom default application associations to Windows 10 using Netwrix PolicyPak Scripts Manager.
...
Hi, this is David in PolicyPak tech support. In this video I'm going to show you how
to apply custom default application file associations using PolicyPak Scripts Manager.
