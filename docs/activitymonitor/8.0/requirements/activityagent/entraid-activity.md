...
The following settings are needed from your tenant after you have registered the application:
...
To register Activity Monitor with Microsoft Entra ID, complete these steps:
...
To set up permissions that enable the Activity Monitor to monitor data and collect
logs from Microsoft Entra ID, complete these steps:
...
To find the registered application's Client ID, complete these steps:
...
You can copy the Tenant ID from the same page where you just copied the Client ID. To copy the Tenant ID from the registered application Overview blade, complete these steps:
...
To find the tenant name where the registered application resides, complete these steps:
...
To find the registered application's Client Secret, create a new key, and save its
value when saving the new key, complete these steps:
