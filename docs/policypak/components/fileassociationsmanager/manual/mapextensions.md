...
:::note
For some video overviews of PolicyPak File Associations Manager, see the
[PolicyPak Cloud: Managing File Assocations](/docs/policypak/components/fileassociationsmanager/videolearningcenter/methods/cloud.md) topic
...
Using PolicyPak File Associations Manager, we want to make the following maps:
...
![about_policypak_file_associations_11](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_11.webp)

**Step 3 –** The PolicyPak File Associations Manager policy editor displays, showing
...
![about_policypak_file_associations_12](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_12.webp)

**Step 5 –** When you click **OK** to save the policy, the entry looks like this:

![about_policypak_file_associations_13](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_13.webp)
...
![about_policypak_file_associations_14](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_14.webp)

You now have two entries, one for PDF and one for MAILTO:

![about_policypak_file_associations_15](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_15.webp)
...
![about_policypak_file_associations_16](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_16.webp)

Now, you'll have a new entry.

![about_policypak_file_associations_17](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_17.webp)

Make sure the endpoint has the same programs installed as the management station and also has the
PolicyPak CSE installed.
...
![about_policypak_file_associations_18](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_18.webp)
...
![about_policypak_file_associations_19](/images/policypak/fileassociations/about_endpointpolicymanager_file_associations_19.webp)
