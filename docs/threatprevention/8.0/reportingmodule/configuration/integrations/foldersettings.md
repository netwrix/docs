...
![Integrations interface on the Folder Settings page](/images/threatprevention/8.0/reportingmodule/configuration/integrations/page_4.webp)
...
![Shared Folder table on the Folders Settings page](/images/threatprevention/8.0/reportingmodule/configuration/integrations/sharedfoldertable.webp)
...
![Shared Folder table on the Folders Settings page showing additional options](/images/threatprevention/8.0/reportingmodule/configuration/integrations/additionaloptions.webp)
...
![Local Folder settings on the Folder Settings page](/images/threatprevention/8.0/reportingmodule/configuration/integrations/localfolder.webp)
...
access to the shared folder. See the [Credential Profile Page](/docs/threatprevention/8.0/reportingmodule/configuration/integrations/credentialprofile.md) topic for
creating a profile.
:::
...
![Add New Shared Folder window](/images/threatprevention/8.0/reportingmodule/configuration/integrations/addnewsharedfolderwindow.webp)
...
- Access – Allow specific users to access the folder when configuring subscriptions in the
  ...
  dropdown menu. Only users granted application access through the System Settings > User Access
  page will be available in the dropdown.
