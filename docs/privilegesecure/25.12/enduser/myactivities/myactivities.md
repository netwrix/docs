...
![My Activiy Dashboard for End User](/images/privilegesecure/25.12/accessmanagement/enduser/access/myactivityuser.webp)
...
[Create Activity Session](/docs/privilegesecure/25.12/enduser/dashboard/active/createsession.md) topic for additional information.
