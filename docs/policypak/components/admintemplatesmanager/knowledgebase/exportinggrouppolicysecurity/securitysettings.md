...
![617_1_ppsec-kb-01-img-01](/images/policypak/troubleshooting/gpoexport/617_1_ppsec-kb-01-img-01.webp)

If you are working with your local group policy editor, and then you try to export your settings
using Netwrix PolicyPak Security Settings Manager, you're going
to get this error message:

![617_2_ppsec-kb-01-img-02](/images/policypak/troubleshooting/gpoexport/617_2_ppsec-kb-01-img-02.webp)

Instead, manage your Windows security settings using the GPMC within a domain-based GPO as seen
here:

![617_3_ppsec-kb-01-img-03](/images/policypak/troubleshooting/gpoexport/617_3_ppsec-kb-01-img-03.webp)

Then use PolicyPak Security Settings Manager to export your settings as XML for use
with the cloud or MDM service, as seen here.

![617_4_ppsec-kb-01-img-04](/images/policypak/troubleshooting/gpoexport/617_4_ppsec-kb-01-img-04.webp)
