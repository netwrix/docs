...
must be met. See the [Qumulo Activity Auditing Configuration](/docs/activitymonitor/10.0/requirements/activityagent/nas-device-configuration/qumulo-activity.md)
...
To add a Qumulo host to be monitored:
...
The added Qumulo host is displayed in the monitored hosts/services table. After a host has been added for
...
- [Qumulo Tab](/docs/activitymonitor/10.0/admin/monitoredhosts/properties/qumulo.md)
