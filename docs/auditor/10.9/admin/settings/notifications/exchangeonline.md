...
directory only**. The redirect URI is optional; Netwrix Auditor doesn't use it.
...
immediately — you can't view it again after you leave the page.
...
that aren't interchangeable with the commercial cloud.
...
`*.cn` endpoints — you must register the application in the corresponding Microsoft Entra
...
**Step 5 –** Choose whether joining the group requires owner approval, then click **Next**.
...
**Step 2 –** Open the group you created and add the mailboxes the application can send from —
these should include the **Sender address** you configured in Netwrix Auditor.
...
**Step 3 –** Create the access policy, scoping the application to the group you created:
