...
[Credentials Page](/docs/privilegesecure/25.12/admin/interface/credentials/credentials.md).

![Add Credentials Window](/images/privilegesecure/25.12/accessmanagement/admin/policy/add/addcredentials.webp)
...
for that platform type. See the [Platforms Page](/docs/privilegesecure/25.12/admin/interface/platforms/overview.md) topic for
...
Secure. See the [Service Accounts Page](/docs/privilegesecure/25.12/admin/configuration/serviceaccounts/serviceaccounts.md)
...
[Manage Internal Service Accounts](/docs/privilegesecure/25.12/admin/interface/credentials/manageinternalserviceaccount.md) topic for additional
information.
