...
![scenario_reports_1](/images/auditor/10.9/admin/navigation/scenario_reports_1.webp)
...
[Use Filters in Simple Mode](/docs/auditor/10.9/admin/search/filtersimple.md) topic for additional information.
...
[IT Risk Assessment Overview ](/docs/auditor/10.9/admin/riskassessment/overview.md) topic for additional information.
...
3. Search the group of risks you want to pin to the home page (in this case, the "_Permissions_"
   risks group):
    ...
    ![scenario_risks_thumb_0_0](/images/auditor/10.9/admin/navigation/scenario_risks_thumb_0_0.webp)
