...
![Analysis Tasks for the LocalUserActivity Job](/img/product_docs/accessanalyzer/11.6/solutions/filesystem/activity/security/localuseractivityanalysis.webp)
