...
Want more details about what processes users are attempting to launch? Then use Netwrix PolicyPak's Email / Long codes function. Users send emails. Admins
approve. UAC prompts are overcome. Poof. Easy.

<iframe width="560" height="315" src="https://www.youtube.com/embed/s6qzARZnVGQ" title="Least Privilege Manager Admin Approval: Using Email / Long Codes" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Hi, this is Jeremy Moskowitz and in this video, I'm going to show you how you can use email to
authorize items using PolicyPak Least Privilege Manager. In a previous video, I set up
...
application name and has the request code here. You can see subject PolicyPak admin
...
PolicyPak admin approval tool here; so there's the admin approval tool, which again I
...
started real soon with PolicyPak. Thanks.
