...
For more information about SQL server-level roles, see the [Microsoft SQL Server-level roles documentation](https://docs.microsoft.com/en-us/sql/relational-databases/security/authentication-access/server-level-roles?view=sql-server-ver15).
...
![sqlserverlevelroles](/images/auditor/10.8/admin/reports/types/stateintime/sqlserverlevelroles.webp)
