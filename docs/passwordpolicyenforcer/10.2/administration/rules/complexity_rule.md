...
Select the **Enabled** checkbox to enable the Complexity rule.

Choose the number of required character sets from the dropdown list. Password Policy Enforcer rejects passwords that don't contain characters from at least the specified number of character sets.
