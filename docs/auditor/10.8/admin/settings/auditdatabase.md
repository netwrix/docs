...
## Review and update global Audit Database settings
...
| Database retention                     | Configure retention if you want audit data to be deleted automatically from your Audit Database after a certain period of time. These settings can't be modified for a certain plan. |
| SQL Server Reporting Services settings | Define the Report Server URL and account used to upload data to Report Server. These settings can't be modified for a certain plan.                                                  |
