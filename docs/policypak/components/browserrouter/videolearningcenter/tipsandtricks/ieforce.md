...
Hi. This is Jeremy Moskowitz. In this video, I'm going to show you how you can us Netwrix PolicyPak Browser Router to force all websites to go to a particular
...
weird thing, that's fine. Like in this example, I have PolicyPak going to Chrome
...
The second thing is in "PolicyPak Application Settings Manager" here now. Here I
...
That part is really important, and that's happening through PolicyPak Application
...
say you decide you want to go over to PolicyPak. It's just an exception that we set.
...
That's it. I hope this helps you out and you're ready to get started with PolicyPak.  
Take care.
