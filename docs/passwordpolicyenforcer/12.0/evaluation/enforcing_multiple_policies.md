...
![Return to the dashboard](/images/passwordpolicyenforcer/11.2/evaluation/evaldashboard.webp)
...
![Enter Admins Policy](/images/passwordpolicyenforcer/11.2/evaluation/evalcopypolicy2.webp)

**Step 3 –** Click **Make copy**.

**Step 4 –** Open the **Users & Groups** tab.

![Open the Users & Groups tab](/images/passwordpolicyenforcer/11.2/evaluation/evalusergroups.webp)
...
![Set the length to 9](/images/passwordpolicyenforcer/11.2/evaluation/evallength9.webp)
...
:::note
The [Set Priorities](/docs/passwordpolicyenforcer/12.0/admin/manage-policies/manage_policies.md#set-policy-priorities) topic contains
