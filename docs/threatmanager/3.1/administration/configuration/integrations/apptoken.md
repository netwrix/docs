...
**Step 2 –** In the Type dropdown, select **App Token**.
...
of the page displays the app token name and the description. These can be modified by clicking the name or description and entering new values.
...
**Step 2 –** Paste the app token into the target field.
