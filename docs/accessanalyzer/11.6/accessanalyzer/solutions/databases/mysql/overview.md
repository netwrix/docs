...
- [0.Collection Job Group](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/mysql/collection/overview.md)
  ...
  reports.
- [Configuration > MySQL_DatabaseSizing Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/mysql/mysql_databasesizing.md)
  – Designed to provide insight into MySQL server configuration settings
- [MySQL_SensitiveData Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/databases/mysql/sensitivedata/mysql_sensitivedata.md)
