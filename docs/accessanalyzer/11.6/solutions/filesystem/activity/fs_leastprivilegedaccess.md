...
![Least Privileged Access > FS_LeastPrivilegedAccess Job in the Jobs Tree](/img/product_docs/accessanalyzer/11.6/solutions/filesystem/activity/leastprivilegedaccessjobstree.webp)
