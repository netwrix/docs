...
type of machine, the settings will be delivered to the target machine, but the underlying PolicyPak AppLock™ codes will be different. For instance, if you capture WinZip's UI on
...
With that in mind, PolicyPak DesignStudio has a function called the "PXML Merge
...
- Updating your existing AppSet with PolicyPak AppLock™ codes from another operating
  system
...
- Updating your existing AppSet with any new elements from an updated application and bringing in
  any new PolicyPak AppLock™ codes

You can use the PXML Merge Wizard in one of two ways (See the figure here):

- You can first run the PolicyPak Capture Wizard on the new operating system (or
  updated application) and create a new pXML file and save it. You only need to re-capture the tabs.
  Remember, you just need the PolicyPak AppLock™ codes from the application, and you
...
![using_designstudio_tools_13](/images/policypak/applicationsettings/designstudio/tools/using_designstudio_tools_13.webp)
...
running on this machine or if you choose to capture the application while running PolicyPak DesignStudio on another operating system. You'll want to choose "Merge with an existing pXML
file" if you've already used PolicyPak DesignStudio to capture all the tabs from your
application and you have the pXML file handy. These two ways to perform the task are functionally
equivalent. So, in this example, we have PolicyPak DesignStudio running on Windows XP
and capturing all the same items as the original project.

:::note
[Troubleshooting](/docs/policypak/components/applicationsettingsmanager/manual/applicationsettings/overview.md), it was
...
![using_designstudio_tools_14](/images/policypak/applicationsettings/designstudio/tools/using_designstudio_tools_14.webp)
...
![using_designstudio_tools_15](/images/policypak/applicationsettings/designstudio/tools/using_designstudio_tools_15.webp)
