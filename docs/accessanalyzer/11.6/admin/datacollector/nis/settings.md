...
Use the NIS Settings page to configure the NIS domain and a NIS server for testing. It is a
...
- (Optional) Sample NIS Server – Enter the host name or IP address of a NIS server for this
