...
- From [Create a New Monitoring Plan](/docs/auditor/10.9/admin/monitoringplans/create.md) for Active Directory data
  source.
- From the [Active Directory](/docs/auditor/10.9/admin/monitoringplans/activedirectory/overview.md) within the plan.
- From the [Logon Activity](/docs/auditor/10.9/admin/monitoringplans/logonactivity/overview.md) source properties.
...
![audit_cfg_assist_creds](/images/auditor/10.9/tools/audit_cfg_assist_creds.webp)
