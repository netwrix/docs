...
- **Audit log retention (days)** and **Audit log export row limit** — Control how long audit log entries are kept and how many rows a single export can contain. See [Audit Log](enterpriseauditlog.md) for what the audit log tracks and how it's structured.
