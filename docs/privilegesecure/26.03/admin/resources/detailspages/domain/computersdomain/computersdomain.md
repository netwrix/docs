...
![Domain Resource Computers Tab](/images/privilegesecure/26.03/accessmanagement/admin/policy/tab/resources/computersdomain.webp)
...
resource. See
[Enroll Hosts in Management Window](/docs/privilegesecure/26.03/admin/resources/detailspages/domain/computersdomain/enrollhostsinmanagement.md) for
