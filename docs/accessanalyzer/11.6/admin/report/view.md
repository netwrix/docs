...
You can view reports either in the Enterprise Auditor Console in the Results Node of the related
job, or view published reports in the Web Console.
...
Each job contains a results node where you can view reports generated by that job. Even if the
...
From within the Web Console, you can't edit or delete reports. However, the interactive grid
