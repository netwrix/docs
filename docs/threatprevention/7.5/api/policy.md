...
created. If a new policy was created, capture the Policy ID and Policy GUID
assigned by Threat Prevention to later access that policy.

:::tip
Remember, the Policy ID and Policy GUID aren't the same as those in the source XML file. Use the
