...
[Basic configuration](/docs/passwordsecure/current/configuration/servermanger/basic_configuration.md) in the AdminConsole. The
...
[Basic configuration](/docs/passwordsecure/current/configuration/servermanger/basic_configuration.md). Please note that a server
