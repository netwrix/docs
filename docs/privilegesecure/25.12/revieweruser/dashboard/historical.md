...
![Historical Dashboard](/images/privilegesecure/25.12/accessmanagement/revieweruser/dashboard/reviwerhistoricaldashboard.webp)
...
- Actions — Contains icons for available actions:
    ...
    - View logs icon — Opens the Session Logs window to view the action log for the selected
      session. See the [Session Logs Window](/docs/privilegesecure/25.12/revieweruser/dashboard/active/startsession/sessionlogs.md) topic for additional
      information.
