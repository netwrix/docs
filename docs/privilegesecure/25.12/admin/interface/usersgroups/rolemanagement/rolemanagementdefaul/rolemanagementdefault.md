...
- Add User — The Add options change based on the selected role:
    ...
    - Administrator — Opens the Add Administrators window. See the
      [Add Administrators Window](/docs/privilegesecure/25.12/admin/interface/usersgroups/rolemanagement/rolemanagementdefaul/addadministrators.md) topic for
    ...
    - Reviewers — Opens the Add Reviewers window. See the
      [Add Reviewers Window](/docs/privilegesecure/25.12/admin/interface/usersgroups/rolemanagement/rolemanagementdefaul/addreviewers.md) topic for additional
      information.
