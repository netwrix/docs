...
Netwrix File Activity Monitor App for Splunk contains several predefined dashboards: File
Activity (Overview), Ransomware, Permission Changes, and Deletions.

![file_activity_monitor_app](/images/activitymonitor/9.0/siem/splunk/file_activity_monitor_app.webp)
