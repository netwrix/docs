...
The PolicyPak Mac Policy Candidates Admin tool allows admins to analyze applications,
...
- Test XML files before uploading them to PolicyPak Cloud
- Search for applications on a Mac hard drive
- Use PolicyPak Log to make XMLs
