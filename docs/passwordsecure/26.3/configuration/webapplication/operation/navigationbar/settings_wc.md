...
The settings are called up via the [Navigation bar](/docs/passwordsecure/26.3/configuration/webapplication/operation/navigationbar/navigation_bar.md). The following options are
available:
...
global [User rights](/docs/passwordsecure/26.3/configuration/advancedview/mainmenufc/userrights/user_rights.md) and
