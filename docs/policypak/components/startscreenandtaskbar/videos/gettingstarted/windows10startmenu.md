---
title: "PolicyPak Start Screen Manager: Own the Win10 Start Menu"
description: "PolicyPak Start Screen Manager: Own the Win10 Start Menu"
sidebar_position: 20
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/05p9hGDMxGE" title="PolicyPak Start Screen Manager: Own the Win10 Start Menu" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak Start Screen Manager: Own the Win10 Start Menu

Hi. This is Jeremy Moskowitz, former Group Policy MVP and Founder of Netwrix PolicyPak Software. In this video, I'm going to show you how you can tame the dreaded
...
I'll call this "Get PolicyPak Help," and then the "URL" can be
...
and click on "Get PolicyPak Help," and that guy's fine. So we've deployed all three
...
groups. Only groups created by PolicyPak will remain." That's it. This is not
...
deployment tool to deploy it and use PolicyPak Start Screen Manager to get the icon
right where you want to in the right group of your choice.

PolicyPak Start Screen Manager is a real game changer. Continue to watch the other
videos, like how to change
[PolicyPak File Associations Manager: Manage Windows 10 & 11 File Associations](/docs/policypak/components/fileassociationsmanager/videolearningcenter/gettingstarted/windows10.md) settings,
