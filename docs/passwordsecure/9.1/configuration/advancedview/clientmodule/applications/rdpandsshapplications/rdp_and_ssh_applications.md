...
missing information will be requested directly after the connection is established. It's therefore
...
It's also possible to use SSH-certificates for authentication. For this purpose, the certificate is
