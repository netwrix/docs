...
![Explore Folder option from Jobs Tree](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/jobs/explorefolder.webp)
...
![Jobs folder in File Explorer](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/jobs/explorefolderfileexplorer.webp)
...
![Extract zip file contents to the Jobs folder](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/jobs/instantiateextract.webp)
...
![New job added in the Jobs folder ](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/jobs/instantiatefileexplorer.webp)
...
![Refresh Tree](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/jobs/refreshtree.webp)

**Step 4 –** In the Enterprise Auditor Console, right-click on the **Jobs** node and select
**Refresh Tree**.

![Job displayed in the Jobs Tree](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/jobs/instantiatejobstree.webp)
