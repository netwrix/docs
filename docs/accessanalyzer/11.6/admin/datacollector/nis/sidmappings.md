...
ID Mappings. You can add multiple entries. For each range of User ID or Group ID you enter, the
wizard adds the offset to the ID, and the resulting SID uses the format with `%d` replaced by the
ID.
