...
**IMPORTANT!** To add an NFS share, ensure you've configured it for crawling as described in
...
| Write classifications       | Select if you want to write classifications directly into the document properties, i.e. use tagging. This applies to DOC/DOCX/XLS/XLSX/PPT/PPTX/PDF. See also [File System](/docs/dataclassification/5.6.2/contentconfigurationoverview/sourcesintro/sourcesmanage/manage_file_system.md).                                                                                                                                                                       |
...
| Date Filter                 | Use this calendar control to crawl only content modified since the specified date. This helps prioritize recent data in situations with high content volume, where the most recent content typically carries the highest risk.                                                                                                                                   |
...
| Document Type               | Specify a value that restricts queries when using the search index.                                                                                                                                                                                                                                                                                                                                                     |
...
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Basic settings**       |                                                                                                                                                                                                                                                             |
| File Source              | Select how you want to provide the file location: - **File** - enter file path - **Browse** - browse for the file you need                                                                                                                                  |
| Source Group             | Default value recommended.                                                                                                                                                                                                                                  |
| **Advanced settings**    |                                                                                                                                                                                                                                                             |
