...
![Box DC Wizard Authentication page](/img/product_docs/accessanalyzer/admin/datacollector/box/authentication.webp)
...
![BoxLogin window](/img/product_docs/accessanalyzer/admin/datacollector/box/boxlogin.webp)
