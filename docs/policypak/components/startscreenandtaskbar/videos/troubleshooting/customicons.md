---
title: "PolicyPak Start Screen Manager and Special Custom Icons"
description: "PolicyPak Start Screen Manager and Special Custom Icons"
sidebar_position: 10
---
# PolicyPak Start Screen Manager and Special Custom Icons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/2A8i7DhKWME" title="PolicyPak Start Screen Manager and Special Custom Icons" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### PolicyPak Start Screen Manager and Special Custom Icons

Hi. This is Jeremy Moskowitz. In this video, I'm going to show you how you can use Netwrix PolicyPak Start Screen Manager to dictate icons with the correct
iconography on the Start Menu.

Here's the example lash-up. I used PolicyPak Start Screen Manager to create a group
...
have to use the custom tile type in PolicyPak Start Screen Manager. Then you have to
