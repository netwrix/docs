---
title: "How to use Netwrix Auditor to Report on PolicyPak events"
description: "How to use Netwrix Auditor to Report on PolicyPak events"
sidebar_position: 20
---

# How to use Netwrix Auditor to Report on PolicyPak events

This topic shows you how to generate reports for interesting events from the PolicyPak
event logs, that you can then use to create LPM policies as needed.

## Report

![1325_1](/images/policypak/integration/auditor/1325_1.webp)

Policy created in LPM using the report details above.

![1325_2](/images/policypak/integration/auditor/1325_2.webp)

## Getting Started

In order to receive PolicyPak reports for events via Netwrix Auditor, you need to
complete the following steps.

**Step 1 –** Creating a monitoring plan for PolicyPak events.

**Step 2 –** Configuring sources, filters, events, database settings.

**Step 3 –** Optional: configure alerts.

## Creating a monitoring plan for PolicyPak events
...
![1325_3](/images/policypak/integration/auditor/1325_3.webp)
...
![1325_4](/images/policypak/integration/auditor/1325_4.webp)
...
![1325_5](/images/policypak/integration/auditor/1325_5.webp)
...
![1325_6](/images/policypak/integration/auditor/1325_6.webp)
...
![1325_7](/images/policypak/integration/auditor/1325_7.webp)

**Step 4 –** In the **Notifications** tab you can configure SMTP settings.

![1325_8](/images/policypak/integration/auditor/1325_8.webp)
...
![1325_9](/images/policypak/integration/auditor/1325_9.webp)
...
![1325_10](/images/policypak/integration/auditor/1325_10.webp)
...
![1325_11](/images/policypak/integration/auditor/1325_11.webp)
...
- Event log – here we need to type in PolicyPak manually, as it is not available in
  the drop down list.
...
![1325_12](/images/policypak/integration/auditor/1325_12.webp)
...
For example, here is the list of event IDs related to PolicyPak Least Privilege
Manager Global Audit events:

![1325_13](/images/policypak/integration/auditor/1325_13.webp)
...
![1325_14](/images/policypak/integration/auditor/1325_14.webp)

Then click **Add** to add a new alert.

![1325_15](/images/policypak/integration/auditor/1325_15.webp)
...
![1325_16](/images/policypak/integration/auditor/1325_16.webp)

![1325_17](/images/policypak/integration/auditor/1325_17.webp)

Group of Specific Events Alert Example:

![1325_18](/images/policypak/integration/auditor/1325_18.webp)

![1325_19](/images/policypak/integration/auditor/1325_19.webp)
...
![1325_20](/images/policypak/integration/auditor/1325_20.webp)

Here you can specify the conditions and filters to represent in the report, such as date range,
Event level etc.

![1325_21](/images/policypak/integration/auditor/1325_21.webp)
...
![1325_22](/images/policypak/integration/auditor/1325_22.webp)
