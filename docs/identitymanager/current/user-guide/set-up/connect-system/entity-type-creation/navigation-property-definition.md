...
How to define the properties which describe the [Entity Type](../../../../integration-guide/toolkit/xml-configuration/metadata/entitytype)'s relationships to other entity types.
...
>
> ![Navigation Property - memberOf](/images/identitymanager/entitytypecreation_memberof_v600.webp)
>
...
>
> ![Navigation Property - member](/images/identitymanager/entitytypecreation_member_v600.webp)
...
> manager"​™s page:
>
> ![Navigation Property - Manager](/images/identitymanager/entitytypecreation_manager_v600.webp)
>
...
>
> ![Navigation Property - Managed Department](/images/identitymanager/entitytypecreation_managerof_v600.webp)
...
Some systems only expose one side. For example, AD only exposes `member` on groups. Users don"​™t have `memberOf`. But Identity Manager links both sides, translating the info to simulate bidirectionality.
...
4. Fill in the information fields:
    ...
    ![**navigation properties**](/images/identitymanager/entitytypecreation_navigationproperties_v602.webp)
...
**> ![AD Entity Type - **navigation properties**](/images/identitymanager/entitytypecreation_examplead3_v603.webp)**
...
5. Click the gear icon to access advanced settings:
    ...
    - `Icon`: Choose from [Microsoft icon set](https://developer.microsoft.com/en-us/fluentui#/styles/web/icons#available-icons)
    - **Source Expression**: Define using a property path or
[expression](../../../../integration-guide/toolkit/expressions)

        > Example: Scalar `isUnused` created by combining `accountExpires` and `lastLogonTimestamp`
>
        > ![Source Expression Example](/images/identitymanager/entitytypecreation_sourceexpressionexample_v60.webp)
