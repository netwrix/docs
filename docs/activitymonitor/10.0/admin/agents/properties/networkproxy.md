...
![Agent Properties - Network Tab](/images/activitymonitor/9.0/admin/agents/properties/networkproxytab.webp)
...
- Bypass list – Specify the Bypass list. This is a list of URIs that don't use the proxy server
  when accessed. Separate multiple addresses with space, comma (,), semicolon (;), or
  on separate lines.
