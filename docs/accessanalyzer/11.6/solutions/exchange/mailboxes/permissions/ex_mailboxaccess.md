...
## Analysis Tasks for the EX_MailboxAccess Job
...
![Analysis Tasks for the EX_MailboxAccess Job](/images/accessanalyzer/11.6/solutions/exchange/mailboxes/permissions/mailboxaccessanalysis.webp)
...
The following analysis task is selected to export data to the AIC:
