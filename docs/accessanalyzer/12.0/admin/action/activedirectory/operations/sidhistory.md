...
![Active Directory Action Module Wizard Clear/Set SID History page](/img/product_docs/accessanalyzer/12.0/admin/action/activedirectory/operations/sidhistory.webp)
