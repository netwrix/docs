...
- [[feedback_kb_step_subheadings]] — the Step N — subheadings rule (subset of this document; consider deprecating in favor of section 1 here)
- [[feedback_kb_pr_description_format]] — PR description structure (distinct concern)
- [[feedback_kb_article_retire_vs_pr]] — routing article-level retire questions vs. detail questions
- [[feedback_kb_pr_review_scan_patterns]] — if we later formalize a scan-patterns memory for the kb-pr-open skill

## Evolution

This document evolves per batch. When new patterns emerge during a batch review, add them here rather than creating scattered small memories.
